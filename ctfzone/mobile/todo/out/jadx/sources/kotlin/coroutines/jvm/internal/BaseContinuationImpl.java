    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM6956constructorimpl = Result.m6956constructorimpl(outcome);
            Object outcome2 = objM6956constructorimpl;
