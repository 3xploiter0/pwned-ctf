...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo8273minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m8419minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo8272elapsedNowUwyO8pc() {
        return Duration.m8317minusLRDsOJo(this.mark.mo8272elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo8275plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m8318plusLRDsOJo(this.adjustment, duration), null);
    }
}
