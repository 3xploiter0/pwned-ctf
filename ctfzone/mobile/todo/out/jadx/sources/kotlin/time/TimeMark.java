...
public interface TimeMark {
    ...
    TimeMark mo8273minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8275plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8420plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8419minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo8275plusLRDsOJo(Duration.m8335unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m8315isNegativeimpl($this.mo8272elapsedNowUwyO8pc());
        }
