...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo8273minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo8274minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo8275plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m8277minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo8275plusLRDsOJo(Duration.m8335unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m8281compareToLRDsOJo($this.mo8274minusUwyO8pc(other), Duration.INSTANCE.m8385getZEROUwyO8pc());
        }
    }
}
