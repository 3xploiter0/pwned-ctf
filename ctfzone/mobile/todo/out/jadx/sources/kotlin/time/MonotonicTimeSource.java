...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m8422boximpl(m8416markNowz9LOYto());
    }
    ...
    public long m8416markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m8425constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m8415elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m8414differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m8413adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m8425constructorimpl(LongSaturatedMathKt.m8411saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
