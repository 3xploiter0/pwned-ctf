        ...
        if (!compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            while (true) {
                ...
                switch (iDecodeElementIndex) {
                    case -1:
                        Object obj = objDecodeSerializableElement$default2;
                        if (objDecodeSerializableElement$default != TuplesKt.NULL) {
                            if (obj == TuplesKt.NULL) {
                                throw new SerializationException("Element 'value' is missing");
                            }
                            result = toResult(objDecodeSerializableElement$default, obj);
                            break;
                        } else {
                    ...
                    case 0:
                        ...
                        objDecodeSerializableElement$default2 = objDecodeSerializableElement$default2;
                        continue;
                    case 1:
            ...
            result = toResult(CompositeDecoder.DefaultImpls.decodeSerializableElement$default(compositeDecoderBeginStructure, getDescriptor(), 0, getKeySerializer(), null, 8, null), CompositeDecoder.DefaultImpls.decodeSerializableElement$default(compositeDecoderBeginStructure, getDescriptor(), 1, getValueSerializer(), null, 8, null));
        }
        R r = (R) result;
