...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m8538computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (default$iv == null) {
            try {
                ...
                objM6956constructorimpl = Result.m6956constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
            }
            default$iv = Result.m6955boximpl(objM6956constructorimpl);
