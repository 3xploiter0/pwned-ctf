...
public interface SendChannel<E> {
    ...
    Object mo8459trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo8459trySendJP2dKIU(e);
            if (ChannelResult.m8479isSuccessimpl(result)) {
                return true;
            }
            Throwable thM8473exceptionOrNullimpl = ChannelResult.m8473exceptionOrNullimpl(result);
