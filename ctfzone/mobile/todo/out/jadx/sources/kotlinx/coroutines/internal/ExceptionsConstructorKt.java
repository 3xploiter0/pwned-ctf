...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM6956constructorimpl = Result.m6956constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m6962isFailureimpl(objM6956constructorimpl)) {
                objM6956constructorimpl = null;
            }
            return (E) objM6956constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    objM6956constructorimpl = Result.m6956constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m6962isFailureimpl(objM6956constructorimpl) ? null : objM6956constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM6956constructorimpl = Result.m6956constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m6962isFailureimpl(objM6956constructorimpl)) {
            objM6956constructorimpl = numValueOf;
        }
        return ((Number) objM6956constructorimpl).intValue();
    }
