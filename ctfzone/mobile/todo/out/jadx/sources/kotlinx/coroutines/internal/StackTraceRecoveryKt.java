...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM6956constructorimpl2;
        ...
        try {
            ...
            objM6956constructorimpl = Result.m6956constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m6959exceptionOrNullimpl(objM6956constructorimpl) == null) {
            obj2 = objM6956constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM6956constructorimpl2 = Result.m6956constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM6956constructorimpl2 = Result.m6956constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m6959exceptionOrNullimpl(objM6956constructorimpl2) == null) {
            obj = objM6956constructorimpl2;
        }
