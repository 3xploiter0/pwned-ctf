...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6956constructorimpl = Result.m6956constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6962isFailureimpl(objM6956constructorimpl) ? null : objM6956constructorimpl);
