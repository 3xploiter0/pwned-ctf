...
final class WeightTypefaceApi14 {
    ...
    private static Typeface getBestFontFromFamily(TypefaceCompatBaseImpl compat, Context context, Typeface base, int weight, boolean italic) throws NoSuchFieldException {
