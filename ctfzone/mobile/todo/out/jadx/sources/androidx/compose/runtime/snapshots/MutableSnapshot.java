...
public class MutableSnapshot extends Snapshot {
    ...
    */
    ...
    public void dispose() {
        if (!getDisposed()) {
            super.dispose();
            mo3591nestedDeactivated$runtime_release(this);
        }
    }
    ...
    public final SnapshotApplyResult innerApplyLocked$runtime_release(int snapshotId, Map<StateRecord, ? extends StateRecord> optimisticMerges, SnapshotIdSet invalidSnapshots) {
                                    ...
                                    if (Intrinsics.areEqual(current, previous)) {
                                        ...
                                        if (!Intrinsics.areEqual(merged, applied)) {
                                            if (Intrinsics.areEqual(merged, current)) {
                                                ...
                                                list5.add(TuplesKt.to(state, current.create()));
                                                if (list == null) {
                                                    it = new ArrayList();
                                                    list = it;
                                                } else {
                                                ...
                                                list5.add(!Intrinsics.areEqual(merged, previous) ? TuplesKt.to(state, merged) : TuplesKt.to(state, previous.create()));
                                                list5 = list3;
                                            }
                                        }
                                    }
        ...
        if (list != null) {
            ...
            this.merged = $this$fastForEach$iv == null ? list7 : CollectionsKt.plus((Collection) $this$fastForEach$iv, (Iterable) list7);
        }
