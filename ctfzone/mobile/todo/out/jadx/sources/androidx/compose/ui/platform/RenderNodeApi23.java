...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m4092getAutoNrFUSI();
    private int left;
    ...
    public void mo5690setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m4088equalsimpl0(value, CompositingStrategy.INSTANCE.m4094getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4088equalsimpl0(value, CompositingStrategy.INSTANCE.m4093getModulateAlphaNrFUSI())) {
            this.renderNode.setLayerType(0);
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4088equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4094getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m3974clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
