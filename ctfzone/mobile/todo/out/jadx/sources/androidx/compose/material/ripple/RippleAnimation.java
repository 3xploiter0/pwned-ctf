...
public final class RippleAnimation {
    ...
    */
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new C00972(RippleAnimation.this, null), 3, null);
    ...
    static final class C04382 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C04382(Continuation<? super C04382> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04382 c04382 = RippleAnimation.this.new C04382(continuation);
            c04382.L$0 = obj;
            return c04382;
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04382(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m1756draw4WTKRHQ(DrawScope $this$draw_u2d4WTKRHQ, long color) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1758getRippleStartRadiusuvyYCjk($this$draw_u2d4WTKRHQ.mo4559getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            float $this$isUnspecified$iv = this.radius;
            this.targetRadius = Float.isNaN($this$isUnspecified$iv) ? Float.valueOf(RippleAnimationKt.m1757getRippleEndRadiuscSwnlzA($this$draw_u2d4WTKRHQ, this.bounded, $this$draw_u2d4WTKRHQ.mo4559getSizeNHjbRc())) : Float.valueOf($this$draw_u2d4WTKRHQ.mo373toPx0680j_4(this.radius));
        }
        if (this.origin == null) {
            this.origin = Offset.m3751boximpl($this$draw_u2d4WTKRHQ.mo4558getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m3751boximpl(OffsetKt.Offset(Size.m3831getWidthimpl($this$draw_u2d4WTKRHQ.mo4559getSizeNHjbRc()) / 2.0f, Size.m3828getHeightimpl($this$draw_u2d4WTKRHQ.mo4559getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM3762getXimpl = Offset.m3762getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp = MathHelpersKt.lerp(fM3762getXimpl, Offset.m3762getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM3763getYimpl = Offset.m3763getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(fLerp, MathHelpersKt.lerp(fM3763getYimpl, Offset.m3763getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long modulatedColor = Color.m4001copywmQWz5c(color, (14 & 1) != 0 ? Color.m4005getAlphaimpl(color) : Color.m4005getAlphaimpl(color) * alpha, (14 & 2) != 0 ? Color.m4009getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(color) : 0.0f);
        if (!this.bounded) {
            DrawScope.m4540drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float right$iv = Size.m3831getWidthimpl($this$draw_u2d4WTKRHQ.mo4559getSizeNHjbRc());
        float bottom$iv = Size.m3828getHeightimpl($this$draw_u2d4WTKRHQ.mo4559getSizeNHjbRc());
        ...
        $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo4483clipRectN_I0leg(0.0f, 0.0f, right$iv, bottom$iv, clipOp$iv);
        DrawScope.m4540drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, 120, null);
