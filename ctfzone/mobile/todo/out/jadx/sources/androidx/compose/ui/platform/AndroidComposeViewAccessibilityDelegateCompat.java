...
public final class AndroidComposeViewAccessibilityDelegateCompat extends AccessibilityDelegateCompat {
    ...
    public final boolean m5672canScroll0AR0LA0$ui_release(boolean vertical, int direction, long position) {
        if (!Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            return false;
        }
        return m5671canScrollmoWRBKg(getCurrentSemanticsNodes(), vertical, direction, position);
    }

    /* renamed from: canScroll-moWRBKg, reason: not valid java name */
    private final boolean m5671canScrollmoWRBKg(IntObjectMap<SemanticsNodeWithAdjustedBounds> currentSemanticsNodes, boolean vertical, int direction, long position) {
        SemanticsPropertyKey scrollRangeProperty;
        ScrollAxisRange scrollRange;
        if (Offset.m3759equalsimpl0(position, Offset.INSTANCE.m3777getUnspecifiedF1C5BW0()) || !Offset.m3765isValidimpl(position)) {
            return false;
        }
        if (vertical) {
                ...
                if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        ...
                        if ($i$f$isFull != 0) {
                            ...
                            if (RectHelper_androidKt.toComposeRect(node.getAdjustedBounds()).m3788containsk4lQ0M(position) && (scrollRange = (ScrollAxisRange) SemanticsConfigurationKt.getOrNull(node.getSemanticsNode().getUnmergedConfig(), scrollRangeProperty)) != null) {
    ...
    public final Rect boundsInScreen(SemanticsNodeWithAdjustedBounds node) {
        ...
        long topLeftInScreen = this.view.mo5292localToScreenMKHz9U(OffsetKt.Offset(boundsInRoot.left, boundsInRoot.top));
        long bottomRightInScreen = this.view.mo5292localToScreenMKHz9U(OffsetKt.Offset(boundsInRoot.right, boundsInRoot.bottom));
        return new Rect((int) Math.floor(Offset.m3762getXimpl(topLeftInScreen)), (int) Math.floor(Offset.m3763getYimpl(topLeftInScreen)), (int) Math.ceil(Offset.m3762getXimpl(bottomRightInScreen)), (int) Math.ceil(Offset.m3763getYimpl(bottomRightInScreen)));
    }
    ...
    */
    ...
    private final String getInfoStateDescriptionOrNull(SemanticsNode node) throws Resources.NotFoundException {
        ...
        if (toggleState != null) {
            switch (WhenMappings.$EnumSwitchMapping$0[toggleState.ordinal()]) {
                case 1:
                    if ((role == null ? false : Role.m5754equalsimpl0(role.getValue(), Role.INSTANCE.m5763getSwitcho7Vup1c())) && stateDescription == null) {
        ...
        if (bool != null) {
            ...
            if (!(role == null ? false : Role.m5754equalsimpl0(role.getValue(), Role.INSTANCE.m5764getTabo7Vup1c())) && stateDescription == null) {
                if (it) {
        ...
        if (rangeInfo != null) {
            if (rangeInfo != ProgressBarRangeInfo.INSTANCE.getIndeterminate()) {
                if (stateDescription == null) {
                    ...
                    float progress = $this$fastCoerceAtLeast$iv$iv;
                    if (!(progress == 0.0f)) {
                        percent = progress == 1.0f ? 1 : 0;
                        if (percent != 0) {
                            percent = 100;
                        } else {
                            float $this$fastRoundToInt$iv = 100 * progress;
    ...
    private final String createStateDescriptionForTextField(SemanticsNode node) {
        ...
        boolean mergedNodeIsUnspeakable = z;
    ...
    private final boolean getInfoIsCheckable(SemanticsNode node) {
        ...
        bool.booleanValue();
        if (!(role == null ? false : Role.m5754equalsimpl0(role.getValue(), Role.INSTANCE.m5764getTabo7Vup1c()))) {
            return true;
        }
        return isCheckable;
    }
                        ...
                        switch (action) {
                            ...
                            case 2:
                                if (Intrinsics.areEqual(SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsProperties.INSTANCE.getFocused()), (Object) true)) {
                                    this.view.getFocusOwner().mo3691clearFocusI7lrPNg(false, true, true, FocusDirection.INSTANCE.m3682getExitdhqQ8s());
                                    break;
                                }
                                break;
                            case 16:
                            ...
                            case android.R.id.accessibilityActionScrollRight:
                                ...
                                if (z || z2) {
                                    ...
                                    if (progressBarRangeInfo != null && accessibilityAction6 != null) {
                                        ...
                                        float steps = progressBarRangeInfo.getSteps() > 0 ? (fCoerceAtLeast - fCoerceAtMost) / (progressBarRangeInfo.getSteps() + 1) : (fCoerceAtLeast - fCoerceAtMost) / 20;
                                        if (z2) {
                                            steps = -steps;
                                        }
                                ...
                                long jM3795getSizeNHjbRc = LayoutCoordinatesKt.boundsInParent(semanticsNode.getLayoutInfo().getCoordinates()).m3795getSizeNHjbRc();
                                ...
                                if (accessibilityAction7 != null) {
                                    ...
                                    if (scrollAxisRange != null && z7) {
                                        float fFloatValue = scrollViewportLength != null ? scrollViewportLength.floatValue() : Size.m3831getWidthimpl(jM3795getSizeNHjbRc);
                                        float f = (z3 || z2) ? -fFloatValue : fFloatValue;
                                        ...
                                        if (performActionHelper$canScroll(scrollAxisRange, f)) {
                                            if (semanticsNode.getUnmergedConfig().contains(SemanticsActions.INSTANCE.getPageLeft()) || semanticsNode.getUnmergedConfig().contains(SemanticsActions.INSTANCE.getPageRight())) {
                                                AccessibilityAction accessibilityAction8 = f > 0.0f ? (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsActions.INSTANCE.getPageRight()) : (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsActions.INSTANCE.getPageLeft());
                                                if (accessibilityAction8 != null && (r3 = (Function0) accessibilityAction8.getAction()) != null) {
                                                    break;
                                                } else {
                                                    break;
                                                }
                                    ...
                                    if (scrollAxisRange2 == null || !z8) {
                                        ...
                                        float fFloatValue2 = scrollViewportLength != null ? scrollViewportLength.floatValue() : Size.m3828getHeightimpl(jM3795getSizeNHjbRc);
                                        if (z5 || z2) {
                                        ...
                                        if (performActionHelper$canScroll(scrollAxisRange2, fFloatValue2)) {
                                            if (semanticsNode.getUnmergedConfig().contains(SemanticsActions.INSTANCE.getPageUp()) || semanticsNode.getUnmergedConfig().contains(SemanticsActions.INSTANCE.getPageDown())) {
                                                AccessibilityAction accessibilityAction9 = fFloatValue2 > 0.0f ? (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsActions.INSTANCE.getPageDown()) : (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsActions.INSTANCE.getPageUp());
                            ...
                            case 2097152:
                                ...
                                if (accessibilityAction15 != null && (r1 = (Function1) accessibilityAction15.getAction()) != null) {
                                    break;
                                }
                                break;
                            case android.R.id.accessibilityActionShowOnScreen:
                                ...
                                if (parent != null) {
                                    ...
                                    androidx.compose.ui.geometry.Rect rectM3799translatek4lQ0M = rectBoundsInParent.m3799translatek4lQ0M(parentLayoutCoordinates != null ? LayoutCoordinatesKt.positionInRoot(parentLayoutCoordinates) : Offset.INSTANCE.m3778getZeroF1C5BW0());
                                    androidx.compose.ui.geometry.Rect rectM3802Recttz77jQw = RectKt.m3802Recttz77jQw(semanticsNode.m5766getPositionInRootF1C5BW0(), IntSizeKt.m6667toSizeozmzZPI(semanticsNode.m5769getSizeYbymL2g()));
                                    ...
                                    float fPerformActionHelper$scrollDelta = performActionHelper$scrollDelta(rectM3802Recttz77jQw.getLeft() - rectM3799translatek4lQ0M.getLeft(), rectM3802Recttz77jQw.getRight() - rectM3799translatek4lQ0M.getRight());
                                    ...
                                    float fPerformActionHelper$scrollDelta2 = performActionHelper$scrollDelta(rectM3802Recttz77jQw.getTop() - rectM3799translatek4lQ0M.getTop(), rectM3802Recttz77jQw.getBottom() - rectM3799translatek4lQ0M.getBottom());
                                    ...
                                    if (accessibilityAction16 != null && (r1 = (Function2) accessibilityAction16.getAction()) != null) {
                                        break;
                                    } else {
                                        break;
                                    }
                            ...
                            case android.R.id.accessibilityActionPageLeft:
                                ...
                                if (accessibilityAction19 != null && (r1 = (Function0) accessibilityAction19.getAction()) != null) {
                                    break;
                                }
                                break;
                            ...
                            case android.R.id.accessibilityActionImeEnter:
                                ...
                                if (accessibilityAction21 != null && (r0 = (Function0) accessibilityAction21.getAction()) != null) {
                                    break;
                                }
                                break;
                            default:
    ...
    private final RectF toScreenCoords(SemanticsNode textNode, androidx.compose.ui.geometry.Rect bounds) {
        ...
        androidx.compose.ui.geometry.Rect boundsInRoot = bounds.m3799translatek4lQ0M(textNode.m5766getPositionInRootF1C5BW0());
        ...
        long topLeftInScreen = this.view.mo5292localToScreenMKHz9U(OffsetKt.Offset(visibleBounds.getLeft(), visibleBounds.getTop()));
        long bottomRightInScreen = this.view.mo5292localToScreenMKHz9U(OffsetKt.Offset(visibleBounds.getRight(), visibleBounds.getBottom()));
        return new RectF(Offset.m3762getXimpl(topLeftInScreen), Offset.m3763getYimpl(topLeftInScreen), Offset.m3762getXimpl(bottomRightInScreen), Offset.m3763getYimpl(bottomRightInScreen));
    }
    ...
    public final int hitTestSemanticsAt$ui_release(float x, float y) {
        ...
        LayoutNode.m5488hitTestSemanticsM_7yMNQ$ui_release$default(this.view.getRoot(), OffsetKt.Offset(x, y), hitSemanticsEntities, false, false, 12, null);
        for (int i = CollectionsKt.getLastIndex(hitSemanticsEntities); -1 < i; i--) {
            ...
            if (layoutNode.getNodes().m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8))) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void semanticsChangeChecker$lambda$49(AndroidComposeViewAccessibilityDelegateCompat this$0) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x0086 A[Catch: all -> 0x00f3, TryCatch #0 {all -> 0x00f3, blocks: (B:24:0x007e, B:26:0x0086, B:28:0x008f, B:30:0x0098, B:31:0x00ac, B:33:0x00b3, B:34:0x00bc), top: B:47:0x007e }] */
    /* JADX WARN: Removed duplicated region for block: B:40:0x00ea  */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0014  */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:37:0x00dd -> B:20:0x0068). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:39:0x00e3 -> B:20:0x0068). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    public final void notifySubtreeAccessibilityStateChangedIfNeeded(LayoutNode layoutNode) {
        if (this.subtreeChangedLayoutNodes.add(layoutNode)) {
            this.boundsUpdateChannel.mo8459trySendJP2dKIU(Unit.INSTANCE);
        }
    }
    ...
    private final void sendSubtreeChangeAccessibilityEvents(LayoutNode layoutNode, MutableIntSet subtreeChangedSemanticsNodesIds) {
        ...
        LayoutNode it;
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            LayoutNode layoutNodeFindClosestParentNode = layoutNode.getNodes().m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8)) ? layoutNode : AndroidComposeViewAccessibilityDelegateCompat_androidKt.findClosestParentNode(layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat$sendSubtreeChangeAccessibilityEvents$semanticsNode$1
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(LayoutNode it2) {
                    return Boolean.valueOf(it2.getNodes().m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8)));
                }
            });
    ...
    private final void updateSemanticsNodesCopyAndPanes() {
        ...
        IntSet this_$iv3 = this.paneDisplayed;
        int[] k$iv3 = this_$iv3.elements;
                ...
                if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        ...
                        if (!(value$iv$iv$iv < 128)) {
                            ...
                            int id = k$iv3[(i$iv$iv << 3) + j$iv$iv];
        ...
        Object[] v$iv3 = this_$iv4.values;
        IntObjectMap this_$iv$iv3 = this_$iv4;
                ...
                if ((((~slot$iv$iv2) << 7) & slot$iv$iv2 & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    while (j$iv$iv2 < bitCount$iv$iv2) {
                        ...
                        if ($i$f$isFull == 0) {
                            ...
                            int index$iv$iv = (i$iv$iv2 << 3) + j$iv$iv2;
                            int key = k$iv4[index$iv$iv];
                            SemanticsNodeWithAdjustedBounds value = (SemanticsNodeWithAdjustedBounds) v$iv3[index$iv$iv];
                            $i$f$forEach2 = $i$f$forEach3;
                            k$iv2 = k$iv4;
                            if (value.getSemanticsNode().getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getPaneTitle()) && this.paneDisplayed.add(key)) {
                                sendPaneChangeEvents(key, 16, (String) value.getSemanticsNode().getUnmergedConfig().get(SemanticsProperties.INSTANCE.getPaneTitle()));
                            }
                            v$iv2 = v$iv3;
                            this_$iv$iv2 = this_$iv$iv3;
                            this.previousSemanticsNodes.set(key, new SemanticsNodeCopy(value.getSemanticsNode(), getCurrentSemanticsNodes()));
                        }
                        slot$iv$iv2 >>= 8;
                        j$iv$iv2++;
                        v$iv3 = v$iv2;
    ...
    */
            ...
            */
            public final void invoke2() {
                ...
                Lf8:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat.C06181.invoke2():void");
            }
        });
    }
    ...
    private final void sendAccessibilitySemanticsStructureChangeEvents(SemanticsNode newNode, SemanticsNodeCopy oldNode) {
        ...
        MutableIntSet newChildren2 = IntSetKt.mutableIntSetOf();
            ...
            while (true) {
                ...
                if ((((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        ...
                        if (value$iv$iv$iv < 128) {
                            int index$iv$iv = (i$iv$iv << 3) + j$iv$iv;
                            if (!newChildren2.contains(k$iv[index$iv$iv])) {
                                notifySubtreeAccessibilityStateChangedIfNeeded(newNode.getLayoutNode());
                                return;
                            }
                        }
    ...
    private final int getAccessibilitySelectionStart(SemanticsNode node) {
        if (!node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getContentDescription()) && node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getTextSelectionRange())) {
            return TextRange.m5948getStartimpl(((TextRange) node.getUnmergedConfig().get(SemanticsProperties.INSTANCE.getTextSelectionRange())).getPackedValue());
        }
    ...
    private final int getAccessibilitySelectionEnd(SemanticsNode node) {
        if (!node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getContentDescription()) && node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getTextSelectionRange())) {
            return TextRange.m5943getEndimpl(((TextRange) node.getUnmergedConfig().get(SemanticsProperties.INSTANCE.getTextSelectionRange())).getPackedValue());
        }
        return this.accessibilityCursorPosition;
    }
