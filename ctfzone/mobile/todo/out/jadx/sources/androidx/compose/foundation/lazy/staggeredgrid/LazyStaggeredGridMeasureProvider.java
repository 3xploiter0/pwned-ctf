...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    private final long m895childConstraintsJhjzzOo(int slot, int span) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6450fixedWidthOenEA2s(end);
        }
        return Constraints.INSTANCE.m6449fixedHeightOenEA2s(end);
    }
    ...
    public final LazyStaggeredGridMeasuredItem m896getAndMeasurejy6DScQ(int index, long span) {
        ...
        int $i$f$unpackInt1 = (int) (span >> 32);
        int spanSize = RangesKt.coerceAtMost(((int) (4294967295L & span)) - $i$f$unpackInt1, slotCount - spanStart);
        long constraints = m895childConstraintsJhjzzOo(spanStart, spanSize);
        List placeables = this.measureScope.mo852measure0kLqBqw(index, constraints);
        return mo889createItempitSLOA(index, spanStart, spanSize, key, contentType, placeables, constraints);
    }
    ...
    public LazyStaggeredGridMeasuredItem mo795getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        ...
        Object contentType = this.itemProvider.getContentType(index);
        List placeables = this.measureScope.mo852measure0kLqBqw(index, constraints);
        return mo889createItempitSLOA(index, lane, span, key, contentType, placeables, constraints);
    }
