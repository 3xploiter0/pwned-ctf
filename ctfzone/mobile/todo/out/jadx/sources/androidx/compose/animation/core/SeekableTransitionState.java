...
public final class SeekableTransitionState<S> extends TransitionState<S> {
    ...
    static final class C02031 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02031(SeekableTransitionState<S> seekableTransitionState, Continuation<? super C02031> continuation) {
            super(continuation);
            this.this$0 = seekableTransitionState;
        }
    ...
    */
    ...
    public final Object snapTo(S s, Continuation<? super Unit> continuation) {
        ...
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C02012(this, s, transition, null), continuation, 1, null);
    ...
    static final class C02012 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02012(SeekableTransitionState<S> seekableTransitionState, S s, Transition<S> transition, Continuation<? super C02012> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02012(this.this$0, this.$targetState, this.$transition, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c02012 = this;
                    c02012.this$0.endAllAnimations();
                    ((SeekableTransitionState) c02012.this$0).lastFrameTimeNanos = Long.MIN_VALUE;
                    c02012.this$0.setFraction(0.0f);
                    S s = c02012.$targetState;
                    if (Intrinsics.areEqual(s, c02012.this$0.getCurrentState())) {
                        fraction = -4.0f;
                    } else {
                        fraction = Intrinsics.areEqual(s, c02012.this$0.getTargetState()) ? -5.0f : -3.0f;
                    }
                    c02012.$transition.updateTarget$animation_core_release(c02012.$targetState);
                    c02012.$transition.setPlayTimeNanos(0L);
                    c02012.this$0.setTargetState$animation_core_release(c02012.$targetState);
                    c02012.this$0.setFraction(0.0f);
                    c02012.this$0.setCurrentState$animation_core_release(c02012.$targetState);
                    c02012.$transition.resetAnimationFraction$animation_core_release(fraction);
                    if (fraction == -3.0f) {
                        c02012.label = 1;
                        if (c02012.this$0.waitForCompositionAfterTargetStateChange(c02012) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        c020122 = c02012;
                        c02012 = c020122;
                    }
                    c02012.$transition.onTransitionEnd$animation_core_release();
                    return Unit.INSTANCE;
                case 1:
                    c020122 = this;
                    ResultKt.throwOnFailure($result);
    ...
    */
    public final java.lang.Object waitForComposition(kotlin.coroutines.Continuation<? super kotlin.Unit> r15) {
        /*
            r14 = this;
            boolean r0 = r15 instanceof androidx.compose.animation.core.SeekableTransitionState.C02021
            if (r0 == 0) goto L14
            r0 = r15
            androidx.compose.animation.core.SeekableTransitionState$waitForComposition$1 r0 = (androidx.compose.animation.core.SeekableTransitionState.C02021) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    public final void moveAnimationToInitialState() {
        ...
        L31:
            ...
            r8.set$animation_core_release(r3, r9)
            goto L63
        L62:
            r1 = r2
        L63:
