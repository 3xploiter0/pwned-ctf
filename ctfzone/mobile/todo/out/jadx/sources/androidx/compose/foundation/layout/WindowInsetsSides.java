...
public final class WindowInsetsSides {
    ...
    private static final int AllowLeftInLtr = m759constructorimpl(8);
    private static final int AllowRightInLtr = m759constructorimpl(4);
    private static final int AllowLeftInRtl = m759constructorimpl(2);
    private static final int AllowRightInRtl = m759constructorimpl(1);
    private static final int Start = m764plusgK_yJZ4(AllowLeftInLtr, AllowRightInRtl);
    private static final int End = m764plusgK_yJZ4(AllowRightInLtr, AllowLeftInRtl);
    private static final int Top = m759constructorimpl(16);
    private static final int Bottom = m759constructorimpl(32);
    private static final int Left = m764plusgK_yJZ4(AllowLeftInLtr, AllowLeftInRtl);
    private static final int Right = m764plusgK_yJZ4(AllowRightInLtr, AllowRightInRtl);
    private static final int Horizontal = m764plusgK_yJZ4(Left, Right);
    private static final int Vertical = m764plusgK_yJZ4(Top, Bottom);
    ...
    public static final int m764plusgK_yJZ4(int arg0, int sides) {
        return m759constructorimpl(arg0 | sides);
    }

    /* renamed from: hasAny-bkgdKaI$foundation_layout_release, reason: not valid java name */
    public static final boolean m762hasAnybkgdKaI$foundation_layout_release(int arg0, int sides) {
        return (arg0 & sides) != 0;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m765toStringimpl(int arg0) {
        return "WindowInsetsSides(" + m766valueToStringimpl(arg0) + ')';
    }
    ...
    private static final String m766valueToStringimpl(int arg0) {
