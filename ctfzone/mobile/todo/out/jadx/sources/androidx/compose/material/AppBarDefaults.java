...
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m6485constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m6485constructorimpl(8);
    ...
    public final WindowInsets getBottomAppBarWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets windowInsetsM752onlybOOhFvg = WindowInsetsKt.m752onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.m764plusgK_yJZ4(WindowInsetsSides.INSTANCE.m774getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m772getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
