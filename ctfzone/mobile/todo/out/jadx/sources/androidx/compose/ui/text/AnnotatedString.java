...
public final class AnnotatedString implements CharSequence {
    ...
    public AnnotatedString(String text, List<Range<SpanStyle>> list, List<Range<ParagraphStyle>> list2) {
        ...
        this(text, list3.isEmpty() ? null : list3, list4.isEmpty() ? null : list4, null);
    }
    ...
    public final AnnotatedString m5799subSequence5zctL8(long range) {
        return subSequence(TextRange.m5946getMinimpl(range), TextRange.m5945getMaximpl(range));
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x004f A[LOOP:0: B:5:0x0010->B:18:0x004f, LOOP_END] */
    ...
    */
    ...
    public final List<Range<String>> getStringAnnotations(int start, int end) {
        ...
        List $this$fastFilter$iv2 = this.annotations;
        if ($this$fastFilter$iv2 != null) {
            List target$iv = new ArrayList($this$fastFilter$iv2.size());
            int size = $this$fastFilter$iv2.size();
            for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                Range<? extends Object> range = $this$fastFilter$iv2.get(index$iv$iv);
                Range<? extends Object> it = range;
                if ((it.getItem() instanceof String) && AnnotatedStringKt.intersect(start, end, it.getStart(), it.getEnd())) {
                    target$iv.add(range);
                }
            }
    ...
    public final List<Range<TtsAnnotation>> getTtsAnnotations(int start, int end) {
        ...
        if ($this$fastFilter$iv2 != null) {
            ...
            for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                Range<? extends Object> range = $this$fastFilter$iv2.get(index$iv$iv);
                Range<? extends Object> it = range;
                if ((it.getItem() instanceof TtsAnnotation) && AnnotatedStringKt.intersect(start, end, it.getStart(), it.getEnd())) {
                    target$iv.add(range);
                }
            }
            $this$fastFilter$iv = target$iv;
    ...
    public final List<Range<UrlAnnotation>> getUrlAnnotations(int start, int end) {
        ...
        if ($this$fastFilter$iv2 != null) {
            ...
            for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                Range<? extends Object> range = $this$fastFilter$iv2.get(index$iv$iv);
                Range<? extends Object> it = range;
                if ((it.getItem() instanceof UrlAnnotation) && AnnotatedStringKt.intersect(start, end, it.getStart(), it.getEnd())) {
                    target$iv.add(range);
                }
            }
            $this$fastFilter$iv = target$iv;
    ...
    public final List<Range<LinkAnnotation>> getLinkAnnotations(int start, int end) {
        ...
        if ($this$fastFilter$iv2 != null) {
            ...
            for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                Range<? extends Object> range = $this$fastFilter$iv2.get(index$iv$iv);
                Range<? extends Object> it = range;
                if ((it.getItem() instanceof LinkAnnotation) && AnnotatedStringKt.intersect(start, end, it.getStart(), it.getEnd())) {
                    target$iv.add(range);
                }
            }
            $this$fastFilter$iv = target$iv;
    ...
    public final boolean hasLinkAnnotations(int start, int end) {
        List $this$fastAny$iv = this.annotations;
    ...
    public static final class Builder implements Appendable {
        ...
        public final AnnotatedString toAnnotatedString() {
            ...
            return new AnnotatedString(string, list, list2, arrayList);
        }
    }
