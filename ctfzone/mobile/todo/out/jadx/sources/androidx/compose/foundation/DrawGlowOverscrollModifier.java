...
final class DrawGlowOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    private final boolean drawLeftGlow(DrawScope $this$drawLeftGlow, EdgeEffect left, Canvas canvas) {
        long offset = OffsetKt.Offset(-Size.m3828getHeightimpl($this$drawLeftGlow.mo4559getSizeNHjbRc()), $this$drawLeftGlow.mo373toPx0680j_4(this.overscrollConfig.getDrawPadding().mo632calculateLeftPaddingu2uoSUM($this$drawLeftGlow.getLayoutDirection())));
        return m290drawWithRotationAndOffsetubNVwUQ(270.0f, offset, left, canvas);
    }

    private final boolean drawTopGlow(DrawScope $this$drawTopGlow, EdgeEffect top, Canvas canvas) {
        long offset = OffsetKt.Offset(0.0f, $this$drawTopGlow.mo373toPx0680j_4(this.overscrollConfig.getDrawPadding().getTop()));
        return m290drawWithRotationAndOffsetubNVwUQ(0.0f, offset, top, canvas);
    }

    private final boolean drawRightGlow(DrawScope $this$drawRightGlow, EdgeEffect right, Canvas canvas) {
        int width = MathKt.roundToInt(Size.m3831getWidthimpl($this$drawRightGlow.mo4559getSizeNHjbRc()));
        ...
        long offset = OffsetKt.Offset(0.0f, (-width) + $this$drawRightGlow.mo373toPx0680j_4(rightPadding));
        return m290drawWithRotationAndOffsetubNVwUQ(90.0f, offset, right, canvas);
    }

    private final boolean drawBottomGlow(DrawScope $this$drawBottomGlow, EdgeEffect bottom, Canvas canvas) {
        float bottomPadding = $this$drawBottomGlow.mo373toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom());
        long offset = OffsetKt.Offset(-Size.m3831getWidthimpl($this$drawBottomGlow.mo4559getSizeNHjbRc()), (-Size.m3828getHeightimpl($this$drawBottomGlow.mo4559getSizeNHjbRc())) + bottomPadding);
        return m290drawWithRotationAndOffsetubNVwUQ(180.0f, offset, bottom, canvas);
    }
    ...
    private final boolean m290drawWithRotationAndOffsetubNVwUQ(float rotationDegrees, long offset, EdgeEffect edgeEffect, Canvas canvas) {
        ...
        canvas.translate(Offset.m3762getXimpl(offset), Offset.m3763getYimpl(offset));
