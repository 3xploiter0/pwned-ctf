...
public final class BadgeKt {
    ...
    private static final float BadgeRadius = Dp.m6485constructorimpl(4);
    private static final float BadgeWithContentRadius = Dp.m6485constructorimpl(8);
    ...
    public static final void BadgedBox(final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function32, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(BadgedBox)P(!1,2)64@2555L1979:Badge.kt#jmzs0o");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        ...
        if (($dirty2 & 731) == 146 && $composer2.getSkipping()) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "anchor")) {
                                    ...
                                    return $this$Layout.layout(totalWidth, totalHeight, MapsKt.mapOf(TuplesKt.to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(firstBaseline)), TuplesKt.to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(lastBaseline))), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.BadgeKt.BadgedBox.2.1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope $this$layout) {
                                            boolean hasContent = badgePlaceable.getWidth() > $this$Layout.mo367roundToPx0680j_4(BadgeKt.getBadgeRadius()) * 2;
            ...
            int $changed$iv$iv = (((($dirty2 & 112) | 384) << 9) & 7168) | 6;
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1649829622, "C66@2585L161,71@2759L105:Badge.kt#jmzs0o");
    ...
    public static final void m1439BadgeeopBjH0(Modifier modifier, long backgroundColor, long contentColor, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long contentColor2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    backgroundColor2 = MaterialTheme.INSTANCE.getColors($composer2, 6).m1490getError0d7_KjU();
                    $dirty &= -113;
                } else {
                    backgroundColor2 = j;
                }
            ...
            RoundedCornerShape shape = RoundedCornerShapeKt.m964RoundedCornerShape0680j_4(radius);
            Modifier modifierM683paddingVpY3zN4$default = PaddingKt.m683paddingVpY3zN4$default(ClipKt.clip(BackgroundKt.m235backgroundbw27NRU(SizeKt.m710defaultMinSizeVpY3zN4(modifier3, Dp.m6485constructorimpl(2 * radius), Dp.m6485constructorimpl(2 * radius)), backgroundColor2, shape), shape), BadgeWithContentHorizontalPadding, 0.0f, 2, null);
            ...
            Function3 skippableUpdate$iv$iv$iv = LayoutKt.modifierMaterializerOf(modifierM683paddingVpY3zN4$default);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 104299802, "C:Badge.kt#jmzs0o");
            $composer2.startReplaceableGroup(521574265);
            ComposerKt.sourceInformation($composer2, "155@6009L340");
            if (content != null) {
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3993boximpl(contentColor2)), ComposableLambdaKt.composableLambda($composer2, 1784526485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BadgeKt$Badge$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ComposerKt.sourceInformation($composer3, "C158@6149L10,159@6221L114:Badge.kt#jmzs0o");
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(1784526485, $changed2, -1, "androidx.compose.material.Badge.<anonymous>.<anonymous> (Badge.kt:158)");
                            }
                            TextStyle style = TextStyle.m5961copyp1EtxEg$default(MaterialTheme.INSTANCE.getTypography($composer3, 6).getButton(), 0L, BadgeKt.BadgeContentFontSize, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, null, 0, 0, null, 16777213, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BadgeKt$Badge$2
                ...
                public final void invoke(Composer composer, int i8) {
                    BadgeKt.m1439BadgeeopBjH0(modifier6, j2, j3, function32, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    static {
        ...
        float arg0$iv2 = Dp.m6485constructorimpl(4);
        BadgeHorizontalOffset = Dp.m6485constructorimpl(-arg0$iv2);
    }
