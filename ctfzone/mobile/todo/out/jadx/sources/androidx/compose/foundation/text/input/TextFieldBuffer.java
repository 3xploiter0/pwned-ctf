...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1106getOriginalRangejx7JFs(int changeIndex);

        /* renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1107getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1102getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m5942getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1104setSelection5zctL8(long value) {
        m1100requireValidRange5zctL8(value);
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        int selStart = TextRange.m5946getMinimpl(getSelectionInChars());
        int selEnd2 = TextRange.m5945getMaximpl(getSelectionInChars());
        if (selEnd2 < start) {
            return;
        }
    ...
    public final void revertAllChanges() {
        ...
        m1104setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1101toTextFieldCharSequenceudt6zUU$foundation_release$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldBuffer.m1105toTextFieldCharSequenceudt6zUU$foundation_release(j, textRange);
    }

    /* renamed from: toTextFieldCharSequence-udt6zUU$foundation_release, reason: not valid java name */
    public final TextFieldCharSequence m1105toTextFieldCharSequenceudt6zUU$foundation_release(long selection, TextRange composition) {
    ...
    private final void m1100requireValidRange5zctL8(long range) {
        long validRange = TextRangeKt.TextRange(0, getLength());
        if (!TextRange.m5938contains5zctL8(validRange, range)) {
            throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m5951toStringimpl(range)) + " to be in " + ((Object) TextRange.m5951toStringimpl(validRange))).toString());
        }
    }
}
