...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo808invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m6431equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m6426boximpl(constraints));
