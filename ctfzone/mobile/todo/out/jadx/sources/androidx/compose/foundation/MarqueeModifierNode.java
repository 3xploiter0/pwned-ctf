...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int iterations, int animationMode, int delayMillis, int initialDelayMillis, final MarqueeSpacing spacing, float velocity) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m307boximpl(animationMode), null, 2, null);
    ...
    public final void m322setAnimationMode97h66l8(int i) {
        ...
        $this$setValue$iv.setValue(MarqueeAnimationMode.m307boximpl(i));
    }
    ...
    public final void m323updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        ...
        if (this.iterations != iterations || this.delayMillis != delayMillis || this.initialDelayMillis != initialDelayMillis || !Dp.m6490equalsimpl0(this.velocity, velocity)) {
            this.iterations = iterations;
            this.delayMillis = delayMillis;
            this.initialDelayMillis = initialDelayMillis;
            this.velocity = velocity;
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        long childConstraints = Constraints.m6428copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6440getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6438getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m6439getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6437getMaxHeightimpl(constraints) : 0);
        final Placeable placeable = measurable.mo5339measureBRTryo0(childConstraints);
        setContainerWidth(ConstraintsKt.m6455constrainWidthK40F9xA(constraints, placeable.getWidth()));
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, getContainerWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                Placeable.PlacementScope.placeWithLayer$default($this$layout, placeable, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, (Function1) null, 12, (Object) null);
            }
        }, 4, null);
    }
    ...
    */
    public void draw(androidx.compose.ui.graphics.drawscope.ContentDrawScope r26) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MarqueeModifierNode.draw(androidx.compose.ui.graphics.drawscope.ContentDrawScope):void");
    }
                ...
                case 0:
                    ...
                    if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                        ...
                        public final Float invoke() {
                            ...
                            if (!MarqueeAnimationMode.m310equalsimpl0(marqueeModifierNode.m321getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m315getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
