    ...
    public static final void MaterialTheme(Colors colors, Typography typography, Shapes shapes, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-891417079, $dirty, -1, "androidx.compose.material.MaterialTheme (MaterialTheme.kt:63)");
            }
            ...
            if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = colors4.m1488copypvPzIIM((8191 & 1) != 0 ? colors4.m1496getPrimary0d7_KjU() : 0L, (8191 & 2) != 0 ? colors4.m1497getPrimaryVariant0d7_KjU() : 0L, (8191 & 4) != 0 ? colors4.m1498getSecondary0d7_KjU() : 0L, (8191 & 8) != 0 ? colors4.m1499getSecondaryVariant0d7_KjU() : 0L, (8191 & 16) != 0 ? colors4.m1489getBackground0d7_KjU() : 0L, (8191 & 32) != 0 ? colors4.m1500getSurface0d7_KjU() : 0L, (8191 & 64) != 0 ? colors4.m1490getError0d7_KjU() : 0L, (8191 & 128) != 0 ? colors4.m1493getOnPrimary0d7_KjU() : 0L, (8191 & 256) != 0 ? colors4.m1494getOnSecondary0d7_KjU() : 0L, (8191 & 512) != 0 ? colors4.m1491getOnBackground0d7_KjU() : 0L, (8191 & 1024) != 0 ? colors4.m1495getOnSurface0d7_KjU() : 0L, (8191 & 2048) != 0 ? colors4.m1492getOnError0d7_KjU() : 0L, (8191 & 4096) != 0 ? colors4.isLight() : false);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ColorsKt.getLocalColors().provides(rememberedColors), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh($composer2, 6))), IndicationKt.getLocalIndication().provides(rippleIndication), RippleThemeKt.getLocalRippleTheme().provides(MaterialRippleTheme.INSTANCE), ShapesKt.getLocalShapes().provides(shapes3), TextSelectionColorsKt.getLocalTextSelectionColors().provides(selectionColors), TypographyKt.getLocalTypography().provides(typography2)}, ComposableLambdaKt.composableLambda($composer2, -1740102967, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.MaterialThemeKt.MaterialTheme.1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1740102967, $changed2, -1, "androidx.compose.material.MaterialTheme.<anonymous> (MaterialTheme.kt:80)");
                        }
                        ...
                        TextKt.ProvideTextStyle(body1, ComposableLambdaKt.composableLambda($composer3, 181426554, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.MaterialThemeKt.MaterialTheme.1.1
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(181426554, $changed3, -1, "androidx.compose.material.MaterialTheme.<anonymous>.<anonymous> (MaterialTheme.kt:81)");
                                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.MaterialThemeKt.MaterialTheme.2
                ...
                public final void invoke(Composer composer, int i5) {
                    MaterialThemeKt.MaterialTheme(colors5, typography4, shapes5, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
