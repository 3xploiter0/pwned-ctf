...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        float firstLine;
        if (textIndent != null) {
            if ((!TextUnit.m6675equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m6675equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m6696isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m6696isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long jM6677getTypeUIouoOA = TextUnit.m6677getTypeUIouoOA(textIndent.getFirstLine());
                float fM6678getValueimpl = 0.0f;
                if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6711getSpUIouoOA())) {
                    firstLine = density.mo372toPxR2X_6o(textIndent.getFirstLine());
                } else {
                    firstLine = TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6710getEmUIouoOA()) ? TextUnit.m6678getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long jM6677getTypeUIouoOA2 = TextUnit.m6677getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA2, TextUnitType.INSTANCE.m6711getSpUIouoOA())) {
                    fM6678getValueimpl = density.mo372toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA2, TextUnitType.INSTANCE.m6710getEmUIouoOA())) {
                    fM6678getValueimpl = TextUnit.m6678getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
                float restLine = fM6678getValueimpl;
    ...
    public static final void m6229setLineHeightKmRG4DE(Spannable $this$setLineHeight_u2dKmRG4DE, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        float resolvedLineHeight = m6224resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan($this$setLineHeight_u2dKmRG4DE, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m6337isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m6338isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, $this$setLineHeight_u2dKmRG4DE.length());
        }
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m6230setLineHeightr9BaKPg(Spannable $this$setLineHeight_u2dr9BaKPg, long lineHeight, float contextFontSize, Density density) {
        float resolvedLineHeight = m6224resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m6224resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long jM6677getTypeUIouoOA = TextUnit.m6677getTypeUIouoOA(lineHeight);
        if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6711getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo372toPxR2X_6o(lineHeight);
            }
            long fontSizeSp = density.mo376toSpkPz2Gy4(contextFontSize);
            float lineHeightMultiplier = TextUnit.m6678getValueimpl(lineHeight) / TextUnit.m6678getValueimpl(fontSizeSp);
            return lineHeightMultiplier * contextFontSize;
        }
        if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6710getEmUIouoOA())) {
            return TextUnit.m6678getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m6223createLetterSpacingSpaneAf_CNQ(style.getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m6226setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m6227setColorRPmYEkk($this$setSpanStyle, style.m5898getColor0d7_KjU(), start, end);
        ...
        m6228setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m6225setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(contextTextStyle)) {
            contextFontSpanStyle = new SpanStyle(0L, 0L, contextTextStyle.getFontWeight(), contextTextStyle.m5980getFontStyle4Lr2A7w(), contextTextStyle.m5981getFontSynthesisZQGJjVo(), contextTextStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                FontStyle fontStyleM6055boximpl = FontStyle.m6055boximpl(fontStyle != null ? fontStyle.m6061unboximpl() : FontStyle.INSTANCE.m6065getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM6055boximpl, FontSynthesis.m6066boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6075getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
        ...
        while (i < length) {
            ...
            if (transitionOffset == lastTransitionOffsets) {
                ...
                while (index$iv2 < size2) {
                    ...
                    AnnotatedString.Range spanStyle2 = item$iv2;
                    int spanCount3 = spanCount2;
                    if (spanStyle2.getStart() != spanStyle2.getEnd() && AnnotatedStringKt.intersect(lastTransitionOffsets, transitionOffset, spanStyle2.getStart(), spanStyle2.getEnd())) {
                        spanStyleMerge = merge(spanStyleMerge, spanStyle2.getItem());
                    }
                    index$iv2++;
    ...
    private static final MetricAffectingSpan m6223createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long jM6677getTypeUIouoOA = TextUnit.m6677getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6711getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo372toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6710getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m6678getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m6706equalsimpl0(TextUnit.m6677getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m6711getSpUIouoOA()) || TextUnitType.m6706equalsimpl0(TextUnit.m6677getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m6710getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            setSpan($this$setShadow, new ShadowSpan(ColorKt.m4057toArgb8_81llA(shadow.getColor()), Offset.m3762getXimpl(shadow.getOffset()), Offset.m3763getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m6225setBackgroundRPmYEkk(Spannable $this$setBackground_u2dRPmYEkk, long color, int start, int end) {
        if (color != 16) {
            setSpan($this$setBackground_u2dRPmYEkk, new BackgroundColorSpan(ColorKt.m4057toArgb8_81llA(color)), start, end);
        }
    }
    ...
    public static final void m6228setFontSizeKmRG4DE(Spannable $this$setFontSize_u2dKmRG4DE, long fontSize, Density density, int start, int end) {
        long jM6677getTypeUIouoOA = TextUnit.m6677getTypeUIouoOA(fontSize);
        if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6711getSpUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo372toPxR2X_6o(fontSize)), false), start, end);
        } else if (TextUnitType.m6706equalsimpl0(jM6677getTypeUIouoOA, TextUnitType.INSTANCE.m6710getEmUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new RelativeSizeSpan(TextUnit.m6678getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m6227setColorRPmYEkk(Spannable $this$setColor_u2dRPmYEkk, long color, int start, int end) {
        if (color != 16) {
            setSpan($this$setColor_u2dRPmYEkk, new ForegroundColorSpan(ColorKt.m4057toArgb8_81llA(color)), start, end);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m6226setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m6242unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m6227setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m5981getFontSynthesisZQGJjVo() != null;
    }
