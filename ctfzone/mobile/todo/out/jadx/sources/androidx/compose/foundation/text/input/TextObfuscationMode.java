...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1124constructorimpl(0);
    private static final int RevealLastTyped = m1124constructorimpl(1);
    private static final int Hidden = m1124constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1123boximpl(int i) {
        return new TextObfuscationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1124constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1125equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1129unboximpl();
    }
    ...
    public static int m1127hashCodeimpl(int i) {
    ...
    public String toString() {
        return m1128toStringimpl(this.value);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m1129unboximpl() {
        return this.value;
    }
