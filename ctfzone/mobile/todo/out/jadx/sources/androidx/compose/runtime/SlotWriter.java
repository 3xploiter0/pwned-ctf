...
public final class SlotWriter {
    ...
    private final GroupSourceInformation groupSourceInformationFor(int parent, String sourceInformation) {
        ...
        GroupSourceInformation groupSourceInformation2 = $this$getOrPut$iv.get(anchor);
        if (groupSourceInformation2 == null) {
            GroupSourceInformation result = new GroupSourceInformation(0, sourceInformation, 0);
            ...
            $this$getOrPut$iv.put(anchor, groupSourceInformation);
        } else {
    ...
    public final int endGroup() {
        ...
        if (inserting) {
            ...
            int oldNodes2 = SlotTableKt.nodeCount(this.groups, groupAddress);
            SlotTableKt.updateGroupSize(this.groups, groupAddress, newGroupSize);
            SlotTableKt.updateNodeCount(this.groups, groupAddress, newNodes);
            ...
            if (groupParent == newParent) {
                ...
                if (groupSizeDelta != 0 || nodesDelta != 0) {
                    ...
                    while (current != 0 && current != newParent && (nodesDelta != 0 || groupSizeDelta != 0)) {
                        ...
                        if (nodesDelta != 0) {
                            SlotTableKt.updateNodeCount(this.groups, currentAddress, SlotTableKt.nodeCount(this.groups, currentAddress) + nodesDelta);
                        }
    ...
    public final void moveGroup(int offset) {
        ...
        int destinationSlot2 = current + moveLen;
        int dataEnd2 = current;
        while (dataEnd2 < destinationSlot2) {
            int i = destinationSlot2;
    ...
    public static final class Companion {
        ...
        public final List<Anchor> moveGroup(SlotWriter fromWriter, int fromIndex, SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            int sourceSlotsStart2 = currentGroup;
            while (true) {
                if (sourceSlotsStart2 >= moveEnd2) {
                    break;
                }
                if (sourceSlotsStart2 != currentGroup) {
                    int previousParent = SlotTableKt.parentAnchor(groups, sourceSlotsStart2);
                    moveEnd = moveEnd2;
                    int moveEnd3 = previousParent + parentDelta;
                    SlotTableKt.updateParentAnchor(groups, sourceSlotsStart2, moveEnd3);
                } else {
                    moveEnd = moveEnd2;
                }
                int newDataIndex = toWriter.dataIndex(groups, sourceSlotsStart2) + dataIndexDelta;
                int dataIndexDelta2 = dataIndexDelta;
                int dataIndexDelta3 = slotsGapOwner2 >= sourceSlotsStart2 ? toWriter.slotsGapStart : 0;
                ...
                SlotTableKt.updateDataAnchor(groups, sourceSlotsStart2, newDataAnchor);
                if (sourceSlotsStart2 == slotsGapOwner2) {
                    slotsGapOwner2++;
                }
                sourceSlotsStart2++;
                moveEnd2 = moveEnd;
            ...
            if (startAnchors < endAnchors) {
                ...
                int slotsGapLen2 = startAnchors;
                while (slotsGapLen2 < endAnchors) {
                    int slotsGapOwner3 = slotsGapOwner2;
                    Anchor sourceAnchor = (Anchor) sourceAnchors.get(slotsGapLen2);
            ...
            if (!anchors.isEmpty()) {
                ...
                if (sourceSourceInformationMap2 != null && destinationSourceInformation != null) {
                    ...
                    int index$iv = 0;
                    int startAnchors2 = $this$fastForEach$iv.size();
                    while (index$iv < startAnchors2) {
                        Object item$iv = $this$fastForEach$iv.get(index$iv);
                        int i = startAnchors2;
                        Anchor anchor = (Anchor) item$iv;
                        int endAnchors2 = endAnchors;
            ...
            toWriter.nodeCount = i2 + iNodeCount;
            if (updateToCursor) {
    ...
    public final List<Anchor> moveFrom(SlotTable table, int index, boolean removeSourceGroup) {
        ...
        try {
            List<Anchor> listMoveGroup = INSTANCE.moveGroup(writer$iv, index, this, true, true, removeSourceGroup);
            normalClose$iv = true;
    ...
    */
    public final java.util.List<androidx.compose.runtime.Anchor> moveIntoGroupFrom(int r21, androidx.compose.runtime.SlotTable r22, int r23) throws java.lang.Throwable {
        /*
            r20 = this;
            r10 = r20
        ...
        L13:
            ...
            int r11 = r10.currentGroup
            int r12 = r10.currentSlot
            int r13 = r10.currentSlotEnd
            r20.advanceBy(r21)
            r20.startGroup()
            r20.beginInsert()
            r14 = r22
            r15 = 0
            androidx.compose.runtime.SlotWriter r0 = r14.openWriter()
            r9 = r0
            r16 = 0
            r8 = 0
            r2 = r9
            r0 = 0
            androidx.compose.runtime.SlotWriter$Companion r1 = androidx.compose.runtime.SlotWriter.INSTANCE     // Catch: java.lang.Throwable -> L6c
            r17 = 32
            r18 = 0
            r5 = 0
            r6 = 1
            ...
            r14 = r9
            r9 = r18
            java.util.List r1 = androidx.compose.runtime.SlotWriter.Companion.moveGroup$default(r1, r2, r3, r4, r5, r6, r7, r8, r9)     // Catch: java.lang.Throwable -> L6a
            r0 = r1
            r2 = 0
            r0 = 1
            r14.close(r0)
            ...
            r20.endInsert()
            r20.endGroup()
            r10.currentGroup = r11
            r10.currentSlot = r12
            r10.currentSlotEnd = r13
            return r0
        L6a:
            r0 = move-exception
            goto L72
    ...
    private final void updateAnchors(int previousGapStart, int newGapStart) {
        ...
        if (previousGapStart < newGapStart) {
            for (int index = SlotTableKt.locationOf(this.anchors, previousGapStart, size); index < this.anchors.size() && (location2 = (anchor2 = this.anchors.get(index)).getLocation()) < 0; index++) {
        ...
        for (int index2 = SlotTableKt.locationOf(this.anchors, newGapStart, size); index2 < this.anchors.size() && (location = (anchor = this.anchors.get(index2)).getLocation()) >= 0; index2++) {
    ...
    public final String toDebugString() {
        ...
        StringBuilder sbAppend = $this$toDebugString_u24lambda_u2445.append(toString());
        Intrinsics.checkNotNullExpressionValue(sbAppend, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend.append('\n'), "append('\\n')");
        StringBuilder sbAppend2 = $this$toDebugString_u24lambda_u2445.append("  parent:    " + this.parent);
        Intrinsics.checkNotNullExpressionValue(sbAppend2, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend2.append('\n'), "append('\\n')");
        StringBuilder sbAppend3 = $this$toDebugString_u24lambda_u2445.append("  current:   " + this.currentGroup);
        Intrinsics.checkNotNullExpressionValue(sbAppend3, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend3.append('\n'), "append('\\n')");
        StringBuilder sbAppend4 = $this$toDebugString_u24lambda_u2445.append("  group gap: " + this.groupGapStart + '-' + (this.groupGapStart + this.groupGapLen) + '(' + this.groupGapLen + ')');
        Intrinsics.checkNotNullExpressionValue(sbAppend4, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend4.append('\n'), "append('\\n')");
        StringBuilder sbAppend5 = $this$toDebugString_u24lambda_u2445.append("  slots gap: " + this.slotsGapStart + '-' + (this.slotsGapStart + this.slotsGapLen) + '(' + this.slotsGapLen + ')');
        Intrinsics.checkNotNullExpressionValue(sbAppend5, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend5.append('\n'), "append('\\n')");
        StringBuilder sbAppend6 = $this$toDebugString_u24lambda_u2445.append("  gap owner: " + this.slotsGapOwner);
        ...
        String string = $this$toDebugString_u24lambda_u2445.toString();
