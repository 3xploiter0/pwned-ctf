...
public final class TextFieldCursorKt {
    private static final AnimationSpec<Float> cursorAnimationSpec = AnimationSpecKt.m139infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursorAnimationSpec$1
        ...
        public final void invoke2(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
            ...
            keyframesSpecConfig.at((KeyframesSpec.KeyframesSpecConfig<Float>) fValueOf2, RoomDatabase.MAX_BIND_PARAMETER_CNT);
        }
    }), null, 0, 6, null);
    private static final float DefaultCursorThickness = Dp.m6485constructorimpl(2);
    ...
    public static final Modifier cursor(Modifier $this$cursor, final LegacyTextFieldState state, final TextFieldValue value, final OffsetMapping offsetMapping, final Brush cursorBrush, boolean enabled) {
        return enabled ? ComposedModifierKt.composed$default($this$cursor, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                boolean isWindowFocused = ((WindowInfo) objConsume).isWindowFocused();
                if (isWindowFocused && state.getHasFocus() && TextRange.m5942getCollapsedimpl(value.getSelection()) && isBrushSpecified) {
                    ...
                    TextRange textRangeM5936boximpl = TextRange.m5936boximpl(value.getSelection());
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer);
                    EffectsKt.LaunchedEffect(text, textRangeM5936boximpl, (Function2) value$iv2, $composer, 0);
                    ComposerKt.sourceInformationMarkerStart($composer, 1411552964, "CC(remember):TextFieldCursor.kt#9igjgp");
                    boolean invalid$iv2 = $composer.changedInstance(cursorAnimation) | $composer.changedInstance(offsetMapping) | $composer.changed(value) | $composer.changedInstance(state) | $composer.changed(cursorBrush);
                    ...
                    if (invalid$iv2 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                        value$iv3 = new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1$2$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(ContentDrawScope $this$drawWithContent) {
                                ...
                                if (!(cursorAlphaValue == 0.0f)) {
                                    int transformedOffset = offsetMapping2.originalToTransformed(TextRange.m5948getStartimpl(textFieldValue.getSelection()));
                                    ...
                                    float cursorWidth = $this$drawWithContent.mo373toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                                    float f = 2;
                                    float cursorX = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(cursorRect.getLeft() + (cursorWidth / f), Size.m3831getWidthimpl($this$drawWithContent.mo4559getSizeNHjbRc()) - (cursorWidth / f)), cursorWidth / f);
                                    DrawScope.m4544drawLine1RTmtNc$default($this$drawWithContent, brush, OffsetKt.Offset(cursorX, cursorRect.getTop()), OffsetKt.Offset(cursorX, cursorRect.getBottom()), cursorWidth, 0, null, cursorAlphaValue, null, 0, 432, null);
                                }
                            }
                        };
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer);
                    companionDrawWithContent = DrawModifierKt.drawWithContent($this$composed, (Function1) value$iv3);
