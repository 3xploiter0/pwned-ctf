...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Color.m4010hashCodeimpl(this.contentColor)) * 31) + Color.m4010hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4010hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4010hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4010hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4010hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4010hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4010hashCodeimpl(this.selectedLeadingIconColor);
    }
}
