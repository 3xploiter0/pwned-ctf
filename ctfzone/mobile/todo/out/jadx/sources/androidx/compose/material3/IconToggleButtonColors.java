...
public final class IconToggleButtonColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, boolean checked, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1175394478, $changed, -1, "androidx.compose.material3.IconToggleButtonColors.containerColor (IconButton.kt:950)");
        }
        if (enabled) {
    ...
    public final State<Color> contentColor$material3_release(boolean enabled, boolean checked, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1340854054, $changed, -1, "androidx.compose.material3.IconToggleButtonColors.contentColor (IconButton.kt:966)");
        }
        if (enabled) {
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m4010hashCodeimpl(this.contentColor)) * 31) + Color.m4010hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4010hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4010hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m4010hashCodeimpl(this.checkedContentColor);
    }
}
