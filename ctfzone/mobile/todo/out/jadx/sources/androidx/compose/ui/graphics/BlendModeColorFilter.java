...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    private BlendModeColorFilter(long color, int blendMode) {
        this(color, blendMode, AndroidColorFilter_androidKt.m3869actualTintColorFilterxETnrds(color, blendMode), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BlendModeColorFilter) && Color.m4004equalsimpl0(this.color, ((BlendModeColorFilter) other).color) && BlendMode.m3914equalsimpl0(this.blendMode, ((BlendModeColorFilter) other).blendMode);
    }

    public int hashCode() {
        int result = Color.m4010hashCodeimpl(this.color);
        return (result * 31) + BlendMode.m3915hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) Color.m4011toStringimpl(this.color)) + ", blendMode=" + ((Object) BlendMode.m3916toStringimpl(this.blendMode)) + ')';
    }
}
