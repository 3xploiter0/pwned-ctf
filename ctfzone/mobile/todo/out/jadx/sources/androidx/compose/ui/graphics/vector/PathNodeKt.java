                ...
                if ($this$addPathNodes != 'M') {
                    if ($this$addPathNodes != 'l') {
                                    ...
                                    if ($this$addPathNodes != 'v') {
                                        if ($this$addPathNodes != 'V') {
                                            if ($this$addPathNodes != 'c') {
                                                if ($this$addPathNodes != 'C') {
                                                    ...
                                                    for (int index$iv8 = 0; index$iv8 <= end$iv8; index$iv8 += 4) {
                                                        ...
                                                        arrayList.add(new PathNode.RelativeReflectiveCurveTo(args[start8], args[start8 + 1], args[start8 + 2], args[start8 + 3]));
                                                    }
                                                    return;
                                                }
                                                int end$iv9 = count - 6;
                                                for (int index$iv9 = 0; index$iv9 <= end$iv9; index$iv9 += 6) {
                                                    ...
                                                    arrayList.add(new PathNode.CurveTo(args[start9], args[start9 + 1], args[start9 + 2], args[start9 + 3], args[start9 + 4], args[start9 + 5]));
                                                }
                                                return;
                                            }
                                            ...
                                            for (int index$iv10 = 0; index$iv10 <= end$iv10; index$iv10 += 6) {
                                                ...
                                                arrayList.add(new PathNode.RelativeCurveTo(args[start10], args[start10 + 1], args[start10 + 2], args[start10 + 3], args[start10 + 4], args[start10 + 5]));
                                            }
                                            return;
                                        }
                                        int end$iv11 = count - 1;
                                        for (int index$iv11 = 0; index$iv11 <= end$iv11; index$iv11++) {
                                            arrayList.add(new PathNode.VerticalTo(args[index$iv11]));
                                        }
                                        return;
                                    }
                                    int end$iv12 = count - 1;
                                    for (int index$iv12 = 0; index$iv12 <= end$iv12; index$iv12++) {
                                        arrayList.add(new PathNode.RelativeVerticalTo(args[index$iv12]));
                                    }
                                    return;
                                }
                                int end$iv13 = count - 1;
                                for (int index$iv13 = 0; index$iv13 <= end$iv13; index$iv13++) {
                                    arrayList.add(new PathNode.HorizontalTo(args[index$iv13]));
                                }
                                return;
                            }
                            int end$iv14 = count - 1;
                            for (int index$iv14 = 0; index$iv14 <= end$iv14; index$iv14++) {
                                arrayList.add(new PathNode.RelativeHorizontalTo(args[index$iv14]));
                            }
                            return;
                        }
                        ...
                        for (int index$iv15 = 0; index$iv15 <= end$iv15; index$iv15 += 2) {
                            ...
                            arrayList.add(new PathNode.LineTo(args[start11], args[start11 + 1]));
                        }
                        return;
                    }
                    ...
                    for (int index$iv16 = 0; index$iv16 <= end$iv16; index$iv16 += 2) {
                        ...
                        arrayList.add(new PathNode.RelativeLineTo(args[start12], args[start12 + 1]));
                    }
                    return;
                }
