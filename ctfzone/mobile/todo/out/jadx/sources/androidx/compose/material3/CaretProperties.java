...
public final /* data */ class CaretProperties {
    ...
    public static /* synthetic */ CaretProperties m1844copyYgX7TsA$default(CaretProperties caretProperties, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return caretProperties.m1847copyYgX7TsA(f, f2);
    }
    ...
    public final CaretProperties m1847copyYgX7TsA(float caretHeight, float caretWidth) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6490equalsimpl0(this.caretHeight, caretProperties.caretHeight) && Dp.m6490equalsimpl0(this.caretWidth, caretProperties.caretWidth);
    }

    public int hashCode() {
        return (Dp.m6491hashCodeimpl(this.caretHeight) * 31) + Dp.m6491hashCodeimpl(this.caretWidth);
    }

    public String toString() {
        return "CaretProperties(caretHeight=" + ((Object) Dp.m6496toStringimpl(this.caretHeight)) + ", caretWidth=" + ((Object) Dp.m6496toStringimpl(this.caretWidth)) + ')';
    }
    ...
    public final float m1848getCaretHeightD9Ej5fM() {
        return this.caretHeight;
    }

    /* renamed from: getCaretWidth-D9Ej5fM, reason: not valid java name */
    public final float m1849getCaretWidthD9Ej5fM() {
        return this.caretWidth;
    }
}
