...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo629measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, List<? extends List<? extends Measurable>> list, long constraints) {
        Object maxElem$iv;
        Object maxElem$iv2;
        Object maxElem$iv3;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(it4.mo5339measureBRTryo0(constraints));
            index$iv$iv2++;
        ...
        int width = Math.max($this$measure_u2d3p2s80s.mo367roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2372getIconSizeD9Ej5fM()), iconWidth) + $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(SegmentedButtonKt.IconSpacing) + (contentWidth != null ? contentWidth.intValue() : 0);
        final int offsetX = iconWidth == 0 ? (-($this$measure_u2d3p2s80s.mo367roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2372getIconSizeD9Ej5fM()) + $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(SegmentedButtonKt.IconSpacing))) / 2 : 0;
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, height2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SegmentedButtonContentMeasurePolicy$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                List $this$fastForEach$iv = iconPlaceables;
                int i = height2;
                int size3 = $this$fastForEach$iv.size();
                for (int index$iv = 0; index$iv < size3; index$iv++) {
                    Object item$iv = $this$fastForEach$iv.get(index$iv);
                    Placeable it10 = (Placeable) item$iv;
                    Placeable.PlacementScope.place$default($this$layout, it10, 0, (i - it10.getHeight()) / 2, 0.0f, 4, null);
                }
                int i2 = $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2372getIconSizeD9Ej5fM()) + $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(SegmentedButtonKt.IconSpacing);
                ...
                for (int index$iv2 = 0; index$iv2 < size4; index$iv2++) {
                    ...
                    Placeable.PlacementScope.place$default($this$layout, it11, contentOffsetX, (i3 - it11.getHeight()) / 2, 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
