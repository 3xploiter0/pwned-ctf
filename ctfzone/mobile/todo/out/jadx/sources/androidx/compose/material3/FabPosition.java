...
public final class FabPosition {
    ...
    private static final int Start = m2099constructorimpl(0);
    private static final int Center = m2099constructorimpl(1);
    private static final int End = m2099constructorimpl(2);
    private static final int EndOverlay = m2099constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m2098boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m2100equalsimpl(this.value, obj);
    }
    ...
    public static String m2103toStringimpl(int arg0) {
        return m2101equalsimpl0(arg0, Start) ? "FabPosition.Start" : m2101equalsimpl0(arg0, Center) ? "FabPosition.Center" : m2101equalsimpl0(arg0, End) ? "FabPosition.End" : "FabPosition.EndOverlay";
    }
}
