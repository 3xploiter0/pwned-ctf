...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:195:0x0520 A[LOOP:13: B:185:0x0500->B:195:0x0520, LOOP_END] */
    ...
    */
    public final void onMeasured(int r50, int r51, int r52, java.util.List<T> r53, androidx.compose.foundation.lazy.layout.LazyLayoutKeyIndexMap r54, androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider<T> r55, boolean r56, boolean r57, int r58, boolean r59, int r60, int r61, kotlinx.coroutines.CoroutineScope r62, androidx.compose.ui.graphics.GraphicsContext r63) {
        /*
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        ...
        int i = 0;
        long firstPlaceableOffset = item.mo793getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            targetFirstPlaceableOffset = IntOffset.m6609copyiSbpLlY$default(firstPlaceableOffset, 0, mainAxisOffset, 1, null);
        } else {
            targetFirstPlaceableOffset = IntOffset.m6609copyiSbpLlY$default(firstPlaceableOffset, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i < length) {
            ...
            if (lazyLayoutItemAnimation == null) {
                ...
                long diffToFirstPlaceableOffset = IntOffset.m6616minusqkQi6aY(item.mo793getOffsetBjo55l4(index$iv), firstPlaceableOffset);
                lazyLayoutItemAnimationArr = animations;
                $i$f$forEachIndexed = $i$f$forEachIndexed2;
                lazyLayoutItemAnimation.m844setRawOffsetgyyYBs(IntOffset.m6617plusqkQi6aY(targetFirstPlaceableOffset, diffToFirstPlaceableOffset));
            }
            i++;
            index$iv = index$iv2;
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int index$iv2 = index$iv + 1;
            if (lazyLayoutItemAnimation != null) {
                long newTarget = item.mo793getOffsetBjo55l4(index$iv);
                long currentTarget = lazyLayoutItemAnimation.getRawOffset();
                itemInfo = itemInfo3;
                if (IntOffset.m6612equalsimpl0(currentTarget, LazyLayoutItemAnimation.INSTANCE.m845getNotInitializednOccac()) || IntOffset.m6612equalsimpl0(currentTarget, newTarget)) {
                    lazyLayoutItemAnimationArr = animations;
                } else {
                    lazyLayoutItemAnimationArr = animations;
                    lazyLayoutItemAnimation.m837animatePlacementDeltaar5cAso(IntOffset.m6616minusqkQi6aY(newTarget, currentTarget), isMovingAway);
                }
                lazyLayoutItemAnimation.m844setRawOffsetgyyYBs(newTarget);
            } else {
                itemInfo = itemInfo3;
                lazyLayoutItemAnimationArr = animations;
            }
    ...
    public final long m846getMinSizeToFitDisappearingItemsYbymL2g() {
        long size = IntSize.INSTANCE.m6660getZeroYbymL2g();
        ...
        for (int index$iv = 0; index$iv < size2; index$iv++) {
            ...
            if (layer != null) {
                size = IntSizeKt.IntSize(Math.max(IntSize.m6655getWidthimpl(size), IntOffset.m6613getXimpl(it.getRawOffset()) + IntSize.m6655getWidthimpl(layer.getSize())), Math.max(IntSize.m6654getHeightimpl(size), IntOffset.m6614getYimpl(it.getRawOffset()) + IntSize.m6654getHeightimpl(layer.getSize())));
            }
        }
        return size;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem $this$mainAxisOffset) {
        long it = $this$mainAxisOffset.mo793getOffsetBjo55l4(0);
        return $this$mainAxisOffset.getIsVertical() ? IntOffset.m6614getYimpl(it) : IntOffset.m6613getXimpl(it);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final int getCrossAxisOffset(LazyLayoutMeasuredItem $this$crossAxisOffset) {
        long it = $this$crossAxisOffset.mo793getOffsetBjo55l4(0);
        return !$this$crossAxisOffset.getIsVertical() ? IntOffset.m6614getYimpl(it) : IntOffset.m6613getXimpl(it);
    }
    ...
    private final class ItemInfo {
        ...
        public final void m848setConstraints_Sx5XlM(Constraints constraints) {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m6426boximpl(positionedItem.getConstraints());
            ...
            for (int i2 = 0; i2 < placeablesCount; i2++) {
                ...
                if (specs == null) {
                    ...
                    LazyLayoutItemAnimation animation = it;
                    animation.setFadeInSpec(specs.getFadeInSpec());
                    animation.setPlacementSpec(specs.getPlacementSpec());
                    animation.setFadeOutSpec(specs.getFadeOutSpec());
                }
            }
        }
    }
        ...
        public void draw(ContentDrawScope $this$draw) {
            ...
            while (index$iv < size) {
                ...
                if (layer == null) {
                    ...
                    float x = IntOffset.m6613getXimpl(it.getFinalOffset());
                    float y = IntOffset.m6614getYimpl(it.getFinalOffset());
                    ContentDrawScope $this$translate$iv = $this$draw;
                    float left$iv = x - IntOffset.m6613getXimpl(layer.getTopLeft());
                    float top$iv = y - IntOffset.m6614getYimpl(layer.getTopLeft());
