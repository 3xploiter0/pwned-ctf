...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(it.m5225getIdJ3iCeTQ());
            if (previousData == null) {
                previousTime = it.getUptime();
                previousPosition = it.m5227getPositionF1C5BW0();
                previousDown = false;
            } else {
                previousTime = previousData.getUptime();
                previousDown = previousData.getDown();
                previousPosition = positionCalculator.mo5293screenToLocalMKHz9U(previousData.getPositionOnScreen());
            }
            changes.put(it.m5225getIdJ3iCeTQ(), new PointerInputChange(it.m5225getIdJ3iCeTQ(), it.getUptime(), it.m5227getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m5230getTypeT8wyACA(), it.getHistorical(), it.m5229getScrollDeltaF1C5BW0(), it.m5226getOriginalEventPositionF1C5BW0(), null));
            if (!it.getDown()) {
                this.previousPointerInputData.remove(it.m5225getIdJ3iCeTQ());
            } else {
                this.previousPointerInputData.put(it.m5225getIdJ3iCeTQ(), new PointerInputData(it.getUptime(), it.m5228getPositionOnScreenF1C5BW0(), it.getDown(), it.m5230getTypeT8wyACA(), null));
            }
            index$iv++;
    ...
    /* compiled from: PointerInputEventProcessor.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u000b\b\u0002\u0018\u00002\u00020\u0001B%\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\u0006\u0010\b\u001a\u00020\t¢\u0006\u0002\u0010\nR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0019\u0010\u0004\u001a\u00020\u0005ø\u0001\u0000ø\u0001\u0001¢\u0006\n\n\u0002\u0010\u000f\u001a\u0004\b\r\u0010\u000eR\u0019\u0010\b\u001a\u00020\tø\u0001\u0000ø\u0001\u0001¢\u0006\n\n\u0002\u0010\u0012\u001a\u0004\b\u0010\u0010\u0011R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u000e\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u0014"}, d2 = {"Landroidx/compose/ui/input/pointer/PointerInputChangeEventProducer$PointerInputData;", "", "uptime", "", "positionOnScreen", "Landroidx/compose/ui/geometry/Offset;", "down", "", ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, "Landroidx/compose/ui/input/pointer/PointerType;", "(JJZILkotlin/jvm/internal/DefaultConstructorMarker;)V", "getDown", "()Z", "getPositionOnScreen-F1C5BW0", "()J", "J", "getType-T8wyACA", "()I", "I", "getUptime", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
