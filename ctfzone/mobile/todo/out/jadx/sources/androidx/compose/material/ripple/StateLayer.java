...
final class StateLayer {
    ...
    public final void m1766drawStateLayerH2RKhps(DrawScope $this$drawStateLayer_u2dH2RKhps, float radius, long color) {
        float targetRadius = Float.isNaN(radius) ? RippleAnimationKt.m1757getRippleEndRadiuscSwnlzA($this$drawStateLayer_u2dH2RKhps, this.bounded, $this$drawStateLayer_u2dH2RKhps.mo4559getSizeNHjbRc()) : $this$drawStateLayer_u2dH2RKhps.mo373toPx0680j_4(radius);
        float alpha = this.animatedAlpha.getValue().floatValue();
        if (alpha > 0.0f) {
            long modulatedColor = Color.m4001copywmQWz5c(color, (14 & 1) != 0 ? Color.m4005getAlphaimpl(color) : alpha, (14 & 2) != 0 ? Color.m4009getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(color) : 0.0f);
            if (!this.bounded) {
                DrawScope.m4540drawCircleVaOC9Bg$default($this$drawStateLayer_u2dH2RKhps, modulatedColor, targetRadius, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float right$iv = Size.m3831getWidthimpl($this$drawStateLayer_u2dH2RKhps.mo4559getSizeNHjbRc());
            float bottom$iv = Size.m3828getHeightimpl($this$drawStateLayer_u2dH2RKhps.mo4559getSizeNHjbRc());
