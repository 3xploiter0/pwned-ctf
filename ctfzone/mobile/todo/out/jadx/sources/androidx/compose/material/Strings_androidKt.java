...
public final class Strings_androidKt {
    ...
    public static final String m1673getString4foXLRw(int string, Composer $composer, int $changed) {
        String string2;
        ...
        if (Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1670getNavigationMenuUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.navigation_menu);
        } else if (Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1666getCloseDrawerUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.close_drawer);
        } else if (Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1667getCloseSheetUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.close_sheet);
        } else if (Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1668getDefaultErrorMessageUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.default_error_message);
        } else if (Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1669getExposedDropdownMenuUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.dropdown_menu);
        } else if (Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1672getSliderRangeStartUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.range_start);
        } else {
            string2 = Strings.m1662equalsimpl0(string, Strings.INSTANCE.m1671getSliderRangeEndUdPEhr4()) ? resources.getString(androidx.compose.ui.R.string.range_end) : "";
        }
        if (ComposerKt.isTraceInProgress()) {
