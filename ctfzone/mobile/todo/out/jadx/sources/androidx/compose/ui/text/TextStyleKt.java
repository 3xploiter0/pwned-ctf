...
public final class TextStyleKt {
    ...
    public static final int m5994resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int textDirection) {
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6366getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m6367getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m6368getContentOrRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6371getUnspecifieds_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m6369getLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m6370getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
