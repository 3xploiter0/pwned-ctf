...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m114animateColorAsStateeuL9pac(long targetValue, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> function1, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        ColorSpace colorSpaceM4007getColorSpaceimpl = Color.m4007getColorSpaceimpl(targetValue);
        ComposerKt.sourceInformationMarkerStart($composer, -1018619694, "CC(remember):SingleValueAnimation.kt#9igjgp");
        boolean invalid$iv = $composer.changed(colorSpaceM4007getColorSpaceimpl);
        ...
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m3993boximpl(targetValue), converter, animationSpec2, null, label2, finishedListener, $composer, ($changed & 14) | (($changed << 3) & 896) | (($changed << 6) & 57344) | (458752 & ($changed << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m113animateColorAsStateKTwxG1Y(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        ...
        State<Color> stateM114animateColorAsStateeuL9pac = m114animateColorAsStateeuL9pac(targetValue, animationSpec, null, finishedListener, $composer, ($changed & 14) | ($changed & 112) | (($changed << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final Animatable<Color, AnimationVector4D> m112Animatable8_81llA(long initialValue) {
        return new Animatable<>(Color.m3993boximpl(initialValue), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4007getColorSpaceimpl(initialValue)), null, null, 12, null);
    }
}
