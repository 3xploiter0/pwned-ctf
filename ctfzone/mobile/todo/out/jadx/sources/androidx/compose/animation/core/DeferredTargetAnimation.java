...
public final class DeferredTargetAnimation<T, V extends AnimationVector> {
    ...
    public final T updateTarget(T target, CoroutineScope coroutineScope, FiniteAnimationSpec<T> animationSpec) {
        ...
        if (animatable == null) {
            it = new Animatable(target, this.vectorConverter, null, null, 12, null);
            this.animatable = it;
        } else {
            it = animatable;
        }
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(it, this, target, animationSpec, null), 3, null);
        return it.getValue();
    }
