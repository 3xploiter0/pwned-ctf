...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo345calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m6613getXimpl(this.localPosition), IntSize.m6655getWidthimpl(popupContentSize), IntSize.m6655getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m6614getYimpl(this.localPosition), IntSize.m6654getHeightimpl(popupContentSize), IntSize.m6654getHeightimpl(windowSize), false, 8, null));
    }
}
