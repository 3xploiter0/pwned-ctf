...
public abstract class LazyListMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m6438getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, isVertical ? Integer.MAX_VALUE : Constraints.m6437getMaxHeightimpl(constraints), 5, null);
    }
    ...
    public final LazyListMeasuredItem m796getAndMeasure0kLqBqw(int index, long constraints) {
        ...
        return mo784createItemX9ElhV4(index, key, contentType, placeables, constraints);
    }
