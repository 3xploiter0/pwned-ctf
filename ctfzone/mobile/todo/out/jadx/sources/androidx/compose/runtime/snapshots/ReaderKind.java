...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m3593boximpl(int i) {
    ...
    public static boolean m3596equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m3602unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3597equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3598hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m3596equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m3598hashCodeimpl(this.mask);
    }

    public String toString() {
        return m3600toStringimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m3595constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m3594constructorimpl(i);
    }
    ...
    public static final int m3601withReadIn3QSx2Dw(int arg0, int reader) {
        return m3594constructorimpl(arg0 | reader);
    }

    /* renamed from: isReadIn-h_f27i8, reason: not valid java name */
    public static final boolean m3599isReadInh_f27i8(int arg0, int reader) {
    ...
    public static final class Companion {
        ...
        public final int m3603getComposition6f8NoZ8() {
            return ReaderKind.m3594constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8, reason: not valid java name */
        public final int m3605getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m3594constructorimpl(2);
        }

        /* renamed from: getSnapshotFlow-6f8NoZ8, reason: not valid java name */
        public final int m3604getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m3594constructorimpl(4);
        }
    }
}
