...
public final class TimePickerDefaults {
    ...
    public final TimePickerColors colors(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2085808058, $changed, -1, "androidx.compose.material3.TimePickerDefaults.colors (TimePicker.kt:263)");
        }
    ...
    public final TimePickerColors m2697colorsu3YEpmA(long clockDialColor, long clockDialSelectedContentColor, long clockDialUnselectedContentColor, long selectorColor, long containerColor, long periodSelectorBorderColor, long periodSelectorSelectedContainerColor, long periodSelectorUnselectedContainerColor, long periodSelectorSelectedContentColor, long periodSelectorUnselectedContentColor, long timeSelectorSelectedContainerColor, long timeSelectorUnselectedContainerColor, long timeSelectorSelectedContentColor, long timeSelectorUnselectedContentColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long clockDialColor2 = (i & 1) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : clockDialColor;
        long clockDialSelectedContentColor2 = (i & 2) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : clockDialSelectedContentColor;
        long clockDialUnselectedContentColor2 = (i & 4) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : clockDialUnselectedContentColor;
        long selectorColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : selectorColor;
        long containerColor2 = (i & 16) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : containerColor;
        long periodSelectorBorderColor2 = (i & 32) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : periodSelectorBorderColor;
        long periodSelectorSelectedContainerColor2 = (i & 64) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : periodSelectorSelectedContainerColor;
        long periodSelectorUnselectedContainerColor2 = (i & 128) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : periodSelectorUnselectedContainerColor;
        long periodSelectorSelectedContentColor2 = (i & 256) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : periodSelectorSelectedContentColor;
        long periodSelectorUnselectedContentColor2 = (i & 512) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : periodSelectorUnselectedContentColor;
        long timeSelectorSelectedContainerColor2 = (i & 1024) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : timeSelectorSelectedContainerColor;
        long timeSelectorUnselectedContainerColor2 = (i & 2048) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : timeSelectorUnselectedContainerColor;
        long timeSelectorSelectedContentColor2 = (i & 4096) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : timeSelectorSelectedContentColor;
        long timeSelectorUnselectedContentColor2 = (i & 8192) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : timeSelectorUnselectedContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-646352288, $changed, $changed1, "androidx.compose.material3.TimePickerDefaults.colors (TimePicker.kt:309)");
        }
        TimePickerColors timePickerColorsM2678copydVHXu7A = getDefaultTimePickerColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2678copydVHXu7A(clockDialColor2, selectorColor2, containerColor2, periodSelectorBorderColor2, clockDialSelectedContentColor2, clockDialUnselectedContentColor2, periodSelectorSelectedContainerColor2, periodSelectorUnselectedContainerColor2, periodSelectorSelectedContentColor2, periodSelectorUnselectedContentColor2, timeSelectorSelectedContainerColor2, timeSelectorUnselectedContainerColor2, timeSelectorSelectedContentColor2, timeSelectorUnselectedContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return timePickerColorsM2678copydVHXu7A;
    }

    public final TimePickerColors getDefaultTimePickerColors$material3_release(ColorScheme $this$defaultTimePickerColors) {
        TimePickerColors defaultTimePickerColorsCached = $this$defaultTimePickerColors.getDefaultTimePickerColorsCached();
        if (defaultTimePickerColorsCached != null) {
            return defaultTimePickerColorsCached;
        }
        TimePickerColors it = new TimePickerColors(ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getClockDialColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getClockDialSelectorHandleContainerColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getPeriodSelectorOutlineColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getClockDialSelectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getClockDialUnselectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getPeriodSelectorSelectedContainerColor()), Color.INSTANCE.m4038getTransparent0d7_KjU(), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getPeriodSelectorSelectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getPeriodSelectorUnselectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getTimeSelectorSelectedContainerColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getTimeSelectorUnselectedContainerColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getTimeSelectorSelectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultTimePickerColors, TimePickerTokens.INSTANCE.getTimeSelectorUnselectedLabelTextColor()), null);
        $this$defaultTimePickerColors.setDefaultTimePickerColorsCached$material3_release(it);
        return it;
    }

    /* renamed from: layoutType-sDNSZnc, reason: not valid java name */
    public final int m2698layoutTypesDNSZnc(Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 517161502, "C(layoutType)358@18364L27:TimePicker.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(517161502, $changed, -1, "androidx.compose.material3.TimePickerDefaults.layoutType (TimePicker.kt:358)");
        }
