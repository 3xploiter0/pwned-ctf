...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6401getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m1323updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m1316updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (!getIsAttached()) {
            return;
        }
    ...
    public final boolean setSubstitution(String updatedText) {
        ...
        if (currentTextSubstitution != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1316updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
        ...
        if (localSemanticsTextLayoutResult == null) {
            localSemanticsTextLayoutResult = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode.applySemantics.1
                ...
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    TextLayoutResult layout = layoutCache.slowCreateTextLayoutResultOrNull(textStyle.m5993mergedA7vx0o((16609105 & 1) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : colorProducer != null ? colorProducer.mo1738invoke0d7_KjU() : Color.INSTANCE.m4039getUnspecified0d7_KjU(), (16609105 & 2) != 0 ? TextUnit.INSTANCE.m6689getUnspecifiedXSAIIZE() : 0L, (16609105 & 4) != 0 ? null : null, (16609105 & 8) != 0 ? null : null, (16609105 & 16) != 0 ? null : null, (16609105 & 32) != 0 ? null : null, (16609105 & 64) != 0 ? null : null, (16609105 & 128) != 0 ? TextUnit.INSTANCE.m6689getUnspecifiedXSAIIZE() : 0L, (16609105 & 256) != 0 ? null : null, (16609105 & 512) != 0 ? null : null, (16609105 & 1024) != 0 ? null : null, (16609105 & 2048) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : 0L, (16609105 & 4096) != 0 ? null : null, (16609105 & 8192) != 0 ? null : null, (16609105 & 16384) != 0 ? null : null, (16609105 & 32768) != 0 ? TextAlign.INSTANCE.m6358getUnspecifiede0LSkKk() : 0, (16609105 & 65536) != 0 ? TextDirection.INSTANCE.m6371getUnspecifieds_7Xco() : 0, (16609105 & 131072) != 0 ? TextUnit.INSTANCE.m6689getUnspecifiedXSAIIZE() : 0L, (16609105 & 262144) != 0 ? null : null, (16609105 & 524288) != 0 ? null : null, (16609105 & 1048576) != 0 ? LineBreak.INSTANCE.m6285getUnspecifiedrAG3T2k() : 0, (16609105 & 2097152) != 0 ? Hyphens.INSTANCE.m6264getUnspecifiedvmbZdU8() : 0, (16609105 & 4194304) != 0 ? null : null, (16609105 & 8388608) != 0 ? null : null));
                    if (layout != null) {
                        list.add(layout);
                    } else {
                        layout = null;
        ...
        SemanticsPropertiesKt.showTextSubstitution$default($this$applySemantics, null, new Function1<Boolean, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode.applySemantics.3
            ...
            public final Boolean invoke(boolean it) {
                if (TextStringSimpleNode.this.textSubstitution != null) {
                    TextSubstitution textSubstitution = TextStringSimpleNode.this.textSubstitution;
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m1314layoutWithConstraintsK40F9xA(constraints, $this$measure_u2d3p2s80s.getLayoutDirection());
        ...
        final Placeable placeable = measurable.mo5339measureBRTryo0(Constraints.INSTANCE.m6447fitPrioritizingWidthZbe2FdA(IntSize.m6655getWidthimpl(layoutSize), IntSize.m6655getWidthimpl(layoutSize), IntSize.m6654getHeightimpl(layoutSize), IntSize.m6654getHeightimpl(layoutSize)));
        int iM6655getWidthimpl = IntSize.m6655getWidthimpl(layoutSize);
        int iM6654getHeightimpl = IntSize.m6654getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(iM6655getWidthimpl, iM6654getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if (getIsAttached()) {
            ...
            if (willClip) {
                float width = IntSize.m6655getWidthimpl(layoutCache.getLayoutSize());
                float height = IntSize.m6654getHeightimpl(layoutCache.getLayoutSize());
                canvas.save();
                Canvas.m3975clipRectN_I0leg$default(canvas, 0.0f, 0.0f, width, height, 0, 16, null);
            }
            try {
                ...
                if (brush != null) {
                    ...
                    Paragraph.m5823painthn5TExg$default(localParagraph, canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ColorProducer colorProducer = this.overrideColor;
                    long overrideColorVal = colorProducer != null ? colorProducer.mo1738invoke0d7_KjU() : Color.INSTANCE.m4039getUnspecified0d7_KjU();
                    long $this$isSpecified$iv = overrideColorVal;
                    boolean z = true;
                    if (($this$isSpecified$iv != 16 ? 1 : 0) != 0) {
                        color = overrideColorVal;
                    } else {
                        long $this$isSpecified$iv2 = this.style.m5978getColor0d7_KjU();
                        if ($this$isSpecified$iv2 == 16) {
                            z = false;
                        }
                        if (z) {
                            color = this.style.m5978getColor0d7_KjU();
                        } else {
                            color = Color.INSTANCE.m4029getBlack0d7_KjU();
                        }
                    }
                    Paragraph.m5821paintLG529CI$default(localParagraph, canvas, color, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
            } finally {
                if (willClip) {
                    canvas.restore();
