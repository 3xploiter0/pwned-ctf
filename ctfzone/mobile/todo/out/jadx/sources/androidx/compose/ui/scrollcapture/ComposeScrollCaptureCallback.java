...
public final class ComposeScrollCaptureCallback implements ScrollCaptureCallback {
    ...
    static final class C06221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C06221(ScrollCaptureSession scrollCaptureSession, Rect rect, Consumer<Rect> consumer, Continuation<? super C06221> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ComposeScrollCaptureCallback.this.new C06221(this.$session, this.$captureArea, this.$onComplete, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c06221 = this;
                    c06221.label = 1;
                    Object objOnScrollCaptureImageRequest = ComposeScrollCaptureCallback.this.onScrollCaptureImageRequest(c06221.$session, RectHelper_androidKt.toComposeIntRect(c06221.$captureArea), c06221);
            ...
            c06221.$onComplete.accept(RectHelper_androidKt.toAndroidRect(result));
    ...
    public void onScrollCaptureImageRequest(ScrollCaptureSession session, CancellationSignal signal, Rect captureArea, Consumer<Rect> onComplete) {
        ComposeScrollCaptureCallback_androidKt.launchWithCancellationSignal(this.coroutineScope, signal, new C06221(session, captureArea, onComplete, null));
    }
    ...
    */
    ...
    private final void drawDebugBackground(Canvas $this$drawDebugBackground) {
        $this$drawDebugBackground.drawColor(ColorKt.m4057toArgb8_81llA(Color.Companion.m4027hslJlNiLsg$default(Color.INSTANCE, Random.INSTANCE.nextFloat() * 360.0f, 0.75f, 0.5f, 1.0f, null, 16, null)));
    }
