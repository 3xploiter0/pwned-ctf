...
public final class LazyGridMeasureKt {
    ...
    */
    public static final androidx.compose.foundation.lazy.grid.LazyGridMeasureResult m822measureLazyGridOZKpZRA(int r52, androidx.compose.foundation.lazy.grid.LazyGridMeasuredLineProvider r53, androidx.compose.foundation.lazy.grid.LazyGridMeasuredItemProvider r54, int r55, int r56, int r57, int r58, int r59, int r60, float r61, long r62, boolean r64, androidx.compose.foundation.layout.Arrangement.Vertical r65, androidx.compose.foundation.layout.Arrangement.Horizontal r66, boolean r67, androidx.compose.ui.unit.Density r68, androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator<androidx.compose.foundation.lazy.grid.LazyGridMeasuredItem> r69, int r70, java.util.List<java.lang.Integer> r71, kotlinx.coroutines.CoroutineScope r72, final androidx.compose.runtime.MutableState<kotlin.Unit> r73, androidx.compose.ui.graphics.GraphicsContext r74, kotlin.jvm.functions.Function1<? super java.lang.Integer, ? extends java.util.List<kotlin.Pair<java.lang.Integer, androidx.compose.ui.unit.Constraints>>> r75, kotlin.jvm.functions.Function3<? super java.lang.Integer, ? super java.lang.Integer, ? super kotlin.jvm.functions.Function1<? super androidx.compose.ui.layout.Placeable.PlacementScope, kotlin.Unit>, ? extends androidx.compose.ui.layout.MeasureResult> r76) {
        /*
            Method dump skipped, instructions count: 1572
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt.m822measureLazyGridOZKpZRA(int, androidx.compose.foundation.lazy.grid.LazyGridMeasuredLineProvider, androidx.compose.foundation.lazy.grid.LazyGridMeasuredItemProvider, int, int, int, int, int, int, float, long, boolean, androidx.compose.foundation.layout.Arrangement$Vertical, androidx.compose.foundation.layout.Arrangement$Horizontal, boolean, androidx.compose.ui.unit.Density, androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator, int, java.util.List, kotlinx.coroutines.CoroutineScope, androidx.compose.runtime.MutableState, androidx.compose.ui.graphics.GraphicsContext, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function3):androidx.compose.foundation.lazy.grid.LazyGridMeasureResult");
    }
    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(List<Integer> list, LazyGridMeasuredItemProvider measuredItemProvider, LazyGridMeasuredLineProvider measuredLineProvider, Function1<? super Integer, Boolean> function1) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (function1.invoke(Integer.valueOf(index)).booleanValue()) {
                ...
                long constraints = measuredLineProvider.m826childConstraintsJhjzzOo$foundation_release(0, span);
                LazyGridMeasuredItem measuredItem = measuredItemProvider.mo795getAndMeasurehBUhpc(index, 0, span, constraints);
                if (arrayList == null) {
