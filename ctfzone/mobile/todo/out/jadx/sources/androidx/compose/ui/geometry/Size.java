...
public final class Size {
    ...
    private static final long Zero = m3822constructorimpl(0);
    private static final long Unspecified = m3822constructorimpl(InlineClassHelperKt.UnspecifiedPackedFloats);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Size m3819boximpl(long j) {
        return new Size(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3822constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3826equalsimpl(long j, Object obj) {
        return (obj instanceof Size) && j == ((Size) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3827equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public boolean equals(Object obj) {
        return m3826equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3832hashCodeimpl(this.packedValue);
    }
    ...
    public static final float m3831getWidthimpl(long arg0) {
    ...
    public static final float m3828getHeightimpl(long arg0) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
    ...
    public static final float m3820component1impl(long arg0) {
        return m3831getWidthimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3821component2impl(long arg0) {
        return m3828getHeightimpl(arg0);
    }

    /* renamed from: copy-xjbvk4A$default, reason: not valid java name */
    public static /* synthetic */ long m3824copyxjbvk4A$default(long value$iv, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m3823copyxjbvk4A(value$iv, f, f2);
    }

    /* renamed from: copy-xjbvk4A, reason: not valid java name */
    public static final long m3823copyxjbvk4A(long arg0, float width, float height) {
        long v1$iv = Float.floatToRawIntBits(width);
        long v2$iv = Float.floatToRawIntBits(height);
        return m3822constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3837getUnspecifiedNHjbRc$annotations() {
        }

        /* renamed from: getZero-NH-jbRc$annotations, reason: not valid java name */
        public static /* synthetic */ void m3838getZeroNHjbRc$annotations() {
        }
        ...
        public final long m3840getZeroNHjbRc() {
            return Size.Zero;
        }

        /* renamed from: getUnspecified-NH-jbRc, reason: not valid java name */
        public final long m3839getUnspecifiedNHjbRc() {
            return Size.Unspecified;
        }
    }

    /* renamed from: isEmpty-impl, reason: not valid java name */
    public static final boolean m3833isEmptyimpl(long arg0) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
    ...
    public static final long m3834times7Ah8Wj8(long arg0, float operand) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
        int bits$iv$iv = (int) (arg0 >> 32);
    ...
    public static final long m3825div7Ah8Wj8(long arg0, float operand) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
        int bits$iv$iv = (int) (arg0 >> 32);
    ...
    public static final float m3830getMinDimensionimpl(long arg0) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
    ...
    public static final float m3829getMaxDimensionimpl(long arg0) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
        int bits$iv$iv = (int) ((arg0 >> 32) & 2147483647L);
    ...
    public String toString() {
        return m3835toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3835toStringimpl(long arg0) {
        if (arg0 != InlineClassHelperKt.UnspecifiedPackedFloats) {
            return "Size(" + GeometryUtilsKt.toStringAsFixed(m3831getWidthimpl(arg0), 1) + ", " + GeometryUtilsKt.toStringAsFixed(m3828getHeightimpl(arg0), 1) + ')';
        }
        return "Size.Unspecified";
    }
}
