...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m5294boximpl(int i) {
    ...
    public static int m5300hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5301toStringimpl(int i) {
        return "ProcessResult(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m5296equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5300hashCodeimpl(this.value);
    }

    public String toString() {
        return m5301toStringimpl(this.value);
    }
    ...
    public static final boolean m5299getDispatchedToAPointerInputModifierimpl(int arg0) {
        return (arg0 & 1) != 0;
    }

    /* renamed from: getAnyMovementConsumed-impl, reason: not valid java name */
    public static final boolean m5298getAnyMovementConsumedimpl(int arg0) {
        return (arg0 & 2) != 0;
    }
}
