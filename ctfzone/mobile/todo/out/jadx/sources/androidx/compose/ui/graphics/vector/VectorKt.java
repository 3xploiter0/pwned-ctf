...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4356getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4367getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3943getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4038getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4286getNonZeroRgk1Os();
    ...
    public static final boolean m4711rgbEqualOWjLjI(long $this$rgbEqual_u2d_u2dOWjLjI, long other) {
        if (Color.m4009getRedimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4009getRedimpl(other)) {
            if (Color.m4008getGreenimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4008getGreenimpl(other)) {
                if (Color.m4006getBlueimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4006getBlueimpl(other)) {
                    return true;
                }
            }
        }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter $this$tintableWithAlphaMask) {
        return $this$tintableWithAlphaMask instanceof BlendModeColorFilter ? BlendMode.m3914equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m3943getSrcIn0nO6VwU()) || BlendMode.m3914equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m3945getSrcOver0nO6VwU()) : $this$tintableWithAlphaMask == null;
    }
}
