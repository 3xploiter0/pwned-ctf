...
public final class DisplayMode {
    ...
    private static final int Picker = m2064constructorimpl(0);
    private static final int Input = m2064constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m2063boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2064constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2065equalsimpl(int i, Object obj) {
    ...
    public static final class Companion {
        ...
        public final int m2071getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* renamed from: getInput-jFl-4v0, reason: not valid java name */
        public final int m2070getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2068toStringimpl(int arg0) {
        return m2066equalsimpl0(arg0, Picker) ? "Picker" : m2066equalsimpl0(arg0, Input) ? "Input" : "Unknown";
    }
