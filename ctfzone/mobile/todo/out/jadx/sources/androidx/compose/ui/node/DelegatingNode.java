    ...
    */
    protected final <T extends androidx.compose.ui.node.DelegatableNode> T delegate(T r13) {
        ...
        L4a:
            ...
            r7 = 0
            r8 = 2
            int r7 = androidx.compose.ui.node.NodeKind.m5574constructorimpl(r8)
            r9 = r6
            r10 = 0
            r11 = r9 & r7
            if (r11 == 0) goto L8a
    ...
    protected final void undelegate(DelegatableNode instance) {
        ...
        if (getIsAttached()) {
            int value$iv = (beforeKindSet & NodeKind.m5574constructorimpl(2)) != 0 ? 1 : 0;
            if (value$iv != 0) {
                if ((afterKindSet & NodeKind.m5574constructorimpl(2)) != 0) {
                    return;
                }
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        ...
        int value$iv = (delegateKindSet & NodeKind.m5574constructorimpl(2)) != 0 ? 1 : 0;
        if (value$iv != 0) {
            if ((current & NodeKind.m5574constructorimpl(2)) != 0) {
