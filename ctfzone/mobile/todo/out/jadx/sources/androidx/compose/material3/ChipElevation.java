...
public final class ChipElevation {
    ...
    public final float m1889tonalElevationu2uoSUM$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipElevation) && Dp.m6490equalsimpl0(this.elevation, ((ChipElevation) other).elevation) && Dp.m6490equalsimpl0(this.pressedElevation, ((ChipElevation) other).pressedElevation) && Dp.m6490equalsimpl0(this.focusedElevation, ((ChipElevation) other).focusedElevation) && Dp.m6490equalsimpl0(this.hoveredElevation, ((ChipElevation) other).hoveredElevation) && Dp.m6490equalsimpl0(this.disabledElevation, ((ChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
