...
public final class TextFieldStateKt {
    ...
    public static final TextFieldState m1113rememberTextFieldStateLepunE(final String initialText, final long initialSelection, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new Function0<TextFieldState>() { // from class: androidx.compose.foundation.text.input.TextFieldStateKt$rememberTextFieldState$1$1
        ...
        TextFieldState textFieldState = (TextFieldState) RememberSaveableKt.m3589rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) value$iv, $composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
