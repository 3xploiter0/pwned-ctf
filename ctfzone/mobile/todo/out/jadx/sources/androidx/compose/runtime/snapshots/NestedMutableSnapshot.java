...
public final class NestedMutableSnapshot extends MutableSnapshot {
    ...
    public NestedMutableSnapshot(int id, SnapshotIdSet invalid, Function1<Object, Unit> function1, Function1<Object, Unit> function12, MutableSnapshot parent) {
        ...
        this.parent = parent;
        this.parent.mo3590nestedActivated$runtime_release(this);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x0072 A[Catch: all -> 0x00d7, TryCatch #0 {, blocks: (B:14:0x0037, B:16:0x003f, B:19:0x0046, B:23:0x0060, B:25:0x0068, B:30:0x0082, B:32:0x008a, B:33:0x008f, B:27:0x0072, B:29:0x007f), top: B:42:0x0037 }] */
    ...
    */
    ...
    private final void deactivate() {
        if (!this.deactivated) {
            ...
            this.parent.mo3591nestedDeactivated$runtime_release(this);
        }
    }
}
