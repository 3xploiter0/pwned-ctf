    ...
    public static final void SubcomposeLayout(final Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 19) != 18 || !$composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1298353104, $dirty2, -1, "androidx.compose.ui.layout.SubcomposeLayout (SubcomposeLayout.kt:78)");
            }
            ...
            SubcomposeLayout((SubcomposeLayoutState) value$iv, modifier, function2, $composer2, (($dirty2 << 3) & 112) | (($dirty2 << 3) & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
