...
public final class CheckboxDefaults {
    ...
    public final CheckboxColors m1864colors5tl4gsc(long checkedColor, long uncheckedColor, long checkmarkColor, long disabledCheckedColor, long disabledUncheckedColor, long disabledIndeterminateColor, Composer $composer, int $changed, int i) {
        ...
        long checkedColor2 = (i & 1) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : checkedColor;
        long uncheckedColor2 = (i & 2) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : uncheckedColor;
        long checkmarkColor2 = (i & 4) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : checkmarkColor;
        long disabledCheckedColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledCheckedColor;
        long disabledUncheckedColor2 = (i & 16) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledUncheckedColor;
        long disabledIndeterminateColor2 = (i & 32) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledIndeterminateColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-89536160, $changed, -1, "androidx.compose.material3.CheckboxDefaults.colors (Checkbox.kt:213)");
        }
        CheckboxColors checkboxColorsM1851copy2qZNXz8 = getDefaultCheckboxColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1851copy2qZNXz8(checkmarkColor2, Color.INSTANCE.m4038getTransparent0d7_KjU(), checkedColor2, Color.INSTANCE.m4038getTransparent0d7_KjU(), disabledCheckedColor2, Color.INSTANCE.m4038getTransparent0d7_KjU(), disabledIndeterminateColor2, checkedColor2, uncheckedColor2, disabledCheckedColor2, disabledUncheckedColor2, disabledIndeterminateColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return checkboxColorsM1851copy2qZNXz8;
    }
    ...
    public final CheckboxColors getDefaultCheckboxColors$material3_release(ColorScheme $this$defaultCheckboxColors) {
        ...
        if (defaultCheckboxColorsCached == null) {
            ...
            long jM4001copywmQWz5c2 = Color.m4001copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken4) : 0.0f);
            ...
            CheckboxColors it = new CheckboxColors(jFromToken, jM4038getTransparent0d7_KjU, jFromToken2, jM4038getTransparent0d7_KjU2, jM4001copywmQWz5c, jM4038getTransparent0d7_KjU3, jM4001copywmQWz5c2, jFromToken5, jFromToken6, jM4001copywmQWz5c3, jM4001copywmQWz5c4, Color.m4001copywmQWz5c(jFromToken9, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken9) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken9) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken9) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken9) : 0.0f), null);
