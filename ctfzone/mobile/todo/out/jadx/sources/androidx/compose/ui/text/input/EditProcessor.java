...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m5953getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        ...
        boolean compositionChanged = !Intrinsics.areEqual(value.getComposition(), this.mBuffer.m6107getCompositionMzsxiRA$ui_text_release());
        if (!Intrinsics.areEqual(this.mBufferState.getText(), value.getText())) {
            ...
            textChanged = true;
        } else if (!TextRange.m5941equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            this.mBuffer.setSelection$ui_text_release(TextRange.m5946getMinimpl(value.getSelection()), TextRange.m5945getMaximpl(value.getSelection()));
            selectionChanged = true;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m5942getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m5946getMinimpl(value.getComposition().getPackedValue()), TextRange.m5945getMaximpl(value.getComposition().getPackedValue()));
        }
        if (textChanged || (!selectionChanged && compositionChanged)) {
            this.mBuffer.commitComposition$ui_text_release();
            newValue = TextFieldValue.m6190copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        } else {
            newValue = value;
        }
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            long $this$apply_u24lambda_u242 = this.mBuffer.m6108getSelectiond9O1mEE$ui_text_release();
            TextRange textRangeM5936boximpl = TextRange.m5936boximpl($this$apply_u24lambda_u242);
            textRangeM5936boximpl.getPackedValue();
            if (TextRange.m5947getReversedimpl(this.mBufferState.getSelection())) {
                textRangeM5936boximpl = null;
            }
            TextFieldValue newState = new TextFieldValue(annotatedString$ui_text_release, textRangeM5936boximpl != null ? textRangeM5936boximpl.getPackedValue() : TextRangeKt.TextRange(TextRange.m5945getMaximpl($this$apply_u24lambda_u242), TextRange.m5946getMinimpl($this$apply_u24lambda_u242)), this.mBuffer.m6107getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder sbAppend = $this$generateBatchErrorMessage_u24lambda_u243.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m6107getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m5951toStringimpl(this.mBuffer.m6108getSelectiond9O1mEE$ui_text_release())) + "):");
        Intrinsics.checkNotNullExpressionValue(sbAppend, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend.append('\n'), "append('\\n')");
        CollectionsKt.joinTo(editCommands, $this$generateBatchErrorMessage_u24lambda_u243, (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) != 0 ? "" : null, (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : new Function1<EditCommand, CharSequence>() { // from class: androidx.compose.ui.text.input.EditProcessor$generateBatchErrorMessage$1$1
        ...
        String string = $this$generateBatchErrorMessage_u24lambda_u243.toString();
