...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3945getSrcOver0nO6VwU();
    }
    ...
    public long mo3876getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3882setColor8_81llA(long color) {
        AndroidPaint_androidKt.m3888setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo3881setBlendModes9anfk8(int value) {
        if (!BlendMode.m3914equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m3887setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo3880getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo3886setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m3892setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo3878getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo3884setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m3890setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo3879getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3885setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m3891setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo3877getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo3883setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m3889setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
