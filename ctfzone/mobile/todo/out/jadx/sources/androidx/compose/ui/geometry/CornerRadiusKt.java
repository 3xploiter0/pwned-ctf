...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m3731constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m3748lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3737getXimpl(start), CornerRadius.m3737getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m3738getYimpl(start), CornerRadius.m3738getYimpl(stop), fraction));
    }
}
