...
public final class IntRectKt {
    ...
    public static final IntRect m6645IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m6613getXimpl(offset), IntOffset.m6614getYimpl(offset), IntOffset.m6613getXimpl(offset) + IntSize.m6655getWidthimpl(size), IntOffset.m6614getYimpl(offset) + IntSize.m6654getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m6644IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m6613getXimpl(topLeft), IntOffset.m6614getYimpl(topLeft), IntOffset.m6613getXimpl(bottomRight), IntOffset.m6614getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m6646IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m6613getXimpl(center) - radius, IntOffset.m6614getYimpl(center) - radius, IntOffset.m6613getXimpl(center) + radius, IntOffset.m6614getYimpl(center) + radius);
    }
