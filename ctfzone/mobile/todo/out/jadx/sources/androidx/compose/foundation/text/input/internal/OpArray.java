...
final class OpArray {
    ...
    public static final /* synthetic */ OpArray m1182boximpl(int[] iArr) {
        return new OpArray(iArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int[] m1184constructorimpl(int[] iArr) {
        return iArr;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1186equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof OpArray) && Intrinsics.areEqual(iArr, ((OpArray) obj).getValues());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1187equalsimpl0(int[] iArr, int[] iArr2) {
        return Intrinsics.areEqual(iArr, iArr2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1191hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1193toStringimpl(int[] iArr) {
        return "OpArray(values=" + Arrays.toString(iArr) + ')';
    }

    public boolean equals(Object obj) {
        return m1186equalsimpl(this.values, obj);
    }

    public int hashCode() {
        return m1191hashCodeimpl(this.values);
    }

    public String toString() {
        return m1193toStringimpl(this.values);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static int[] m1183constructorimpl(int size) {
        return m1184constructorimpl(new int[size * 3]);
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static final int m1190getSizeimpl(int[] arg0) {
        return arg0.length / 3;
    }

    /* renamed from: set-impl, reason: not valid java name */
    public static final void m1192setimpl(int[] arg0, int index, int offset, int srcLen, int destLen) {
        arg0[index * 3] = offset;
    ...
    public static final int[] m1185copyOfpSmdads(int[] arg0, int newSize) {
        int[] iArrCopyOf = Arrays.copyOf(arg0, newSize * 3);
        Intrinsics.checkNotNullExpressionValue(iArrCopyOf, "copyOf(this, newSize)");
        return m1184constructorimpl(iArrCopyOf);
    }

    /* renamed from: forEach-impl$default, reason: not valid java name */
    public static /* synthetic */ void m1189forEachimpl$default(int[] arg0, int max, boolean reversed, Function3 block, int i, Object obj) {
        if ((i & 2) != 0) {
            reversed = false;
        }
        if (max < 0) {
    ...
    public static final void m1188forEachimpl(int[] arg0, int max, boolean reversed, Function3<? super Integer, ? super Integer, ? super Integer, Unit> function3) {
        if (max < 0) {
            return;
        }
        if (reversed) {
