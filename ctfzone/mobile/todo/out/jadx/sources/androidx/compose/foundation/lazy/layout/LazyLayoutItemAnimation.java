...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.finalOffset = IntOffset.INSTANCE.m6623getZeronOccac();
        ...
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m6604boximpl(IntOffset.INSTANCE.m6623getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m6604boximpl(IntOffset.INSTANCE.m6623getZeronOccac()), null, 2, null);
    ...
    public final void m844setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m842setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m836setPlacementDeltagyyYBs(long j) {
        MutableState $this$setValue$iv = this.placementDelta;
        $this$setValue$iv.setValue(IntOffset.m6604boximpl(j));
    }

    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m840getPlacementDeltanOccac() {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (LazyLayoutItemAnimation.this.placementDeltaAnimation.snapTo(IntOffset.m6604boximpl(IntOffset.INSTANCE.m6623getZeronOccac()), this) == coroutine_suspended) {
            ...
            LazyLayoutItemAnimation.this.m836setPlacementDeltagyyYBs(IntOffset.INSTANCE.m6623getZeronOccac());
    ...
    public final void m843setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m837animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec spec = this.placementSpec;
        if (spec == null) {
            return;
        }
        long totalDelta = IntOffset.m6616minusqkQi6aY(m840getPlacementDeltanOccac(), delta);
        m836setPlacementDeltagyyYBs(totalDelta);
    ...
    public final void animateAppearance() {
        ...
        if (isAppearanceAnimationInProgress() || spec == null || layer == null) {
            if (isDisappearanceAnimationInProgress()) {
                ...
                BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03081(null), 3, null);
                return;
            }
            return;
        }
        setAppearanceAnimationInProgress(true);
        boolean shouldResetValue = true ^ isDisappearanceAnimationInProgress();
        if (shouldResetValue) {
            layer.setAlpha(0.0f);
        }
    ...
    static final class C03081 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03081(continuation);
        }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Type inference failed for: r1v5, types: [androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateAppearance$2] */
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r14) throws java.lang.Throwable {
            ...
            L23:
                ...
                r1 = r13
                boolean r3 = r1.$shouldResetValue     // Catch: java.lang.Throwable -> L1e
                if (r3 == 0) goto L45
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation r3 = r1.this$0     // Catch: java.lang.Throwable -> L1e
                androidx.compose.animation.core.Animatable r3 = androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation.access$getVisibilityAnimation$p(r3)     // Catch: java.lang.Throwable -> L1e
                r4 = 0
            ...
            L45:
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation r3 = r1.this$0     // Catch: java.lang.Throwable -> L1e
                androidx.compose.animation.core.Animatable r4 = androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation.access$getVisibilityAnimation$p(r3)     // Catch: java.lang.Throwable -> L1e
                ...
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateAppearance$2$1 r3 = new androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateAppearance$2$1     // Catch: java.lang.Throwable -> L1e
                androidx.compose.ui.graphics.layer.GraphicsLayer r7 = r1.$layer     // Catch: java.lang.Throwable -> L1e
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation r8 = r1.this$0     // Catch: java.lang.Throwable -> L1e
            ...
            L72:
                r0 = r1
            L73:
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation r1 = r0.this$0
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation.access$setAppearanceAnimationInProgress(r1, r2)
                kotlin.Unit r1 = kotlin.Unit.INSTANCE
                return r1
            L7c:
                androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation r3 = r0.this$0
    ...
    public final void animateDisappearance() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03091(spec, layer, null), 3, null);
    }
    ...
    static final class C03091 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03091(FiniteAnimationSpec<Float> finiteAnimationSpec, GraphicsLayer graphicsLayer, Continuation<? super C03091> continuation) {
            super(2, continuation);
            this.$spec = finiteAnimationSpec;
            this.$layer = graphicsLayer;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03091(this.$spec, this.$layer, continuation);
        }
    ...
    public final void release() {
        ...
        if (isPlacementAnimationInProgress()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03111(null), 3, null);
        }
        if (isAppearanceAnimationInProgress()) {
            setAppearanceAnimationInProgress(false);
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03122(null), 3, null);
        }
        if (isDisappearanceAnimationInProgress()) {
        ...
        m836setPlacementDeltagyyYBs(IntOffset.INSTANCE.m6623getZeronOccac());
        this.rawOffset = NotInitialized;
    ...
    static final class C03111 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03111(continuation);
        }
    ...
    static final class C03122 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;

        C03122(Continuation<? super C03122> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03122(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C03122) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class Companion {
        ...
        public final long m845getNotInitializednOccac() {
