...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r0v13, types: [androidx.compose.ui.tooling.ComposeViewAdapter$FakeOnBackPressedDispatcherOwner$1] */
    /* JADX WARN: Type inference failed for: r0v14, types: [androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1] */
    public ComposeViewAdapter(Context context, AttributeSet attrs) throws NumberFormatException {
        ...
        this.previewComposition = ComposableSingletons$ComposeViewAdapter_androidKt.INSTANCE.m6405getLambda2$ui_tooling_release();
        ...
        $this$debugBoundsPaint_u24lambda_u240.setColor(ColorKt.m4057toArgb8_81llA(Color.INSTANCE.m4037getRed0d7_KjU()));
    ...
    /* synthetic */ class C06292 extends FunctionReferenceImpl implements Function0<Unit> {
        C06292(Object obj) {
                        ...
                        if (!($this$any$iv2 instanceof Collection) || !((Collection) $this$any$iv2).isEmpty()) {
                            ...
                            while (true) {
                                if (it2.hasNext()) {
                                    ...
                                    if (((Intrinsics.areEqual(child.getName(), "remember") && composeViewAdapter.hasDesignInfo(child)) ? 1 : null) != null) {
                                        $this$any$iv = 1;
                                        break;
                                    }
                                } else {
    ...
    private final void invalidateComposition() {
        this.content.setValue(ComposableSingletons$ComposeViewAdapter_androidKt.INSTANCE.m6406getLambda3$ui_tooling_release());
                        ...
                        public final void invoke(final Composer $composer2, int $changed2) {
                            ...
                            if (($changed2 & 3) != 2 || !$composer2.getSkipping()) {
                                ...
                                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                                    value$iv = new Function0<Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$init$3$1$composable$1$1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(0);
                                        }
                                ...
                                if (j >= 0) {
                                    ...
                                    if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                                        value$iv2 = new Function0<Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$init$3$1$1$1
                                            {
                                                super(0);
                                            }
