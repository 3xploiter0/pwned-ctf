...
public final class SlotTreeKt {
    ...
    */
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = coordinates.mo5347getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m3762getXimpl(position));
        int top = MathKt.roundToInt(Offset.m3763getYimpl(position));
        int right = IntSize.m6655getWidthimpl(size) + left;
        int bottom = IntSize.m6654getHeightimpl(size) + top;
