...
public final class ContextMenu_androidKt {
    public static final void ContextMenuArea(final TextFieldSelectionManager manager, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 19) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1985516685, $dirty2, -1, "androidx.compose.foundation.text.ContextMenuArea (ContextMenu.android.kt:35)");
            }
            ...
            if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new Function0<Unit>() { // from class: androidx.compose.foundation.text.ContextMenu_androidKt$ContextMenuArea$1$1
                    {
                        super(0);
                    }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ContextMenuArea_androidKt.ContextMenuArea(state, (Function0) value$iv2, TextFieldSelectionManager_androidKt.contextMenuBuilder(manager, state), null, manager.getEnabled(), function2, $composer2, (($dirty2 << 12) & 458752) | 54, 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.ContextMenu_androidKt.ContextMenuArea.2
                ...
                public final void invoke(Composer composer, int i) {
                    ContextMenu_androidKt.ContextMenuArea(manager, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void ContextMenuArea(final TextFieldSelectionState selectionState, final boolean enabled, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 147) != 146 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2103477555, $dirty2, -1, "androidx.compose.foundation.text.ContextMenuArea (ContextMenu.android.kt:51)");
            }
            ...
            Object it$iv2 = $composer2.rememberedValue();
            if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new Function0<Unit>() { // from class: androidx.compose.foundation.text.ContextMenu_androidKt$ContextMenuArea$3$1
                    {
                        super(0);
                    }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ContextMenuArea_androidKt.ContextMenuArea(state, (Function0) value$iv2, TextFieldSelectionState_androidKt.contextMenuBuilder(selectionState, state), null, enabled, function2, $composer2, (($dirty2 << 9) & 57344) | 54 | (458752 & ($dirty2 << 9)), 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.ContextMenu_androidKt.ContextMenuArea.4
                ...
                public final void invoke(Composer composer, int i) {
                    ContextMenu_androidKt.ContextMenuArea(selectionState, enabled, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void ContextMenuArea(final SelectionManager manager, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 19) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(605522716, $dirty2, -1, "androidx.compose.foundation.text.ContextMenuArea (ContextMenu.android.kt:66)");
            }
            ...
            Object it$iv2 = $composer2.rememberedValue();
            if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new Function0<Unit>() { // from class: androidx.compose.foundation.text.ContextMenu_androidKt$ContextMenuArea$5$1
                    {
                        super(0);
                    }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ContextMenuArea_androidKt.ContextMenuArea(state, (Function0) value$iv2, SelectionManager_androidKt.contextMenuBuilder(manager, state), null, false, function2, $composer2, (($dirty2 << 12) & 458752) | 54, 24);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function2<Composer, Integer, String> {
        ...
        public final String invoke(Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final void TextItem(ContextMenuScope $this$TextItem, final ContextMenuState state, TextContextMenuItems label, boolean enabled, final Function0<Unit> function0) {
        $this$TextItem.item(new AnonymousClass1(label), (10 & 2) != 0 ? Modifier.INSTANCE : null, (10 & 4) != 0 ? true : enabled, (10 & 8) != 0 ? null : null, new Function0<Unit>() { // from class: androidx.compose.foundation.text.ContextMenu_androidKt.TextItem.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
