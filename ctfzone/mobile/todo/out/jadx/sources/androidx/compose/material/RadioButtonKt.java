...
public final class RadioButtonKt {
    ...
    private static final float RadioButtonRippleRadius = Dp.m6485constructorimpl(24);
    private static final float RadioButtonPadding = Dp.m6485constructorimpl(2);
    private static final float RadioButtonSize = Dp.m6485constructorimpl(20);
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    ...
                    modifier3 = modifier4;
                    enabled2 = enabled3;
                    colors2 = RadioButtonDefaults.INSTANCE.m1639colorsRGew2ao(0L, 0L, 0L, $composer2, 3072, 7);
                } else {
                    colors2 = colors;
                    interactionSource3 = interactionSource2;
                    $dirty = $dirty3;
            ...
            if (selected) {
                ...
                arg0$iv = Dp.m6485constructorimpl(arg0$iv2 / 2);
            } else {
                arg0$iv = Dp.m6485constructorimpl(0);
            }
            State dotRadius2 = AnimateAsStateKt.m128animateDpAsStateAjpBEmI(arg0$iv, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer2, 48, 12);
            ...
            if (function0 != null) {
                ...
                $dirty2 = $dirty;
                selectableModifier = SelectableKt.m932selectableO2vRcR0(Modifier.INSTANCE, selected, interactionSource3, RippleKt.m1763rememberRipple9IZ8Weo(false, RadioButtonRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m5751boximpl(Role.INSTANCE.m5762getRadioButtono7Vup1c()), function0);
            } else {
                radioColor = radioColor2;
                dotRadius = dotRadius2;
                $dirty2 = $dirty;
            ...
            $composer2.endReplaceableGroup();
            Modifier modifierM718requiredSize3ABfNKs = SizeKt.m718requiredSize3ABfNKs(PaddingKt.m681padding3ABfNKs(SizeKt.wrapContentSize$default(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(selectableModifier), Alignment.INSTANCE.getCenter(), false, 2, null), RadioButtonPadding), RadioButtonSize);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.RadioButtonKt$RadioButton$2$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        ...
                        float f = 2;
                        DrawScope.m4540drawCircleVaOC9Bg$default($this$Canvas, radioColor3.getValue().m4013unboximpl(), $this$Canvas.mo373toPx0680j_4(RadioButtonKt.RadioRadius) - (strokeWidth / f), 0L, 0.0f, new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null), null, 0, 108, null);
                        if (Dp.m6484compareTo0680j_4(dotRadius3.getValue().m6499unboximpl(), Dp.m6485constructorimpl(0)) > 0) {
                            DrawScope.m4540drawCircleVaOC9Bg$default($this$Canvas, radioColor3.getValue().m4013unboximpl(), $this$Canvas.mo373toPx0680j_4(dotRadius3.getValue().m6499unboximpl()) - (strokeWidth / f), 0L, 0.0f, Fill.INSTANCE, null, 0, 108, null);
                        }
                    }
                };
            ...
            $composer2.endReplaceableGroup();
            CanvasKt.Canvas(modifierM718requiredSize3ABfNKs, (Function1) value$iv, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    static {
        ...
        RadioRadius = Dp.m6485constructorimpl(arg0$iv / 2);
        RadioButtonDotSize = Dp.m6485constructorimpl(12);
        RadioStrokeWidth = Dp.m6485constructorimpl(2);
    }
}
