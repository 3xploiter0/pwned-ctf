...
public final class RectKt {
    ...
    public static final Rect m3802Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m3762getXimpl(offset), Offset.m3763getYimpl(offset), Offset.m3762getXimpl(offset) + Size.m3831getWidthimpl(size), Offset.m3763getYimpl(offset) + Size.m3828getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m3800Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m3762getXimpl(topLeft), Offset.m3763getYimpl(topLeft), Offset.m3762getXimpl(bottomRight), Offset.m3763getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m3801Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m3762getXimpl(center) - radius, Offset.m3763getYimpl(center) - radius, Offset.m3762getXimpl(center) + radius, Offset.m3763getYimpl(center) + radius);
    }
