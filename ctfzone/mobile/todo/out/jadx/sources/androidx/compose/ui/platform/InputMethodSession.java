                ...
                */
                public final void invoke2(androidx.compose.ui.text.input.NullableInputConnectionWrapper r8) {
                    /*
                        r7 = this;
                        r8.disposeDelegate()
                        androidx.compose.ui.platform.InputMethodSession r0 = r7.this$0
                    ...
                    L27:
                        r0 = r3
                        if (r0 < 0) goto L33
                        androidx.compose.ui.platform.InputMethodSession r1 = r7.this$0
                        androidx.compose.runtime.collection.MutableVector r1 = androidx.compose.ui.platform.InputMethodSession.access$getConnections$p(r1)
                        r1.removeAt(r0)
                    L33:
                        androidx.compose.ui.platform.InputMethodSession r1 = r7.this$0
                        androidx.compose.runtime.collection.MutableVector r1 = androidx.compose.ui.platform.InputMethodSession.access$getConnections$p(r1)
                        ...
                        if (r1 == 0) goto L48
                        androidx.compose.ui.platform.InputMethodSession r1 = r7.this$0
                        kotlin.jvm.functions.Function0 r1 = androidx.compose.ui.platform.InputMethodSession.access$getOnAllConnectionsClosed$p(r1)
                        r1.invoke()
                    L48:
                        return
                    */
