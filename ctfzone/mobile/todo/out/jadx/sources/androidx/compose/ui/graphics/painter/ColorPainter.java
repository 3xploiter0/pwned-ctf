...
public final class ColorPainter extends Painter {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        DrawScope.m4553drawRectnJ9OG0$default($this$onDraw, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m4004equalsimpl0(this.color, ((ColorPainter) other).color);
    }

    public int hashCode() {
        return Color.m4010hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m4011toStringimpl(this.color)) + ')';
    }
