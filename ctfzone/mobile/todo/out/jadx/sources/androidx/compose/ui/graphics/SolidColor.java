...
public final class SolidColor extends Brush {
    ...
    public void mo3950applyToPq9zytI(long size, Paint p, float alpha) {
        long jM4001copywmQWz5c;
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            long j = this.value;
            jM4001copywmQWz5c = Color.m4001copywmQWz5c(j, (14 & 1) != 0 ? Color.m4005getAlphaimpl(j) : Color.m4005getAlphaimpl(this.value) * alpha, (14 & 2) != 0 ? Color.m4009getRedimpl(j) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(j) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(j) : 0.0f);
        } else {
            jM4001copywmQWz5c = this.value;
        }
        p.mo3882setColor8_81llA(jM4001copywmQWz5c);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m4004equalsimpl0(this.value, ((SolidColor) other).value);
    }

    public int hashCode() {
        return Color.m4010hashCodeimpl(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m4011toStringimpl(this.value)) + ')';
    }
}
