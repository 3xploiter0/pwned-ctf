...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String strM6424getEnterjXw82LU;
        this.animation = animation;
        if (getAnimation().m6410getAnimationObject().getCurrentState().booleanValue()) {
            strM6424getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m6425getExitjXw82LU();
        } else {
            strM6424getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m6424getEnterjXw82LU();
        }
        this.state = strM6424getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ ComposeAnimationState getState() {
        return AnimatedVisibilityState.m6417boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(ComposeAnimationState composeAnimationState) {
        m6416setState7IW2chM(((AnimatedVisibilityState) composeAnimationState).m6423unboximpl());
    }
    ...
    public void m6416setState7IW2chM(String value) {
        this.state = value;
        setClockTime(0L);
    }
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m6416setState7IW2chM(((AnimatedVisibilityState) par1).m6423unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m6410getAnimationObject();
        Pair<Boolean, Boolean> pairM6414toCurrentTargetPair7IW2chM = m6414toCurrentTargetPair7IW2chM(getState());
        boolean current = pairM6414toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = pairM6414toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m6414toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m6420equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.INSTANCE.m6424getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
