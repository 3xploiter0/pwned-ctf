    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                case 0:
                                    ResultKt.throwOnFailure($result);
                                    this.label = 1;
                                    if (this.this$0.state.onTap$material3_release(Offset.m3762getXimpl(this.$it), Offset.m3763getYimpl(this.$it), this.this$0.getMaxDist(), this.this$0.autoSwitchToMinute, this) != coroutine_suspended) {
                                        break;
                                    } else {
                ...
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures($this$SuspendingPointerInputModifierNode, (7 & 1) != 0 ? null : null, (7 & 2) != 0 ? null : null, (7 & 4) != 0 ? TapGestureDetectorKt.NoPressGesture : anonymousClass1, (7 & 8) != 0 ? null : function1, this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    long it = this.J$0;
                    this.this$0.offsetX = Offset.m3762getXimpl(it);
                    this.this$0.offsetY = Offset.m3763getYimpl(it);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
