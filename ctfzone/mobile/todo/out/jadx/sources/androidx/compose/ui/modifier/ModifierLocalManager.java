...
public final class ModifierLocalManager {
    ...
    private final void invalidateConsumersOfNodeForKey(Modifier.Node node, ModifierLocal<?> key, Set<BackwardsCompatNode> set) {
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((node4.getAggregateChildKindSet() & iM5574constructorimpl) != 0) {
                Modifier.Node child2 = node4;
                while (child2 != null) {
                    if ((child2.getKindSet() & iM5574constructorimpl) != 0) {
                        ...
                        while (true) {
                            ...
                            if (nodePop instanceof ModifierLocalModifierNode) {
                                ...
                                node2 = node3;
                                i2 = i6;
                                if (((nodePop.getKindSet() & iM5574constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
                                    int i7 = 0;
