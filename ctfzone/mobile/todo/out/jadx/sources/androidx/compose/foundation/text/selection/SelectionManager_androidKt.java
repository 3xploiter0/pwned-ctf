...
public final class SelectionManager_androidKt {
    ...
    public static final Modifier selectionMagnifier(Modifier $this$selectionMagnifier, SelectionManager manager) {
        ...
        return ComposedModifierKt.composed$default($this$selectionMagnifier, null, new C03791(manager), 1, null);
    }
    ...
    static final class C03791 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        C03791(SelectionManager selectionManager) {
            super(3);
        ...
        public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6647boximpl(IntSize.INSTANCE.m6660getZeroYbymL2g()), null, 2, null);
            ...
            if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3751boximpl(m1384invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1384invokeF1C5BW0() {
                        return SelectionManagerKt.m1380calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, SelectionManager_androidKt.C03791.invoke$lambda$1(magnifierSize$delegate));
                    }
                };
            ...
            if (invalid$iv2 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv3 = new Function1<Function0<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m3751boximpl(m1385invoketuRUvjQ(density2));
                            }
                        ...
                        return Magnifier_androidKt.m306magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void m1386invokeEaSLcWc(long size) {
                                ...
                                SelectionManager_androidKt.C03791.invoke$lambda$2(mutableState2, IntSizeKt.IntSize($this$invoke_EaSLcWc_u24lambda_u240.mo367roundToPx0680j_4(DpSize.m6583getWidthD9Ej5fM(size)), $this$invoke_EaSLcWc_u24lambda_u240.mo367roundToPx0680j_4(DpSize.m6581getHeightD9Ej5fM(size))));
                            }
        ...
        public static final void invoke$lambda$2(MutableState<IntSize> mutableState, long value) {
            mutableState.setValue(IntSize.m6647boximpl(value));
        }
    }
