...
public final class LazyStaggeredGridMeasureKt {
    ...
    public static final LazyStaggeredGridMeasureResult m892measureStaggeredGridXtK8cYQ(LazyLayoutMeasureScope $this$measureStaggeredGrid_u2dXtK8cYQ, LazyStaggeredGridState state, List<Integer> list, LazyStaggeredGridItemProvider itemProvider, LazyStaggeredGridSlots resolvedSlots, long constraints, boolean isVertical, boolean reverseLayout, long contentOffset, int mainAxisAvailableSize, int mainAxisSpacing, int beforeContentPadding, int afterContentPadding, CoroutineScope coroutineScope, GraphicsContext graphicsContext) {
        int[] $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242;
        int iM891maxInRangejy6DScQ;
        int[] $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243;
        int i;
        ...
        if (firstVisibleIndices.length == context.getLaneCount()) {
            $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242 = firstVisibleIndices;
        } else {
            context.getLaneInfo().reset();
            $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242 = new int[context.getLaneCount()];
            int length = $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242.length;
            for (int lane = 0; lane < length; lane++) {
                if (lane < firstVisibleIndices.length && firstVisibleIndices[lane] != -1) {
                    iM891maxInRangejy6DScQ = firstVisibleIndices[lane];
                } else if (lane == 0) {
                    iM891maxInRangejy6DScQ = 0;
                } else {
                    iM891maxInRangejy6DScQ = m891maxInRangejy6DScQ($this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242, SpanRange.m902constructorimpl(0, lane)) + 1;
                }
                $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242[lane] = iM891maxInRangejy6DScQ;
                context.getLaneInfo().setLane($this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242[lane], lane);
            }
        }
        int[] initialItemIndices = $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u242;
        if (firstVisibleOffsets.length == context.getLaneCount()) {
            $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243 = firstVisibleOffsets;
        } else {
            $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243 = new int[context.getLaneCount()];
            int lane2 = 0;
            int length2 = $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243.length;
            while (lane2 < length2) {
                if (lane2 < firstVisibleOffsets.length) {
                    i = firstVisibleOffsets[lane2];
                } else {
                    i = lane2 == 0 ? 0 : $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243[lane2 - 1];
                }
                $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243[lane2] = i;
                lane2++;
            }
        }
        int[] initialItemOffsets = $this$measureStaggeredGrid_XtK8cYQ_u24lambda_u243;
    ...
    /* JADX WARN: Removed duplicated region for block: B:256:0x06e4  */
    /* JADX WARN: Removed duplicated region for block: B:409:0x0b61  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private static final androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureResult measure(final androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureContext r65, int r66, int[] r67, int[] r68, boolean r69) {
        /*
    ...
    private static final boolean measure$lambda$41$hasSpaceBeforeFirst(int[] firstItemIndices, int[] firstItemOffsets, LazyStaggeredGridMeasureContext $this_measure) {
    ...
    private static final boolean measure$lambda$41$misalignedStart(int[] firstItemIndices, LazyStaggeredGridMeasureContext $this_measure, int[] firstItemOffsets, int referenceLane) {
        int lane = 0;
        int length = firstItemIndices.length;
        while (true) {
            boolean z = false;
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateVisibleItems(LazyStaggeredGridMeasureContext $this$calculateVisibleItems, ArrayDeque<LazyStaggeredGridMeasuredItem>[] arrayDequeArr, int[] itemScrollOffsets, int mainAxisLayoutSize) {
        ...
        while (true) {
            ...
            if (item.getLane() == laneIndex) {
                long spanRange = SpanRange.m902constructorimpl(item.getLane(), item.getSpan());
                int mainAxisOffset = m891maxInRangejy6DScQ(itemScrollOffsets, spanRange);
        ...
        if (beforeVisibleBounds) {
            ...
            if (size >= 0) {
                while (true) {
                    ...
                    if (function13.invoke(Integer.valueOf(index)).booleanValue()) {
                        ...
                        long spanRange = $this$calculateExtraItems.m887getSpanRangelOCCd4c($this$calculateExtraItems.getItemProvider(), index, 0);
                        if (arrayList == null) {
                            Object result = new ArrayList();
                            arrayList = (List) result;
                        }
                        LazyStaggeredGridMeasuredItem measuredItem = $this$calculateExtraItems.getMeasuredItemProvider().m896getAndMeasurejy6DScQ(index, spanRange);
            ...
            while (index$iv$iv2 < size2) {
                ...
                if (function13.invoke(Integer.valueOf(index2)).booleanValue()) {
                    ...
                    long spanRange2 = $this$calculateExtraItems.m887getSpanRangelOCCd4c($this$calculateExtraItems.getItemProvider(), index2, 0);
                    if (arrayList == null) {
                        Object result2 = new ArrayList();
                        arrayList = (List) result2;
                    }
                    LazyStaggeredGridMeasuredItem measuredItem2 = $this$calculateExtraItems.getMeasuredItemProvider().m896getAndMeasurejy6DScQ(index2, spanRange2);
    ...
    private static final void m890forEachnIS5qE8(long $this$forEach_u2dnIS5qE8, Function1<? super Integer, Unit> function1) {
    ...
    private static final int m891maxInRangejy6DScQ(int[] $this$maxInRange_u2djy6DScQ, long indexRange) {
