...
public final class AndroidPaint_androidKt {
    ...
    public static final void m3887setNativeBlendModeGB0RdKg(android.graphics.Paint $this$setNativeBlendMode_u2dGB0RdKg, int mode) {
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m4406setBlendModeGB0RdKg($this$setNativeBlendMode_u2dGB0RdKg, mode);
        } else {
            $this$setNativeBlendMode_u2dGB0RdKg.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m3855toPorterDuffModes9anfk8(mode)));
        }
    }
    ...
    public static final void m3888setNativeColor4WTKRHQ(android.graphics.Paint $this$setNativeColor_u2d4WTKRHQ, long value) {
        $this$setNativeColor_u2d4WTKRHQ.setColor(ColorKt.m4057toArgb8_81llA(value));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m3892setNativeStyle5YerkU(android.graphics.Paint $this$setNativeStyle_u2d_u2d5YerkU, int value) {
        $this$setNativeStyle_u2d_u2d5YerkU.setStyle(PaintingStyle.m4266equalsimpl0(value, PaintingStyle.INSTANCE.m4271getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint $this$getNativeStyle) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m4271getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m4270getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint $this$getNativeStrokeCap) {
        ...
        return StrokeCap.INSTANCE.m4356getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m3890setNativeStrokeCapCSYIeUk(android.graphics.Paint $this$setNativeStrokeCap_u2dCSYIeUk, int value) {
        Paint.Cap cap;
        if (StrokeCap.m4352equalsimpl0(value, StrokeCap.INSTANCE.m4358getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m4352equalsimpl0(value, StrokeCap.INSTANCE.m4357getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m4352equalsimpl0(value, StrokeCap.INSTANCE.m4356getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint $this$getNativeStrokeJoin) {
        ...
        return StrokeJoin.INSTANCE.m4367getMiterLxFBmk8();
    }

    /* renamed from: setNativeStrokeJoin-kLtJ_vA, reason: not valid java name */
    public static final void m3891setNativeStrokeJoinkLtJ_vA(android.graphics.Paint $this$setNativeStrokeJoin_u2dkLtJ_vA, int value) {
        Paint.Join join;
        if (StrokeJoin.m4362equalsimpl0(value, StrokeJoin.INSTANCE.m4367getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m4362equalsimpl0(value, StrokeJoin.INSTANCE.m4366getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m4362equalsimpl0(value, StrokeJoin.INSTANCE.m4368getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint $this$getNativeFilterQuality) {
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m4105getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m4103getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m3889setNativeFilterQuality50PEsBU(android.graphics.Paint $this$setNativeFilterQuality_u2d50PEsBU, int value) {
        $this$setNativeFilterQuality_u2d50PEsBU.setFilterBitmap(!FilterQuality.m4098equalsimpl0(value, FilterQuality.INSTANCE.m4105getNonefv9h1I()));
    }
