...
public final class TextFieldSelectionManager_androidKt {
    ...
    public static final Modifier textFieldMagnifier(Modifier $this$textFieldMagnifier, TextFieldSelectionManager manager) {
        ...
        return ComposedModifierKt.composed$default($this$textFieldMagnifier, null, new C03801(manager), 1, null);
    }
    ...
    static final class C03801 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        final /* synthetic */ TextFieldSelectionManager $manager;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03801(TextFieldSelectionManager textFieldSelectionManager) {
            super(3);
        ...
        public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
            ...
            if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3751boximpl(m1407invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1407invokeF1C5BW0() {
                        return TextFieldSelectionManagerKt.m1406calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, TextFieldSelectionManager_androidKt.C03801.invoke$lambda$1(magnifierSize$delegate));
                    }
                };
            ...
            if (invalid$iv2 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv3 = new Function1<Function0<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m3751boximpl(m1408invoketuRUvjQ(density2));
                            }
                        ...
                        return Magnifier_androidKt.m306magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                            ...
                            public final void m1409invokeEaSLcWc(long size) {
                                ...
                                TextFieldSelectionManager_androidKt.C03801.invoke$lambda$2(mutableState2, IntSizeKt.IntSize($this$invoke_EaSLcWc_u24lambda_u240.mo367roundToPx0680j_4(DpSize.m6583getWidthD9Ej5fM(size)), $this$invoke_EaSLcWc_u24lambda_u240.mo367roundToPx0680j_4(DpSize.m6581getHeightD9Ej5fM(size))));
                            }
