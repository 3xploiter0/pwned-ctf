...
public final class ComposableSingletons$BackdropScaffoldKt {
    ...
    public static Function3<SnackbarHostState, Composer, Integer, Unit> f7lambda1 = ComposableLambdaKt.composableLambdaInstance(229445492, false, new Function3<SnackbarHostState, Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$BackdropScaffoldKt$lambda-1$1
        ...
        public final void invoke(SnackbarHostState it, Composer $composer, int $changed) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(229445492, $dirty, -1, "androidx.compose.material.ComposableSingletons$BackdropScaffoldKt.lambda-1.<anonymous> (BackdropScaffold.kt:275)");
            }
    ...
    public final Function3<SnackbarHostState, Composer, Integer, Unit> m1521getLambda1$material_release() {
        return f7lambda1;
    }
}
