...
public final class LazyGridMeasuredItem implements LazyGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyGridMeasuredItem(int index, Object key, boolean isVertical, int crossAxisSize, int mainAxisSpacing, boolean reverseLayout, LayoutDirection layoutDirection, int beforeContentPadding, int afterContentPadding, List<? extends Placeable> list, long visualOffset, Object contentType, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, long constraints, int lane, int span) {
        ...
        this.offset = IntOffset.INSTANCE.m6623getZeronOccac();
        this.row = -1;
        this.column = -1;
    }
    ...
    public final void applyScrollDelta(int delta) {
        ...
        if (getIsVertical()) {
            it = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
        } else {
            int it3 = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
            it = it3 + delta;
        }
        if (getIsVertical()) {
            int it4 = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
            it2 = it4 + delta;
        } else {
            it2 = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
        }
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (animation != null) {
                ...
                if (getIsVertical()) {
                    iIntValue = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv2);
                } else {
                    int mainAxis2 = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv2);
                    iIntValue = Integer.valueOf(mainAxis2 + delta).intValue();
                }
                if (getIsVertical()) {
                    int mainAxis3 = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv2);
                    mainAxis = mainAxis3 + delta;
                } else {
                    mainAxis = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv2);
                }
                animation.m844setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iIntValue, mainAxis));
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < placeablesCount) {
            ...
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), index);
            if (animation != null) {
                long animatedOffset = IntOffset.m6617plusqkQi6aY(offset, animation.m840getPlacementDeltanOccac());
                if ((m824getMainAxisgyyYBs(offset) <= minOffset && m824getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m824getMainAxisgyyYBs(offset) >= maxOffset && m824getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
                    animation.cancelPlacementAnimation();
                }
                offset = animatedOffset;
                GraphicsLayer layer2 = animation.getLayer();
                layer = layer2;
            } else {
                layer = null;
            }
            if (this.reverseLayout) {
                ...
                if (getIsVertical()) {
                    mainAxisOffset = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                    int mainAxisOffset2 = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (getIsVertical()) {
                    int mainAxisOffset3 = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
                    iM6614getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    iM6614getYimpl = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(mainAxisOffset, iM6614getYimpl);
            }
            long offset2 = IntOffset.m6617plusqkQi6aY(offset, this.visualOffset);
            if (animation != null) {
                animation.m842setFinalOffsetgyyYBs(offset2);
            }
            if (!getIsVertical()) {
                i = i3;
                i2 = placeablesCount;
                if (layer != null) {
                    Placeable.PlacementScope.m5406placeRelativeWithLayeraW9wM$default(scope, placeable, offset2, layer, 0.0f, 4, (Object) null);
                } else {
                    Placeable.PlacementScope.m5405placeRelativeWithLayeraW9wM$default(scope, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
                }
            } else if (layer != null) {
                Placeable.PlacementScope.m5408placeWithLayeraW9wM$default(scope, placeable, offset2, layer, 0.0f, 4, (Object) null);
                i = i3;
                i2 = placeablesCount;
            } else {
                i = i3;
                i2 = placeablesCount;
                Placeable.PlacementScope.m5407placeWithLayeraW9wM$default(scope, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
            }
            i3 = i + 1;
            placeablesCount = i2;
        }
    ...
    private final int m824getMainAxisgyyYBs(long $this$mainAxis) {
        return getIsVertical() ? IntOffset.m6614getYimpl($this$mainAxis) : IntOffset.m6613getXimpl($this$mainAxis);
    }
    ...
    private final long m823copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(getIsVertical() ? IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE))).intValue(), getIsVertical() ? function1.invoke(Integer.valueOf(IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE));
    }
}
