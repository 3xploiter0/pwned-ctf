...
final class AnchoredDraggableNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        switch (this.label) {
            case 0:
                ...
                if (((AnchoredDraggableNode) this.this$0).overscrollEffect != null) {
                    ...
                    this.label = 2;
                    if (overscrollEffect.mo217applyToFlingBMRW4eQ(this.this$0.m384reverseIfNeededAH228Gc(this.$velocity), new AnonymousClass1(this.this$0, null), this) == coroutine_suspended) {
                ...
                this.label = 1;
                Object obj = ((AnchoredDraggableNode) this.this$0).state.settle(this.this$0.m386toFloatTH1AsA0(this.this$0.m384reverseIfNeededAH228Gc(this.$velocity)), this);
                if (obj != coroutine_suspended) {
                    $result = obj;
                    anchoredDraggableNode.m389toVelocityadjELrA(((Number) $result).floatValue());
                    return Unit.INSTANCE;
                }
                return coroutine_suspended;
            case 1:
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<Velocity, Continuation<? super Velocity>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Velocity> continuation) {
            return m393invokesFctU(velocity.getPackedValue(), continuation);
        }

        /* renamed from: invoke-sF-c-tU, reason: not valid java name */
        public final Object m393invokesFctU(long j, Continuation<? super Velocity> continuation) {
            return ((AnonymousClass1) create(Velocity.m6713boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    Object obj = ((AnchoredDraggableNode) anonymousClass1.this$0).state.settle(anonymousClass1.this$0.m386toFloatTH1AsA0(availableVelocity), anonymousClass1);
                    if (obj != coroutine_suspended) {
                        $result = obj;
                        break;
                    } else {
            ...
            long consumed = anchoredDraggableNode.m389toVelocityadjELrA(((Number) $result).floatValue());
            ...
            return Velocity.m6713boximpl(availableVelocity);
        }
    }
}
