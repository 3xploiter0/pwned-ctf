...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m6613getXimpl(getOffset()) : IntOffset.m6614getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        int i5 = 0;
        List $this$fastForEachIndexed$iv2 = this.placeables;
        int size = $this$fastForEachIndexed$iv2.size();
        int index$iv2 = 0;
        while (index$iv2 < size) {
            Object item$iv = $this$fastForEachIndexed$iv2.get(index$iv2);
            ...
            if (animation != null) {
                ...
                if ((m898getMainAxisgyyYBs(offset) <= minOffset && m898getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m898getMainAxisgyyYBs(offset) >= maxOffset && m898getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if (context.getReverseLayout()) {
                ...
                if (getIsVertical()) {
                    height = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                    int mainAxisOffset = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
                    height = (this.mainAxisLayoutSize - mainAxisOffset) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (getIsVertical()) {
                    int mainAxisOffset2 = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
                    iM6614getYimpl = (this.mainAxisLayoutSize - mainAxisOffset2) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                } else {
                    iM6614getYimpl = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(height, iM6614getYimpl);
            }
            long offset2 = IntOffset.m6617plusqkQi6aY(offset, context.getContentOffset());
            if (animation != null) {
    ...
    private final int m898getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m897copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
