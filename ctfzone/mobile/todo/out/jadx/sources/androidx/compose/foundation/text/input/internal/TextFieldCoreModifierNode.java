...
public final class TextFieldCoreModifierNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        if (this.orientation == Orientation.Vertical) {
            return m1199measureVerticalScroll3p2s80s($this$measure_u2d3p2s80s, measurable, constraints);
        }
        return m1198measureHorizontalScroll3p2s80s($this$measure_u2d3p2s80s, measurable, constraints);
    }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if (TextRange.m5942getCollapsedimpl(value.getSelection())) {
            ...
            if (value.shouldShowSelection()) {
                m1197drawSelectionSbBc2M($this$draw, value.getSelection(), textLayoutResult);
            }
            drawText($this$draw, textLayoutResult);
        }
    ...
    private final MeasureResult m1199measureVerticalScroll3p2s80s(final MeasureScope $this$measureVerticalScroll_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        final Placeable placeable = measurable.mo5339measureBRTryo0(childConstraints);
        final int height = Math.min(placeable.getHeight(), Constraints.m6437getMaxHeightimpl(constraints));
        return MeasureScope.layout$default($this$measureVerticalScroll_u2d3p2s80s, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureVerticalScroll$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                this.this$0.m1200updateScrollStatetIlFzwE($this$measureVerticalScroll_u2d3p2s80s, height, placeable.getHeight(), this.this$0.textFieldState.getVisualText().getSelection(), $this$measureVerticalScroll_u2d3p2s80s.getLayoutDirection());
    ...
    private final MeasureResult m1198measureHorizontalScroll3p2s80s(final MeasureScope $this$measureHorizontalScroll_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measureHorizontalScroll_u2d3p2s80s, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureHorizontalScroll$1
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                this.this$0.m1200updateScrollStatetIlFzwE($this$measureHorizontalScroll_u2d3p2s80s, width, placeable.getWidth(), this.this$0.textFieldState.getVisualText().getSelection(), $this$measureHorizontalScroll_u2d3p2s80s.getLayoutDirection());
    ...
    private final int m1196calculateOffsetToFollow72CqOWE(long currSelection, int currTextLayoutSize) {
        TextRange textRange = this.previousSelection;
        if (!(textRange != null && TextRange.m5943getEndimpl(currSelection) == TextRange.m5943getEndimpl(textRange.getPackedValue()))) {
            return TextRange.m5943getEndimpl(currSelection);
        }
        TextRange textRange2 = this.previousSelection;
        if ((textRange2 != null && TextRange.m5948getStartimpl(currSelection) == TextRange.m5948getStartimpl(textRange2.getPackedValue())) && currTextLayoutSize == this.previousTextLayoutSize) {
            return -1;
        }
        return TextRange.m5948getStartimpl(currSelection);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: updateScrollState-tIlFzwE, reason: not valid java name */
    public final void m1200updateScrollStatetIlFzwE(Density $this$updateScrollState_u2dtIlFzwE, int containerSize, int textLayoutSize, long currSelection, LayoutDirection layoutDirection) {
        TextLayoutResult layoutResult;
        float offsetDifference;
        this.scrollState.setMaxValue$foundation_release(textLayoutSize - containerSize);
        int offsetToFollow = m1196calculateOffsetToFollow72CqOWE(currSelection, textLayoutSize);
        ...
        this.previousSelection = TextRange.m5936boximpl(currSelection);
    ...
    private final void m1197drawSelectionSbBc2M(DrawScope $this$drawSelection_u2dSb_u2dBc2M, long selection, TextLayoutResult textLayoutResult) {
        int start = TextRange.m5946getMinimpl(selection);
        int end = TextRange.m5945getMaximpl(selection);
        if (start != end) {
            ...
            DrawScope.m4549drawPathLG529CI$default($this$drawSelection_u2dSb_u2dBc2M, selectionPath, selectionBackgroundColor, 0.0f, null, null, 0, 60, null);
        }
    }
    ...
    private final void drawHighlight(DrawScope $this$drawHighlight, Pair<TextHighlightType, TextRange> pair, TextLayoutResult textLayoutResult) {
        ...
        Path highlightPath = textLayoutResult.getPathForRange(TextRange.m5946getMinimpl(range), TextRange.m5945getMaximpl(range));
        if (TextHighlightType.m1117equalsimpl0(type, TextHighlightType.INSTANCE.m1121getHandwritingDeletePreviewsxJuwY())) {
            Brush brush = textLayoutResult.getLayoutInput().getStyle().getBrush();
            if (brush != null) {
                DrawScope.m4548drawPathGBMwjPU$default($this$drawHighlight, highlightPath, brush, 0.2f, null, null, 0, 56, null);
                return;
            }
            long $this$takeOrElse_u2dDxMtmZc$iv = textLayoutResult.getLayoutInput().getStyle().m5978getColor0d7_KjU();
            long textColor = ($this$takeOrElse_u2dDxMtmZc$iv > 16L ? 1 : ($this$takeOrElse_u2dDxMtmZc$iv == 16L ? 0 : -1)) != 0 ? $this$takeOrElse_u2dDxMtmZc$iv : Color.INSTANCE.m4029getBlack0d7_KjU();
            long highlightBackgroundColor = Color.m4001copywmQWz5c(textColor, (14 & 1) != 0 ? Color.m4005getAlphaimpl(textColor) : Color.m4005getAlphaimpl(textColor) * 0.2f, (14 & 2) != 0 ? Color.m4009getRedimpl(textColor) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(textColor) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(textColor) : 0.0f);
            DrawScope.m4549drawPathLG529CI$default($this$drawHighlight, highlightPath, highlightBackgroundColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        ...
        DrawScope.m4549drawPathLG529CI$default($this$drawHighlight, highlightPath, highlightBackgroundColor2, 0.0f, null, null, 0, 60, null);
    }
    ...
    private final void drawCursor(DrawScope $this$drawCursor) {
        ...
        DrawScope.m4544drawLine1RTmtNc$default($this$drawCursor, this.cursorBrush, cursorRect.m3796getTopCenterF1C5BW0(), cursorRect.m3789getBottomCenterF1C5BW0(), cursorRect.getWidth(), 0, null, cursorAlphaValue, null, 0, 432, null);
    }
