...
public final class SelectionGesturesKt {
    ...
    static final class C03731 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        C03731(Function1<? super Boolean, Unit> function1, Continuation<? super C03731> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03731 c03731 = new C03731(this.$updateTouchMode, continuation);
            c03731.L$0 = obj;
            return c03731;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C03731) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C00611 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00611(Function1<? super Boolean, Unit> function1, Continuation<? super C00611> continuation) {
                super(2, continuation);
                this.$updateTouchMode = function1;
            }
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r9) {
                ...
                L4b:
                    ...
                    goto L27
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.SelectionGesturesKt.C03731.C00611.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if ($this$pointerInput.awaitPointerEventScope(new C00611(this.$updateTouchMode, null), this) != coroutine_suspended) {
                        break;
                    } else {
    ...
    public static final Modifier updateSelectionTouchMode(Modifier $this$updateSelectionTouchMode, Function1<? super Boolean, Unit> function1) {
        return SuspendingPointerInputFilterKt.pointerInput($this$updateSelectionTouchMode, Integer.valueOf(STATIC_KEY), new C03731(function1, null));
    }
    ...
    static final class C03681 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03681(MouseSelectionObserver mouseSelectionObserver, TextDragObserver textDragObserver, Continuation<? super C03681> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03681 c03681 = new C03681(this.$mouseSelectionObserver, this.$textDragObserver, continuation);
            c03681.L$0 = obj;
            return c03681;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C03681) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture($this$pointerInput, new C00601(this.$mouseSelectionObserver, clicksCounter, this.$textDragObserver, null), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
        ...
        static final class C00601 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00601(MouseSelectionObserver mouseSelectionObserver, ClicksCounter clicksCounter, TextDragObserver textDragObserver, Continuation<? super C00601> continuation) {
                super(2, continuation);
                this.$mouseSelectionObserver = mouseSelectionObserver;
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r19) {
                ...
                L4c:
                    ...
                    boolean r7 = androidx.compose.ui.input.pointer.PointerEvent_androidKt.m5183isPrimaryPressedaHzCxE(r7)
                    if (r7 == 0) goto Laa
                ...
                Lc5:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.SelectionGesturesKt.C03681.C00601.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
    }
    ...
    public static final Modifier selectionGestureInput(Modifier $this$selectionGestureInput, MouseSelectionObserver mouseSelectionObserver, TextDragObserver textDragObserver) {
        return SuspendingPointerInputFilterKt.pointerInput($this$selectionGestureInput, mouseSelectionObserver, textDragObserver, new C03681(mouseSelectionObserver, textDragObserver, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:31:0x00a8 A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:34:0x00b1 A[Catch: CancellationException -> 0x00e4, TryCatch #1 {CancellationException -> 0x00e4, blocks: (B:32:0x00a9, B:34:0x00b1, B:36:0x00c2, B:38:0x00d1, B:39:0x00d4, B:40:0x00d9, B:41:0x00de, B:18:0x004c, B:25:0x0077, B:27:0x007b, B:29:0x0085, B:21:0x0055), top: B:50:0x0022 }] */
    /* JADX WARN: Removed duplicated region for block: B:41:0x00de A[Catch: CancellationException -> 0x00e4, TRY_LEAVE, TryCatch #1 {CancellationException -> 0x00e4, blocks: (B:32:0x00a9, B:34:0x00b1, B:36:0x00c2, B:38:0x00d1, B:39:0x00d4, B:40:0x00d9, B:41:0x00de, B:18:0x004c, B:25:0x0077, B:27:0x007b, B:29:0x0085, B:21:0x0055), top: B:50:0x0022 }] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x00af A[Catch: CancellationException -> 0x00e2, TryCatch #0 {CancellationException -> 0x00e2, blocks: (B:32:0x00a7, B:34:0x00af, B:36:0x00c0, B:38:0x00cf, B:39:0x00d2, B:40:0x00d7, B:41:0x00dc, B:18:0x004b, B:25:0x0076, B:27:0x007a, B:29:0x0084, B:21:0x0054), top: B:48:0x0022 }] */
    /* JADX WARN: Removed duplicated region for block: B:41:0x00dc A[Catch: CancellationException -> 0x00e2, TRY_LEAVE, TryCatch #0 {CancellationException -> 0x00e2, blocks: (B:32:0x00a7, B:34:0x00af, B:36:0x00c0, B:38:0x00cf, B:39:0x00d2, B:40:0x00d7, B:41:0x00dc, B:18:0x004b, B:25:0x0076, B:27:0x007a, B:29:0x0084, B:21:0x0054), top: B:48:0x0022 }] */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0014  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:29:0x00a7 A[Catch: CancellationException -> 0x003c, TryCatch #1 {CancellationException -> 0x003c, blocks: (B:13:0x0036, B:44:0x00e4, B:46:0x00ec, B:48:0x00fe, B:50:0x010d, B:51:0x0110, B:52:0x0115, B:53:0x011a, B:27:0x00a3, B:29:0x00a7, B:30:0x00a9, B:32:0x00ae, B:34:0x00b1, B:36:0x00bc, B:38:0x00c2, B:40:0x00c6, B:41:0x00cb), top: B:62:0x0023 }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00ae A[Catch: CancellationException -> 0x003c, TryCatch #1 {CancellationException -> 0x003c, blocks: (B:13:0x0036, B:44:0x00e4, B:46:0x00ec, B:48:0x00fe, B:50:0x010d, B:51:0x0110, B:52:0x0115, B:53:0x011a, B:27:0x00a3, B:29:0x00a7, B:30:0x00a9, B:32:0x00ae, B:34:0x00b1, B:36:0x00bc, B:38:0x00c2, B:40:0x00c6, B:41:0x00cb), top: B:62:0x0023 }] */
    /* JADX WARN: Removed duplicated region for block: B:34:0x00b1 A[Catch: CancellationException -> 0x003c, TryCatch #1 {CancellationException -> 0x003c, blocks: (B:13:0x0036, B:44:0x00e4, B:46:0x00ec, B:48:0x00fe, B:50:0x010d, B:51:0x0110, B:52:0x0115, B:53:0x011a, B:27:0x00a3, B:29:0x00a7, B:30:0x00a9, B:32:0x00ae, B:34:0x00b1, B:36:0x00bc, B:38:0x00c2, B:40:0x00c6, B:41:0x00cb), top: B:62:0x0023 }] */
    /* JADX WARN: Removed duplicated region for block: B:46:0x00ec A[Catch: CancellationException -> 0x003c, TryCatch #1 {CancellationException -> 0x003c, blocks: (B:13:0x0036, B:44:0x00e4, B:46:0x00ec, B:48:0x00fe, B:50:0x010d, B:51:0x0110, B:52:0x0115, B:53:0x011a, B:27:0x00a3, B:29:0x00a7, B:30:0x00a9, B:32:0x00ae, B:34:0x00b1, B:36:0x00bc, B:38:0x00c2, B:40:0x00c6, B:41:0x00cb), top: B:62:0x0023 }] */
    /* JADX WARN: Removed duplicated region for block: B:53:0x011a A[Catch: CancellationException -> 0x003c, TRY_LEAVE, TryCatch #1 {CancellationException -> 0x003c, blocks: (B:13:0x0036, B:44:0x00e4, B:46:0x00ec, B:48:0x00fe, B:50:0x010d, B:51:0x0110, B:52:0x0115, B:53:0x011a, B:27:0x00a3, B:29:0x00a7, B:30:0x00a9, B:32:0x00ae, B:34:0x00b1, B:36:0x00bc, B:38:0x00c2, B:40:0x00c6, B:41:0x00cb), top: B:62:0x0023 }] */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0014  */
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:32:0x0094 A[Catch: all -> 0x004b, TryCatch #2 {all -> 0x004b, blocks: (B:18:0x0046, B:30:0x008c, B:32:0x0094, B:34:0x00a6, B:36:0x00b5), top: B:75:0x0046 }] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x0119 A[Catch: all -> 0x003b, TryCatch #3 {all -> 0x003b, blocks: (B:13:0x0035, B:55:0x0111, B:57:0x0119, B:59:0x012b, B:61:0x013a), top: B:77:0x0035 }] */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0014  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    ...
    */
    ...
    public static final boolean distanceIsTolerable(ViewConfiguration viewConfiguration, PointerInputChange change1, PointerInputChange change2) {
        float slop = DragGestureDetectorKt.m425pointerSlopE8SPZFQ(viewConfiguration, change1.getType());
        return Offset.m3760getDistanceimpl(Offset.m3766minusMKHz9U(change1.getPosition(), change2.getPosition())) < slop;
    }
    ...
    public static final boolean isPrecisePointer(PointerEvent $this$isPrecisePointer) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (!PointerType.m5282equalsimpl0(it.getType(), PointerType.INSTANCE.m5287getMouseT8wyACA())) {
                return false;
            }
        }
        return true;
