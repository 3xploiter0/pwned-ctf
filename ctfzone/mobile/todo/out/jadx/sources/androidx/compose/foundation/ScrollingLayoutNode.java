...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        CheckScrollableContainerConstraintsKt.m264checkScrollableContainerConstraintsK40F9xA(constraints, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        long childConstraints = Constraints.m6428copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6440getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6438getMaxWidthimpl(constraints) : this.isVertical ? Constraints.m6438getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m6439getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6437getMaxHeightimpl(constraints) : this.isVertical ? Integer.MAX_VALUE : Constraints.m6437getMaxHeightimpl(constraints));
        final Placeable placeable = measurable.mo5339measureBRTryo0(childConstraints);
        int width = RangesKt.coerceAtMost(placeable.getWidth(), Constraints.m6438getMaxWidthimpl(constraints));
        int height = RangesKt.coerceAtMost(placeable.getHeight(), Constraints.m6437getMaxHeightimpl(constraints));
