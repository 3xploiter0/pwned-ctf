...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4728getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4356getButtKaPHkGw();
        }
        return m4727getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4727getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m4356getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m4357getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m4358getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m4730getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4367getMiterLxFBmk8();
        }
        return m4729getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4729getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m4367getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m4368getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m4366getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
     ...
     */
    public static final int parseCurrentVectorNode(AndroidVectorParser $this$parseCurrentVectorNode, Resources res, AttributeSet attrs, Resources.Theme theme, ImageVector.Builder builder, int nestedGroups) throws IllegalArgumentException {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) throws XmlPullParserException {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type != 2 && (tintColorStateList = $this$createVectorImageBuilder.getNamedColorStateList(vectorAttrs, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                ...
                tintColor = Color.INSTANCE.m4039getUnspecified0d7_KjU();
            }
        } else {
            tintColor = Color.INSTANCE.m4039getUnspecified0d7_KjU();
        }
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.INSTANCE.m3945getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.INSTANCE.m3943getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.INSTANCE.m3942getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.INSTANCE.m3934getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.INSTANCE.m3939getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.INSTANCE.m3937getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.INSTANCE.m3943getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m6485constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m6485constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m4727getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m4356getButtKaPHkGw());
        ...
        int strokeLineJoin = m4729getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m4366getBevelLxFBmk8());
        ...
        int fillPathType = fillRule == 0 ? companion.m4286getNonZeroRgk1Os() : companion.m4285getEvenOddRgk1Os();
        builder.m4695addPathoIyEayM(pathData, fillPathType, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
    ...
    public static final void parseClipPath(AndroidVectorParser $this$parseClipPath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) {
        ...
        a.recycle();
        builder.addGroup((254 & 1) != 0 ? "" : name, (254 & 2) != 0 ? 0.0f : 0.0f, (254 & 4) != 0 ? 0.0f : 0.0f, (254 & 8) != 0 ? 0.0f : 0.0f, (254 & 16) != 0 ? 1.0f : 0.0f, (254 & 32) == 0 ? 0.0f : 1.0f, (254 & 64) != 0 ? 0.0f : 0.0f, (254 & 128) == 0 ? 0.0f : 0.0f, (254 & 256) != 0 ? VectorKt.getEmptyPath() : pathData);
    }
