...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1899621712, $changed, -1, "androidx.compose.material3.ChipBorder.borderStroke (Chip.kt:2677)");
        }
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m263BorderStrokecXLIe8U(this.borderWidth, enabled ? this.borderColor : this.disabledBorderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipBorder) && Color.m4004equalsimpl0(this.borderColor, ((ChipBorder) other).borderColor) && Color.m4004equalsimpl0(this.disabledBorderColor, ((ChipBorder) other).disabledBorderColor) && Dp.m6490equalsimpl0(this.borderWidth, ((ChipBorder) other).borderWidth)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4010hashCodeimpl(this.borderColor);
        return (((result * 31) + Color.m4010hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m6491hashCodeimpl(this.borderWidth);
    }
}
