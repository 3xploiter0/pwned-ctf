...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4004equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m4004equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual(this.inputFieldColors, ((SearchBarColors) other).inputFieldColors);
    }

    public int hashCode() {
        int result = Color.m4010hashCodeimpl(this.containerColor);
        return (((result * 31) + Color.m4010hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
