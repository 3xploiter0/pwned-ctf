...
public final class ComposableMethodKt {
    ...
    public static final ComposableMethod getDeclaredComposableMethod(Class<?> cls, String methodName, Class<?>... clsArr) throws NoSuchMethodException, SecurityException {
        Method method;
