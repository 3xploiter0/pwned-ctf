...
public final class FontListFontFamilyTypefaceAdapterKt {
    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        Object result;
        Object it$iv;
        Object objM6022unboximpl;
        int size = list.size();
        List asyncFontsToLoad = null;
        for (int idx = 0; idx < size; idx++) {
            Font font = list.get(idx);
            int loadingStrategy = font.getLoadingStrategy();
            if (!FontLoadingStrategy.m6045equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6050getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m6045equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6051getOptionalLocalPKNRLFQ())) {
                    if (!FontLoadingStrategy.m6045equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6049getAsyncPKNRLFQ())) {
                        throw new IllegalStateException("Unknown font type " + font);
                    }
                    AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m6014get1ASDuI8(font, platformFontLoader);
                    if (cacheResult == null) {
                    ...
                    } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m6020isPermanentFailureimpl(cacheResult.m6022unboximpl()) && cacheResult.m6022unboximpl() != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m6079synthesizeTypefaceFxwP2eA(typefaceRequest.m6104getFontSynthesisGVVA2EU(), cacheResult.m6022unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m6103getFontStyle_LCdwA()));
                    }
                } else {
                    ...
                    synchronized (lock$iv$iv) {
                        ...
                        if (priorResult$iv == null) {
                            ...
                            try {
                                ...
                                it$iv = Result.m6956constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                it$iv = Result.m6956constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m6962isFailureimpl(it$iv)) {
                                it$iv = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, it$iv, false, 8, null);
                            objM6022unboximpl = it$iv;
                        } else {
                            objM6022unboximpl = priorResult$iv.m6022unboximpl();
                        }
                    }
                    Object result2 = objM6022unboximpl;
                    if (result2 != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m6079synthesizeTypefaceFxwP2eA(typefaceRequest.m6104getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m6103getFontStyle_LCdwA()));
                    }
                }
            } else {
                ...
                synchronized (lock$iv$iv2) {
                    ...
                    if (priorResult$iv2 == null) {
                        ...
                        result = priorResult$iv2.m6022unboximpl();
                    }
                }
                if (result == null) {
                    throw new IllegalStateException("Unable to load font " + font);
                }
                return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m6079synthesizeTypefaceFxwP2eA(typefaceRequest.m6104getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m6103getFontStyle_LCdwA()));
            }
        }
