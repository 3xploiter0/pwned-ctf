...
final class GroupKind {
    ...
    private static final int Group = m3465constructorimpl(0);
    private static final int Node = m3465constructorimpl(1);
    private static final int ReusableNode = m3465constructorimpl(2);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m3464boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3465constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3466equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m3472unboximpl();
    }
    ...
    public static String m3471toStringimpl(int i) {
    ...
    public String toString() {
        return m3471toStringimpl(this.value);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m3472unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m3469isNodeimpl(int arg0) {
        return arg0 != INSTANCE.m3473getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m3470isReusableimpl(int arg0) {
        return arg0 != INSTANCE.m3474getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m3473getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs, reason: not valid java name */
        public final int m3474getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs, reason: not valid java name */
        public final int m3475getReusableNodeULZAiWs() {
