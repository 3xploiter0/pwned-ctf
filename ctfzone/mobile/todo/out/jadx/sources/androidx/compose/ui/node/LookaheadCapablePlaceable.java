...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode, MotionReferencePlacementDelegate {
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof VerticalAlignmentLine) {
            iM6614getYimpl = IntOffset.m6613getXimpl(getApparentToRealOffset());
        } else {
            iM6614getYimpl = IntOffset.m6614getYimpl(getApparentToRealOffset());
        }
        return iM6614getYimpl + measuredPosition;
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void captureRulers$ui_release(androidx.compose.ui.layout.MeasureResult r20) {
        /*
            r19 = this;
            r0 = r19
            r1 = r20
