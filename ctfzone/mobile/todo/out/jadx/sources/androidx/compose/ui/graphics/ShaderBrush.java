...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo3972createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m3839getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo3950applyToPq9zytI(long size, Paint p, float alpha) {
        Shader shader = this.internalShader;
        if (shader == null || !Size.m3827equalsimpl0(this.createdSize, size)) {
            if (Size.m3833isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m3839getUnspecifiedNHjbRc();
            } else {
                Shader it = mo3972createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m4004equalsimpl0(p.mo3876getColor0d7_KjU(), Color.INSTANCE.m4029getBlack0d7_KjU())) {
            p.mo3882setColor8_81llA(Color.INSTANCE.m4029getBlack0d7_KjU());
        }
