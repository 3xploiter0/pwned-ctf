...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1590defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1765defaultRippleColor5vOe2sY = companion.m1765defaultRippleColor5vOe2sY(((Color) objConsume).m4013unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return jM1765defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object objConsume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha rippleAlphaM1764defaultRippleAlphaDxMtmZc = companion.m1764defaultRippleAlphaDxMtmZc(((Color) objConsume).m4013unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return rippleAlphaM1764defaultRippleAlphaDxMtmZc;
    }
}
