...
public final class KeyEvent_androidKt {
    ...
    public static final long m5068getKeyZmokQxo(android.view.KeyEvent $this$key) {
        return Key_androidKt.Key($this$key.getKeyCode());
    }

    /* renamed from: getUtf16CodePoint-ZmokQxo, reason: not valid java name */
    public static final int m5070getUtf16CodePointZmokQxo(android.view.KeyEvent $this$utf16CodePoint) {
        return $this$utf16CodePoint.getUnicodeChar();
    }

    /* renamed from: getType-ZmokQxo, reason: not valid java name */
    public static final int m5069getTypeZmokQxo(android.view.KeyEvent $this$type) {
        switch ($this$type.getAction()) {
            case 0:
                return KeyEventType.INSTANCE.m5065getKeyDownCS__XNY();
            case 1:
                return KeyEventType.INSTANCE.m5066getKeyUpCS__XNY();
            default:
                return KeyEventType.INSTANCE.m5067getUnknownCS__XNY();
        }
    }

    /* renamed from: isAltPressed-ZmokQxo, reason: not valid java name */
    public static final boolean m5071isAltPressedZmokQxo(android.view.KeyEvent $this$isAltPressed) {
        return $this$isAltPressed.isAltPressed();
    }

    /* renamed from: isCtrlPressed-ZmokQxo, reason: not valid java name */
    public static final boolean m5072isCtrlPressedZmokQxo(android.view.KeyEvent $this$isCtrlPressed) {
        return $this$isCtrlPressed.isCtrlPressed();
    }

    /* renamed from: isMetaPressed-ZmokQxo, reason: not valid java name */
    public static final boolean m5073isMetaPressedZmokQxo(android.view.KeyEvent $this$isMetaPressed) {
        return $this$isMetaPressed.isMetaPressed();
    }

    /* renamed from: isShiftPressed-ZmokQxo, reason: not valid java name */
    public static final boolean m5074isShiftPressedZmokQxo(android.view.KeyEvent $this$isShiftPressed) {
