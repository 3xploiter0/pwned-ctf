...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo3608alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m6655getWidthimpl(space) - IntSize.m6655getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m6654getHeightimpl(space) - IntSize.m6654getHeightimpl(size)) / 2.0f;
