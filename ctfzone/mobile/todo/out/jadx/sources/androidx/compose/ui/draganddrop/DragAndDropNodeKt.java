...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m3636containsUv8p0NA(DragAndDropModifierNode $this$contains_u2dUv8p0NA, long position) {
        ...
        long jMo5347getSizeYbymL2g = currentCoordinates.mo5347getSizeYbymL2g();
        int iM6655getWidthimpl = IntSize.m6655getWidthimpl(jMo5347getSizeYbymL2g);
        int height = IntSize.m6654getHeightimpl(jMo5347getSizeYbymL2g);
        long jPositionInRoot = LayoutCoordinatesKt.positionInRoot(currentCoordinates);
        float x1 = Offset.m3762getXimpl(jPositionInRoot);
        float y1 = Offset.m3763getYimpl(jPositionInRoot);
        float x2 = iM6655getWidthimpl + x1;
        float y2 = height + y1;
        float fM3762getXimpl = Offset.m3762getXimpl(position);
        if (!(x1 <= fM3762getXimpl && fM3762getXimpl <= x2)) {
            return false;
        }
        float fM3763getYimpl = Offset.m3763getYimpl(position);
        return (y1 > fM3763getYimpl ? 1 : (y1 == fM3763getYimpl ? 0 : -1)) <= 0 && (fM3763getYimpl > y2 ? 1 : (fM3763getYimpl == y2 ? 0 : -1)) <= 0;
    }
