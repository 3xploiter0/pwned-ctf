...
public final class BasicSecureTextFieldKt {
    ...
    */
    public static final void m969BasicSecureTextFieldJb9bMDk(final androidx.compose.foundation.text.input.TextFieldState r35, androidx.compose.ui.Modifier r36, boolean r37, androidx.compose.foundation.text.input.InputTransformation r38, androidx.compose.ui.text.TextStyle r39, androidx.compose.foundation.text.KeyboardOptions r40, androidx.compose.foundation.text.input.KeyboardActionHandler r41, kotlin.jvm.functions.Function2<? super androidx.compose.ui.unit.Density, ? super kotlin.jvm.functions.Function0<androidx.compose.ui.text.TextLayoutResult>, kotlin.Unit> r42, androidx.compose.foundation.interaction.MutableInteractionSource r43, androidx.compose.ui.graphics.Brush r44, androidx.compose.foundation.text.input.TextFieldDecorator r45, int r46, char r47, androidx.compose.runtime.Composer r48, final int r49, final int r50, final int r51) {
        /*
            Method dump skipped, instructions count: 1115
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.BasicSecureTextFieldKt.m969BasicSecureTextFieldJb9bMDk(androidx.compose.foundation.text.input.TextFieldState, androidx.compose.ui.Modifier, boolean, androidx.compose.foundation.text.input.InputTransformation, androidx.compose.ui.text.TextStyle, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.input.KeyboardActionHandler, kotlin.jvm.functions.Function2, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Brush, androidx.compose.foundation.text.input.TextFieldDecorator, int, char, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final int BasicSecureTextField_Jb9bMDk$lambda$4$lambda$3(State $obfuscationMaskState, int i, int i2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = KeyInputModifierKt.onPreviewKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.text.BasicSecureTextFieldKt.DisableCutCopy.1.1
                            ...
                            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                                return m970invokeZmokQxo(keyEvent.m5057unboximpl());
                            }

                            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
                            public final Boolean m970invokeZmokQxo(android.view.KeyEvent keyEvent) {
                                KeyCommand command = KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo997mapZmokQxo(keyEvent);
