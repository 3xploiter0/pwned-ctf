...
public final class SizeKt {
    ...
    public static /* synthetic */ void m3842getCenteruvyYCjk$annotations(long j) {
    }

    /* renamed from: isSpecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m3844isSpecifieduvyYCjk$annotations(long j) {
    }

    /* renamed from: isUnspecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m3846isUnspecifieduvyYCjk$annotations(long j) {
    }
    ...
    public static final long Size(float width, float height) {
        ...
        return Size.m3822constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* renamed from: isSpecified-uvyYCjk, reason: not valid java name */
    public static final boolean m3843isSpecifieduvyYCjk(long $this$isSpecified) {
        return $this$isSpecified != InlineClassHelperKt.UnspecifiedPackedFloats;
    }

    /* renamed from: isUnspecified-uvyYCjk, reason: not valid java name */
    public static final boolean m3845isUnspecifieduvyYCjk(long $this$isUnspecified) {
        return $this$isUnspecified == InlineClassHelperKt.UnspecifiedPackedFloats;
    }

    /* renamed from: takeOrElse-TmRCtEA, reason: not valid java name */
    public static final long m3848takeOrElseTmRCtEA(long $this$takeOrElse_u2dTmRCtEA, Function0<Size> function0) {
    ...
    public static final long m3847lerpVgWVRYQ(long start, long stop, float fraction) {
    ...
    public static final long m3851timesd16Qtg0(int $this$times_u2dd16Qtg0, long size) {
        return Size.m3834times7Ah8Wj8(size, $this$times_u2dd16Qtg0);
    }

    /* renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m3849timesd16Qtg0(double $this$times_u2dd16Qtg0, long size) {
        return Size.m3834times7Ah8Wj8(size, (float) $this$times_u2dd16Qtg0);
    }

    /* renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m3850timesd16Qtg0(float $this$times_u2dd16Qtg0, long size) {
        return Size.m3834times7Ah8Wj8(size, $this$times_u2dd16Qtg0);
    }

    /* renamed from: toRect-uvyYCjk, reason: not valid java name */
    public static final Rect m3852toRectuvyYCjk(long $this$toRect_u2duvyYCjk) {
        return RectKt.m3802Recttz77jQw(Offset.INSTANCE.m3778getZeroF1C5BW0(), $this$toRect_u2duvyYCjk);
    }

    /* renamed from: getCenter-uvyYCjk, reason: not valid java name */
    public static final long m3841getCenteruvyYCjk(long $this$center) {
