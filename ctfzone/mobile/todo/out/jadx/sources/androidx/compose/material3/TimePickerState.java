...
public final class TimePickerState {
    ...
    public TimePickerState(int initialHour, int initialMinute, final boolean is24Hour) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m6540boximpl(m2725invokeRKDOV3M());
            }

            /* renamed from: invoke-RKDOV3M, reason: not valid java name */
            public final long m2725invokeRKDOV3M() {
                boolean inInnerCircle = this.this$0.isInnerCircle$material3_release();
                float arg0$iv = Dp.m6485constructorimpl(TimePickerTokens.INSTANCE.m3384getClockDialSelectorHandleContainerSizeD9Ej5fM() / 2);
                float length = Dp.m6485constructorimpl(Dp.m6485constructorimpl(((is24Hour && inInnerCircle && Selection.m2393equalsimpl0(this.this$0.m2721getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m2397getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - arg0$iv) + arg0$iv);
                float other$iv = (float) Math.cos(this.this$0.getCurrentAngle$material3_release().getValue().floatValue());
                float arg0$iv2 = Dp.m6485constructorimpl(Dp.m6485constructorimpl(length * other$iv) + Dp.m6485constructorimpl(TimePickerTokens.INSTANCE.m3382getClockDialContainerSizeD9Ej5fM() / 2));
                float other$iv2 = (float) Math.sin(this.this$0.getCurrentAngle$material3_release().getValue().floatValue());
                return DpKt.m6506DpOffsetYgX7TsA(arg0$iv2, Dp.m6485constructorimpl(Dp.m6485constructorimpl(length * other$iv2) + Dp.m6485constructorimpl(TimePickerTokens.INSTANCE.m3382getClockDialContainerSizeD9Ej5fM() / 2)));
            }
        });
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m6604boximpl(IntOffset.INSTANCE.m6623getZeronOccac()), null, 2, null);
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m2390boximpl(Selection.INSTANCE.m2397getHourJiIwxys()), null, 2, null);
    ...
    public final long m2722getSelectorPosRKDOV3M$material3_release() {
    ...
    public final long m2720getCenternOccac$material3_release() {
    ...
    public final void m2723setCentergyyYBs$material3_release(long j) {
    ...
    public final List<Integer> getValues$material3_release() {
        return Selection.m2393equalsimpl0(m2721getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m2398getMinuteJiIwxys()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }

    /* renamed from: getSelection-JiIwxys$material3_release, reason: not valid java name */
    public final int m2721getSelectionJiIwxys$material3_release() {
        State $this$getValue$iv = this.selection;
        return ((Selection) $this$getValue$iv.getValue()).m2396unboximpl();
    }

    /* renamed from: setSelection-iHAOin8$material3_release, reason: not valid java name */
    public final void m2724setSelectioniHAOin8$material3_release(int i) {
        MutableState $this$setValue$iv = this.selection;
        $this$setValue$iv.setValue(Selection.m2390boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        if (!Selection.m2393equalsimpl0(m2721getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m2397getHourJiIwxys()) || !this.is24hour) {
            return;
        }
        setInnerCircle$material3_release(TimePickerKt.dist(x, y, IntOffset.m6613getXimpl(m2720getCenternOccac$material3_release()), IntOffset.m6614getYimpl(m2720getCenternOccac$material3_release())) < maxDist);
    }

    public final boolean isSelected$material3_release(int value) {
        if (Selection.m2393equalsimpl0(m2721getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m2398getMinuteJiIwxys())) {
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L3e:
            kotlin.ResultKt.throwOnFailure(r8)
            r1 = r12
            int r0 = r1.m2721getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r2 = androidx.compose.material3.Selection.INSTANCE
            int r2 = r2.m2397getHourJiIwxys()
            boolean r0 = androidx.compose.material3.Selection.m2393equalsimpl0(r0, r2)
            if (r0 == 0) goto L5f
