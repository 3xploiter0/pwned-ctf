        ...
        if (($dirty & 19) != 18 || !$composer2.getSkipping()) {
            ...
            while (index$iv < size) {
                ...
                MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                    ...
                    public final MeasureResult mo38measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list2, long constrains) {
                        ...
                        for (int index$iv$iv = 0; index$iv$iv < size2; index$iv$iv++) {
                            ...
                            target$iv.add(it.mo5339measureBRTryo0(constrains));
                        }
                        final List placeables = target$iv;
                        return MeasureScope.layout$default($this$Layout, Constraints.m6438getMaxWidthimpl(constrains), Constraints.m6437getMaxHeightimpl(constrains), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
                ...
                ComposerKt.sourceInformationMarkerStart($composer2, 256183196, "C76@2767L42:AnnotatedStringResolveInlineContent.kt#423gt5");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt.InlineChildren.2
                ...
                public final void invoke(Composer composer, int i3) {
                    AnnotatedStringResolveInlineContentKt.InlineChildren(text, list, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
