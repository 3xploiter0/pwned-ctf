...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m4381boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4384constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4387equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4388equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m4391hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4392toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m4387equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4391hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4392toStringimpl(this.packedValue);
    }
    ...
    public static final float m4389getPivotFractionXimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m4390getPivotFractionYimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m4382component1impl(long arg0) {
        return m4389getPivotFractionXimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m4383component2impl(long arg0) {
        return m4390getPivotFractionYimpl(arg0);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m4386copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m4389getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m4390getPivotFractionYimpl(j);
        }
        return m4385copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m4385copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m4394getCenterSzJe1aQ() {
