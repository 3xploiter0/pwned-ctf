...
public interface BeyondBoundsLayout {
    ...
    <T> T mo834layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m5317constructorimpl(1);
        private static final int After = m5317constructorimpl(2);
        private static final int Left = m5317constructorimpl(3);
        private static final int Right = m5317constructorimpl(4);
        private static final int Above = m5317constructorimpl(5);
        private static final int Below = m5317constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m5316boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m5317constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5318equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5319equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5320hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object obj) {
            return m5318equalsimpl(this.value, obj);
        }
        ...
        public static final class Companion {
            ...
            public final int m5325getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m5324getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m5327getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m5328getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m5323getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m5326getBelowhoxUOeE() {
                return LayoutDirection.Below;
            }
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5321toStringimpl(int arg0) {
            return m5319equalsimpl0(arg0, Before) ? "Before" : m5319equalsimpl0(arg0, After) ? "After" : m5319equalsimpl0(arg0, Left) ? "Left" : m5319equalsimpl0(arg0, Right) ? "Right" : m5319equalsimpl0(arg0, Above) ? "Above" : m5319equalsimpl0(arg0, Below) ? "Below" : "invalid LayoutDirection";
        }
