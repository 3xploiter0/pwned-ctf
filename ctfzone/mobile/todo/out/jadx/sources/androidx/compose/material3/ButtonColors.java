...
public final class ButtonColors {
    ...
    public final ButtonColors m1811copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonColors) && Color.m4004equalsimpl0(this.containerColor, ((ButtonColors) other).containerColor) && Color.m4004equalsimpl0(this.contentColor, ((ButtonColors) other).contentColor) && Color.m4004equalsimpl0(this.disabledContainerColor, ((ButtonColors) other).disabledContainerColor) && Color.m4004equalsimpl0(this.disabledContentColor, ((ButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
