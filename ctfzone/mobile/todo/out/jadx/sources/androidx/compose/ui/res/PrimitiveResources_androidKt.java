...
public final class PrimitiveResources_androidKt {
    public static final int integerResource(int id, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final int[] integerArrayResource(int id, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final boolean booleanResource(int id, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final float dimensionResource(int id, Composer $composer, int $changed) throws Resources.NotFoundException {
        ...
        float fM6485constructorimpl = Dp.m6485constructorimpl(pxValue / density.getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return fM6485constructorimpl;
    }
}
