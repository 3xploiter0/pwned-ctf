...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public void update(PainterModifier node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m3827equalsimpl0(node.getPainter().mo4680getIntrinsicSizeNHjbRc(), this.painter.mo4680getIntrinsicSizeNHjbRc()));
