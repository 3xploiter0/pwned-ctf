...
public final class ParagraphStyleKt {
    private static final long DefaultLineHeight = TextUnit.INSTANCE.m6689getUnspecifiedXSAIIZE();

    public static final ParagraphStyle lerp(ParagraphStyle start, ParagraphStyle stop, float fraction) {
        int value = ((TextAlign) SpanStyleKt.lerpDiscrete(TextAlign.m6345boximpl(start.getTextAlign()), TextAlign.m6345boximpl(stop.getTextAlign()), fraction)).getValue();
        int value2 = ((TextDirection) SpanStyleKt.lerpDiscrete(TextDirection.m6359boximpl(start.getTextDirection()), TextDirection.m6359boximpl(stop.getTextDirection()), fraction)).getValue();
        long jM5904lerpTextUnitInheritableC3pnCVY = SpanStyleKt.m5904lerpTextUnitInheritableC3pnCVY(start.getLineHeight(), stop.getLineHeight(), fraction);
        ...
        return new ParagraphStyle(value, value2, jM5904lerpTextUnitInheritableC3pnCVY, TextIndentKt.lerp(textIndent, textIndent2, fraction), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), fraction), (LineHeightStyle) SpanStyleKt.lerpDiscrete(start.getLineHeightStyle(), stop.getLineHeightStyle(), fraction), ((LineBreak) SpanStyleKt.lerpDiscrete(LineBreak.m6265boximpl(start.getLineBreak()), LineBreak.m6265boximpl(stop.getLineBreak()), fraction)).getMask(), ((Hyphens) SpanStyleKt.lerpDiscrete(Hyphens.m6255boximpl(start.getHyphens()), Hyphens.m6255boximpl(stop.getHyphens()), fraction)).getValue(), (TextMotion) SpanStyleKt.lerpDiscrete(start.getTextMotion(), stop.getTextMotion(), fraction), (DefaultConstructorMarker) null);
    }
    ...
    public static final ParagraphStyle resolveParagraphStyleDefaults(ParagraphStyle style, LayoutDirection direction) {
        int iM6357getStarte0LSkKk = TextAlign.m6348equalsimpl0(style.getTextAlign(), TextAlign.INSTANCE.m6358getUnspecifiede0LSkKk()) ? TextAlign.INSTANCE.m6357getStarte0LSkKk() : style.getTextAlign();
        int iM5994resolveTextDirectionIhaHGbI = TextStyleKt.m5994resolveTextDirectionIhaHGbI(direction, style.getTextDirection());
        long lineHeight = TextUnitKt.m6696isUnspecifiedR2X_6o(style.getLineHeight()) ? DefaultLineHeight : style.getLineHeight();
        ...
        int iM6284getSimplerAG3T2k = LineBreak.m6271equalsimpl0(style.getLineBreak(), LineBreak.INSTANCE.m6285getUnspecifiedrAG3T2k()) ? LineBreak.INSTANCE.m6284getSimplerAG3T2k() : style.getLineBreak();
        int iM6263getNonevmbZdU8 = Hyphens.m6258equalsimpl0(style.getHyphens(), Hyphens.INSTANCE.m6264getUnspecifiedvmbZdU8()) ? Hyphens.INSTANCE.m6263getNonevmbZdU8() : style.getHyphens();
        TextMotion textMotion = style.getTextMotion();
        if (textMotion == null) {
            textMotion = TextMotion.INSTANCE.getStatic();
        }
        return new ParagraphStyle(iM6357getStarte0LSkKk, iM5994resolveTextDirectionIhaHGbI, lineHeight, textIndent2, platformStyle, lineHeightStyle, iM6284getSimplerAG3T2k, iM6263getNonevmbZdU8, textMotion, (DefaultConstructorMarker) null);
    }
    ...
    */
    public static final androidx.compose.ui.text.ParagraphStyle m5857fastMergej5T8yCg(androidx.compose.ui.text.ParagraphStyle r27, int r28, int r29, long r30, androidx.compose.ui.text.style.TextIndent r32, androidx.compose.ui.text.PlatformParagraphStyle r33, androidx.compose.ui.text.style.LineHeightStyle r34, int r35, int r36, androidx.compose.ui.text.style.TextMotion r37) {
        /*
            Method dump skipped, instructions count: 345
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.ParagraphStyleKt.m5857fastMergej5T8yCg(androidx.compose.ui.text.ParagraphStyle, int, int, long, androidx.compose.ui.text.style.TextIndent, androidx.compose.ui.text.PlatformParagraphStyle, androidx.compose.ui.text.style.LineHeightStyle, int, int, androidx.compose.ui.text.style.TextMotion):androidx.compose.ui.text.ParagraphStyle");
    }
