        ...
        switch (this.label) {
            case 0:
                ...
                if (TapGestureDetectorKt.detectTapAndPress($this$pointerInput, anonymousClass1, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1.2
                    ...
                    public final void m1081invokek4lQ0M(long it) {
                        state.getValue().invoke(Offset.m3751boximpl(it));
                    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default(anonymousClass1.$scope, null, null, new C00451(anonymousClass1.$pressedInteraction, it, anonymousClass1.$interactionSource, null), 3, null);
                    anonymousClass1.label = 1;
                    Object objTryAwaitRelease = $this$detectTapAndPress.tryAwaitRelease(anonymousClass1);
