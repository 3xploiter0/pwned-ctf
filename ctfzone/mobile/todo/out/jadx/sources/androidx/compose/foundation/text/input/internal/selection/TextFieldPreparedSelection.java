...
public final class TextFieldPreparedSelection {
    ...
    public final void m1256setSelection5zctL8(long j) {
        this.selection = j;
    }

    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m5942getCollapsedimpl(getSelection())) {
            TransformedTextFieldState.m1227replaceTextM8tDOmk$default(this.state, "", getSelection(), null, !this.isFromSoftKeyboard, 4, null);
            return;
        }
        TextRange textRangeInvoke = block.invoke();
        if (textRangeInvoke != null) {
            long it = textRangeInvoke.getPackedValue();
            TransformedTextFieldState.m1227replaceTextM8tDOmk$default(this.state, "", it, null, !this.isFromSoftKeyboard, 4, null);
        }
    }
    ...
    private final int jumpByPagesOffset(int pagesAmount) {
        int currentOffset = TextRange.m5943getEndimpl(this.initialValue.getSelection());
        ...
        if (Math.abs(newPos.getTop() - lineSeparator) > Math.abs(newPos.getBottom() - lineSeparator)) {
            return this.textLayoutResult.m5920getOffsetForPositionk4lQ0M(newPos.m3797getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m5920getOffsetForPositionk4lQ0M(newPos.m3790getBottomLeftF1C5BW0());
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        ...
        if (this.text.length() > 0) {
            ...
            $this$deselect_u24lambda_u245.setCursor(TextRange.m5943getEndimpl($this$deselect_u24lambda_u245.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        ...
        if (this.text.length() > 0) {
            ...
            if (TextRange.m5942getCollapsedimpl($this$collapseLeftOr_u24lambda_u248.selection)) {
                or.invoke($this$collapseLeftOr_u24lambda_u248);
            } else if ($this$collapseLeftOr_u24lambda_u248.isLtr()) {
                $this$collapseLeftOr_u24lambda_u248.setCursor(TextRange.m5946getMinimpl($this$collapseLeftOr_u24lambda_u248.selection));
            } else {
                $this$collapseLeftOr_u24lambda_u248.setCursor(TextRange.m5945getMaximpl($this$collapseLeftOr_u24lambda_u248.selection));
            }
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseRightOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        ...
        if (this.text.length() > 0) {
            ...
            if (TextRange.m5942getCollapsedimpl($this$collapseRightOr_u24lambda_u249.selection)) {
                or.invoke($this$collapseRightOr_u24lambda_u249);
            } else if ($this$collapseRightOr_u24lambda_u249.isLtr()) {
                $this$collapseRightOr_u24lambda_u249.setCursor(TextRange.m5945getMaximpl($this$collapseRightOr_u24lambda_u249.selection));
            } else {
                $this$collapseRightOr_u24lambda_u249.setCursor(TextRange.m5946getMinimpl($this$collapseRightOr_u24lambda_u249.selection));
            }
        }
        return this;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m5943getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m5943getEndimpl(this.selection));
    }
    ...
    private final TextFieldPreparedSelection moveCursorPrev() {
        ...
        if (this.text.length() > 0) {
            ...
            int oldCursor = TextRange.m5943getEndimpl($this$moveCursorPrev_u24lambda_u2410.selection);
    ...
    private final TextFieldPreparedSelection moveCursorNext() {
        ...
        if (this.text.length() > 0) {
            ...
            int oldCursor = TextRange.m5943getEndimpl($this$moveCursorNext_u24lambda_u2411.selection);
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            ...
            int paragraphStart = StringHelpersKt.findParagraphStart($this$moveCursorPrevByParagraph_u24lambda_u2418.text, TextRange.m5946getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2418.selection));
            if (paragraphStart == TextRange.m5946getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2418.selection) && paragraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            ...
            int paragraphEnd = StringHelpersKt.findParagraphEnd($this$moveCursorNextByParagraph_u24lambda_u2419.text, TextRange.m5945getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2419.selection));
            if (paragraphEnd == TextRange.m5945getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2419.selection) && paragraphEnd != $this$moveCursorNextByParagraph_u24lambda_u2419.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2426.selection = TextRangeKt.TextRange(TextRange.m5948getStartimpl($this$selectMovement_u24lambda_u2426.initialValue.getSelection()), TextRange.m5943getEndimpl($this$selectMovement_u24lambda_u2426.selection));
        }
        return this;
    }
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (direction = textLayoutResult.getParagraphDirection(TextRange.m5943getEndimpl(this.selection))) == null || direction == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5943getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.initialValue.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m5922getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m5943getEndimpl(currentWord) <= currentOffset) {
                currentOffset++;
            } else {
                return TextRange.m5943getEndimpl(currentWord);
            }
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult $this$getPrevWordOffsetForLayout, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffsetForLayout.m5922getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m5948getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return TextRange.m5948getStartimpl(currentWord);
            }
        }
        return 0;
    }
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5946getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5945getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        int currentOffset = TextRange.m5943getEndimpl(this.selection);
        ...
        return $this$jumpByLinesOffset.m5920getOffsetForPositionk4lQ0M(OffsetKt.Offset(it, y));
    }
