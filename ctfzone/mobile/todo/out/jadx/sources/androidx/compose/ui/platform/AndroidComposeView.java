...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    /* JADX WARN: Type inference failed for: r1v59, types: [androidx.compose.ui.platform.AndroidComposeView$resendMotionEventRunnable$1] */
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        super(context);
        this.lastDownPointerPosition = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        ...
        this.keyInputModifier = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m5667invokeZmokQxo(keyEvent.m5057unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m5667invokeZmokQxo(android.view.KeyEvent keyEvent) {
                final FocusDirection focusDirection = this.this$0.mo5629getFocusDirectionP8AzH3I(keyEvent);
                if (focusDirection != null && KeyEventType.m5061equalsimpl0(KeyEvent_androidKt.m5069getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m5065getKeyDownCS__XNY())) {
                    Rect focusedRect = this.this$0.onFetchFocusRect();
                    Boolean boolMo3694focusSearchULY8qGw = this.this$0.getFocusOwner().mo3694focusSearchULY8qGw(focusDirection.getValue(), focusedRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                        {
                            super(1);
                        }
                        ...
                        public final Boolean invoke(FocusTargetNode it) {
                            Boolean boolM3713requestFocusMxy_nc0 = FocusTransactionsKt.m3713requestFocusMxy_nc0(it, focusDirection.getValue());
                            return Boolean.valueOf(boolM3713requestFocusMxy_nc0 != null ? boolM3713requestFocusMxy_nc0.booleanValue() : true);
                        }
                    });
                    boolean focusWasMovedOrCancelled = boolMo3694focusSearchULY8qGw != null ? boolMo3694focusSearchULY8qGw.booleanValue() : true;
                    if (focusWasMovedOrCancelled) {
                        return true;
                    }
                    if (!FocusOwnerImplKt.m3700is1dFocusSearch3ESFkO8(focusDirection.getValue())) {
                        return false;
                    }
                    Integer numM3688toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3688toAndroidFocusDirection3ESFkO8(focusDirection.getValue());
                    if (numM3688toAndroidFocusDirection3ESFkO8 == null) {
                        throw new IllegalStateException("Invalid focus direction".toString());
                    }
                    int androidDirection = numM3688toAndroidFocusDirection3ESFkO8.intValue();
                    android.graphics.Rect androidRect = focusedRect != null ? RectHelper_androidKt.toAndroidRect(focusedRect) : null;
                    if (androidRect == null) {
                        throw new IllegalStateException("Invalid rect".toString());
                    }
                    View nextView = this.this$0.findNextNonChildView(androidDirection);
                    if (Intrinsics.areEqual(nextView, this.this$0)) {
                        nextView = null;
                    }
                    if (nextView != null && FocusInteropUtils_androidKt.requestInteropFocus(nextView, Integer.valueOf(androidDirection), androidRect)) {
                        return true;
                    }
                    boolean clearedFocusSuccessfully = this.this$0.getFocusOwner().mo3691clearFocusI7lrPNg(false, true, false, focusDirection.getValue());
                    if (!clearedFocusSuccessfully) {
                        return true;
                    }
                    Boolean boolMo3694focusSearchULY8qGw2 = this.this$0.getFocusOwner().mo3694focusSearchULY8qGw(focusDirection.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                        {
                            super(1);
                        }
                    ...
                    return Boolean.valueOf(boolMo3694focusSearchULY8qGw2 != null ? boolMo3694focusSearchULY8qGw2.booleanValue() : true);
                }
                return false;
            }
        });
        ...
        this.tmpMatrix = Matrix.m4234constructorimpl$default(null, 1, null);
        this.viewToWindowMatrix = Matrix.m4234constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m4234constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m3776getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m3611constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m4751getTouchaOaMEAU() : InputMode.INSTANCE.m4750getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m5663invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m5663invokeiuPiT84(int it) {
                boolean zRequestFocusFromTouch;
                if (InputMode.m4746equalsimpl0(it, InputMode.INSTANCE.m4751getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else if (InputMode.m4746equalsimpl0(it, InputMode.INSTANCE.m4750getKeyboardaOaMEAU())) {
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(this.tmpMatrix, objArr == true ? 1 : 0) : new CalculateMatrixToWindowApi29();
    ...
    public void setCoroutineContext(CoroutineContext value) {
        ...
        DelegatableNode $this$visitSubtree_u2d6rFNWt0$iv;
        DelegatableNode delegatableNode2;
        DelegatableNode $this$visitSubtree_u2d6rFNWt0$iv2;
        DelegatableNode $this$visitSubtree_u2d6rFNWt0$iv3;
        int count$iv$iv;
        ...
        DelegatableNode $this$visitSubtree_u2d6rFNWt0$iv4 = head;
        int iM5574constructorimpl = NodeKind.m5574constructorimpl(16);
        boolean value$iv$iv$iv = $this$visitSubtree_u2d6rFNWt0$iv4.getNode().getIsAttached();
        if (!value$iv$iv$iv) {
            InlineClassHelperKt.throwIllegalStateException("visitSubtree called on an unattached node");
        }
        Modifier.Node node$iv$iv = $this$visitSubtree_u2d6rFNWt0$iv4.getNode().getChild();
        LayoutNode layout$iv$iv = DelegatableNodeKt.requireLayoutNode($this$visitSubtree_u2d6rFNWt0$iv4);
        ...
        while (layout$iv$iv != null) {
            ...
            if ((node$iv$iv2.getAggregateChildKindSet() & iM5574constructorimpl) != 0) {
                while (node$iv$iv2 != null) {
                    if ((node$iv$iv2.getKindSet() & iM5574constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof PointerInputModifierNode) {
                                ...
                                $this$visitSubtree_u2d6rFNWt0$iv2 = $this$visitSubtree_u2d6rFNWt0$iv4;
                            } else {
                                delegatableNode2 = head;
                                Modifier.Node this_$iv$iv$iv = nodePop;
                                int kindSet = this_$iv$iv$iv.getKindSet() & iM5574constructorimpl;
                                int i = 1;
                                if ((kindSet != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                                    ...
                                    while (node$iv$iv$iv != null) {
                                        ...
                                        if (((next$iv$iv.getKindSet() & iM5574constructorimpl) != 0 ? i : 0) != 0) {
                                            count$iv$iv2++;
                                            if (count$iv$iv2 == i) {
                                                nodePop = next$iv$iv;
                                                $this$visitSubtree_u2d6rFNWt0$iv3 = $this$visitSubtree_u2d6rFNWt0$iv4;
                                            } else {
                                        ...
                                        $this$visitSubtree_u2d6rFNWt0$iv4 = $this$visitSubtree_u2d6rFNWt0$iv3;
                                        i = 1;
                                    }
                                    $this$visitSubtree_u2d6rFNWt0$iv2 = $this$visitSubtree_u2d6rFNWt0$iv4;
                                    if (count$iv$iv2 == 1) {
                                        head = delegatableNode2;
                                        $this$visitSubtree_u2d6rFNWt0$iv4 = $this$visitSubtree_u2d6rFNWt0$iv2;
                                    }
                                }
                            }
                    ...
                    head = head;
                    $this$visitSubtree_u2d6rFNWt0$iv4 = $this$visitSubtree_u2d6rFNWt0$iv4;
                }
                delegatableNode = head;
                $this$visitSubtree_u2d6rFNWt0$iv = $this$visitSubtree_u2d6rFNWt0$iv4;
            } else {
                delegatableNode = head;
                $this$visitSubtree_u2d6rFNWt0$iv = $this$visitSubtree_u2d6rFNWt0$iv4;
            }
            ...
            $this$visitSubtree_u2d6rFNWt0$iv4 = $this$visitSubtree_u2d6rFNWt0$iv;
        }
    }
    ...
    public final boolean m5658onMoveFocusInChildren3ESFkO8(int focusDirection) {
        View viewFindNextFocusFromRect;
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3681getEnterdhqQ8s()) || FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3682getExitdhqQ8s())) {
            return false;
        }
        ...
        int direction = numM3688toAndroidFocusDirection3ESFkO8.intValue();
        Rect rectOnFetchFocusRect = onFetchFocusRect();
        android.graphics.Rect focusedRect = rectOnFetchFocusRect != null ? RectHelper_androidKt.toAndroidRect(rectOnFetchFocusRect) : null;
        FocusFinder it = FocusFinder.getInstance();
        if (focusedRect == null) {
            viewFindNextFocusFromRect = it.findNextFocus(this, findFocus(), direction);
        } else {
            viewFindNextFocusFromRect = it.findNextFocusFromRect(this, focusedRect, direction);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void touchModeChangeListener$lambda$6(AndroidComposeView this$0, boolean touchMode) {
        InputModeManagerImpl inputModeManagerImpl = this$0._inputModeManager;
        InputMode.Companion companion = InputMode.INSTANCE;
        inputModeManagerImpl.m4754setInputModeiuPiT84(touchMode ? companion.m4751getTouchaOaMEAU() : companion.m4750getKeyboardaOaMEAU());
    }
    ...
    */
    public java.lang.Object textInputSession(kotlin.jvm.functions.Function2<? super androidx.compose.ui.platform.PlatformTextInputSessionScope, ? super kotlin.coroutines.Continuation<?>, ? extends java.lang.Object> r6, kotlin.coroutines.Continuation<?> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof androidx.compose.ui.platform.AndroidComposeView.C06171
            if (r0 == 0) goto L14
            r0 = r7
            androidx.compose.ui.platform.AndroidComposeView$textInputSession$1 r0 = (androidx.compose.ui.platform.AndroidComposeView.C06171) r0
            int r1 = r0.label
        ...
        L31:
            ...
            r2 = 1
            r7.label = r2
            java.lang.Object r6 = androidx.compose.ui.SessionMutex.m3618withSessionCancellingPreviousimpl(r3, r4, r6, r7)
            if (r6 != r1) goto L49
            return r1
        L49:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendHoverExitEvent$lambda$8(AndroidComposeView this$0) {
        ...
        this$0.m5661sendMotionEvent8iAsVTc(lastEvent);
    }
    ...
    public View focusSearch(View focused, int direction) {
        if (focused != null) {
            ...
            int focusDirection2 = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3680getDowndhqQ8s();
            if (Intrinsics.areEqual((Object) getFocusOwner().mo3694focusSearchULY8qGw(focusDirection2, focusedBounds, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.focusSearch.1
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode it) {
                    return true;
                }
    ...
    public boolean requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int focusDirection2 = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3681getEnterdhqQ8s();
        Boolean boolMo3694focusSearchULY8qGw = getFocusOwner().mo3694focusSearchULY8qGw(focusDirection2, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocus.1
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode it) {
                Boolean boolM3713requestFocusMxy_nc0 = FocusTransactionsKt.m3713requestFocusMxy_nc0(it, focusDirection2);
    ...
    public final boolean m5659onRequestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer numM3688toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (numM3688toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3688toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : numM3688toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public boolean mo5631sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo3692dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.m3690dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEvent(final android.view.KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m5740setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5273constructorimpl(event.getMetaState()));
            return FocusOwner.m3690dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m5052constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo3693dispatchKeyEventYhN2O0w(KeyEvent.m5052constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        return (isFocused() && getFocusOwner().mo3692dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m5052constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m5662startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        Resources $this$startDrag_12SF9DM_u24lambda_u2411 = getContext().getResources();
        Density density = DensityKt.Density($this$startDrag_12SF9DM_u24lambda_u2411.getDisplayMetrics().density, $this$startDrag_12SF9DM_u24lambda_u2411.getConfiguration().fontScale);
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r1 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r4) {
                            /*
                                ...
                                r1 = 0
                                r2 = 8
                                int r1 = androidx.compose.ui.node.NodeKind.m5574constructorimpl(r2)
                                boolean r0 = r0.m5535hasH91voCI$ui_release(r1)
    ...
    public void mo5630measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m5528measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) throws Throwable {
        ...
        try {
            ...
            long $this$component2_u2dVKZWuLQ$iv = m5656convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int minWidth = (int) ULong.m7130constructorimpl($this$component2_u2dVKZWuLQ$iv >>> 32);
            int maxWidth = (int) ULong.m7130constructorimpl($this$component2_u2dVKZWuLQ$iv & 4294967295L);
            try {
                long $this$component2_u2dVKZWuLQ$iv2 = m5656convertMeasureSpecI7RO_PI(heightMeasureSpec);
                int minHeight = (int) ULong.m7130constructorimpl($this$component2_u2dVKZWuLQ$iv2 >>> 32);
                int maxHeight = (int) ULong.m7130constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ$iv2);
                long constraints = Constraints.INSTANCE.m6446fitPrioritizingHeightZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
                if (this.onMeasureConstraints == null) {
                    this.onMeasureConstraints = Constraints.m6426boximpl(constraints);
                    this.wasMeasuredWithMultipleConstraints = false;
                } else {
                    Constraints constraints2 = this.onMeasureConstraints;
                    if (!(constraints2 != null ? Constraints.m6431equalsimpl0(constraints2.getValue(), constraints) : false)) {
                        this.wasMeasuredWithMultipleConstraints = true;
                    }
                }
                this.measureAndLayoutDelegate.m5529updateRootConstraintsBRTryo0(constraints);
    ...
    private final int m5654component1VKZWuLQ(long $this$component1_u2dVKZWuLQ) {
        return (int) ULong.m7130constructorimpl($this$component1_u2dVKZWuLQ >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m5655component2VKZWuLQ(long $this$component2_u2dVKZWuLQ) {
        return (int) ULong.m7130constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m5660packZIaKswc(int a, int b) {
        return ULong.m7130constructorimpl(ULong.m7130constructorimpl(ULong.m7130constructorimpl(a) << 32) | ULong.m7130constructorimpl(b));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m5656convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        switch (mode) {
            case Integer.MIN_VALUE:
                return m5660packZIaKswc(0, size);
            case 0:
                return m5660packZIaKswc(0, Integer.MAX_VALUE);
            case 1073741824:
                return m5660packZIaKswc(size, size);
            default:
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int iM6613getXimpl = IntOffset.m6613getXimpl(j);
        int globalY = IntOffset.m6614getYimpl(j);
        if (iM6613getXimpl != this.tmpPositionArray[0] || globalY != this.tmpPositionArray[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(this.tmpPositionArray[0], this.tmpPositionArray[1]);
            if (iM6613getXimpl != Integer.MAX_VALUE && globalY != Integer.MAX_VALUE) {
    ...
    public FocusDirection mo5629getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        long jM5068getKeyZmokQxo = KeyEvent_androidKt.m5068getKeyZmokQxo(keyEvent);
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4996getTabEK5gGoQ())) {
            return FocusDirection.m3671boximpl(KeyEvent_androidKt.m5074isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m3685getPreviousdhqQ8s() : FocusDirection.INSTANCE.m3684getNextdhqQ8s());
        }
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4837getDirectionRightEK5gGoQ())) {
            return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3686getRightdhqQ8s());
        }
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4836getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3683getLeftdhqQ8s());
        }
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4838getDirectionUpEK5gGoQ()) ? true : Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4949getPageUpEK5gGoQ())) {
            return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3687getUpdhqQ8s());
        }
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4833getDirectionDownEK5gGoQ()) ? true : Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4948getPageDownEK5gGoQ())) {
            return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3680getDowndhqQ8s());
        }
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4832getDirectionCenterEK5gGoQ()) ? true : Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4846getEnterEK5gGoQ()) ? true : Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4938getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3681getEnterdhqQ8s());
        }
        if (Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4775getBackEK5gGoQ()) ? true : Key.m4760equalsimpl0(jM5068getKeyZmokQxo, Key.INSTANCE.m4849getEscapeEK5gGoQ())) {
            return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3682getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (resetViewTreeOwner) {
            ...
            if (oldViewTreeOwners != null && (lifecycleOwner2 = oldViewTreeOwners.getLifecycleOwner()) != null && (lifecycle = lifecycleOwner2.getLifecycleRegistry()) != null) {
        ...
        this._inputModeManager.m4754setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m4751getTouchaOaMEAU() : InputMode.INSTANCE.m4750getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return motionEvent.isFromSource(4194304) ? handleRotaryEvent(motionEvent) : ProcessResult.m5299getDispatchedToAPointerInputModifierimpl(m5657handleMotionEvent8iAsVTc(motionEvent));
        }
        return super.dispatchGenericMotionEvent(motionEvent);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int processResult = m5657handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m5298getAnyMovementConsumedimpl(processResult)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m5299getDispatchedToAPointerInputModifierimpl(processResult);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:82:0x0126 A[Catch: all -> 0x0169, TryCatch #0 {all -> 0x0169, blocks: (B:5:0x001f, B:7:0x002a, B:13:0x0039, B:15:0x003f, B:17:0x0045, B:25:0x007e, B:34:0x0093, B:36:0x0099, B:38:0x00ad, B:39:0x00b0, B:41:0x00b4, B:46:0x00c1, B:48:0x00c5, B:50:0x00cb, B:52:0x00d4, B:55:0x00dc, B:56:0x00e3, B:58:0x00e9, B:60:0x00ef, B:62:0x00f5, B:64:0x00fb, B:66:0x00ff, B:67:0x0103, B:80:0x0121, B:82:0x0126, B:84:0x012d, B:97:0x0149, B:98:0x014e, B:99:0x0153, B:18:0x004e, B:21:0x0056), top: B:109:0x001f, outer: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:83:0x012b  */
    /* JADX WARN: Removed duplicated region for block: B:86:0x0135  */
    /* JADX WARN: Removed duplicated region for block: B:87:0x0137  */
    /* JADX WARN: Removed duplicated region for block: B:90:0x013b A[ADDED_TO_REGION] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final int m5657handleMotionEvent8iAsVTc(android.view.MotionEvent r24) {
        /*
            Method dump skipped, instructions count: 371
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeView.m5657handleMotionEvent8iAsVTc(android.view.MotionEvent):int");
    }
    ...
    private final int m5661sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        Object item$iv;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m5740setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5273constructorimpl(motionEvent.getMetaState()));
        }
        ...
        if (pointerInputEventData != null) {
            long it2 = pointerInputEventData.m5227getPositionF1C5BW0();
            this.lastDownPointerPosition = it2;
        }
        int result = this.pointerInputEventProcessor.m5232processBIzXfog(pointerInputEvent, this, isInBounds(motionEvent));
        int action = motionEvent.getActionMasked();
        if ((action != 0 && action != 5) || ProcessResult.m5299getDispatchedToAPointerInputModifierimpl(result)) {
            return result;
        }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long screenPosition = mo5292localToScreenMKHz9U(localPosition);
            coords.x = Offset.m3762getXimpl(screenPosition);
            coords.y = Offset.m3763getYimpl(screenPosition);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m5232processBIzXfog(pointerInputEvent, this, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m5672canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m5672canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo5292localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long local = Matrix.m4240mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m3762getXimpl(local) + Offset.m3762getXimpl(this.windowPosition), Offset.m3763getYimpl(local) + Offset.m3763getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo5291localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m4251timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m5677preTranslatecG2Xzmc(localTransform, Offset.m3762getXimpl(this.windowPosition), Offset.m3763getYimpl(this.windowPosition), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo5293screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        float x = Offset.m3762getXimpl(positionOnScreen) - Offset.m3762getXimpl(this.windowPosition);
        float y = Offset.m3763getYimpl(positionOnScreen) - Offset.m3763getYimpl(this.windowPosition);
        return Matrix.m4240mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(x, y));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long positionInWindow = Matrix.m4240mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m3762getXimpl(positionInWindow), motionEvent.getRawY() - Offset.m3763getYimpl(positionInWindow));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo5678calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m5704invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession parentSession = (AndroidPlatformTextInputSession) SessionMutex.m3615getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo5627calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m4240mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo5628calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m4240mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        int result = m5657handleMotionEvent8iAsVTc(event);
        return ProcessResult.m5299getDispatchedToAPointerInputModifierimpl(result);
    }
    ...
    */
    ...
    public boolean isLifecycleInResumedState() {
        ...
        Lifecycle lifecycle;
        ViewTreeOwners viewTreeOwners = getViewTreeOwners();
        return ((viewTreeOwners == null || (lifecycleOwner = viewTreeOwners.getLifecycleOwner()) == null || (lifecycle = lifecycleOwner.getLifecycleRegistry()) == null) ? null : lifecycle.getState()) == Lifecycle.State.RESUMED;
    }
