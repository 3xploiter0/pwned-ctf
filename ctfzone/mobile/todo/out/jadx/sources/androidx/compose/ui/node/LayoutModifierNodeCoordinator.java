...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode measureNode) {
        ...
        if ((this_$iv.getKindSet() & NodeKind.m5574constructorimpl(512)) != 0) {
    ...
    public final void m5486setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo5339measureBRTryo0(long constraints) {
            ...
            this_$iv.m5402setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.m5486setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m6426boximpl(constraints));
            ...
            this_$iv.set_measureResult($this$measure_BRTryo0_u24lambda_u241_u24lambda_u240.mo91measure3p2s80s(this, lookaheadDelegate, constraints));
            return this_$iv;
        }
    ...
    */
    public androidx.compose.ui.layout.Placeable mo5339measureBRTryo0(long r17) {
        /*
            r16 = this;
            r0 = r16
            boolean r1 = r16.getForceMeasureWithLookaheadConstraints()
            if (r1 == 0) goto L1f
        ...
        L21:
            ...
            r4 = 0
            androidx.compose.ui.node.NodeCoordinator.m5542access$setMeasurementConstraintsBRTryo0(r3, r1)
            r5 = 0
            ...
            r9 = 0
            long r10 = r6.mo5314getLookaheadSizeYbymL2g()
            boolean r10 = r8.mo104isMeasurementApproachInProgressozmzZPI(r10)
            r11 = 0
            r12 = 1
            if (r10 != 0) goto L50
            androidx.compose.ui.unit.Constraints r10 = r16.getLookaheadConstraints()
            boolean r10 = androidx.compose.ui.unit.Constraints.m6430equalsimpl(r1, r10)
            if (r10 != 0) goto L4e
            goto L50
        L4e:
            r10 = r11
        ...
        L61:
            ...
            androidx.compose.ui.layout.MeasureResult r10 = r8.mo103approachMeasure3p2s80s(r10, r13, r1)
            androidx.compose.ui.node.NodeCoordinator r13 = r16.getWrappedNonNull()
        ...
        L9a:
            ...
            long r12 = r12.mo5347getSizeYbymL2g()
            ...
            if (r14 == 0) goto Lbc
            long r14 = r14.m5521getSizeYbymL2g$ui_release()
            androidx.compose.ui.unit.IntSize r14 = androidx.compose.ui.unit.IntSize.m6647boximpl(r14)
            goto Lbd
        Lbc:
            r14 = 0
        Lbd:
            boolean r12 = androidx.compose.ui.unit.IntSize.m6652equalsimpl(r12, r14)
            if (r12 == 0) goto Lcd
            if (r11 != 0) goto Lcd
        ...
        Ld2:
            ...
            androidx.compose.ui.node.NodeCoordinator r9 = r16.getWrappedNonNull()
            androidx.compose.ui.layout.Measurable r9 = (androidx.compose.ui.layout.Measurable) r9
            androidx.compose.ui.layout.MeasureResult r12 = r6.mo91measure3p2s80s(r8, r9, r1)
        Le5:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutModifierNodeCoordinator.mo5339measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
    }
    ...
    public void mo5400placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        super.mo5400placeAtf8xVGno(position, zIndex, layer);
        onAfterPlaceAt();
    }
    ...
    public void mo5340placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo5340placeAtf8xVGno(position, zIndex, layerBlock);
        onAfterPlaceAt();
    }
    ...
    */
    private final void onAfterPlaceAt() {
        /*
            r13 = this;
            boolean r0 = r13.getIsShallowPlacing()
            if (r0 == 0) goto L7
            return
        L7:
            r13.onPlaced()
            androidx.compose.ui.layout.ApproachMeasureScopeImpl r0 = r13.approachMeasureScope
            r1 = 0
            if (r0 == 0) goto L7f
            r2 = 0
            androidx.compose.ui.layout.ApproachLayoutModifierNode r3 = r0.getApproachNode()
            r4 = 0
            androidx.compose.ui.layout.Placeable$PlacementScope r5 = r13.getPlacementScope()
            r6 = 0
            androidx.compose.ui.node.LookaheadDelegate r7 = r13.getLookaheadDelegate()
            kotlin.jvm.internal.Intrinsics.checkNotNull(r7)
            androidx.compose.ui.layout.LookaheadLayoutCoordinates r7 = r7.getLookaheadLayoutCoordinates()
            androidx.compose.ui.layout.LayoutCoordinates r7 = (androidx.compose.ui.layout.LayoutCoordinates) r7
            boolean r7 = r3.isPlacementApproachInProgress(r5, r7)
            if (r7 != 0) goto L71
            boolean r7 = r0.getApproachMeasureRequired()
            if (r7 != 0) goto L71
            long r7 = r13.mo5347getSizeYbymL2g()
            androidx.compose.ui.node.LookaheadDelegate r9 = r13.getLookaheadDelegate()
            r10 = 0
            if (r9 == 0) goto L48
            long r11 = r9.m5521getSizeYbymL2g$ui_release()
            androidx.compose.ui.unit.IntSize r9 = androidx.compose.ui.unit.IntSize.m6647boximpl(r11)
            goto L49
        L48:
            r9 = r10
        L49:
            boolean r7 = androidx.compose.ui.unit.IntSize.m6652equalsimpl(r7, r9)
            if (r7 == 0) goto L71
            androidx.compose.ui.node.NodeCoordinator r7 = r13.getWrappedNonNull()
            long r7 = r7.mo5347getSizeYbymL2g()
            androidx.compose.ui.node.NodeCoordinator r9 = r13.getWrappedNonNull()
            androidx.compose.ui.node.LookaheadDelegate r9 = r9.getLookaheadDelegate()
            if (r9 == 0) goto L69
            long r9 = r9.m5521getSizeYbymL2g$ui_release()
            androidx.compose.ui.unit.IntSize r10 = androidx.compose.ui.unit.IntSize.m6647boximpl(r9)
        L69:
            boolean r7 = androidx.compose.ui.unit.IntSize.m6652equalsimpl(r7, r10)
            if (r7 == 0) goto L71
            r7 = 1
            goto L72
        L71:
        ...
        L72:
            r5 = r7
            androidx.compose.ui.node.NodeCoordinator r6 = r13.getWrappedNonNull()
            r6.setForcePlaceWithLookaheadOffset$ui_release(r5)
        L7f:
            androidx.compose.ui.layout.MeasureResult r0 = r13.getMeasureResult$ui_release()
            r0.placeChildren()
            androidx.compose.ui.node.NodeCoordinator r0 = r13.getWrappedNonNull()
    ...
    static {
        ...
        paint.mo3882setColor8_81llA(Color.INSTANCE.m4030getBlue0d7_KjU());
        paint.setStrokeWidth(1.0f);
        paint.mo3886setStylek9PVt8s(PaintingStyle.INSTANCE.m4271getStrokeTiuSbCo());
