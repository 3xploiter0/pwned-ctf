...
final class SkipToLookaheadNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m125setLookaheadConstraints_Sx5XlM(Constraints constraints) {
    ...
    public MeasureResult mo91measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        final Placeable p = measurable.mo5339measureBRTryo0(constraints2.getValue());
        final long contentSize = IntSizeKt.IntSize(p.getWidth(), p.getHeight());
        final long constrainedSize = ConstraintsKt.m6452constrain4WqzIAM(constraints, contentSize);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6655getWidthimpl(constrainedSize), IntSize.m6654getHeightimpl(constrainedSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                final long resolvedScale = (IntSize.m6655getWidthimpl(contentSize) == 0 || IntSize.m6654getHeightimpl(contentSize) == 0) ? ScaleFactorKt.ScaleFactor(1.0f, 1.0f) : contentScale.mo5330computeScaleFactorH7hwNQA(IntSizeKt.m6667toSizeozmzZPI(contentSize), IntSizeKt.m6667toSizeozmzZPI(constrainedSize));
                long jMo3608alignKFBX0sM = scaleToBounds.getAlignment().mo3608alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(IntSize.m6655getWidthimpl(contentSize) * ScaleFactor.m5428getScaleXimpl(resolvedScale)), MathKt.roundToInt(IntSize.m6654getHeightimpl(contentSize) * ScaleFactor.m5429getScaleYimpl(resolvedScale))), constrainedSize, $this$measure_u2d3p2s80s.getLayoutDirection());
                int x = IntOffset.m6613getXimpl(jMo3608alignKFBX0sM);
                int y = IntOffset.m6614getYimpl(jMo3608alignKFBX0sM);
                Placeable.PlacementScope.placeWithLayer$default($this$layout, p, x, y, 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(GraphicsLayerScope $this$placeWithLayer) {
                        $this$placeWithLayer.setScaleX(ScaleFactor.m5428getScaleXimpl(resolvedScale));
                        $this$placeWithLayer.setScaleY(ScaleFactor.m5429getScaleYimpl(resolvedScale));
                        $this$placeWithLayer.mo4196setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(0.0f, 0.0f));
                    }
                }, 4, (Object) null);
            }
        }, 4, null);
