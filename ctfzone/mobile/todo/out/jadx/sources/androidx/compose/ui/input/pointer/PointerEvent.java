...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m5143constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m5273constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m5149calculatePointerEventType7fucELk();
    }
    ...
    public final void m5153setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m5149calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent$ui_release();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
            }
            return PointerEventType.INSTANCE.m5166getPress7fucELk();
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m5167getRelease7fucELk();
            }
            if (PointerEventKt.changedToDownIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m5166getPress7fucELk();
            }
        }
        return PointerEventType.INSTANCE.m5165getMove7fucELk();
    }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            long jM5208getIdJ3iCeTQ = change.getId();
            long uptimeMillis = change.getUptimeMillis();
            long jM5210getPositionF1C5BW0 = change.getPosition();
            long jM5210getPositionF1C5BW02 = change.getPosition();
            boolean pressed = change.getPressed();
            float pressure = change.getPressure();
            int iM5213getTypeT8wyACA = change.getType();
            InternalPointerEvent internalPointerEvent = this.internalPointerEvent;
            if (internalPointerEvent != null) {
                $this$fastForEach$iv = $this$fastForEach$iv2;
                $i$f$fastForEach = $i$f$fastForEach2;
                z = true;
                if (internalPointerEvent.m5139activeHoverEvent0FcD4WY(change.getId())) {
                }
                arrayList.add(new PointerInputEventData(jM5208getIdJ3iCeTQ, uptimeMillis, jM5210getPositionF1C5BW0, jM5210getPositionF1C5BW02, pressed, pressure, iM5213getTypeT8wyACA, z, null, 0L, 0L, 1792, null));
                index$iv++;
