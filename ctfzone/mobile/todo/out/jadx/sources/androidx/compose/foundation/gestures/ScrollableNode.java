...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    public boolean mo208onKeyEventZmokQxo(KeyEvent event) {
        ...
        long scrollAmount;
        float yAmount;
        if (getEnabled() && ((Key.m4760equalsimpl0(KeyEvent_androidKt.m5068getKeyZmokQxo(event), Key.INSTANCE.m4948getPageDownEK5gGoQ()) || Key.m4760equalsimpl0(KeyEvent_androidKt.m5068getKeyZmokQxo(event), Key.INSTANCE.m4949getPageUpEK5gGoQ())) && KeyEventType.m5061equalsimpl0(KeyEvent_androidKt.m5069getTypeZmokQxo(event), KeyEventType.INSTANCE.m5065getKeyDownCS__XNY()) && !KeyEvent_androidKt.m5072isCtrlPressedZmokQxo(event))) {
            if (this.scrollingLogic.isVertical()) {
                int viewportHeight = IntSize.m6654getHeightimpl(this.contentInViewNode.getViewportSize());
                if (Key.m4760equalsimpl0(KeyEvent_androidKt.m5068getKeyZmokQxo(event), Key.INSTANCE.m4949getPageUpEK5gGoQ())) {
                ...
                int viewportWidth = IntSize.m6655getWidthimpl(this.contentInViewNode.getViewportSize());
                if (Key.m4760equalsimpl0(KeyEvent_androidKt.m5068getKeyZmokQxo(event), Key.INSTANCE.m4949getPageUpEK5gGoQ())) {
    ...
    public void mo209onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass != PointerEventPass.Main || !PointerEventType.m5159equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5168getScroll7fucELk())) {
            return;
        }
    ...
    private final void setScrollSemanticsActions() {
        this.scrollByAction = new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableNode.setScrollSemanticsActions.1
            ...
            static final class C00211 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                C00211(ScrollableNode scrollableNode, float f, float f2, Continuation<? super C00211> continuation) {
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.label = 1;
                            if (ScrollableKt.m481semanticsScrollByd4ec7I(this.this$0.scrollingLogic, OffsetKt.Offset(this.$x, this.$y), this) != coroutine_suspended) {
                                break;
                            } else {
            ...
            public final Boolean invoke(float x, float y) {
                BuildersKt__Builders_commonKt.launch$default(ScrollableNode.this.getCoroutineScope(), null, null, new C00211(ScrollableNode.this, x, y, null), 3, null);
                return true;
            }
        };
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m485invoke3MmeM6k(offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m485invoke3MmeM6k(long j, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m3751boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    Object objM481semanticsScrollByd4ec7I = ScrollableKt.m481semanticsScrollByd4ec7I(ScrollableNode.this.scrollingLogic, offset, this);
                    return objM481semanticsScrollByd4ec7I == coroutine_suspended ? coroutine_suspended : objM481semanticsScrollByd4ec7I;
                case 1:
                    ResultKt.throwOnFailure($result);
                    return $result;
                default:
    ...
    private final void m484processMouseWheelEventO0kMr_c(PointerEvent event, long size) {
        ...
        if (z) {
            ...
            long scrollAmount = $this$processMouseWheelEvent_O0kMr_c_u24lambda_u246.mo394calculateMouseWheelScroll8xgXZGE(DelegatableNodeKt.requireDensity(this), event, size);
