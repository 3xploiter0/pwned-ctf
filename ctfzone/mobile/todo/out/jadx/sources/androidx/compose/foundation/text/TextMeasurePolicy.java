...
final class TextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        List inlineContentMeasurables2 = target$iv;
        List $this$fastMapIndexedNotNull$iv2 = this.placements.invoke();
        if ($this$fastMapIndexedNotNull$iv2 != null) {
            ArrayList target$iv2 = new ArrayList($this$fastMapIndexedNotNull$iv2.size());
            ...
            while (index$iv$iv2 < size2) {
                ...
                if (rect != null) {
                    ...
                    Placeable placeableMo5339measureBRTryo0 = ((Measurable) inlineContentMeasurables2.get(index$iv)).mo5339measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null));
                    ...
                    pair = new Pair(placeableMo5339measureBRTryo0, IntOffset.m6604boximpl(IntOffsetKt.IntOffset(iRound, Math.round($this$fastRoundToInt$iv2))));
                } else {
                    inlineContentMeasurables = inlineContentMeasurables2;
                    $this$fastMapIndexedNotNull$iv = $this$fastMapIndexedNotNull$iv2;
                    $this$fastForEachIndexed$iv$iv = $this$fastForEachIndexed$iv$iv2;
        ...
        final List inlineContentToPlace = arrayList;
        List target$iv3 = new ArrayList(list.size());
        int size3 = list.size();
        for (int index$iv$iv3 = 0; index$iv$iv3 < size3; index$iv$iv3++) {
            ...
            if (it2.getParentData() instanceof TextRangeLayoutModifier) {
                target$iv3.add(measurable2);
            }
        }
        List linksMeasurables = target$iv3;
        final List linksToPlace = BasicTextKt.measureWithTextRangeMeasureConstraints(linksMeasurables, this.shouldMeasureLinks);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m6438getMaxWidthimpl(constraints), Constraints.m6437getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                for (int index$iv3 = 0; index$iv3 < size5; index$iv3++) {
                    ...
                    Placeable.PlacementScope.m5403place70tqf50$default($this$layout, placeable2, measureResult != null ? measureResult.invoke().getPackedValue() : IntOffset.INSTANCE.m6623getZeronOccac(), 0.0f, 2, null);
                }
            }
        }, 4, null);
    }
