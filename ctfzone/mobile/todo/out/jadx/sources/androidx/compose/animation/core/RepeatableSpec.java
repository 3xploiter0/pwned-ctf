...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM174constructorimpl$default;
        if ((i2 & 4) == 0) {
        ...
        if ((i2 & 8) == 0) {
            jM174constructorimpl$default = j;
        } else {
            jM174constructorimpl$default = StartOffset.m174constructorimpl$default(0, 0, 2, null);
        }
        this(i, durationBasedAnimationSpec, repeatMode2, jM174constructorimpl$default, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ RepeatableSpec(int iterations, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(iterations, animation, repeatMode, StartOffset.m174constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof RepeatableSpec) && ((RepeatableSpec) other).iterations == this.iterations && Intrinsics.areEqual(((RepeatableSpec) other).animation, this.animation) && ((RepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m176equalsimpl0(((RepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }

    public int hashCode() {
        return (((((this.iterations * 31) + this.animation.hashCode()) * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m179hashCodeimpl(this.initialStartOffset);
    }
}
