...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, final long constraints) {
        long jM6428copyZbe2FdA;
        if (!this.tabPositionsState.getValue().isEmpty()) {
            float currentTabWidth = this.tabPositionsState.getValue().get(this.selectedTabIndex).getContentWidth();
            if (this.followContentSize) {
                if (this.initialWidth == null) {
                    this.initialWidth = Dp.m6483boximpl(currentTabWidth);
                } else {
                    ...
                    if (!Dp.m6490equalsimpl0(currentTabWidth, it.getTargetValue().m6499unboximpl())) {
            ...
            if (this.initialOffset == null) {
                this.initialOffset = Dp.m6483boximpl(indicatorOffset);
            } else {
                ...
                if (!Dp.m6490equalsimpl0(indicatorOffset, it2.getTargetValue().m6499unboximpl())) {
            ...
            final float offset = animatable != null ? animatable.getValue().m6499unboximpl() : indicatorOffset;
            if (this.followContentSize) {
                Animatable<Dp, AnimationVector1D> animatable2 = this.widthAnimatable;
                float width = animatable2 != null ? animatable2.getValue().m6499unboximpl() : currentTabWidth;
                jM6428copyZbe2FdA = Constraints.m6428copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6440getMinWidthimpl(constraints) : $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(width), (11 & 2) != 0 ? Constraints.m6438getMaxWidthimpl(constraints) : $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(width), (11 & 4) != 0 ? Constraints.m6439getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6437getMaxHeightimpl(constraints) : 0);
            } else {
                jM6428copyZbe2FdA = constraints;
            }
            final Placeable placeable = measurable.mo5339measureBRTryo0(jM6428copyZbe2FdA);
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), Constraints.m6437getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
                ...
                public final void invoke2(Placeable.PlacementScope $this$layout) {
                    Placeable.PlacementScope.place$default($this$layout, placeable, $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(offset), Constraints.m6437getMaxHeightimpl(constraints) - placeable.getHeight(), 0.0f, 4, null);
                }
            }, 4, null);
        }
