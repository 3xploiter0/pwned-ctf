...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        long offset = OffsetKt.Offset(IntSize.m6655getWidthimpl(sourceCoordinates.mo5347getSizeYbymL2g()) / 2.0f, coordinate);
        return Offset.m3763getYimpl(targetCoordinates.mo5348localPositionOfR5De75A(sourceCoordinates, offset));
    }
}
