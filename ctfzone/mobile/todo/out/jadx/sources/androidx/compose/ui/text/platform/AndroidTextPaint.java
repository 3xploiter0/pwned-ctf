...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m6210getBrushSizeVsRJwc0$ui_text_release$annotations() {
    }
    ...
    public AndroidTextPaint(int flags, float density) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m4561getDefaultBlendMode0nO6VwU();
    ...
    public final void m6216setBrushSizeiaC8Vc4$ui_text_release(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        if (shadow != null && !Intrinsics.areEqual(this.shadow, shadow)) {
            ...
            if (Intrinsics.areEqual(this.shadow, Shadow.INSTANCE.getNone())) {
                ...
                setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m3762getXimpl(this.shadow.getOffset()), Offset.m3763getYimpl(this.shadow.getOffset()), ColorKt.m4057toArgb8_81llA(this.shadow.getColor()));
            }
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m6217setColor8_81llA(long color) {
        if (color != 16) {
            setColor(ColorKt.m4057toArgb8_81llA(color));
            clearShader();
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m6211setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m6215setBrush12SF9DM(brush, j, f);
    }
    ...
    */
    public final void m6215setBrush12SF9DM(final androidx.compose.ui.graphics.Brush r7, final long r8, float r10) {
        /*
            r6 = this;
            if (r7 != 0) goto L8
            r6.clearShader()
        ...
        L8:
            ...
            long r0 = r0.getValue()
            long r0 = androidx.compose.ui.text.style.TextDrawStyleKt.m6372modulateDxMtmZc(r0, r10)
            r6.m6217setColor8_81llA(r0)
            goto L74
        L1b:
        ...
        L2e:
            ...
            boolean r0 = androidx.compose.ui.geometry.Size.m3827equalsimpl0(r2, r8)
        L36:
            if (r0 != 0) goto L5b
        L38:
            r2 = r8
        ...
        L44:
            if (r1 == 0) goto L5b
            r6.brush = r7
            androidx.compose.ui.geometry.Size r0 = androidx.compose.ui.geometry.Size.m3819boximpl(r8)
            r6.brushSize = r0
        ...
        L74:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m6215setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        if (drawStyle != null && !Intrinsics.areEqual(this.drawStyle, drawStyle)) {
            ...
            if (drawStyle instanceof Stroke) {
                getComposePaint().mo3886setStylek9PVt8s(PaintingStyle.INSTANCE.m4271getStrokeTiuSbCo());
                getComposePaint().setStrokeWidth(((Stroke) drawStyle).getWidth());
                getComposePaint().setStrokeMiterLimit(((Stroke) drawStyle).getMiter());
                getComposePaint().mo3885setStrokeJoinWw9F2mQ(((Stroke) drawStyle).getJoin());
                getComposePaint().mo3884setStrokeCapBeK7IIE(((Stroke) drawStyle).getCap());
    ...
    public final void m6214setBlendModes9anfk8(int value) {
        if (BlendMode.m3914equalsimpl0(value, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo3881setBlendModes9anfk8(value);
