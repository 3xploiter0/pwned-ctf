...
public final class EditorInfo_androidKt {
    ...
    public static /* synthetic */ void m1147updatepLxbY9I$default(EditorInfo editorInfo, CharSequence charSequence, long j, ImeOptions imeOptions, String[] strArr, int i, Object obj) {
        String[] strArr2;
        if ((i & 8) == 0) {
            strArr2 = strArr;
        } else {
        ...
        m1146updatepLxbY9I(editorInfo, charSequence, j, imeOptions, strArr2);
    }

    /* renamed from: update-pLxbY9I, reason: not valid java name */
    public static final void m1146updatepLxbY9I(EditorInfo $this$update_u2dpLxbY9I, CharSequence text, long selection, ImeOptions imeOptions, String[] contentMimeTypes) {
        String it;
        ...
        if (KeyboardType.m6166equalsimpl0(keyboardType, KeyboardType.INSTANCE.m6187getTextPjHm6EE())) {
            ...
            if (KeyboardType.m6166equalsimpl0(keyboardType, KeyboardType.INSTANCE.m6189getUriPjHm6EE())) {
                i = 17;
        ...
        $this$update_u2dpLxbY9I.initialSelStart = TextRange.m5948getStartimpl(selection);
        $this$update_u2dpLxbY9I.initialSelEnd = TextRange.m5943getEndimpl(selection);
        ...
        if (StylusHandwriting_androidKt.isStylusHandwritingSupported() && !KeyboardType.m6166equalsimpl0(imeOptions.getKeyboardType(), KeyboardType.INSTANCE.m6185getPasswordPjHm6EE()) && !KeyboardType.m6166equalsimpl0(imeOptions.getKeyboardType(), KeyboardType.INSTANCE.m6184getNumberPasswordPjHm6EE())) {
