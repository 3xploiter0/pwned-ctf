            ...
            synchronized (lock$iv$iv$iv$iv$iv$iv) {
                try {
                    ...
                    try {
                        ...
                        try {
                            SnapshotStateMap.StateMapStateRecord $this$mutate_u24lambda_u2415$iv$iv = (SnapshotStateMap.StateMapStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv$iv, this_$iv2, current);
