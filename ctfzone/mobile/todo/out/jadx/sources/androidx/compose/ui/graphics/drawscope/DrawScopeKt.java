...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m4607rotateRg1IO4c$default(DrawScope $this$rotate_u2dRg1IO4c_u24default, float degrees, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$rotate_u2dRg1IO4c_u24default.mo4558getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$rotate_Rg1IO4c_u24lambda_u240.mo4486rotateUv8p0NA(degrees, pivot);
    ...
    public static final void m4606rotateRg1IO4c(DrawScope $this$rotate_u2dRg1IO4c, float degrees, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4609rotateRadRg1IO4c$default(DrawScope $this$rotateRad_u2dRg1IO4c_u24default, float radians, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$rotateRad_u2dRg1IO4c_u24default.mo4558getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$rotateRad_Rg1IO4c_u24lambda_u241.mo4486rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    ...
    public static final void m4608rotateRadRg1IO4c(DrawScope $this$rotateRad_u2dRg1IO4c, float radians, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4611scaleFgt4K4Q$default(DrawScope $this$scale_u2dFgt4K4Q_u24default, float scaleX, float scaleY, long pivot, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            pivot = $this$scale_u2dFgt4K4Q_u24default.mo4558getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$scale_Fgt4K4Q_u24lambda_u242.mo4487scale0AR0LA0(scaleX, scaleY, pivot);
    ...
    public static final void m4610scaleFgt4K4Q(DrawScope $this$scale_u2dFgt4K4Q, float scaleX, float scaleY, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4613scaleRg1IO4c$default(DrawScope $this$scale_u2dRg1IO4c_u24default, float scale, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$scale_u2dRg1IO4c_u24default.mo4558getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$scale_Rg1IO4c_u24lambda_u243.mo4487scale0AR0LA0(scale, scale, pivot);
    ...
    public static final void m4612scaleRg1IO4c(DrawScope $this$scale_u2dRg1IO4c, float scale, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4602clipRectrOu3jXo$default(DrawScope $this$clipRect_u2drOu3jXo_u24default, float left, float top, float right, float bottom, int clipOp, Function1 block, int i, Object obj) throws Throwable {
        long previousSize$iv;
        float left2 = (i & 1) != 0 ? 0.0f : left;
        float top2 = (i & 2) != 0 ? 0.0f : top;
        float right2 = (i & 4) != 0 ? Size.m3831getWidthimpl($this$clipRect_u2drOu3jXo_u24default.mo4559getSizeNHjbRc()) : right;
        float bottom2 = (i & 8) != 0 ? Size.m3828getHeightimpl($this$clipRect_u2drOu3jXo_u24default.mo4559getSizeNHjbRc()) : bottom;
        int clipOp2 = (i & 16) != 0 ? ClipOp.INSTANCE.m3992getIntersectrtfAjoo() : clipOp;
        DrawContext $this$withTransform_u24lambda_u246$iv = $this$clipRect_u2drOu3jXo_u24default.getDrawContext();
        long previousSize$iv2 = $this$withTransform_u24lambda_u246$iv.mo4480getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        try {
            ...
            try {
                $this$clipRect_rOu3jXo_u24lambda_u244.mo4483clipRectN_I0leg(f, top2, right2, bottom2, clipOp2);
                try {
    ...
    public static final void m4601clipRectrOu3jXo(DrawScope $this$clipRect_u2drOu3jXo, float left, float top, float right, float bottom, int clipOp, Function1<? super DrawScope, Unit> function1) throws Throwable {
        DrawContext $this$withTransform_u24lambda_u246$iv = $this$clipRect_u2drOu3jXo.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo4480getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        try {
            DrawTransform $this$clipRect_rOu3jXo_u24lambda_u244 = $this$withTransform_u24lambda_u246$iv.getTransform();
            $this$clipRect_rOu3jXo_u24lambda_u244.mo4483clipRectN_I0leg(left, top, right, bottom, clipOp);
            try {
    ...
    public static /* synthetic */ void m4600clipPathKD09W0M$default(DrawScope $this$clipPath_u2dKD09W0M_u24default, Path path, int clipOp, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            clipOp = ClipOp.INSTANCE.m3992getIntersectrtfAjoo();
        }
        ...
        try {
            ...
            $this$clipPath_KD09W0M_u24lambda_u245.mo4482clipPathmtrdDE(path, clipOp);
    ...
    public static final void m4599clipPathKD09W0M(DrawScope $this$clipPath_u2dKD09W0M, Path path, int clipOp, Function1<? super DrawScope, Unit> function1) {
    ...
    public static final void withTransform(DrawScope $this$withTransform, Function1<? super DrawTransform, Unit> function1, Function1<? super DrawScope, Unit> function12) {
        ...
        long previousSize = $this$withTransform_u24lambda_u246.mo4480getSizeNHjbRc();
        ...
        try {
            ...
            $this$withTransform_u24lambda_u246.mo4481setSizeuvyYCjk(previousSize);
            InlineMarker.finallyEnd(1);
        }
    }
    ...
    public static final /* synthetic */ void m4603drawGRGpd60(DrawScope $this$draw_u2dGRGpd60, Density density, LayoutDirection layoutDirection, Canvas canvas, long size, Function1<? super DrawScope, Unit> function1) {
        ...
        long prevSize$iv = $this$draw_u2dGRGpd60.getDrawContext().mo4480getSizeNHjbRc();
    ...
    public static /* synthetic */ void m4605drawymL40Pk$default(DrawScope $this$draw_u2dymL40Pk_u24default, Density density, LayoutDirection layoutDirection, Canvas canvas, long size, GraphicsLayer graphicsLayer, Function1 block, int i, Object obj) {
        ...
        long prevSize = $this$draw_u2dymL40Pk_u24default.getDrawContext().mo4480getSizeNHjbRc();
        ...
        $this$draw_ymL40Pk_u24lambda_u247.mo4481setSizeuvyYCjk(size);
        ...
        try {
            ...
            $this$draw_ymL40Pk_u24lambda_u248.mo4481setSizeuvyYCjk(prevSize);
    ...
    public static final void m4604drawymL40Pk(DrawScope $this$draw_u2dymL40Pk, Density density, LayoutDirection layoutDirection, Canvas canvas, long size, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
        ...
        long prevSize = $this$draw_u2dymL40Pk.getDrawContext().mo4480getSizeNHjbRc();
