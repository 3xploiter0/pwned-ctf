...
public final class BezierKt {
    ...
    private static final float findFirstQuadraticRoot(float p0, float p1, float p2) {
        ...
        if (r$iv2 < 0.0f) {
            f = r$iv2 >= -8.34465E-7f ? 0.0f : Float.NaN;
        } else if (r$iv2 > 1.0f) {
            f = r$iv2 <= 1.0000008f ? 1.0f : Float.NaN;
        } else {
            f = r$iv2;
        }
        float r$iv3 = f;
        if (!Float.isNaN(r$iv3)) {
            return r$iv3;
        }
        float r$iv4 = (float) ((v1 - v2) / d);
        if (r$iv4 < 0.0f) {
            return r$iv4 >= -8.34465E-7f ? 0.0f : Float.NaN;
        }
        if (r$iv4 > 1.0f) {
            return r$iv4 <= 1.0000008f ? 1.0f : Float.NaN;
        }
        return r$iv4;
    }
    ...
    public static final float findFirstCubicRoot(float p0, float p1, float p2, float p3) {
        ...
        if (Math.abs(d - 0.0d) < Epsilon) {
            ...
            if (r$iv2 < 0.0f) {
                f4 = r$iv2 >= -8.34465E-7f ? 0.0f : Float.NaN;
            } else if (r$iv2 > 1.0f) {
                f4 = r$iv2 <= 1.0000008f ? 1.0f : Float.NaN;
            } else {
                f4 = r$iv2;
            }
            float r$iv3 = f4;
        ...
        if (discriminant >= 0.0d) {
            if (discriminant == 0.0d) {
                ...
                float r$iv5 = (2.0f * u1) - ((float) a32);
                if (r$iv5 < 0.0f) {
                    f = r$iv5 >= -8.34465E-7f ? 0.0f : Float.NaN;
                } else if (r$iv5 > 1.0f) {
                    f = r$iv5 <= 1.0000008f ? 1.0f : Float.NaN;
                } else {
                    f = r$iv5;
                }
                float root = f;
            ...
            float r$iv7 = (float) ((u12 - v1) - a32);
            if (r$iv7 < 0.0f) {
                return r$iv7 >= -8.34465E-7f ? 0.0f : Float.NaN;
            }
            if (r$iv7 > 1.0f) {
                return r$iv7 <= 1.0000008f ? 1.0f : Float.NaN;
            }
            return r$iv7;
        }
        ...
        double minimumValue$iv = $this$fastCoerceAtLeast$iv$iv;
        double phi = Math.acos(minimumValue$iv);
        float t1 = MathHelpersKt.fastCbrt((float) r) * 2.0f;
        float r$iv8 = (float) ((t1 * Math.cos(phi / 3.0d)) - a32);
        if (r$iv8 < 0.0f) {
            f2 = r$iv8 >= -8.34465E-7f ? 0.0f : Float.NaN;
        } else if (r$iv8 > 1.0f) {
            f2 = r$iv8 <= 1.0000008f ? 1.0f : Float.NaN;
        } else {
            f2 = r$iv8;
        }
        float r$iv9 = f2;
        if (!Float.isNaN(r$iv9)) {
            return r$iv9;
        }
        float r$iv10 = (float) ((t1 * Math.cos((phi + Tau) / 3.0d)) - a32);
        if (r$iv10 < 0.0f) {
            f3 = r$iv10 >= -8.34465E-7f ? 0.0f : Float.NaN;
        } else if (r$iv10 > 1.0f) {
            f3 = r$iv10 <= 1.0000008f ? 1.0f : Float.NaN;
        } else {
            f3 = r$iv10;
        }
        float r$iv11 = f3;
        if (!Float.isNaN(r$iv11)) {
            return r$iv11;
        }
        float r$iv12 = (float) ((t1 * Math.cos((phi + 12.566370614359172d) / 3.0d)) - a32);
        if (r$iv12 < 0.0f) {
            return r$iv12 >= -8.34465E-7f ? 0.0f : Float.NaN;
        }
        if (r$iv12 > 1.0f) {
            return r$iv12 <= 1.0000008f ? 1.0f : Float.NaN;
        }
        return r$iv12;
    }
    ...
    private static final int findQuadraticRoots(float p0, float p1, float p2, float[] roots, int index) {
        ...
        if (d == 0.0d) {
            if (!(b == c)) {
                return 0 + writeValidRootInUnitRange((float) (((b * 2.0d) - c) / ((b * 2.0d) - (2.0d * c))), roots, index);
            }
            return 0;
        }
        double v1 = -Math.sqrt((b * b) - (a * c));
    ...
    */
    ...
    private static final int cubicToMonotonicCubics(float[] cubic, float[] dst, float[] tmpRoot) {
        ...
        if (rootCount == 0) {
            ...
            for (int i = 0; i < rootCount; i++) {
                float $this$fastCoerceIn$iv = (tmpRoot[i] - lastT) / (1.0f - lastT);
                ...
                float t = $this$fastCoerceAtLeast$iv$iv;
                lastT = t;
    ...
    private static final void splitCubicAt(float[] src, int srcOffset, float[] dst, int dstOffset, float t) {
        ...
        float p0y2 = src[srcOffset + 6];
        float p3y = src[srcOffset + 7];
        float cdx = MathHelpersKt.lerp(p2x, p0y2, t);
