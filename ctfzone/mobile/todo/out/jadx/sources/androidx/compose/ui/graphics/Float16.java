...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m4112constructorimpl((short) 5120);
    private static final short LowestValue = m4112constructorimpl((short) -1025);
    private static final short MaxValue = m4112constructorimpl((short) 31743);
    private static final short MinNormal = m4112constructorimpl((short) 1024);
    private static final short MinValue = m4112constructorimpl((short) 1);
    private static final short NaN = m4112constructorimpl((short) 32256);
    private static final short NegativeInfinity = m4112constructorimpl((short) -1024);
    private static final short NegativeZero = m4112constructorimpl(ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m4112constructorimpl((short) 31744);
    private static final short PositiveZero = m4112constructorimpl((short) 0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Float16 m4107boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m4112constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4113equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m4138unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4114equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4119hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    public boolean equals(Object obj) {
        return m4113equalsimpl(this.halfValue, obj);
    }

    public int hashCode() {
        return m4119hashCodeimpl(this.halfValue);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m4137compareTo41bOqos(float16.m4138unboximpl());
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m4111constructorimpl(float value) {
        short s;
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m4110constructorimpl(double value) {
        return m4111constructorimpl((float) value);
    }

    /* renamed from: toByte-impl, reason: not valid java name */
    public static final byte m4126toByteimpl(short arg0) {
        return (byte) m4128toFloatimpl(arg0);
    }

    /* renamed from: toShort-impl, reason: not valid java name */
    public static final short m4133toShortimpl(short arg0) {
        return (short) m4128toFloatimpl(arg0);
    }

    /* renamed from: toInt-impl, reason: not valid java name */
    public static final int m4130toIntimpl(short arg0) {
        return (int) m4128toFloatimpl(arg0);
    }

    /* renamed from: toLong-impl, reason: not valid java name */
    public static final long m4131toLongimpl(short arg0) {
        return (long) m4128toFloatimpl(arg0);
    }

    /* renamed from: toFloat-impl, reason: not valid java name */
    public static final float m4128toFloatimpl(short arg0) {
    ...
    public static final double m4127toDoubleimpl(short arg0) {
        return m4128toFloatimpl(arg0);
    }

    /* renamed from: toBits-impl, reason: not valid java name */
    public static final int m4125toBitsimpl(short arg0) {
        if (m4122isNaNimpl(arg0)) {
            return NaN;
        }
        return 65535 & arg0;
    }
    ...
    public static final int m4132toRawBitsimpl(short arg0) {
        return 65535 & arg0;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4134toStringimpl(short arg0) {
        return String.valueOf(m4128toFloatimpl(arg0));
    }

    public String toString() {
        return m4134toStringimpl(this.halfValue);
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public int m4137compareTo41bOqos(short other) {
        return m4109compareTo41bOqos(this.halfValue, other);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public static int m4109compareTo41bOqos(short s, short s2) {
        if (m4122isNaNimpl(s)) {
            return !m4122isNaNimpl(s2) ? 1 : 0;
        }
        if (m4122isNaNimpl(s2)) {
            return -1;
        }
    ...
    public static final short m4117getSignslo4al4(short arg0) {
        if (m4122isNaNimpl(arg0)) {
            return NaN;
        }
        if (m4109compareTo41bOqos(arg0, NegativeZero) < 0) {
            return Float16Kt.NegativeOne;
        }
        if (m4109compareTo41bOqos(arg0, PositiveZero) > 0) {
    ...
    public static final short m4136withSignqCeQghg(short arg0, short sign) {
        return m4112constructorimpl((short) ((Short.MIN_VALUE & sign) | (arg0 & ShortCompanionObject.MAX_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4, reason: not valid java name */
    public static final short m4106absoluteValueslo4al4(short arg0) {
        return m4112constructorimpl((short) (arg0 & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4, reason: not valid java name */
    public static final short m4124roundslo4al4(short arg0) {
        ...
        return m4112constructorimpl((short) result);
    }

    /* renamed from: ceil-slo4al4, reason: not valid java name */
    public static final short m4108ceilslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & LayoutKt.LargeDimension;
        int result = bits;
        if (e < 15360) {
    ...
    public static final short m4115floorslo4al4(short arg0) {
        int i = SupportMenu.USER_MASK;
        int bits = arg0 & UShort.MAX_VALUE;
        int e = bits & LayoutKt.LargeDimension;
        int result = bits;
    ...
    public static final short m4135truncslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & LayoutKt.LargeDimension;
        int result = bits;
        if (e < 15360) {
    ...
    public static final int m4116getExponentimpl(short arg0) {
        return ((arg0 >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl, reason: not valid java name */
    public static final int m4118getSignificandimpl(short arg0) {
        return arg0 & 1023;
    }

    /* renamed from: isNaN-impl, reason: not valid java name */
    public static final boolean m4122isNaNimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) > 31744;
    }

    /* renamed from: isInfinite-impl, reason: not valid java name */
    public static final boolean m4121isInfiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) == 31744;
    }

    /* renamed from: isFinite-impl, reason: not valid java name */
    public static final boolean m4120isFiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) != 31744;
    }

    /* renamed from: isNormalized-impl, reason: not valid java name */
    public static final boolean m4123isNormalizedimpl(short arg0) {
        return ((arg0 & 31744) == 0 || (arg0 & 31744) == 31744) ? false : true;
    }

    /* renamed from: toHexString-impl, reason: not valid java name */
    public static final String m4129toHexStringimpl(short arg0) {
