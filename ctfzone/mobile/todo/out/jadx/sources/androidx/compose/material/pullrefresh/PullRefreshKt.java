...
public final class PullRefreshKt {
    ...
    public static final Modifier pullRefresh(Modifier $this$pullRefresh, final Function1<? super Float, Float> function1, final Function2<? super Float, ? super Continuation<? super Float>, ? extends Object> function2, final boolean enabled) {
        Function1 inspectorInfo$iv = InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshKt$pullRefresh$$inlined$debugInspectorInfo$2
            ...
            public final void invoke2(InspectorInfo $this$null) {
                $this$null.setName("pullRefresh");
                $this$null.getProperties().set("onPull", function1);
                $this$null.getProperties().set("onRelease", function2);
                $this$null.getProperties().set("enabled", Boolean.valueOf(enabled));
            }
        } : InspectableValueKt.getNoInspectorInfo();
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier $this$pullRefresh_u24lambda_u243 = NestedScrollModifierKt.nestedScroll$default(Modifier.INSTANCE, new PullRefreshNestedScrollConnection(function1, function2, enabled), null, 2, null);
