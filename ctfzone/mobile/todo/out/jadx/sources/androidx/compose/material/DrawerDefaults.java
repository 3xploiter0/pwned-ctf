...
public final class DrawerDefaults {
    ...
    private static final float Elevation = Dp.m6485constructorimpl(16);

    private DrawerDefaults() {
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m1542getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(617225966, $changed, -1, "androidx.compose.material.DrawerDefaults.<get-scrimColor> (Drawer.kt:775)");
        }
        long jM1495getOnSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer, 6).m1495getOnSurface0d7_KjU();
        long jM4001copywmQWz5c = Color.m4001copywmQWz5c(jM1495getOnSurface0d7_KjU, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM1495getOnSurface0d7_KjU) : 0.32f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM1495getOnSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM1495getOnSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM1495getOnSurface0d7_KjU) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
