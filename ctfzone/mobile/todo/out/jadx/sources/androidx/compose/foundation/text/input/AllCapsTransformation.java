...
final /* data */ class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.INSTANCE.m6158getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 126, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer $this$transformInput) {
        ...
        for (int i$iv = 0; i$iv < $this$forEachChange$iv.getChangeCount(); i$iv++) {
            long range = $this$forEachChange$iv.mo1107getRangejx7JFs(i$iv);
            $this$forEachChange$iv.mo1106getOriginalRangejx7JFs(i$iv);
            if (!TextRange.m5942getCollapsedimpl(range)) {
                $this$transformInput.replace(TextRange.m5946getMinimpl(range), TextRange.m5945getMaximpl(range), StringKt.toUpperCase(TextRangeKt.m5955substringFDrldGo($this$transformInput.asCharSequence(), range), this.locale));
            }
        }
    }
