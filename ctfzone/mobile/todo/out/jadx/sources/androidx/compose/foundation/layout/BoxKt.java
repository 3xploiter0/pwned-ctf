...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo38measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long constraints) {
            return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m6440getMinWidthimpl(constraints), Constraints.m6439getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1.1
    ...
    private static final void cacheFor$lambda$1$putAlignment(HashMap<Alignment, MeasurePolicy> map, boolean $propagateMinConstraints, Alignment it) {
        map.put(it, new BoxMeasurePolicy(it, $propagateMinConstraints));
    }
    ...
    public static final void placeInBox(Placeable.PlacementScope $this$placeInBox, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int boxWidth, int boxHeight, Alignment alignment) {
        ...
        long position = childAlignment.mo3608alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(boxWidth, boxHeight), layoutDirection);
        Placeable.PlacementScope.m5403place70tqf50$default($this$placeInBox, placeable, position, 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Box)237@9098L66:Box.kt#2w3rfo");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (($dirty & 3) != 2 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-211209833, $dirty, -1, "androidx.compose.foundation.layout.Box (Box.kt:236)");
            }
            ...
            Updater.m3503setimpl($this$Layout_u24lambda_u241$iv, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
