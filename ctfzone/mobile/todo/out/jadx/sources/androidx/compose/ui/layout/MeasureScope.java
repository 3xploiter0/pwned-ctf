...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5381roundToPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo366roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5382roundToPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo367roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5383toDpGaN1DYA(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo368toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5384toDpu2uoSUM(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo369toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5385toDpu2uoSUM(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo370toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5386toDpSizekrfVVM(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo371toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5387toPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo372toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5388toPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo373toPx0680j_4($receiver);
        }
        ...
        public static long m5389toSizeXkaWNTQ(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo374toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5390toSp0xMU5do(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo375toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5391toSpkPz2Gy4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo376toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5392toSpkPz2Gy4(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo377toSpkPz2Gy4($receiver);
        }
