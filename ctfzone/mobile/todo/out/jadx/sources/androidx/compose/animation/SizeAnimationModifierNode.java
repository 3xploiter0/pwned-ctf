...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m115setLookaheadConstraintsBRTryo0(long value) {
    ...
    public static final /* data */ class AnimData {
        ...
        public final AnimData m120copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m6653equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m6656hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m6658toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo91measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            m115setLookaheadConstraintsBRTryo0(constraints);
            placeable = measurable.mo5339measureBRTryo0(constraints);
        } else {
            placeable = measurable.mo5339measureBRTryo0(m116targetConstraintsZezNO4M(constraints));
        }
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            long it2 = m117animateTomzRDjE0(AnimationModifierKt.m68isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : measuredSize);
            it = ConstraintsKt.m6452constrain4WqzIAM(constraints, it2);
        }
        final int width = IntSize.m6655getWidthimpl(it);
        final int height = IntSize.m6654getHeightimpl(it);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                long offset = this.this$0.getAlignment().mo3608alignKFBX0sM(measuredSize, IntSizeKt.IntSize(width, height), $this$measure_u2d3p2s80s.getLayoutDirection());
                Placeable.PlacementScope.m5403place70tqf50$default($this$layout, placeable, offset, 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m117animateTomzRDjE0(long targetSize) {
        AnimData $this$animateTo_mzRDjE0_u24lambda_u241 = getAnimData();
        if ($this$animateTo_mzRDjE0_u24lambda_u241 != null) {
            boolean wasInterrupted = (IntSize.m6653equalsimpl0(targetSize, $this$animateTo_mzRDjE0_u24lambda_u241.getAnim().getValue().getPackedValue()) || $this$animateTo_mzRDjE0_u24lambda_u241.getAnim().isRunning()) ? false : true;
            if (!IntSize.m6653equalsimpl0(targetSize, $this$animateTo_mzRDjE0_u24lambda_u241.getAnim().getTargetValue().getPackedValue()) || wasInterrupted) {
                $this$animateTo_mzRDjE0_u24lambda_u241.m122setStartSizeozmzZPI($this$animateTo_mzRDjE0_u24lambda_u241.getAnim().getValue().getPackedValue());
                BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new SizeAnimationModifierNode$animateTo$data$1$1($this$animateTo_mzRDjE0_u24lambda_u241, targetSize, this, null), 3, null);
            }
        } else {
            $this$animateTo_mzRDjE0_u24lambda_u241 = new AnimData(new Animatable(IntSize.m6647boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m6647boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
        AnimData data = $this$animateTo_mzRDjE0_u24lambda_u241;
        setAnimData(data);
