        ...
        switch (this.label) {
            case 0:
                ...
                Function1<Offset, Unit> function12 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$pressIndicator$1$1.1
                    ...
                    public final void m986invokek4lQ0M(long pos) {
                        TextLayoutResult layoutResult = mutableState.getValue();
                        if (layoutResult != null) {
                            function1.invoke(Integer.valueOf(layoutResult.m5920getOffsetForPositionk4lQ0M(pos)));
                        }
                    }
                };
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures($this$pointerInput, (7 & 1) != 0 ? null : null, (7 & 2) != 0 ? null : null, (7 & 4) != 0 ? TapGestureDetectorKt.NoPressGesture : null, (7 & 8) != 0 ? null : function12, this) != coroutine_suspended) {
                    break;
                } else {
