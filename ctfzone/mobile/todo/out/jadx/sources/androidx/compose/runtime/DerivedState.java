...
final class DerivedState<T> extends StateObjectImpl implements androidx.compose.runtime.DerivedState<T> {
        ...
        */
        public final boolean isValid(androidx.compose.runtime.DerivedState<?> r9, androidx.compose.runtime.snapshots.Snapshot r10) {
            /*
                ...
                monitor-enter(r1)
                r3 = 0
                int r4 = r8.validSnapshotId     // Catch: java.lang.Throwable -> L56
                int r5 = r10.getId()     // Catch: java.lang.Throwable -> L56
                r6 = 0
                r7 = 1
                if (r4 != r5) goto L1d
                int r4 = r8.validSnapshotWriteCount     // Catch: java.lang.Throwable -> L56
                int r5 = r10.getWriteCount()     // Catch: java.lang.Throwable -> L56
                if (r4 == r5) goto L1b
                goto L1d
            L1b:
                r3 = r6
            ...
            L34:
                ...
                monitor-enter(r3)
                r5 = 0
                int r6 = r10.getId()     // Catch: java.lang.Throwable -> L52
                r8.validSnapshotId = r6     // Catch: java.lang.Throwable -> L52
                int r6 = r10.getWriteCount()     // Catch: java.lang.Throwable -> L52
                r8.validSnapshotWriteCount = r6     // Catch: java.lang.Throwable -> L52
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public final int readableHash(androidx.compose.runtime.DerivedState<?> r30, androidx.compose.runtime.snapshots.Snapshot r31) throws java.lang.Throwable {
            /*
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:103:0x025a A[Catch: all -> 0x02c2, TRY_LEAVE, TryCatch #0 {, blocks: (B:92:0x021d, B:94:0x0230, B:96:0x0236, B:102:0x0248, B:103:0x025a), top: B:139:0x021d }] */
    /* JADX WARN: Removed duplicated region for block: B:60:0x0152  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private final androidx.compose.runtime.DerivedState.ResultRecord<T> currentRecord(androidx.compose.runtime.DerivedState.ResultRecord<T> r34, androidx.compose.runtime.snapshots.Snapshot r35, boolean r36, kotlin.jvm.functions.Function0<? extends T> r37) throws java.lang.Throwable {
        /*
