...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m2712constructorimpl(0);
    private static final int Vertical = m2712constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m2711boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2718getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE, reason: not valid java name */
        public final int m2719getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2716toStringimpl(int arg0) {
        return m2714equalsimpl0(arg0, Horizontal) ? "Horizontal" : m2714equalsimpl0(arg0, Vertical) ? "Vertical" : "Unknown";
    }
