...
public final class StylusHandwritingNodeWithNegativePadding extends StylusHandwritingNode implements LayoutModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        final int paddingVerticalPx = $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(StylusHandwritingKt.getHandwritingBoundsVerticalOffset());
        final int paddingHorizontalPx = $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(StylusHandwritingKt.getHandwritingBoundsHorizontalOffset());
        long newConstraint = ConstraintsKt.m6457offsetNN6EwU(constraints, paddingHorizontalPx * 2, paddingVerticalPx * 2);
