...
final class SingleSelectionLayout implements SelectionLayout {
    ...
    public LongObjectMap<Selection> createSubSelections(Selection selection) {
        ...
        if ((!selection.getHandlesCrossed() && selection.getStart().getOffset() > selection.getEnd().getOffset()) || (selection.getHandlesCrossed() && selection.getStart().getOffset() <= selection.getEnd().getOffset())) {
            selectionCopy$default = Selection.copy$default(selection, null, null, !selection.getHandlesCrossed(), 3, null);
        } else {
            selectionCopy$default = selection;
        }
        Selection $this$createSubSelections_u24lambda_u240 = selectionCopy$default;
        return LongObjectMapKt.longObjectMapOf(this.info.getSelectableId(), $this$createSubSelections_u24lambda_u240);
    }
