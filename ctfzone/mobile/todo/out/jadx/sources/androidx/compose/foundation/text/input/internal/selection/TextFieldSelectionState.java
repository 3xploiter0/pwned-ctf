...
public final class TextFieldSelectionState {
    ...
    private final MutableState startTextLayoutPositionInWindow = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3751boximpl(Offset.INSTANCE.m3777getUnspecifiedF1C5BW0()), null, 2, null);

    /* renamed from: rawHandleDragPosition$delegate, reason: from kotlin metadata */
    private final MutableState rawHandleDragPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3751boximpl(Offset.INSTANCE.m3777getUnspecifiedF1C5BW0()), null, 2, null);
    ...
    private final long m1263getStartTextLayoutPositionInWindowF1C5BW0() {
    ...
    private final void m1267setStartTextLayoutPositionInWindowk4lQ0M(long j) {
        MutableState $this$setValue$iv = this.startTextLayoutPositionInWindow;
        $this$setValue$iv.setValue(Offset.m3751boximpl(j));
    }

    /* renamed from: getCurrentTextLayoutPositionInWindow-F1C5BW0, reason: not valid java name */
    private final long m1260getCurrentTextLayoutPositionInWindowF1C5BW0() {
        LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
        return textLayoutCoordinates != null ? LayoutCoordinatesKt.positionInWindow(textLayoutCoordinates) : Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
    }

    /* renamed from: getRawHandleDragPosition-F1C5BW0, reason: not valid java name */
    private final long m1262getRawHandleDragPositionF1C5BW0() {
    ...
    private final void m1266setRawHandleDragPositionk4lQ0M(long j) {
    ...
    public final long m1270getHandleDragPositionF1C5BW0() {
        if (OffsetKt.m3783isUnspecifiedk4lQ0M(m1262getRawHandleDragPositionF1C5BW0())) {
            return Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        }
        if (OffsetKt.m3783isUnspecifiedk4lQ0M(m1263getStartTextLayoutPositionInWindowF1C5BW0())) {
            return TextLayoutStateKt.m1222fromDecorationToTextLayoutUv8p0NA(this.textLayoutState, m1262getRawHandleDragPositionF1C5BW0());
        }
        return Offset.m3767plusMKHz9U(m1262getRawHandleDragPositionF1C5BW0(), Offset.m3766minusMKHz9U(m1263getStartTextLayoutPositionInWindowF1C5BW0(), m1260getCurrentTextLayoutPositionInWindowF1C5BW0()));
    }
    ...
    */
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState getCursorHandleState$foundation_release(boolean r14) {
        ...
        L17:
            ...
            boolean r6 = androidx.compose.ui.text.TextRange.m5942getCollapsedimpl(r6)
            if (r6 == 0) goto L48
        ...
        L49:
            ...
            return r5
        L53:
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState r5 = new androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState
            if (r14 == 0) goto L61
            androidx.compose.ui.geometry.Rect r6 = r13.getCursorRect()
            long r6 = r6.m3789getBottomCenterF1C5BW0()
            goto L67
        L61:
            androidx.compose.ui.geometry.Offset$Companion r6 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r6 = r6.m3777getUnspecifiedF1C5BW0()
        L67:
            r8 = r6
    ...
    private final boolean isCursorHandleInVisibleBounds() {
        ...
        try {
            long position = getCursorRect().m3789getBottomCenterF1C5BW0();
    ...
    public final Rect getCursorRect() {
        ...
        if (!TextRange.m5942getCollapsedimpl(value.getSelection())) {
            return Rect.INSTANCE.getZero();
        }
        Rect cursorRect = layoutResult.getCursorRect(TextRange.m5948getStartimpl(value.getSelection()));
        Density $this$getCursorRect_u24lambda_u242 = this.density;
        float cursorWidth = $this$getCursorRect_u24lambda_u242.mo373toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        ...
        float f = 2;
        float coercedCursorCenterX = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(cursorCenterX, IntSize.m6655getWidthimpl(layoutResult.getSize()) - (cursorWidth / f)), cursorWidth / f);
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00552(TextFieldSelectionState.this, this.$this_cursorHandleGestures, null), 1, null);
        ...
        static final class C00552 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            final /* synthetic */ PointerInputScope $this_cursorHandleGestures;
            int label;
            final /* synthetic */ TextFieldSelectionState this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00552(TextFieldSelectionState textFieldSelectionState, PointerInputScope pointerInputScope, Continuation<? super C00552> continuation) {
                super(2, continuation);
                this.this$0 = textFieldSelectionState;
                this.$this_cursorHandleGestures = pointerInputScope;
            }
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.cursorHandleGestures.2.3.1
                            ...
                            public final void m1277invokek4lQ0M(long it) {
    ...
    static final class C03632 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03632(PointerInputScope pointerInputScope, boolean z, Continuation<? super C03632> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03632 c03632 = TextFieldSelectionState.this.new C03632(this.$this_selectionHandleGestures, this.$isStartHandle, continuation);
            c03632.L$0 = obj;
            return c03632;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00572(this.$this_selectionHandleGestures, TextFieldSelectionState.this, this.$isStartHandle, null), 1, null);
        ...
        static final class C00572 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00572(PointerInputScope pointerInputScope, TextFieldSelectionState textFieldSelectionState, boolean z, Continuation<? super C00572> continuation) {
                super(2, continuation);
                this.$this_selectionHandleGestures = pointerInputScope;
                this.this$0 = textFieldSelectionState;
                this.$isStartHandle = z;
                ...
                switch (this.label) {
                    case 0:
                        ...
                        TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                            ...
                            public final void mo1241onEventk4lQ0M(long it) {
                                Handle handle;
                                ...
                                textFieldSelectionState2.m1271updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.m1261getHandlePositiontuRUvjQ(z)));
                            }
                        };
    ...
    public final Object selectionHandleGestures(PointerInputScope $this$selectionHandleGestures, boolean isStartHandle, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C03632($this$selectionHandleGestures, isStartHandle, null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    */
    public final java.lang.Object observeChanges(kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
        /*
            r7 = this;
            boolean r0 = r8 instanceof androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03561
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$observeChanges$1 r0 = (androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03561) r0
            int r1 = r0.label
    ...
    static final class C03572 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C03572(Continuation<? super C03572> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03572 c03572 = TextFieldSelectionState.this.new C03572(continuation);
            c03572.L$0 = obj;
            return c03572;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    return BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new C00562(TextFieldSelectionState.this, null), 3, null);
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
        }
        ...
        static final class C00562 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00562(TextFieldSelectionState textFieldSelectionState, Continuation<? super C00562> continuation) {
                super(2, continuation);
                this.this$0 = textFieldSelectionState;
            }
    ...
    static final class C03542 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03542 c03542 = TextFieldSelectionState.this.new C03542(continuation);
            c03542.L$0 = obj;
            return c03542;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C03542) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) {
            ...
            L4b:
                ...
                goto L27
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03542.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    public final Object detectTouchMode(PointerInputScope $this$detectTouchMode, Continuation<? super Unit> continuation) {
        Object objAwaitPointerEventScope = $this$detectTouchMode.awaitPointerEventScope(new C03542(null), continuation);
    ...
    public final Object detectTextFieldTapGestures(PointerInputScope $this$detectTextFieldTapGestures, MutableInteractionSource interactionSource, final Function0<Unit> function0, final Function0<Unit> function02, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress($this$detectTextFieldTapGestures, new C03522(interactionSource, this, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectTextFieldTapGestures.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1283invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1283invokek4lQ0M(long offset) {
                ...
                if (this.enabled && this.getIsFocused()) {
                    ...
                    long coercedOffset = this.textLayoutState.m1215coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset);
                    this.m1265placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1222fromDecorationToTextLayoutUv8p0NA(this.textLayoutState, coercedOffset));
                }
            }
        }, continuation);
    ...
    static final class C03522 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03522(MutableInteractionSource mutableInteractionSource, TextFieldSelectionState textFieldSelectionState, Continuation<? super C03522> continuation) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1282invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }
        ...
        public final Object m1282invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            C03522 c03522 = new C03522(this.$interactionSource, this.this$0, continuation);
            c03522.L$0 = pressGestureScope;
            c03522.J$0 = j;
            return c03522.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final boolean m1265placeCursorAtNearestOffsetk4lQ0M(long offset) {
        int index;
        IndexTransformationType type$iv;
        int iM5948getStartimpl;
        SelectionWedgeAffinity selectionWedgeAffinity;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null || (index = layoutResult.m5920getOffsetForPositionk4lQ0M(offset)) == -1) {
            return false;
        }
        ...
        long untransformed$iv = $this$getIndexTransformationType$iv.m1229mapFromTransformedjx7JFs(index);
        long retransformed$iv = $this$getIndexTransformationType$iv.m1232mapToTransformedGEjPoXI(untransformed$iv);
        if (TextRange.m5942getCollapsedimpl(untransformed$iv) && TextRange.m5942getCollapsedimpl(retransformed$iv)) {
            type$iv = IndexTransformationType.Untransformed;
        } else if (!TextRange.m5942getCollapsedimpl(untransformed$iv) && !TextRange.m5942getCollapsedimpl(retransformed$iv)) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
            case 1:
                iM5948getStartimpl = TextRange.m5948getStartimpl(untransformed$iv);
                break;
            case 2:
                iM5948getStartimpl = TextRange.m5948getStartimpl(untransformed$iv);
                break;
            case 3:
                Rect wedgeStartCursorRect = layoutResult.getCursorRect(TextRange.m5948getStartimpl(retransformed$iv));
                Rect wedgeEndCursorRect = layoutResult.getCursorRect(TextRange.m5943getEndimpl(retransformed$iv));
                if (MathUtilsKt.m1177findClosestRect9KIMszo(offset, wedgeStartCursorRect, wedgeEndCursorRect) < 0) {
                ...
                break;
            case 4:
                Rect wedgeStartCursorRect2 = layoutResult.getCursorRect(TextRange.m5948getStartimpl(retransformed$iv));
                Rect wedgeEndCursorRect2 = layoutResult.getCursorRect(TextRange.m5943getEndimpl(retransformed$iv));
                if (MathUtilsKt.m1177findClosestRect9KIMszo(offset, wedgeStartCursorRect2, wedgeEndCursorRect2) < 0) {
                    iM5948getStartimpl = TextRange.m5948getStartimpl(untransformed$iv);
                    break;
                } else {
                    iM5948getStartimpl = TextRange.m5943getEndimpl(untransformed$iv);
                    break;
                }
            default:
                throw new NoWhenBranchMatchedException();
        }
        int untransformedCursor = iM5948getStartimpl;
        long untransformedCursorRange = TextRangeKt.TextRange(untransformedCursor);
        if (TextRange.m5941equalsimpl0(untransformedCursorRange, this.textFieldState.getUntransformedText().getSelection()) && (selectionWedgeAffinity2 == null || Intrinsics.areEqual(selectionWedgeAffinity2, this.textFieldState.getSelectionWedgeAffinity()))) {
            return false;
        }
        this.textFieldState.m1235selectUntransformedCharsIn5zctL8(untransformedCursorRange);
    ...
    */
    public final java.lang.Object detectCursorHandleDragGestures(androidx.compose.ui.input.pointer.PointerInputScope r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) throws java.lang.Throwable {
        ...
        L3f:
            ...
            long r1 = r1.m3777getUnspecifiedF1C5BW0()
            r11.element = r1
            ...
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$detectCursorHandleDragGestures$3 r2 = new androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$detectCursorHandleDragGestures$3     // Catch: java.lang.Throwable -> L97
            r2.<init>()     // Catch: java.lang.Throwable -> L97
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2     // Catch: java.lang.Throwable -> L97
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$detectCursorHandleDragGestures$4 r3 = new androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$detectCursorHandleDragGestures$4     // Catch: java.lang.Throwable -> L97
            r3.<init>()     // Catch: java.lang.Throwable -> L97
            kotlin.jvm.functions.Function0 r3 = (kotlin.jvm.functions.Function0) r3     // Catch: java.lang.Throwable -> L97
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$detectCursorHandleDragGestures$5 r4 = new androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$detectCursorHandleDragGestures$5     // Catch: java.lang.Throwable -> L97
    ...
    public static final void detectCursorHandleDragGestures$onDragStop(Ref.LongRef cursorDragStart, Ref.LongRef cursorDragDelta, TextFieldSelectionState this$0) {
        if (OffsetKt.m3781isSpecifiedk4lQ0M(cursorDragStart.element)) {
            cursorDragStart.element = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
            cursorDragDelta.element = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
    ...
    private final class TextFieldMouseSelectionObserver implements MouseSelectionObserver {
        ...
        private long dragBeginPosition = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        ...
        public boolean mo1276onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
            if (TextFieldSelectionState.this.enabled) {
                if (!(TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0)) {
                    ...
                    long newSelection = m1272updateSelectionr1Wruf4(downPosition, adjustment, true);
                    this.dragBeginOffsetInText = TextRange.m5948getStartimpl(newSelection);
                    return true;
                }
            }
            return false;
        ...
        public boolean mo1273onDrag3MmeM6k(final long dragPosition, SelectionAdjustment adjustment) {
            if (TextFieldSelectionState.this.enabled) {
                if (!(TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0)) {
                    TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldMouseSelectionObserver$onDrag$1
                        ...
                        @Override // kotlin.jvm.functions.Function0
                        public final String invoke() {
                            return "Mouse.onDrag " + ((Object) Offset.m3770toStringimpl(dragPosition));
                        }
                    });
                    m1272updateSelectionr1Wruf4(dragPosition, adjustment, false);
                    return true;
                }
            }
            return false;
        ...
        private final long m1272updateSelectionr1Wruf4(long dragPosition, SelectionAdjustment adjustment, boolean isStartOfSelection) {
            Integer numValueOf = Integer.valueOf(this.dragBeginOffsetInText);
            int it = numValueOf.intValue();
            if (!(it >= 0)) {
                numValueOf = null;
            }
            int startOffset = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1217getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
            int endOffset = TextFieldSelectionState.this.textLayoutState.m1217getOffsetForPosition3MmeM6k(dragPosition, false);
            long newSelection = TextFieldSelectionState.this.m1268updateSelectionSsLRf8(TextFieldSelectionState.this.textFieldState.getVisualText(), startOffset, endOffset, false, adjustment, false, isStartOfSelection);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m5942getCollapsedimpl(newSelection)) {
                this.dragBeginOffsetInText = TextRange.m5948getStartimpl(newSelection);
            }
            if (TextRange.m5947getReversedimpl(newSelection)) {
                newSelection = TextFieldSelectionStateKt.m1285reverse5zctL8(newSelection);
            }
            TextFieldSelectionState.this.textFieldState.m1234selectCharsIn5zctL8(newSelection);
        ...
        public boolean mo1274onExtendk4lQ0M(long downPosition) {
        ...
        public boolean mo1275onExtendDragk4lQ0M(long dragPosition) {
    ...
    private final class TextFieldTextDragObserver implements TextDragObserver {
        ...
        private int dragBeginOffsetInText = -1;
        private long dragBeginPosition = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        private long dragTotalDistance = Offset.INSTANCE.m3778getZeroF1C5BW0();
        ...
        private final void onDragStop() {
            if (OffsetKt.m3781isSpecifiedk4lQ0M(this.dragBeginPosition)) {
                ...
                this.dragBeginOffsetInText = -1;
                this.dragBeginPosition = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
                this.dragTotalDistance = Offset.INSTANCE.m3778getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                TextFieldSelectionState.this.setDirectDragGestureInitiator(InputType.None);
                this.requestFocus.invoke();
            }
        ...
        public void mo1060onStartk4lQ0M(final long startPoint) {
            if (TextFieldSelectionState.this.enabled) {
                TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onStart$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Touch.onDragStart after longPress at " + ((Object) Offset.m3770toStringimpl(startPoint));
                    }
                });
                TextFieldSelectionState.this.m1271updateHandleDraggingUv8p0NA(this.actingHandle, startPoint);
                ...
                this.dragTotalDistance = Offset.INSTANCE.m3778getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                if (!TextFieldSelectionState.this.textLayoutState.m1218isPositionOnTextk4lQ0M(startPoint)) {
                    int offset = TextLayoutState.m1214getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                    HapticFeedback hapticFeedback = TextFieldSelectionState.this.hapticFeedBack;
                    if (hapticFeedback != null) {
                        hapticFeedback.mo4731performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m4740getTextHandleMove5zf0vsI());
                    }
                ...
                int offset2 = TextLayoutState.m1214getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                long newSelection = TextFieldSelectionState.m1269updateSelectionSsLRf8$default(TextFieldSelectionState.this, new TextFieldCharSequence(TextFieldSelectionState.this.textFieldState.getVisualText(), TextRange.INSTANCE.m5953getZerod9O1mEE(), null, null, 12, null), offset2, offset2, false, SelectionAdjustment.INSTANCE.getWord(), false, false, 96, null);
                TextFieldSelectionState.this.textFieldState.m1234selectCharsIn5zctL8(newSelection);
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                this.dragBeginOffsetInText = TextRange.m5948getStartimpl(newSelection);
            }
        ...
        public void mo1059onDragk4lQ0M(long delta) {
            ...
            if (TextFieldSelectionState.this.enabled) {
                ...
                this.dragTotalDistance = Offset.m3767plusMKHz9U(this.dragTotalDistance, delta);
                final long currentDragPosition = Offset.m3767plusMKHz9U(this.dragBeginPosition, this.dragTotalDistance);
                TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onDrag$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Touch.onDrag at " + ((Object) Offset.m3770toStringimpl(currentDragPosition));
                    }
                });
                if (this.dragBeginOffsetInText < 0 && !TextFieldSelectionState.this.textLayoutState.m1218isPositionOnTextk4lQ0M(currentDragPosition)) {
                    startOffset = TextLayoutState.m1214getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, this.dragBeginPosition, false, 2, null);
                    endOffset = TextLayoutState.m1214getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, currentDragPosition, false, 2, null);
                    ...
                    startOffset = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1217getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                    endOffset = TextFieldSelectionState.this.textLayoutState.m1217getOffsetForPosition3MmeM6k(currentDragPosition, false);
                    if (this.dragBeginOffsetInText < 0 && startOffset == endOffset) {
                        return;
                    }
                    adjustment = SelectionAdjustment.INSTANCE.getWord();
                    TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                ...
                long newSelection = TextFieldSelectionState.m1269updateSelectionSsLRf8$default(TextFieldSelectionState.this, TextFieldSelectionState.this.textFieldState.getVisualText(), startOffset, endOffset, false, adjustment, false, false, 64, null);
                if (this.dragBeginOffsetInText == -1 && !TextRange.m5942getCollapsedimpl(newSelection)) {
                    this.dragBeginOffsetInText = TextRange.m5948getStartimpl(newSelection);
                }
                if (TextRange.m5947getReversedimpl(newSelection)) {
                ...
                if (!TextRange.m5941equalsimpl0(newSelection, prevSelection)) {
                    if (TextRange.m5948getStartimpl(newSelection) != TextRange.m5948getStartimpl(prevSelection) && TextRange.m5943getEndimpl(newSelection) == TextRange.m5943getEndimpl(prevSelection)) {
                        handle = Handle.SelectionStart;
                    } else if (TextRange.m5948getStartimpl(newSelection) != TextRange.m5948getStartimpl(prevSelection) || TextRange.m5943getEndimpl(newSelection) == TextRange.m5943getEndimpl(prevSelection)) {
                        float newMiddle = (TextRange.m5948getStartimpl(newSelection) + TextRange.m5943getEndimpl(newSelection)) / 2.0f;
                        float prevMiddle = (TextRange.m5948getStartimpl(prevSelection) + TextRange.m5943getEndimpl(prevSelection)) / 2.0f;
                ...
                if (TextRange.m5942getCollapsedimpl(prevSelection) || !TextRange.m5942getCollapsedimpl(newSelection)) {
                    TextFieldSelectionState.this.textFieldState.m1234selectCharsIn5zctL8(newSelection);
                }
                TextFieldSelectionState.this.m1271updateHandleDraggingUv8p0NA(this.actingHandle, currentDragPosition);
            }
        }
    }
    ...
    */
    ...
    public static final void detectSelectionHandleDragGestures$onDragStop$5(Ref.LongRef dragBeginPosition, TextFieldSelectionState this$0, Ref.LongRef dragTotalDistance) {
        if (OffsetKt.m3781isSpecifiedk4lQ0M(dragBeginPosition.element)) {
            this$0.clearHandleDragging();
            dragBeginPosition.element = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
            dragTotalDistance.element = Offset.INSTANCE.m3778getZeroF1C5BW0();
    ...
    /* synthetic */ class C03593 extends FunctionReferenceImpl implements Function2<TextFieldCharSequence, CharSequence, Boolean> {
        public static final C03593 INSTANCE = new C03593();
    ...
    public final Object observeTextChanges(Continuation<? super Unit> continuation) {
        ...
        }), C03593.INSTANCE), 1).collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextChanges.4
    ...
    public final Object observeTextToolbarVisibility(Continuation<? super Unit> continuation) {
        Object objCollect = SnapshotStateKt.snapshotFlow(new Function0<Rect>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextToolbarVisibility.2
            ...
            public final Rect invoke() {
                Rect visibleBounds;
                boolean isCollapsed = TextRange.m5942getCollapsedimpl(TextFieldSelectionState.this.textFieldState.getVisualText().getSelection());
                ...
                if (textToolbarVisible) {
                    ...
                    if (visibleBounds2 != null) {
                        ...
                        Offset visibleBoundsTopLeftInRoot = textLayoutCoordinates2 != null ? Offset.m3751boximpl(textLayoutCoordinates2.mo5350localToRootMKHz9U(visibleBounds2.m3797getTopLeftF1C5BW0())) : null;
                        Intrinsics.checkNotNull(visibleBoundsTopLeftInRoot);
                        Rect visibleBoundsInRoot = RectKt.m3802Recttz77jQw(visibleBoundsTopLeftInRoot.getPackedValue(), visibleBounds2.m3795getSizeNHjbRc());
    ...
    public final Rect getContentRect() {
        ...
        if (TextRange.m5942getCollapsedimpl(text.getSelection())) {
            Rect cursorRect3 = getCursorRect();
            LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
            long topLeft = textLayoutCoordinates != null ? textLayoutCoordinates.mo5350localToRootMKHz9U(cursorRect3.m3797getTopLeftF1C5BW0()) : Offset.INSTANCE.m3778getZeroF1C5BW0();
            return RectKt.m3802Recttz77jQw(topLeft, cursorRect3.m3795getSizeNHjbRc());
        }
        LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
        long startOffset = textLayoutCoordinates2 != null ? textLayoutCoordinates2.mo5350localToRootMKHz9U(m1261getHandlePositiontuRUvjQ(true)) : Offset.INSTANCE.m3778getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates3 = getTextLayoutCoordinates();
        long endOffset = textLayoutCoordinates3 != null ? textLayoutCoordinates3.mo5350localToRootMKHz9U(m1261getHandlePositiontuRUvjQ(false)) : Offset.INSTANCE.m3778getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates4 = getTextLayoutCoordinates();
        float endTop = 0.0f;
        if (textLayoutCoordinates4 != null) {
            TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
            startTop = Offset.m3763getYimpl(textLayoutCoordinates4.mo5350localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (cursorRect2 = layoutResult.getCursorRect(TextRange.m5948getStartimpl(text.getSelection()))) == null) ? 0.0f : cursorRect2.getTop())));
        } else {
            startTop = 0.0f;
        }
        ...
        if (textLayoutCoordinates5 != null) {
            ...
            endTop = Offset.m3763getYimpl(textLayoutCoordinates5.mo5350localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (cursorRect = layoutResult2.getCursorRect(TextRange.m5943getEndimpl(text.getSelection()))) == null) ? 0.0f : cursorRect.getTop())));
        }
        return new Rect(Math.min(Offset.m3762getXimpl(startOffset), Offset.m3762getXimpl(endOffset)), Math.min(startTop, endTop), Math.max(Offset.m3762getXimpl(startOffset), Offset.m3762getXimpl(endOffset)), Math.max(Offset.m3763getYimpl(startOffset), Offset.m3763getYimpl(endOffset)));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState getSelectionHandleState$foundation_release(boolean r20, boolean r21) {
        /*
            r19 = this;
            r0 = r19
            if (r20 == 0) goto L7
        ...
        L18:
            ...
            boolean r5 = androidx.compose.ui.text.TextRange.m5942getCollapsedimpl(r3)
            if (r5 == 0) goto L2f
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState$Companion r5 = androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState.INSTANCE
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState r5 = r5.getHidden()
            return r5
        L2f:
            long r5 = r19.m1261getHandlePositiontuRUvjQ(r20)
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$InputType r7 = r19.getDirectDragGestureInitiator()
        ...
        L77:
            if (r20 == 0) goto L7e
            int r8 = androidx.compose.ui.text.TextRange.m5948getStartimpl(r3)
            goto L87
        L7e:
            int r8 = androidx.compose.ui.text.TextRange.m5943getEndimpl(r3)
            int r8 = r8 - r9
            int r8 = java.lang.Math.max(r8, r10)
        L87:
            androidx.compose.ui.text.style.ResolvedTextDirection r16 = r2.getBidiRunDirection(r8)
            boolean r17 = androidx.compose.ui.text.TextRange.m5947getReversedimpl(r3)
            if (r21 == 0) goto La6
            ...
            if (r9 == 0) goto La4
            r10 = 0
            long r9 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1221coerceIn3MmeM6k(r5, r9)
            r11 = r9
            goto Lad
        La4:
            r11 = r5
        ...
        La6:
            ...
            long r9 = r9.m3777getUnspecifiedF1C5BW0()
            r11 = r9
        Lad:
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState r18 = new androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState
            r10 = 1
            r15 = 0
            r9 = r18
            r13 = r16
    ...
    public final long m1261getHandlePositiontuRUvjQ(boolean isStartHandle) {
        int offset;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
        ...
        if (isStartHandle) {
            offset = TextRange.m5948getStartimpl(selection);
        } else {
            offset = TextRange.m5943getEndimpl(selection);
        }
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult, offset, isStartHandle, TextRange.m5947getReversedimpl(selection));
    }

    /* renamed from: updateHandleDragging-Uv8p0NA, reason: not valid java name */
    public final void m1271updateHandleDraggingUv8p0NA(Handle handle, long position) {
        setDraggingHandle(handle);
        m1266setRawHandleDragPositionk4lQ0M(position);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void markStartContentVisibleOffset() {
        m1267setStartTextLayoutPositionInWindowk4lQ0M(m1260getCurrentTextLayoutPositionInWindowF1C5BW0());
    }

    public final void clearHandleDragging() {
        setDraggingHandle(null);
        m1266setRawHandleDragPositionk4lQ0M(Offset.INSTANCE.m3777getUnspecifiedF1C5BW0());
        m1267setStartTextLayoutPositionInWindowk4lQ0M(Offset.INSTANCE.m3777getUnspecifiedF1C5BW0());
    }

    public final boolean canCut() {
        return (TextRange.m5942getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || !getEditable() || this.isPassword) ? false : true;
    }
    ...
    public final boolean canCopy() {
        return (TextRange.m5942getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || this.isPassword) ? false : true;
    }
    ...
    public final void paste() {
        ...
        TransferableContent remaining = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m336getClipboardkB6V9T0(), null, 8, null));
    ...
    public final boolean canSelectAll() {
        return TextRange.m5944getLengthimpl(this.textFieldState.getVisualText().getSelection()) != this.textFieldState.getVisualText().length();
    }
    ...
    public final void deselect() {
        if (!TextRange.m5942getCollapsedimpl(this.textFieldState.getVisualText().getSelection())) {
    ...
    static /* synthetic */ long m1269updateSelectionSsLRf8$default(TextFieldSelectionState textFieldSelectionState, TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, int i3, Object obj) {
        boolean z4;
        boolean z5;
        if ((i3 & 32) == 0) {
            z4 = z2;
        ...
        return textFieldSelectionState.m1268updateSelectionSsLRf8(textFieldCharSequence, i, i2, z, selectionAdjustment, z4, z5);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final long m1268updateSelectionSsLRf8(androidx.compose.foundation.text.input.TextFieldCharSequence r13, int r14, int r15, boolean r16, androidx.compose.foundation.text.selection.SelectionAdjustment r17, boolean r18, boolean r19) {
        /*
            r12 = this;
            long r0 = r13.getSelection()
            androidx.compose.ui.text.TextRange r0 = androidx.compose.ui.text.TextRange.m5936boximpl(r0)
            ...
            if (r19 != 0) goto L1e
            if (r18 != 0) goto L1c
            boolean r6 = androidx.compose.ui.text.TextRange.m5942getCollapsedimpl(r1)
            if (r6 != 0) goto L1e
        L1c:
            r1 = r4
            goto L1f
        ...
        L23:
            ...
            r10 = r16
            r11 = r17
            long r0 = r6.m1264getTextFieldSelectionqeG_v_k(r7, r8, r9, r10, r11)
            long r2 = r13.getSelection()
            boolean r2 = androidx.compose.ui.text.TextRange.m5941equalsimpl0(r0, r2)
            if (r2 == 0) goto L3c
            return r0
        L3c:
            boolean r2 = androidx.compose.ui.text.TextRange.m5947getReversedimpl(r0)
            long r6 = r13.getSelection()
            boolean r3 = androidx.compose.ui.text.TextRange.m5947getReversedimpl(r6)
            if (r2 == r3) goto L63
            r2 = r0
            r6 = 0
            int r7 = androidx.compose.ui.text.TextRange.m5943getEndimpl(r2)
            int r8 = androidx.compose.ui.text.TextRange.m5948getStartimpl(r2)
            long r2 = androidx.compose.ui.text.TextRangeKt.TextRange(r7, r8)
            long r6 = r13.getSelection()
            boolean r2 = androidx.compose.ui.text.TextRange.m5941equalsimpl0(r2, r6)
            if (r2 == 0) goto L63
            goto L64
        L63:
            r4 = r5
        L64:
            r2 = r4
            boolean r3 = r12.isInTouchMode()
            if (r3 == 0) goto L7c
            if (r2 != 0) goto L7c
            r3 = r12
            androidx.compose.ui.hapticfeedback.HapticFeedback r4 = r3.hapticFeedBack
            if (r4 == 0) goto L7d
            ...
            int r5 = r5.m4740getTextHandleMove5zf0vsI()
            r4.mo4731performHapticFeedbackCdsT49E(r5)
            goto L7d
        L7c:
            r3 = r12
        L7d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.m1268updateSelectionSsLRf8(androidx.compose.foundation.text.input.TextFieldCharSequence, int, int, boolean, androidx.compose.foundation.text.selection.SelectionAdjustment, boolean, boolean):long");
    }

    /* renamed from: getTextFieldSelection-qeG_v_k, reason: not valid java name */
    private final long m1264getTextFieldSelectionqeG_v_k(int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return TextRange.INSTANCE.m5953getZerod9O1mEE();
        }
        ...
        SelectionLayout selectionLayout = SelectionLayoutKt.m1347getTextFieldSelectionLayoutRcvTLA(layoutResult, rawStartOffset, rawEndOffset, this.previousRawDragOffset, previousSelection != null ? previousSelection.getPackedValue() : TextRange.INSTANCE.m5953getZerod9O1mEE(), previousSelection == null, isStartHandle);
        ...
        long result = adjustment.adjust(selectionLayout).m1335toTextRanged9O1mEE();
