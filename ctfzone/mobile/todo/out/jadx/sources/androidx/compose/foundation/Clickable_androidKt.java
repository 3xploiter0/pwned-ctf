...
public final class Clickable_androidKt {
    ...
    public static final boolean m283isPressZmokQxo(KeyEvent $this$isPress) {
        return KeyEventType.m5061equalsimpl0(KeyEvent_androidKt.m5069getTypeZmokQxo($this$isPress), KeyEventType.INSTANCE.m5065getKeyDownCS__XNY()) && m282isEnterZmokQxo($this$isPress);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m281isClickZmokQxo(KeyEvent $this$isClick) {
        return KeyEventType.m5061equalsimpl0(KeyEvent_androidKt.m5069getTypeZmokQxo($this$isClick), KeyEventType.INSTANCE.m5066getKeyUpCS__XNY()) && m282isEnterZmokQxo($this$isClick);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m282isEnterZmokQxo(KeyEvent $this$isEnter) {
        switch (Key_androidKt.m5075getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m5068getKeyZmokQxo($this$isEnter))) {
            case 23:
            case 66:
            case 160:
                return true;
