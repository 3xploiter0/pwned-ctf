...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m6373from8_81llA(ColorKt.m4054lerpjxsXWHM(start.mo6250getColor0d7_KjU(), stop.mo6250getColor0d7_KjU(), fraction));
        }
        if ((start instanceof BrushStyle) && (stop instanceof BrushStyle)) {
    ...
    public static final long m6372modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        return Color.m4001copywmQWz5c($this$modulate_u2dDxMtmZc, (14 & 1) != 0 ? Color.m4005getAlphaimpl($this$modulate_u2dDxMtmZc) : Color.m4005getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, (14 & 2) != 0 ? Color.m4009getRedimpl($this$modulate_u2dDxMtmZc) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl($this$modulate_u2dDxMtmZc) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl($this$modulate_u2dDxMtmZc) : 0.0f);
    }
