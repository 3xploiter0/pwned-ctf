...
public final class PullToRefreshStateImpl$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo757onPreScrollOzD1aCk(long available, int source) {
        ...
        if (NestedScrollSource.m5093equalsimpl0(source, NestedScrollSource.INSTANCE.m5101getDragWNlRxjI()) && Offset.m3763getYimpl(available) < 0.0f) {
            return this.this$0.m2848consumeAvailableOffsetMKHz9U(available);
        }
        return Offset.INSTANCE.m3778getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo756onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        ...
        L4c:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.pulltorefresh.PullToRefreshStateImpl$nestedScrollConnection$1.mo756onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
