...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List measurables, long constraints) {
            return (MeasureResult) m5496measure3p2s80s($this$measure_u2d3p2s80s, (List<? extends Measurable>) measurables, constraints);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m5496measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo5495getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m6593getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        ...
        if (!this.nodes.m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int type$iv3 = NodeKind.m5574constructorimpl(8);
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (owner == null) {
            ...
            LayoutNode parent$ui_release = getParent$ui_release();
            InlineClassHelperKt.throwIllegalStateExceptionForNullCheck(sbAppend.append(parent$ui_release != null ? debugTreeToString$default(parent$ui_release, 0, 1, null) : null).toString());
        ...
        if (this.nodes.m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long innerContentConstraints = getInnerCoordinator$ui_release().m5558getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m6436getHasFixedWidthimpl(innerContentConstraints) && Constraints.m6435getHasFixedHeightimpl(innerContentConstraints);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List measurables, int width) {
            return ((Number) m5497maxIntrinsicHeight($this$maxIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List measurables, int height) {
            return ((Number) m5498maxIntrinsicWidth($this$maxIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List measurables, int width) {
            return ((Number) m5499minIntrinsicHeight($this$minIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List measurables, int height) {
            return ((Number) m5500minIntrinsicWidth($this$minIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m5500minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m5499minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m5498maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m5497maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setDensity(Density value) {
        if (!Intrinsics.areEqual(this.density, value)) {
            ...
            for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
                ...
                if ((node.getKindSet() & NodeKind.m5574constructorimpl(16)) != 0) {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof DrawModifierNode) {
                            ...
                            if ((kindSet != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                                ...
                                while (node$iv$iv$iv2 != null) {
                                    Modifier.Node next$iv$iv = node$iv$iv$iv2;
                                    if (((next$iv$iv.getKindSet() & type$iv4) != 0 ? i : 0) == 0) {
                                        type$iv3 = type$iv4;
                                    } else {
                                        count$iv$iv2++;
                                        if (count$iv$iv2 == i) {
    ...
    public void setViewConfiguration(ViewConfiguration value) {
        ...
        if (!Intrinsics.areEqual(this.viewConfiguration, value)) {
            ...
            int type$iv4 = NodeKind.m5574constructorimpl(16);
            int i4 = 0;
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        int type$iv4 = NodeKind.m5574constructorimpl(32768);
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(512))) {
    ...
    public static /* synthetic */ void m5487hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        boolean z3;
        boolean z4;
        if ((i & 4) == 0) {
            z3 = z;
        ...
        layoutNode.m5491hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z4);
    }

    /* renamed from: hitTest-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m5491hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        long positionInWrapped = NodeCoordinator.m5545fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null);
        getOuterCoordinator$ui_release().m5561hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release$default, reason: not valid java name */
    public static /* synthetic */ void m5488hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        boolean z3;
        boolean z4;
        if ((i & 4) == 0) {
            z3 = z;
        ...
        layoutNode.m5492hitTestSemanticsM_7yMNQ$ui_release(j, hitTestResult, z3, z4);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m5492hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        long positionInWrapped = NodeCoordinator.m5545fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null);
        getOuterCoordinator$ui_release().m5561hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), positionInWrapped, hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        ...
        int $this$or_u2d64DMado$iv = NodeKind.m5574constructorimpl(1024) | NodeKind.m5574constructorimpl(2048);
        if (nodeChain.has$ui_release($this$or_u2d64DMado$iv | NodeKind.m5574constructorimpl(4096))) {
            NodeChain this_$iv = this.nodes;
            for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
                Modifier.Node it = node$iv;
                int kind$iv = (it.getKindSet() & NodeKind.m5574constructorimpl(1024)) != 0 ? 1 : 0;
                int kind$iv2 = (it.getKindSet() & NodeKind.m5574constructorimpl(2048)) != 0 ? 1 : 0;
                if ((kind$iv | kind$iv2 | ((it.getKindSet() & NodeKind.m5574constructorimpl(4096)) == 0 ? 0 : 1)) != 0) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain this_$iv3 = this.nodes;
        char c2 = 256;
        int type$iv4 = NodeKind.m5574constructorimpl(256);
        int i3 = 0;
        if ((this_$iv3.getAggregateChildKindSet() & type$iv4) == 0) {
            return;
        }
            ...
            if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                ...
                while (nodePop != null) {
                    if (nodePop instanceof GlobalPositionAwareModifierNode) {
                        ...
                        this_$iv2 = this_$iv3;
                        i2 = i3;
                        it.onGloballyPositioned(DelegatableNodeKt.m5461requireCoordinator64DMado(it, NodeKind.m5574constructorimpl(256)));
                        type$iv2 = type$iv4;
                    } else {
                        this_$iv2 = this_$iv3;
                        i2 = i3;
    ...
    public static /* synthetic */ boolean m5489lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5508getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m5493lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m5493lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null && this.lookaheadRoot != null) {
            LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
            Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
            return lookaheadPassDelegate$ui_release.m5512remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default, reason: not valid java name */
    public static /* synthetic */ boolean m5490remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5507getLastConstraintsDWUhwKw();
        }
        return layoutNode.m5494remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m5494remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null) {
            if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
                clearSubtreeIntrinsicsUsage$ui_release();
            }
            return getMeasurePassDelegate$ui_release().m5516remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }
    ...
    public final void invalidateSubtree(boolean isRootOfInvalidation) {
        ...
        NodeChain this_$iv4 = this.nodes;
        char c3 = 2;
        int type$iv4 = NodeKind.m5574constructorimpl(2);
        if ((this_$iv4.getAggregateChildKindSet() & type$iv4) != 0) {
            Modifier.Node node$iv$iv$iv = this_$iv4.getHead();
            while (node$iv$iv$iv != null) {
                Modifier.Node it$iv$iv = node$iv$iv$iv;
                if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof LayoutModifierNode) {
                            ...
                            c2 = 2;
                            OwnedLayer layer = DelegatableNodeKt.m5461requireCoordinator64DMado(it, NodeKind.m5574constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                            this_$iv2 = this_$iv4;
    ...
    public void forceRemeasure() {
        ...
        Constraints lastConstraints = this.layoutDelegate.m5507getLastConstraintsDWUhwKw();
        if (lastConstraints != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo5630measureAndLayout0kLqBqw(this, lastConstraints.getValue());
                return;
            }
            return;
        }
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(4)) && !this.nodes.m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(2))) {
            return true;
        }
        NodeChain this_$iv = this.nodes;
        for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
            Modifier.Node it = node$iv;
            int kind$iv = (it.getKindSet() & NodeKind.m5574constructorimpl(2)) != 0 ? 1 : 0;
            if (kind$iv != 0 && DelegatableNodeKt.m5461requireCoordinator64DMado(it, NodeKind.m5574constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((it.getKindSet() & NodeKind.m5574constructorimpl(4)) != 0) {
                return true;
            }
        }
        return true;
