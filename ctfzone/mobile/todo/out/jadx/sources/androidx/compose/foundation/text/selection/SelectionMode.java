...
public enum SelectionMode {
    Vertical { // from class: androidx.compose.foundation.text.selection.SelectionMode.Vertical
        ...
        public int mo1388compare3MmeM6k$foundation_release(long position, Rect bounds) {
            ...
            if (Offset.m3763getYimpl(position) < bounds.getTop()) {
                return -1;
            }
            return (Offset.m3762getXimpl(position) >= bounds.getLeft() || Offset.m3763getYimpl(position) >= bounds.getBottom()) ? 1 : -1;
        }
    },
    Horizontal { // from class: androidx.compose.foundation.text.selection.SelectionMode.Horizontal
        ...
        public int mo1388compare3MmeM6k$foundation_release(long position, Rect bounds) {
            ...
            if (Offset.m3762getXimpl(position) < bounds.getLeft()) {
                return -1;
            }
            return (Offset.m3763getYimpl(position) >= bounds.getTop() || Offset.m3762getXimpl(position) >= bounds.getRight()) ? 1 : -1;
        }
    };
