...
public final class SpanStyleKt {
    ...
    private static final long DefaultBackgroundColor = Color.INSTANCE.m4038getTransparent0d7_KjU();
    private static final long DefaultColor = Color.INSTANCE.m4029getBlack0d7_KjU();
    private static final TextForegroundStyle DefaultColorForegroundStyle = TextForegroundStyle.INSTANCE.m6373from8_81llA(DefaultColor);

    /* renamed from: lerpTextUnitInheritable-C3pnCVY, reason: not valid java name */
    public static final long m5904lerpTextUnitInheritableC3pnCVY(long a, long b, float t) {
        if (TextUnitKt.m6696isUnspecifiedR2X_6o(a) || TextUnitKt.m6696isUnspecifiedR2X_6o(b)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m6668boximpl(a), TextUnit.m6668boximpl(b), t)).getPackedValue();
        }
        return TextUnitKt.m6698lerpC3pnCVY(a, b, t);
    }
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float fraction) {
        ...
        long jM5904lerpTextUnitInheritableC3pnCVY = m5904lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), fraction);
        ...
        long jM5904lerpTextUnitInheritableC3pnCVY2 = m5904lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), fraction);
        BaselineShift baselineShift = start.getBaselineShift();
        float fM6242unboximpl = baselineShift != null ? baselineShift.m6242unboximpl() : BaselineShift.m6237constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float fM6249lerpjWV1Mfo = BaselineShiftKt.m6249lerpjWV1Mfo(fM6242unboximpl, baselineShift2 != null ? baselineShift2.m6242unboximpl() : BaselineShift.m6237constructorimpl(0.0f), fraction);
        ...
        long jM4054lerpjxsXWHM = ColorKt.m4054lerpjxsXWHM(start.getBackground(), stop.getBackground(), fraction);
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        long fontSize = TextUnitKt.m6696isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis fontSynthesisM6066boximpl = FontSynthesis.m6066boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6075getAllGVVA2EU());
        ...
        if (TextUnitKt.m6696isUnspecifiedR2X_6o(style.getLetterSpacing())) {
            letterSpacing = DefaultLetterSpacing;
        } else {
            letterSpacing = style.getLetterSpacing();
        }
        BaselineShift baselineShift = style.getBaselineShift();
        BaselineShift baselineShiftM6236boximpl = BaselineShift.m6236boximpl(baselineShift != null ? baselineShift.m6242unboximpl() : BaselineShift.INSTANCE.m6246getNoney9eOQZs());
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM6055boximpl, fontSynthesisM6066boximpl, fontFamily2, str, letterSpacing, baselineShiftM6236boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
