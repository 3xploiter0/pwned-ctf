...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m6417boximpl(AnimatedVisibilityState.INSTANCE.m6424getEnterjXw82LU()), AnimatedVisibilityState.m6417boximpl(AnimatedVisibilityState.INSTANCE.m6425getExitjXw82LU())});
    ...
    public Transition<Boolean> m6410getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m6410getAnimationObject().getTransitions(), 0);
