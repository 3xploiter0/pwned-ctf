...
public final class TextFieldTextLayoutModifierNode extends Modifier.Node implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        TextLayoutResult result = this.textLayoutState.m1219layoutWithNewMeasureInputshBUhpc($this$measure_u2d3p2s80s, $this$measure_u2d3p2s80s.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), constraints);
        final Placeable placeable = measurable.mo5339measureBRTryo0(Constraints.INSTANCE.m6447fitPrioritizingWidthZbe2FdA(IntSize.m6655getWidthimpl(result.getSize()), IntSize.m6655getWidthimpl(result.getSize()), IntSize.m6654getHeightimpl(result.getSize()), IntSize.m6654getHeightimpl(result.getSize())));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            fM6485constructorimpl = $this$measure_u2d3p2s80s.mo370toDpu2uoSUM(TextDelegateKt.ceilToIntPx(result.getLineBottom(0)));
        } else {
            fM6485constructorimpl = Dp.m6485constructorimpl(0);
        }
        textLayoutState.m1220setMinHeightForSingleLineField0680j_4(fM6485constructorimpl);
        ...
        int iM6655getWidthimpl = IntSize.m6655getWidthimpl(result.getSize());
        int iM6654getHeightimpl = IntSize.m6654getHeightimpl(result.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(iM6655getWidthimpl, iM6654getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$measure$1
            {
                super(1);
            }
