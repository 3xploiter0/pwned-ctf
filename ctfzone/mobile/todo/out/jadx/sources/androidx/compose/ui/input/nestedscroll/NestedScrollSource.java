...
public final class NestedScrollSource {
    ...
    private static final int UserInput = m5091constructorimpl(1);
    private static final int SideEffect = m5091constructorimpl(2);
    private static final int Drag = UserInput;
    private static final int Fling = SideEffect;
    private static final int Relocate = m5091constructorimpl(3);
    private static final int Wheel = UserInput;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m5090boximpl(int i) {
    ...
    public static String m5095toStringimpl(int arg0) {
        if (m5093equalsimpl0(arg0, UserInput)) {
            return "UserInput";
        }
        if (m5093equalsimpl0(arg0, SideEffect)) {
            return "SideEffect";
        }
        if (m5093equalsimpl0(arg0, Relocate)) {
            return "Relocate";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5097getDragWNlRxjI$annotations() {
        }
        ...
        public static /* synthetic */ void m5098getFlingWNlRxjI$annotations() {
        }

        @Deprecated(message = "Do not use. Will be removed in the future.")
        /* renamed from: getRelocate-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m5099getRelocateWNlRxjI$annotations() {
        }

        @Deprecated(message = "This has been replaced by UserInput.", replaceWith = @ReplaceWith(expression = "NestedScrollSource.UserInput", imports = {"import androidx.compose.ui.input.nestedscroll.NestedScrollSource.Companion.UserInput"}))
        /* renamed from: getWheel-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m5100getWheelWNlRxjI$annotations() {
        }
