...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m4394getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((maybeChangedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m4389getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
            setPivotY(TransformOrigin.m4390getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            if ((maybeChangedFields & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m4057toArgb8_81llA(scope.getAmbientShadowColor()));
            }
            if ((maybeChangedFields & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m4057toArgb8_81llA(scope.getSpotShadowColor()));
            }
        }
        ...
        if ((32768 & maybeChangedFields) != 0) {
            int iMo4189getCompositingStrategyNrFUSI = scope.getCompositingStrategy();
            if (CompositingStrategy.m4088equalsimpl0(iMo4189getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m4094getOffscreenNrFUSI())) {
                setLayerType(2, null);
                z = true;
            } else if (CompositingStrategy.m4088equalsimpl0(iMo4189getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m4093getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
            } else {
                setLayerType(0, null);
                z = true;
    ...
    public void mo5625resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m4389getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m4390getPivotFractionYimpl(this.mTransformOrigin) * height);
            updateOutlineResolver();
    ...
    public void mo5624movegyyYBs(long position) {
        int left = IntOffset.m6613getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m6614getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo5623mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM5706calculateInverseMatrixbWbORWo = this.matrixCache.m5706calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m4240mapMKHz9U(this.matrixCache.m5707calculateMatrixGrdbGEg(this), point);
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    public void mapBounds(MutableRect rect, boolean inverse) {
        if (inverse) {
            float[] matrix = this.matrixCache.m5706calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m4242mapimpl(this.matrixCache.m5707calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo5626transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4251timesAssign58bKbWc(matrix, this.matrixCache.m5707calculateMatrixGrdbGEg(this));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* renamed from: inverseTransform-58bKbWc */
    public void mo5621inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = this.matrixCache.m5706calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
