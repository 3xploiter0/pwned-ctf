                    ...
                    ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(958604965, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity.setParameterizedContent.1.1
                        ...
                        public final void invoke(Composer $composer2, int $changed2) {
                            ...
                            if (($changed2 & 3) != 2 || !$composer2.getSkipping()) {
                                ...
                                Function2<Composer, Integer, Unit> function2M6407getLambda1$ui_tooling_release = ComposableSingletons$PreviewActivity_androidKt.INSTANCE.m6407getLambda1$ui_tooling_release();
                                ...
                                if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                                    value$iv2 = new Function0<Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity$setParameterizedContent$1$1$1$1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(0);
                                        }
                                ...
                                FloatingActionButtonKt.m1582ExtendedFloatingActionButtonwqdebIU(function2M6407getLambda1$ui_tooling_release, (Function0) value$iv2, null, null, null, null, 0L, 0L, null, $composer2, 6, 508);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
