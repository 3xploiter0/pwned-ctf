...
public final class AnchoredDraggableState<T> {
    ...
    static final class C02322 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02322(AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C02322> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02322(this.this$0, this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C02322) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C00162 extends SuspendLambda implements Function2<DraggableAnchors<T>, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> $block;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00162(Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C00162> continuation) {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    }, new C00162(this.$block, this.this$0, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    c02322 = this;
                    break;
            ...
            T tClosestAnchor = c02322.this$0.getAnchors().closestAnchor(c02322.this$0.getOffset());
            if (tClosestAnchor != null) {
                float closestAnchorOffset = c02322.this$0.getAnchors().positionOf(tClosestAnchor);
                boolean isAtClosestAnchor = Math.abs(c02322.this$0.getOffset() - closestAnchorOffset) < 0.5f;
                if (isAtClosestAnchor && c02322.this$0.getConfirmValueChange$foundation_release().invoke(tClosestAnchor).booleanValue()) {
                    c02322.this$0.setSettledValue(tClosestAnchor);
                    c02322.this$0.setCurrentValue(tClosestAnchor);
                }
            }
    ...
    public final Object anchoredDrag(MutatePriority dragPriority, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super Unit> continuation) {
        Object objMutate = this.dragMutex.mutate(dragPriority, new C02322(this, function3, null), continuation);
    ...
    */
    public final java.lang.Object anchoredDrag(T r8, androidx.compose.foundation.MutatePriority r9, kotlin.jvm.functions.Function4<? super androidx.compose.foundation.gestures.AnchoredDragScope, ? super androidx.compose.foundation.gestures.DraggableAnchors<T>, ? super T, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) throws java.lang.Throwable {
        ...
        L47:
            ...
            r11.L$0 = r2     // Catch: java.lang.Throwable -> L61
            r6 = 1
            r11.label = r6     // Catch: java.lang.Throwable -> L61
            java.lang.Object r4 = r4.mutate(r9, r5, r11)     // Catch: java.lang.Throwable -> L61
            if (r4 != r1) goto L5c
            return r1
        L5c:
            r8 = r2
