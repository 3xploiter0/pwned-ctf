...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope scope) {
        super(scope);
        this.surfaceSize = IntSize.INSTANCE.m6660getZeroYbymL2g();
    ...
    public final void m222setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        int w = width;
        int h = height;
        if (!IntSize.m6653equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6660getZeroYbymL2g())) {
            w = IntSize.m6655getWidthimpl(this.surfaceSize);
            h = IntSize.m6654getHeightimpl(this.surfaceSize);
