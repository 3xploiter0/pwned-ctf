...
final class AnchoredDraggableNode<T> extends DragGestureNode {
                    ...
                    Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1
                        ...
                        public final void invoke2(DragEvent.DragDelta dragDelta) {
                            if (((AnchoredDraggableNode) anchoredDraggableNode).overscrollEffect == null) {
                                AnchoredDragScope.dragTo$default($this$anchoredDrag, ((AnchoredDraggableNode) anchoredDraggableNode).state.newOffsetForDelta$foundation_release(anchoredDraggableNode.m387toFloatk4lQ0M(anchoredDraggableNode.m385reverseIfNeededMKHz9U(dragDelta.getDelta()))), 0.0f, 2, null);
                                return;
                            }
                            ...
                            long jM385reverseIfNeededMKHz9U = anchoredDraggableNode.m385reverseIfNeededMKHz9U(dragDelta.getDelta());
                            int iM5105getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m5105getUserInputWNlRxjI();
                            ...
                            overscrollEffect.mo218applyToScrollRhakbz0(jM385reverseIfNeededMKHz9U, iM5105getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                    return Offset.m3751boximpl(m392invokeMKHz9U(offset.getPackedValue()));
                                }

                                /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                                public final long m392invokeMKHz9U(long deltaForDrag) {
                                    float dragOffset = ((AnchoredDraggableNode) anchoredDraggableNode2).state.newOffsetForDelta$foundation_release(anchoredDraggableNode2.m387toFloatk4lQ0M(deltaForDrag));
                                    long consumedDelta = anchoredDraggableNode2.m388toOffsettuRUvjQ(dragOffset - ((AnchoredDraggableNode) anchoredDraggableNode2).state.requireOffset());
    ...
    public final long m388toOffsettuRUvjQ(float $this$toOffset_u2dtuRUvjQ) {
    ...
    public final long m389toVelocityadjELrA(float $this$toVelocity_u2dadjELrA) {
    ...
    public final float m386toFloatTH1AsA0(long $this$toFloat_u2dTH1AsA0) {
        return this.orientation == Orientation.Vertical ? Velocity.m6723getYimpl($this$toFloat_u2dTH1AsA0) : Velocity.m6722getXimpl($this$toFloat_u2dTH1AsA0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m387toFloatk4lQ0M(long $this$toFloat_u2dk_u2d4lQ0M) {
        return this.orientation == Orientation.Vertical ? Offset.m3763getYimpl($this$toFloat_u2dk_u2d4lQ0M) : Offset.m3762getXimpl($this$toFloat_u2dk_u2d4lQ0M);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-AH228Gc, reason: not valid java name */
    public final long m384reverseIfNeededAH228Gc(long $this$reverseIfNeeded_u2dAH228Gc) {
        return Velocity.m6728timesadjELrA($this$reverseIfNeeded_u2dAH228Gc, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m385reverseIfNeededMKHz9U(long $this$reverseIfNeeded_u2dMK_u2dHz9U) {
        return Offset.m3769timestuRUvjQ($this$reverseIfNeeded_u2dMK_u2dHz9U, isReverseDirection() ? -1.0f : 1.0f);
    }
}
