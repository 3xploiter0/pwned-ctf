...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo284createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m3831getWidthimpl(size), Size.m3828getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo3895opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.INSTANCE.m4295getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        float cutoutOffset = density.mo373toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m3831getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m3828getHeightimpl(cutoutSize) / 2.0f;
        float cutoutStartY = -cutoutRadius;
        OutlineKt.addOutline($this$addCutoutShape, this.cutoutShape.mo284createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        $this$addCutoutShape.mo3898translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            float edgeRadius = density.mo373toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius);
