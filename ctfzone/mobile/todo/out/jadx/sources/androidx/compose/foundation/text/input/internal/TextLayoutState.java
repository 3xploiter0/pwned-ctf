...
public final class TextLayoutState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6483boximpl(Dp.m6485constructorimpl(0)), null, 2, null);
    ...
    public final float m1216getMinHeightForSingleLineFieldD9Ej5fM() {
        State $this$getValue$iv = this.minHeightForSingleLineField;
        return ((Dp) $this$getValue$iv.getValue()).m6499unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1220setMinHeightForSingleLineField0680j_4(float f) {
        MutableState $this$setValue$iv = this.minHeightForSingleLineField;
        $this$setValue$iv.setValue(Dp.m6483boximpl(f));
    }
    ...
    public final TextLayoutResult m1219layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult layoutResult = this.layoutCache.m1208layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
    ...
    public static /* synthetic */ int m1214getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1217getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1217getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        if (coerceInVisibleBounds) {
            coercedPosition = m1215coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(position);
        } else {
            coercedPosition = position;
        }
        long relativePosition = TextLayoutStateKt.m1222fromDecorationToTextLayoutUv8p0NA(this, coercedPosition);
        return layoutResult.m5920getOffsetForPositionk4lQ0M(relativePosition);
    }

    /* renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m1218isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long relativeOffset = TextLayoutStateKt.m1222fromDecorationToTextLayoutUv8p0NA(this, m1215coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset));
        int line = layoutResult.getLineForVerticalPosition(Offset.m3763getYimpl(relativeOffset));
        return Offset.m3762getXimpl(relativeOffset) >= layoutResult.getLineLeft(line) && Offset.m3762getXimpl(relativeOffset) <= layoutResult.getLineRight(line);
    }
    ...
    */
    public final long m1215coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long r7) {
        /*
            r6 = this;
        ...
        L2a:
            r0 = r3
            long r1 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1221coerceIn3MmeM6k(r7, r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextLayoutState.m1215coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long):long");
    }
}
