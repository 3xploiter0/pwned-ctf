...
public final class LayoutKt {
    ...
    public static final void Layout(Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, MeasurePolicy measurePolicy, Composer $composer, int $changed, int i) {
        ...
        Composer $this$Layout_u24lambda_u240 = Updater.m3496constructorimpl($composer);
        Updater.m3503setimpl($this$Layout_u24lambda_u240, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m3503setimpl($this$Layout_u24lambda_u240, localMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        ...
        Updater.m3503setimpl($this$Layout_u24lambda_u240, materialized, ComposeUiNode.INSTANCE.getSetModifier());
    ...
    public static final void Layout(Modifier modifier, MeasurePolicy measurePolicy, Composer $composer, int $changed, int i) {
        ...
        Composer $this$Layout_u24lambda_u241 = Updater.m3496constructorimpl($composer);
        Updater.m3503setimpl($this$Layout_u24lambda_u241, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m3503setimpl($this$Layout_u24lambda_u241, localMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        Updater.m3503setimpl($this$Layout_u24lambda_u241, materialized, ComposeUiNode.INSTANCE.getSetModifier());
        Function2 block$iv = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
    ...
    */
            ...
            public final void invoke(Composer $composer, int $changed) {
                ...
                if (($changed & 3) != 2 || !$composer.getSkipping()) {
                    ...
                    while (index$iv < size) {
                        ...
                        Composer $this$invoke_u24lambda_u241_u24lambda_u240 = Updater.m3496constructorimpl($composer);
                        Function2 block$iv = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
    ...
    public static final Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf(final Modifier modifier) {
        return ComposableLambdaKt.composableLambdaInstance(-1586257396, true, new Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt.materializerOf.1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
                m5363invokeDeg8D_g(skippableUpdater.getComposer(), composer, num.intValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Deg8D_g, reason: not valid java name */
            public final void m5363invokeDeg8D_g(Composer $this$null, Composer $composer, int $changed) {
                ...
                Composer $this$invoke_Deg8D_g_u24lambda_u240 = Updater.m3496constructorimpl($this$null);
                Updater.m3503setimpl($this$invoke_Deg8D_g_u24lambda_u240, materialized, ComposeUiNode.INSTANCE.getSetModifier());
                Function2 block$iv = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
    ...
    public static final Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf(final Modifier modifier) {
        return ComposableLambdaKt.composableLambdaInstance(-55743822, true, new Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt$materializerOfWithCompositionLocalInjection$1
            ...
            @Override // kotlin.jvm.functions.Function3
            public /* bridge */ /* synthetic */ Unit invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
                m5364invokeDeg8D_g(skippableUpdater.getComposer(), composer, num.intValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Deg8D_g, reason: not valid java name */
            public final void m5364invokeDeg8D_g(Composer $this$null, Composer $composer, int $changed) {
