    ...
    public static final void LazySaveableStateHolderProvider(final Function3<? super SaveableStateHolder, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 3) != 2 || !$composer2.getSkipping()) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new Function0<LazySaveableStateHolder>() { // from class: androidx.compose.foundation.lazy.layout.LazySaveableStateHolderKt$LazySaveableStateHolderProvider$holder$1$1
                    {
                        super(0);
                    }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            final LazySaveableStateHolder holder = (LazySaveableStateHolder) RememberSaveableKt.m3589rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) value$iv, $composer2, 0, 4);
