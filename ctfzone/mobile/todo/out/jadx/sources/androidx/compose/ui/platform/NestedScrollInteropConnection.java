...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo757onPreScrollOzD1aCk(long available, int source) {
        if (!this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5725getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5727toViewTypeGyEprt8(source))) {
            return Offset.INSTANCE.m3778getZeroF1C5BW0();
        }
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3762getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3763getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m5727toViewTypeGyEprt8(source));
        return NestedScrollInteropConnectionKt.m5726toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
    ...
    public long mo483onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3762getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3763getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3762getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3763getYimpl(available)), null, NestedScrollInteropConnectionKt.m5727toViewTypeGyEprt8(source), this.consumedScrollCache);
        return NestedScrollInteropConnectionKt.m5726toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
    ...
    public Object mo756onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        long result;
        if (this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6722getXimpl(available)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6723getYimpl(available)))) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m6733getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m6713boximpl(result);
    }
    ...
    public Object mo482onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        long result;
        if (this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6722getXimpl(available)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6723getYimpl(available)), true)) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m6733getZero9UxMQ8M();
        }
