...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) throws Throwable {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM3751boximpl = currentBounds != null ? Offset.m3751boximpl(currentBounds.m3797getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM3751boximpl);
            long packedValue = offsetM3751boximpl.getPackedValue();
            float fM3762getXimpl = Offset.m3762getXimpl(packedValue);
            float fM3763getYimpl = Offset.m3763getYimpl(packedValue);
            ...
            if (it != null) {
                ...
                try {
                    ...
                    $this$clipPath_KD09W0M_u24lambda_u245$iv.mo4482clipPathmtrdDE(it, clipOp$iv);
                    drawScope.getDrawContext().getTransform().translate(fM3762getXimpl, fM3763getYimpl);
                } catch (Throwable th) {
                    th = th;
                }
                try {
    ...
    public final long m107getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m6667toSizeozmzZPI(layoutCoordinatesInvoke.mo5347getSizeYbymL2g());
    }
    ...
    public final long m106calculateLookaheadOffsetF1C5BW0() {
        ...
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5348localPositionOfR5De75A(c, Offset.INSTANCE.m3778getZeroF1C5BW0());
    }
