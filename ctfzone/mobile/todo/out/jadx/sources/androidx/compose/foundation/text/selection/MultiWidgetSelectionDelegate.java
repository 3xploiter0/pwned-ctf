...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult $this$lastVisibleOffset) {
        ...
        if (this._previousTextLayoutResult != $this$lastVisibleOffset) {
            if (!$this$lastVisibleOffset.getDidOverflowHeight() || $this$lastVisibleOffset.getMultiParagraph().getDidExceedMaxLines()) {
                ...
                iCoerceAtLeast = finalVisibleLine - 1;
            } else {
                int finalVisibleLine2 = RangesKt.coerceAtMost($this$lastVisibleOffset.getLineForVerticalPosition(IntSize.m6654getHeightimpl($this$lastVisibleOffset.getSize())), $this$lastVisibleOffset.getLineCount() - 1);
                while (finalVisibleLine2 >= 0 && $this$lastVisibleOffset.getLineTop(finalVisibleLine2) >= IntSize.m6654getHeightimpl($this$lastVisibleOffset.getSize())) {
                    finalVisibleLine2--;
                }
                iCoerceAtLeast = RangesKt.coerceAtLeast(finalVisibleLine2, 0);
            }
            int lastVisibleLine2 = iCoerceAtLeast;
            this._previousLastVisibleOffset = $this$lastVisibleOffset.getLineEnd(lastVisibleLine2, true);
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long relativePosition = builder.getContainerCoordinates().mo5348localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3778getZeroF1C5BW0());
        long localPosition = Offset.m3766minusMKHz9U(builder.getCurrentPosition(), relativePosition);
        if (!OffsetKt.m3783isUnspecifiedk4lQ0M(builder.getPreviousHandlePosition())) {
            localPreviousHandlePosition = Offset.m3766minusMKHz9U(builder.getPreviousHandlePosition(), relativePosition);
        } else {
            localPreviousHandlePosition = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        }
        MultiWidgetSelectionDelegateKt.m1331appendSelectableInfoParwq6A(builder, textLayoutResult, localPosition, localPreviousHandlePosition, getSelectableId());
    }
    ...
    public long mo1329getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResult;
    ...
    public long mo1330getRangeOfLineContainingjx7JFs(int offset) {
