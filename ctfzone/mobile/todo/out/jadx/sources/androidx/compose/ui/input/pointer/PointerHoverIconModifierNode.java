...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public void mo209onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m5159equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5163getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m5159equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5164getExit7fucELk())) {
                onExit();
            }
        }
    }
    ...
    private final void displayIcon() {
        ...
        if (pointerHoverIconModifierNodeFindOverridingAncestorNode == null || (iconToUse = pointerHoverIconModifierNodeFindOverridingAncestorNode.icon) == null) {
            iconToUse = this.icon;
        }
    ...
    private final PointerHoverIconModifierNode findOverridingAncestorNode() {
        ...
        TraversableNodeKt.traverseAncestors(this, new Function1<PointerHoverIconModifierNode, Boolean>() { // from class: androidx.compose.ui.input.pointer.PointerHoverIconModifierNode.findOverridingAncestorNode.1
            ...
            public final Boolean invoke(PointerHoverIconModifierNode pointerHoverIconModifierNode2) {
                if (pointerHoverIconModifierNode2.getOverrideDescendants() && pointerHoverIconModifierNode2.cursorInBoundsOfNode) {
    ...
    private final void displayIconFromAncestorNodeWithCursorInBoundsOrDefaultIcon() {
        ...
        TraversableNodeKt.traverseAncestors(this, new Function1<PointerHoverIconModifierNode, Boolean>() { // from class: androidx.compose.ui.input.pointer.PointerHoverIconModifierNode.displayIconFromAncestorNodeWithCursorInBoundsOrDefaultIcon.1
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(PointerHoverIconModifierNode pointerHoverIconModifierNode2) {
                if (pointerHoverIconModifierNode.element == null && pointerHoverIconModifierNode2.cursorInBoundsOfNode) {
                    pointerHoverIconModifierNode.element = pointerHoverIconModifierNode2;
                } else if (pointerHoverIconModifierNode.element != null && pointerHoverIconModifierNode2.getOverrideDescendants() && pointerHoverIconModifierNode2.cursorInBoundsOfNode) {
                    pointerHoverIconModifierNode.element = pointerHoverIconModifierNode2;
                }
                return true;
            }
