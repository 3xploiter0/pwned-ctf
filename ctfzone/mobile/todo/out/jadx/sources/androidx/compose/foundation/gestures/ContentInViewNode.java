...
public final class ContentInViewNode extends Modifier.Node implements BringIntoViewResponder, LayoutAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    private long viewportSize = IntSize.INSTANCE.m6660getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        if (IntSize.m6653equalsimpl0(this.viewportSize, IntSize.INSTANCE.m6660getZeroYbymL2g())) {
            throw new IllegalStateException("Expected BringIntoViewRequester to not be used before parents are placed.".toString());
        }
        return m397computeDestinationO0kMr_c(localRect, this.viewportSize);
    }
    ...
    public Object bringChildIntoView(Function0<Rect> function0, Continuation<? super Unit> continuation) {
        ...
        boolean z = false;
        if (rectInvoke != null && !m399isMaxVisibleO0kMr_c$default(this, rectInvoke, 0L, 1, null)) {
            z = true;
        }
        if (!z) {
    ...
    public void mo363onRemeasuredozmzZPI(long size) {
        ...
        if (m395compareToTemP2vQ(size, oldSize) < 0 && (focusedChild = getFocusedChildBounds()) != null) {
            ...
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m398isMaxVisibleO0kMr_c(previousFocusedChildBounds, oldSize) && !m398isMaxVisibleO0kMr_c(focusedChild, size)) {
    ...
    public final Rect getFocusedChildBounds() {
        ...
        LayoutCoordinates it = this.focusedChild;
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
            }
    ...
    public final void launchAnimation() {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(animationState, bringIntoViewSpec, null), 1, null);
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    CoroutineScope $this$launch = (CoroutineScope) anonymousClass2.L$0;
                    Job animationJob = JobKt.getJob($this$launch.getCoroutineContext());
                    try {
                        ContentInViewNode.this.isAnimationRunning = true;
                        anonymousClass2.label = 1;
                        if (ContentInViewNode.this.scrollingLogic.scroll(MutatePriority.Default, new AnonymousClass1(anonymousClass2.$animationState, ContentInViewNode.this, anonymousClass2.$bringIntoViewSpec, animationJob, null), anonymousClass2) == coroutine_suspended) {
                    ...
                    case 0:
                        ...
                        Function1<Float, Unit> function1 = new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewNode.launchAnimation.2.1.1
                            ...
                            public final void invoke(float delta) {
                                ...
                                ScrollingLogic $this$invoke_u24lambda_u240 = contentInViewNode.scrollingLogic;
                                float consumedScroll = $this$invoke_u24lambda_u240.m498toFloatk4lQ0M($this$invoke_u24lambda_u240.m496reverseIfNeededMKHz9U($this$scroll.mo454scrollByOzD1aCk($this$invoke_u24lambda_u240.m496reverseIfNeededMKHz9U($this$invoke_u24lambda_u240.m499toOffsettuRUvjQ(adjustedDelta)), NestedScrollSource.INSTANCE.m5105getUserInputWNlRxjI()))) * scrollMultiplier;
                        ...
                        if (updatableAnimationState.animateToZero(function1, new Function0<Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewNode.launchAnimation.2.1.2
                            ...
                            public final void invoke2() {
                                ...
                                while (true) {
                                    ...
                                    if (!(bounds == null ? true : ContentInViewNode.m399isMaxVisibleO0kMr_c$default(contentInViewNode3, bounds, 0L, 1, null))) {
                                        break;
                                    }
                                    ...
                                    continuation.resumeWith(Result.m6956constructorimpl(unit));
                                }
                                if (contentInViewNode2.trackingFocusedChild) {
                                    Rect focusedChildBounds = contentInViewNode2.getFocusedChildBounds();
                                    if (focusedChildBounds != null && ContentInViewNode.m399isMaxVisibleO0kMr_c$default(contentInViewNode2, focusedChildBounds, 0L, 1, null)) {
    ...
    public final float calculateScrollDelta(BringIntoViewSpec bringIntoViewSpec) {
        ...
        long size = IntSizeKt.m6667toSizeozmzZPI(this.viewportSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return bringIntoViewSpec.calculateScrollDistance(rectangleToMakeVisible.getTop(), rectangleToMakeVisible.getBottom() - rectangleToMakeVisible.getTop(), Size.m3828getHeightimpl(size));
            case 2:
                return bringIntoViewSpec.calculateScrollDistance(rectangleToMakeVisible.getLeft(), rectangleToMakeVisible.getRight() - rectangleToMakeVisible.getLeft(), Size.m3831getWidthimpl(size));
            default:
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                if (bounds != null) {
                    ...
                    if (m396compareToiLBOSCw(bounds.m3795getSizeNHjbRc(), IntSizeKt.m6667toSizeozmzZPI(this.viewportSize)) > 0) {
    ...
    private final Rect m397computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m3799translatek4lQ0M(Offset.m3771unaryMinusF1C5BW0(m400relocationOffsetBMxPBkI(childBounds, containerSize)));
    }

    /* renamed from: isMaxVisible-O0kMr_c$default, reason: not valid java name */
    static /* synthetic */ boolean m399isMaxVisibleO0kMr_c$default(ContentInViewNode contentInViewNode, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = contentInViewNode.viewportSize;
        }
        return contentInViewNode.m398isMaxVisibleO0kMr_c(rect, j);
    }

    /* renamed from: isMaxVisible-O0kMr_c, reason: not valid java name */
    private final boolean m398isMaxVisibleO0kMr_c(Rect $this$isMaxVisible_u2dO0kMr_c, long size) {
        long relocationOffset = m400relocationOffsetBMxPBkI($this$isMaxVisible_u2dO0kMr_c, size);
        return Math.abs(Offset.m3762getXimpl(relocationOffset)) <= 0.5f && Math.abs(Offset.m3763getYimpl(relocationOffset)) <= 0.5f;
    }

    /* renamed from: relocationOffset-BMxPBkI, reason: not valid java name */
    private final long m400relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long size = IntSizeKt.m6667toSizeozmzZPI(containerSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return OffsetKt.Offset(0.0f, requireBringIntoViewSpec().calculateScrollDistance(childBounds.getTop(), childBounds.getBottom() - childBounds.getTop(), Size.m3828getHeightimpl(size)));
            case 2:
                return OffsetKt.Offset(requireBringIntoViewSpec().calculateScrollDistance(childBounds.getLeft(), childBounds.getRight() - childBounds.getLeft(), Size.m3831getWidthimpl(size)), 0.0f);
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m395compareToTemP2vQ(long $this$compareTo_u2dTemP2vQ, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Intrinsics.compare(IntSize.m6654getHeightimpl($this$compareTo_u2dTemP2vQ), IntSize.m6654getHeightimpl(other));
            case 2:
                return Intrinsics.compare(IntSize.m6655getWidthimpl($this$compareTo_u2dTemP2vQ), IntSize.m6655getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m396compareToiLBOSCw(long $this$compareTo_u2diLBOSCw, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Float.compare(Size.m3828getHeightimpl($this$compareTo_u2diLBOSCw), Size.m3828getHeightimpl(other));
            case 2:
                return Float.compare(Size.m3831getWidthimpl($this$compareTo_u2diLBOSCw), Size.m3831getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
