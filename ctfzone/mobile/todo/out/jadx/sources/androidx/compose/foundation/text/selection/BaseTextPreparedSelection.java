...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m1327setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            $this$deselect_u24lambda_u241.setCursor(TextRange.m5943getEndimpl($this$deselect_u24lambda_u241.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m5942getCollapsedimpl($this$collapseLeftOr_u24lambda_u244.selection)) {
                ...
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m5946getMinimpl($this$collapseLeftOr_u24lambda_u244.selection));
            } else {
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m5945getMaximpl($this$collapseLeftOr_u24lambda_u244.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T collapseRightOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m5942getCollapsedimpl($this$collapseRightOr_u24lambda_u245.selection)) {
                ...
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m5945getMaximpl($this$collapseRightOr_u24lambda_u245.selection));
            } else {
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m5946getMinimpl($this$collapseRightOr_u24lambda_u245.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m5943getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m5943getEndimpl(this.selection));
    }
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            int paragraphStart = StringHelpersKt.findParagraphStart($this$moveCursorPrevByParagraph_u24lambda_u2416.getText$foundation_release(), TextRange.m5946getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2416.selection));
            if (paragraphStart == TextRange.m5946getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2416.selection) && paragraphStart != 0) {
    ...
    public final T moveCursorNextByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            int paragraphEnd = StringHelpersKt.findParagraphEnd($this$moveCursorNextByParagraph_u24lambda_u2417.getText$foundation_release(), TextRange.m5945getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2417.selection));
            if (paragraphEnd == TextRange.m5945getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2417.selection) && paragraphEnd != $this$moveCursorNextByParagraph_u24lambda_u2417.getText$foundation_release().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2428.selection = TextRangeKt.TextRange(TextRange.m5948getStartimpl($this$selectMovement_u24lambda_u2428.originalSelection), TextRange.m5943getEndimpl($this$selectMovement_u24lambda_u2428.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            ...
            if (TextRange.m5943getEndimpl(currentWord) <= currentOffset) {
                ...
                return this.offsetMapping.transformedToOriginal(TextRange.m5943getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m5922getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m5948getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m5948getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m5920getOffsetForPositionk4lQ0M(OffsetKt.Offset(x, y)));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5943getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5946getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5945getMaximpl(this.selection));
    }
