...
public final class Html_androidKt {
    ...
    private static final void addSpans(AnnotatedString.Builder $this$addSpans, Spanned spanned, TextLinkStyles linkStyles, LinkInteractionListener linkInteractionListener) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            addSpan($this$addSpans, element$iv, TextRange.m5948getStartimpl(range), TextRange.m5943getEndimpl(range), linkStyles, linkInteractionListener);
        }
    }
    ...
    private static final void addSpan(AnnotatedString.Builder $this$addSpan, Object span, int start, int end, TextLinkStyles linkStyles, LinkInteractionListener linkInteractionListener) {
        ...
        if (!(span instanceof AbsoluteSizeSpan)) {
            ...
            if (span instanceof SubscriptSpan) {
                $this$addSpan.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m6236boximpl(BaselineShift.INSTANCE.m6247getSubscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), start, end);
                return;
            }
            if (span instanceof SuperscriptSpan) {
                $this$addSpan.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m6236boximpl(BaselineShift.INSTANCE.m6248getSuperscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), start, end);
                return;
            }
    ...
    private static final ParagraphStyle toParagraphStyle(AlignmentSpan $this$toParagraphStyle) {
        int alignment;
        Layout.Alignment alignment2 = $this$toParagraphStyle.getAlignment();
        switch (alignment2 == null ? -1 : WhenMappings.$EnumSwitchMapping$0[alignment2.ordinal()]) {
            case 1:
                alignment = TextAlign.INSTANCE.m6357getStarte0LSkKk();
                break;
            case 2:
                alignment = TextAlign.INSTANCE.m6352getCentere0LSkKk();
                break;
            case 3:
                alignment = TextAlign.INSTANCE.m6353getEnde0LSkKk();
                break;
            default:
                alignment = TextAlign.INSTANCE.m6358getUnspecifiede0LSkKk();
                break;
        }
        return new ParagraphStyle(alignment, 0, 0L, (TextIndent) null, (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 510, (DefaultConstructorMarker) null);
    }
    ...
    private static final SpanStyle toSpanStyle(StyleSpan $this$toSpanStyle) {
        switch ($this$toSpanStyle.getStyle()) {
            ...
            case 2:
                return new SpanStyle(0L, 0L, (FontWeight) null, FontStyle.m6055boximpl(FontStyle.INSTANCE.m6064getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65527, (DefaultConstructorMarker) null);
            case 3:
                return new SpanStyle(0L, 0L, FontWeight.INSTANCE.getBold(), FontStyle.m6055boximpl(FontStyle.INSTANCE.m6064getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65523, (DefaultConstructorMarker) null);
            default:
                return null;
        }
    }
    ...
    private static final SpanStyle toSpanStyle(TypefaceSpan $this$toSpanStyle) {
        ...
        if (Intrinsics.areEqual(family, FontFamily.INSTANCE.getCursive().getName())) {
            fontFamily = FontFamily.INSTANCE.getCursive();
        } else if (Intrinsics.areEqual(family, FontFamily.INSTANCE.getMonospace().getName())) {
            fontFamily = FontFamily.INSTANCE.getMonospace();
        } else if (Intrinsics.areEqual(family, FontFamily.INSTANCE.getSansSerif().getName())) {
            fontFamily = FontFamily.INSTANCE.getSansSerif();
        } else {
            fontFamily = Intrinsics.areEqual(family, FontFamily.INSTANCE.getSerif().getName()) ? FontFamily.INSTANCE.getSerif() : optionalFontFamilyFromName($this$toSpanStyle.getFamily());
        }
