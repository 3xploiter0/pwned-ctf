...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m2822copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
        return new TopAppBarColors((containerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (scrolledContainerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (scrolledContainerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? scrolledContainerColor : this.scrolledContainerColor, (navigationIconContentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (navigationIconContentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? navigationIconContentColor : this.navigationIconContentColor, (titleContentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (titleContentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? titleContentColor : this.titleContentColor, actionIconContentColor != Color.INSTANCE.m4039getUnspecified0d7_KjU() ? actionIconContentColor : this.actionIconContentColor, null);
    }

    /* renamed from: containerColor-vNxB06k$material3_release, reason: not valid java name */
    public final long m2821containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4054lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m4010hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4010hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4010hashCodeimpl(this.titleContentColor)) * 31) + Color.m4010hashCodeimpl(this.actionIconContentColor);
    }
}
