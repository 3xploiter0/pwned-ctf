...
final class ThreeLine {
    ...
    private static final float MinHeight = Dp.m6485constructorimpl(88);
    ...
    private static final float IconThreeLineVerticalPadding = Dp.m6485constructorimpl(16);
    ...
    private static final float ThreeLineBaselineFirstOffset = Dp.m6485constructorimpl(28);
    private static final float ThreeLineBaselineSecondOffset = Dp.m6485constructorimpl(20);
    private static final float ThreeLineBaselineThirdOffset = Dp.m6485constructorimpl(20);
    private static final float ThreeLineTrailingTopPadding = Dp.m6485constructorimpl(16);
