...
public final class TransformedTextFieldState {
    ...
    private static final long m1225mapFromTransformedxdX6G0(long j, OffsetMappingCalculator offsetMappingCalculator) {
        return Companion.m1238mapFromTransformedxdX6G0(j, offsetMappingCalculator);
    }

    @JvmStatic
    /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
    private static final long m1226mapToTransformedXGyztTk(long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity) {
        return Companion.m1239mapToTransformedXGyztTk(j, offsetMappingCalculator, selectionWedgeAffinity);
    }
    ...
    public final void placeCursorBeforeCharAt(int transformedOffset) {
        m1234selectCharsIn5zctL8(TextRangeKt.TextRange(transformedOffset));
    }

    /* renamed from: selectCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1234selectCharsIn5zctL8(long transformedRange) {
        long untransformedRange = m1230mapFromTransformedGEjPoXI(transformedRange);
        m1235selectUntransformedCharsIn5zctL8(untransformedRange);
    }

    /* renamed from: selectUntransformedCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1235selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        $this$selectUntransformedCharsIn_5zc_tL8_u24lambda_u242.setSelection(TextRange.m5948getStartimpl(untransformedRange), TextRange.m5943getEndimpl(untransformedRange));
    ...
    public final void m1228highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long untransformedRange = m1230mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState $this$iv = this.textFieldState;
        InputTransformation inputTransformation$iv = this.inputTransformation;
        TextFieldEditUndoBehavior undoBehavior$iv = TextFieldEditUndoBehavior.MergeIfPossible;
        ...
        $this$highlightCharsIn_7RAjNK8_u24lambda_u243.m1144setHighlightK7f2yys(type, TextRange.m5948getStartimpl(untransformedRange), TextRange.m5943getEndimpl(untransformedRange));
        $this$iv.commitEditAsUser(inputTransformation$iv, true, undoBehavior$iv);
    }
    ...
    public final void deleteSelectedText() {
        ...
        $this$deleteSelectedText_u24lambda_u246.delete(TextRange.m5946getMinimpl($this$deleteSelectedText_u24lambda_u246.m1143getSelectiond9O1mEE()), TextRange.m5945getMaximpl($this$deleteSelectedText_u24lambda_u246.m1143getSelectiond9O1mEE()));
        $this$deleteSelectedText_u24lambda_u246.setSelection(TextRange.m5946getMinimpl($this$deleteSelectedText_u24lambda_u246.m1143getSelectiond9O1mEE()), TextRange.m5946getMinimpl($this$deleteSelectedText_u24lambda_u246.m1143getSelectiond9O1mEE()));
        $this$iv.commitEditAsUser(inputTransformation$iv, true, undoBehavior$iv);
    }

    /* renamed from: replaceText-M8tDOmk$default, reason: not valid java name */
    public static /* synthetic */ void m1227replaceTextM8tDOmk$default(TransformedTextFieldState transformedTextFieldState, CharSequence charSequence, long j, TextFieldEditUndoBehavior textFieldEditUndoBehavior, boolean z, int i, Object obj) {
        ...
        transformedTextFieldState.m1233replaceTextM8tDOmk(charSequence, j, textFieldEditUndoBehavior2, z2);
    }

    /* renamed from: replaceText-M8tDOmk, reason: not valid java name */
    public final void m1233replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        ...
        long selection = m1230mapFromTransformedGEjPoXI(range);
        $this$replaceText_M8tDOmk_u24lambda_u247.replace(TextRange.m5946getMinimpl(selection), TextRange.m5945getMaximpl(selection), newText);
        int cursor = TextRange.m5946getMinimpl(selection) + newText.length();
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior) {
        ...
        long selection = $this$replaceSelectedText_u24lambda_u248.m1143getSelectiond9O1mEE();
        $this$replaceSelectedText_u24lambda_u248.replace(TextRange.m5946getMinimpl(selection), TextRange.m5945getMaximpl(selection), newText);
        int cursor = TextRange.m5946getMinimpl(selection) + newText.length();
    ...
    public final void collapseSelectionToMax() {
        ...
        $this$collapseSelectionToMax_u24lambda_u249.setSelection(TextRange.m5945getMaximpl($this$collapseSelectionToMax_u24lambda_u249.m1143getSelectiond9O1mEE()), TextRange.m5945getMaximpl($this$collapseSelectionToMax_u24lambda_u249.m1143getSelectiond9O1mEE()));
        $this$iv.commitEditAsUser(inputTransformation$iv, true, undoBehavior$iv);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        $this$collapseSelectionToEnd_u24lambda_u2410.setSelection(TextRange.m5943getEndimpl($this$collapseSelectionToEnd_u24lambda_u2410.m1143getSelectiond9O1mEE()), TextRange.m5943getEndimpl($this$collapseSelectionToEnd_u24lambda_u2410.m1143getSelectiond9O1mEE()));
        $this$iv.commitEditAsUser(inputTransformation$iv, true, undoBehavior$iv);
    }
    ...
    public final long m1231mapToTransformedjx7JFs(int offset) {
        TransformedText value;
        ...
        long intermediateRange = presentMapping != null ? presentMapping.m1181mapFromSourcejx7JFs(offset) : TextRangeKt.TextRange(offset);
        if (visualMapping == null) {
            return intermediateRange;
        }
        OffsetMappingCalculator it = visualMapping;
        return Companion.m1239mapToTransformedXGyztTk(intermediateRange, it, getSelectionWedgeAffinity());
    }

    /* renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public final long m1232mapToTransformedGEjPoXI(long range) {
        ...
        if (presentMapping != null) {
            ...
            intermediateRange = Companion.m1240mapToTransformedXGyztTk$default(Companion, range, it, null, 4, null);
        } else {
        ...
        return Companion.m1239mapToTransformedXGyztTk(intermediateRange, it2, getSelectionWedgeAffinity());
    }

    /* renamed from: mapFromTransformed--jx7JFs, reason: not valid java name */
    public final long m1229mapFromTransformedjx7JFs(int offset) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator visualMapping = null;
        ...
        long intermediateOffset = visualMapping != null ? visualMapping.m1180mapFromDestjx7JFs(offset) : TextRangeKt.TextRange(offset);
        if (presentMapping == null) {
            return intermediateOffset;
        }
        OffsetMappingCalculator it = presentMapping;
        return Companion.m1238mapFromTransformedxdX6G0(intermediateOffset, it);
    }

    /* renamed from: mapFromTransformed-GEjPoXI, reason: not valid java name */
    public final long m1230mapFromTransformedGEjPoXI(long range) {
        long intermediateRange;
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        ...
        if (visualMapping == null) {
            ...
            OffsetMappingCalculator it = visualMapping;
            intermediateRange = Companion.m1238mapFromTransformedxdX6G0(range, it);
        }
        if (presentMapping == null) {
            return intermediateRange;
        }
        OffsetMappingCalculator it2 = presentMapping;
        return Companion.m1238mapFromTransformedxdX6G0(intermediateRange, it2);
    }
    ...
    */
    ...
    static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            long jM1239mapToTransformedXGyztTk = m1239mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange composition = untransformedValue.getComposition();
            if (composition != null) {
                long it = composition.getPackedValue();
                textRangeM5936boximpl = TextRange.m5936boximpl(TransformedTextFieldState.Companion.m1239mapToTransformedXGyztTk(it, offsetMappingCalculator, wedgeAffinity));
            }
            TextFieldCharSequence transformedTextWithSelection = buffer.m1105toTextFieldCharSequenceudt6zUU$foundation_release(jM1239mapToTransformedXGyztTk, textRangeM5936boximpl);
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            TextFieldCharSequence transformedTextWithSelection = new TextFieldCharSequence(transformedText, jM1239mapToTransformedXGyztTk, textRangeM5936boximpl, null, 8, null);
            return new TransformedText(transformedTextWithSelection, offsetMappingCalculator);
        }

        /* renamed from: mapToTransformed-XGyztTk$default, reason: not valid java name */
        static /* synthetic */ long m1240mapToTransformedXGyztTk$default(Companion companion, long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity, int i, Object obj) {
            if ((i & 4) != 0) {
        ...
        @JvmStatic
        /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
        public final long m1239mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity wedgeAffinity) {
            long transformedRange;
            long transformedStart = mapping.m1181mapFromSourcejx7JFs(TextRange.m5948getStartimpl(range));
            long transformedEnd = TextRange.m5942getCollapsedimpl(range) ? transformedStart : mapping.m1181mapFromSourcejx7JFs(TextRange.m5943getEndimpl(range));
            int transformedMin = Math.min(TextRange.m5946getMinimpl(transformedStart), TextRange.m5946getMinimpl(transformedEnd));
            int transformedMax = Math.max(TextRange.m5945getMaximpl(transformedStart), TextRange.m5945getMaximpl(transformedEnd));
            if (TextRange.m5947getReversedimpl(range)) {
            ...
            if (TextRange.m5942getCollapsedimpl(range) && !TextRange.m5942getCollapsedimpl(transformedRange)) {
                ...
                switch (startAffinity == null ? -1 : WhenMappings.$EnumSwitchMapping$0[startAffinity.ordinal()]) {
                    ...
                    case 1:
                        return TextRangeKt.TextRange(TextRange.m5948getStartimpl(transformedRange));
                    case 2:
                        return TextRangeKt.TextRange(TextRange.m5943getEndimpl(transformedRange));
                }
            }
        ...
        @JvmStatic
        /* renamed from: mapFromTransformed-xdX6-G0, reason: not valid java name */
        public final long m1238mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long untransformedStart = mapping.m1180mapFromDestjx7JFs(TextRange.m5948getStartimpl(range));
            long untransformedEnd = TextRange.m5942getCollapsedimpl(range) ? untransformedStart : mapping.m1180mapFromDestjx7JFs(TextRange.m5943getEndimpl(range));
            int untransformedMin = Math.min(TextRange.m5946getMinimpl(untransformedStart), TextRange.m5946getMinimpl(untransformedEnd));
            int untransformedMax = Math.max(TextRange.m5945getMaximpl(untransformedStart), TextRange.m5945getMaximpl(untransformedEnd));
            if (TextRange.m5947getReversedimpl(range)) {
