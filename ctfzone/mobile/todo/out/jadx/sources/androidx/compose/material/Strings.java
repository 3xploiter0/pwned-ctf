...
public final class Strings {
    ...
    private static final int NavigationMenu = m1660constructorimpl(0);
    private static final int CloseDrawer = m1660constructorimpl(1);
    private static final int CloseSheet = m1660constructorimpl(2);
    private static final int DefaultErrorMessage = m1660constructorimpl(3);
    private static final int ExposedDropdownMenu = m1660constructorimpl(4);
    private static final int SliderRangeStart = m1660constructorimpl(5);
    private static final int SliderRangeEnd = m1660constructorimpl(6);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Strings m1659boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1660constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1661equalsimpl(this.value, obj);
    }
