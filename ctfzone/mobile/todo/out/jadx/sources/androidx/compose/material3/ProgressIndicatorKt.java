...
public final class ProgressIndicatorKt {
    ...
    private static final float SemanticsBoundsPadding = Dp.m6485constructorimpl(10);
    private static final Modifier IncreaseSemanticsBounds = PaddingKt.m683paddingVpY3zN4$default(SemanticsModifierKt.semantics(LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ProgressIndicatorKt$IncreaseSemanticsBounds$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
            return m2311invoke3p2s80s(measureScope, measurable, constraints.getValue());
        }

        /* renamed from: invoke-3p2s80s, reason: not valid java name */
        public final MeasureResult m2311invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
            final int paddingPx = $this$layout.mo367roundToPx0680j_4(ProgressIndicatorKt.SemanticsBoundsPadding);
    ...
    private static final float LinearIndicatorHeight = LinearProgressIndicatorTokens.INSTANCE.m3150getTrackHeightD9Ej5fM();

    /* renamed from: LinearProgressIndicator-_5eSR-E, reason: not valid java name */
    public static final void m2298LinearProgressIndicator_5eSRE(final Function0<Float> function0, Modifier modifier, long color, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long color2;
        long trackColor2;
        int strokeCap2;
        ...
        Modifier modifier4;
        long color3;
        Composer $composer2 = $composer.startRestartGroup(-1796992155);
        ComposerKt.sourceInformation($composer2, "C(LinearProgressIndicator)P(2,1,0:c#ui.graphics.Color,4:c#ui.graphics.Color,3:c#ui.graphics.StrokeCap)81@3829L11,82@3892L16,85@4010L31,89@4162L102,93@4334L196,86@4046L484:ProgressIndicator.kt#uh7d8r");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($dirty & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    strokeCap2 = ProgressIndicatorDefaults.INSTANCE.m2289getLinearStrokeCapKaPHkGw();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1796992155, $dirty, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:84)");
            }
            $composer2.startReplaceableGroup(-1348540816);
            ComposerKt.sourceInformation($composer2, "CC(remember):ProgressIndicator.kt#9igjgp");
            ...
            $composer2.startReplaceableGroup(-1348540664);
            ComposerKt.sourceInformation($composer2, "CC(remember):ProgressIndicator.kt#9igjgp");
            boolean invalid$iv2 = $composer2.changed(coercedProgress);
            Modifier modifier5 = modifier3;
            Object value$iv3 = $composer2.rememberedValue();
            if (invalid$iv2 || value$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv3 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
            ...
            $composer2.endReplaceableGroup();
            Modifier modifierM728sizeVpY3zN4 = SizeKt.m728sizeVpY3zN4(SemanticsModifierKt.semantics(modifierThen, true, (Function1) value$iv3), LinearIndicatorWidth, LinearIndicatorHeight);
            $composer2.startReplaceableGroup(-1348540492);
            ComposerKt.sourceInformation($composer2, "CC(remember):ProgressIndicator.kt#9igjgp");
            boolean invalid$iv3 = (((($dirty & 7168) ^ 3072) > 2048 && $composer2.changed(trackColor2)) || ($dirty & 3072) == 2048) | ((57344 & $dirty) == 16384) | $composer2.changed(coercedProgress) | (((($dirty & 896) ^ 384) > 256 && $composer2.changed(color2)) || ($dirty & 384) == 256);
            ...
            if (invalid$iv3 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$2$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        ...
                        ProgressIndicatorKt.m2310drawLinearIndicatorTrackAZGd3zU($this$Canvas, j, strokeWidth, i6);
                        ProgressIndicatorKt.m2309drawLinearIndicatorqYKTg0g($this$Canvas, 0.0f, coercedProgress.invoke().floatValue(), j2, strokeWidth, i6);
                    }
                };
            ...
            $composer2.endReplaceableGroup();
            CanvasKt.Canvas(modifierM728sizeVpY3zN4, (Function1) value$iv2, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$3
                ...
                public final void invoke(Composer composer, int i8) {
                    ProgressIndicatorKt.m2298LinearProgressIndicator_5eSRE(function0, modifier6, j3, j4, i7, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:89:0x0233 A[PHI: r5
      0x0233: PHI (r5v16 'trackColor' long) = (r5v14 'trackColor' long), (r5v17 'trackColor' long) binds: [B:88:0x0231, B:84:0x022a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final void m2295LinearProgressIndicator2cYBFYY(androidx.compose.ui.Modifier r30, long r31, long r33, int r35, androidx.compose.runtime.Composer r36, final int r37, final int r38) {
        /*
            Method dump skipped, instructions count: 743
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ProgressIndicatorKt.m2295LinearProgressIndicator2cYBFYY(androidx.compose.ui.Modifier, long, long, int, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* renamed from: LinearProgressIndicator-_5eSR-E, reason: not valid java name */
    public static final void m2297LinearProgressIndicator_5eSRE(final float progress, Modifier modifier, long color, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        int i2;
        ...
        ComposerKt.sourceInformation($composer2, "C(LinearProgressIndicator)P(2,1,0:c#ui.graphics.Color,4:c#ui.graphics.Color,3:c#ui.graphics.StrokeCap)213@8723L11,214@8786L16,217@8918L12,216@8878L155:ProgressIndicator.kt#uh7d8r");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($changed & 3072) == 0) {
            if ((i & 8) == 0) {
                j2 = trackColor;
                int i5 = $composer2.changed(j2) ? 2048 : 1024;
                $dirty |= i5;
            } else {
                j2 = trackColor;
            }
        ...
        if (($dirty & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                strokeCap2 = i6 != 0 ? ProgressIndicatorDefaults.INSTANCE.m2289getLinearStrokeCapKaPHkGw() : i2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(905419617, $dirty, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:216)");
            }
            $composer2.startReplaceableGroup(-1348535908);
            ComposerKt.sourceInformation($composer2, "CC(remember):ProgressIndicator.kt#9igjgp");
            boolean invalid$iv = ($dirty & 14) == 4;
            Object it$iv = $composer2.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function0) new Function0<Float>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$6$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
            ...
            $composer2.endReplaceableGroup();
            m2298LinearProgressIndicator_5eSRE((Function0<Float>) value$iv, modifier3, color2, trackColor2, strokeCap2, $composer2, ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$7
                ...
                public final void invoke(Composer composer, int i8) {
                    ProgressIndicatorKt.m2297LinearProgressIndicator_5eSRE(progress, modifier5, j3, j4, i7, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2299LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long trackColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        Modifier.Companion modifier3;
        ...
        ComposerKt.sourceInformation($composer2, "C(LinearProgressIndicator)P(2,1,0:c#ui.graphics.Color,3:c#ui.graphics.Color)230@9286L11,231@9349L16,232@9371L140:ProgressIndicator.kt#uh7d8r");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-372717133, $dirty, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:232)");
            }
            m2297LinearProgressIndicator_5eSRE(progress, modifier3, color2, trackColor2, ProgressIndicatorDefaults.INSTANCE.m2289getLinearStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$8
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m2299LinearProgressIndicatoreaDK9VM(progress, modifier5, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2296LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long trackColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        Modifier.Companion modifier3;
        ...
        ComposerKt.sourceInformation($composer2, "C(LinearProgressIndicator)P(1,0:c#ui.graphics.Color,2:c#ui.graphics.Color)244@9718L11,245@9781L16,246@9803L126:ProgressIndicator.kt#uh7d8r");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(585576195, $dirty, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:246)");
            }
            m2295LinearProgressIndicator2cYBFYY(modifier3, color2, trackColor2, ProgressIndicatorDefaults.INSTANCE.m2289getLinearStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | 3072 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$9
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m2296LinearProgressIndicatorRIQooxk(modifier5, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2309drawLinearIndicatorqYKTg0g(DrawScope $this$drawLinearIndicator_u2dqYKTg0g, float startFraction, float endFraction, long color, float strokeWidth, int strokeCap) {
    ...
    public static final void m2310drawLinearIndicatorTrackAZGd3zU(DrawScope $this$drawLinearIndicatorTrack_u2dAZGd3zU, long color, float strokeWidth, int strokeCap) {
        m2309drawLinearIndicatorqYKTg0g($this$drawLinearIndicatorTrack_u2dAZGd3zU, 0.0f, 1.0f, color, strokeWidth, strokeCap);
    }

    static {
        float arg0$iv = CircularProgressIndicatorTokens.INSTANCE.m2884getSizeD9Ej5fM();
        float arg0$iv2 = CircularProgressIndicatorTokens.INSTANCE.m2883getActiveIndicatorWidthD9Ej5fM();
        CircularIndicatorDiameter = Dp.m6485constructorimpl(arg0$iv - Dp.m6485constructorimpl(2 * arg0$iv2));
    ...
    /* JADX WARN: Removed duplicated region for block: B:144:0x025c A[ADDED_TO_REGION] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2291CircularProgressIndicatorDUhRLBM(final kotlin.jvm.functions.Function0<java.lang.Float> r25, androidx.compose.ui.Modifier r26, long r27, float r29, long r30, int r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 697
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ProgressIndicatorKt.m2291CircularProgressIndicatorDUhRLBM(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, long, float, long, int, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX WARN: Removed duplicated region for block: B:101:0x02db A[PHI: r8
      0x02db: PHI (r8v19 'trackColor' long) = (r8v17 'trackColor' long), (r8v20 'trackColor' long) binds: [B:100:0x02d9, B:96:0x02d0] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2292CircularProgressIndicatorLxG7B9w(androidx.compose.ui.Modifier r37, long r38, float r40, long r41, int r43, androidx.compose.runtime.Composer r44, final int r45, final int r46) {
        /*
            Method dump skipped, instructions count: 912
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ProgressIndicatorKt.m2292CircularProgressIndicatorLxG7B9w(androidx.compose.ui.Modifier, long, float, long, int, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* renamed from: CircularProgressIndicator-DUhRLBM, reason: not valid java name */
    public static final void m2290CircularProgressIndicatorDUhRLBM(final float progress, Modifier modifier, long color, float strokeWidth, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long color2;
        float strokeWidth2;
        long trackColor2;
        ...
        ComposerKt.sourceInformation($composer2, "C(CircularProgressIndicator)P(2,1,0:c#ui.graphics.Color,4:c#ui.unit.Dp,5:c#ui.graphics.Color,3:c#ui.graphics.StrokeCap)487@19401L13,489@19535L18,492@19684L12,491@19642L188:ProgressIndicator.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($dirty2 & 74899) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    strokeWidth2 = ProgressIndicatorDefaults.INSTANCE.m2288getCircularStrokeWidthD9Ej5fM();
                }
                if ((i & 16) != 0) {
                ...
                if (i7 != 0) {
                    $dirty = $dirty2;
                    strokeCap2 = ProgressIndicatorDefaults.INSTANCE.m2286getCircularDeterminateStrokeCapKaPHkGw();
                    trackColor3 = trackColor2;
                } else {
                    $dirty = $dirty2;
                    trackColor3 = trackColor2;
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1472321743, $dirty, -1, "androidx.compose.material3.CircularProgressIndicator (ProgressIndicator.kt:491)");
            }
            $composer2.startReplaceableGroup(821871588);
            ComposerKt.sourceInformation($composer2, "CC(remember):ProgressIndicator.kt#9igjgp");
            boolean invalid$iv = ($dirty & 14) == 4;
            Object it$iv = $composer2.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function0) new Function0<Float>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$6$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
            ...
            $composer2.endReplaceableGroup();
            m2291CircularProgressIndicatorDUhRLBM((Function0<Float>) value$iv, modifier3, color2, strokeWidth2, trackColor3, strokeCap2, $composer2, ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$7
                ...
                public final void invoke(Composer composer, int i10) {
                    ProgressIndicatorKt.m2290CircularProgressIndicatorDUhRLBM(progress, modifier6, j, f, j2, i9, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2293CircularProgressIndicatorMBs18nI(final float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        Modifier.Companion modifier3;
        ...
        ComposerKt.sourceInformation($composer2, "C(CircularProgressIndicator)P(2,1,0:c#ui.graphics.Color,3:c#ui.unit.Dp)506@20085L13,513@20298L18,508@20172L219:ProgressIndicator.kt#uh7d8r");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                strokeWidth2 = i4 != 0 ? ProgressIndicatorDefaults.INSTANCE.m2288getCircularStrokeWidthD9Ej5fM() : f;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(402841196, $dirty, -1, "androidx.compose.material3.CircularProgressIndicator (ProgressIndicator.kt:508)");
            }
            m2290CircularProgressIndicatorDUhRLBM(progress, modifier3, color2, strokeWidth2, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor($composer2, 6), ProgressIndicatorDefaults.INSTANCE.m2286getCircularDeterminateStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$8
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m2293CircularProgressIndicatorMBs18nI(progress, modifier5, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2294CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        Modifier.Companion modifier3;
        ...
        ComposerKt.sourceInformation($composer2, "C(CircularProgressIndicator)P(1,0:c#ui.graphics.Color,2:c#ui.unit.Dp)521@20600L13,527@20799L18,523@20687L207:ProgressIndicator.kt#uh7d8r");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(947193756, $dirty, -1, "androidx.compose.material3.CircularProgressIndicator (ProgressIndicator.kt:523)");
            }
            m2292CircularProgressIndicatorLxG7B9w(modifier3, color2, strokeWidth2, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor($composer2, 6), ProgressIndicatorDefaults.INSTANCE.m2287getCircularIndeterminateStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$9
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m2294CircularProgressIndicatoraMcp0Q(modifier5, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final void m2305drawCircularIndicator42QJj7c(DrawScope $this$drawCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        float f = 2;
    ...
    public static final void m2306drawCircularIndicatorTrackbw27NRU(DrawScope $this$drawCircularIndicatorTrack_u2dbw27NRU, long color, Stroke stroke) {
        m2305drawCircularIndicator42QJj7c($this$drawCircularIndicatorTrack_u2dbw27NRU, 0.0f, 360.0f, color, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawDeterminateCircularIndicator-42QJj7c, reason: not valid java name */
    public static final void m2307drawDeterminateCircularIndicator42QJj7c(DrawScope $this$drawDeterminateCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        m2305drawCircularIndicator42QJj7c($this$drawDeterminateCircularIndicator_u2d42QJj7c, startAngle, sweep, color, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawIndeterminateCircularIndicator-hrjfTZI, reason: not valid java name */
    public static final void m2308drawIndeterminateCircularIndicatorhrjfTZI(DrawScope $this$drawIndeterminateCircularIndicator_u2dhrjfTZI, float startAngle, float strokeWidth, float sweep, long color, Stroke stroke) {
        ...
        m2305drawCircularIndicator42QJj7c($this$drawIndeterminateCircularIndicator_u2dhrjfTZI, adjustedStartAngle, adjustedSweep, color, stroke);
    }
