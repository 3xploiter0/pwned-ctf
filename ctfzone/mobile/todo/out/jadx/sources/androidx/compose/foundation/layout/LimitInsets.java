...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m768getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m769getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowLeft = WindowInsetsSides.m762hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowLeft) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        int layoutDirectionSide;
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m770getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m771getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowRight = WindowInsetsSides.m762hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowRight) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof LimitInsets) {
            return Intrinsics.areEqual(this.insets, ((LimitInsets) other).insets) && WindowInsetsSides.m761equalsimpl0(this.sides, ((LimitInsets) other).sides);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (result * 31) + WindowInsetsSides.m763hashCodeimpl(this.sides);
    }
