...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float widthParameter, Brush brushParameter, Shape shapeParameter) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope $this$CacheDrawModifierNode) {
                boolean hasValidBorderParams = $this$CacheDrawModifierNode.mo373toPx0680j_4(this.this$0.getWidth()) >= 0.0f && Size.m3830getMinDimensionimpl($this$CacheDrawModifierNode.m3652getSizeNHjbRc()) > 0.0f;
                if (!hasValidBorderParams) {
                    return BorderKt.drawContentWithoutBorder($this$CacheDrawModifierNode);
                }
                float f = 2;
                float strokeWidthPx = Math.min(Dp.m6490equalsimpl0(this.this$0.getWidth(), Dp.INSTANCE.m6503getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil($this$CacheDrawModifierNode.mo373toPx0680j_4(this.this$0.getWidth())), (float) Math.ceil(Size.m3830getMinDimensionimpl($this$CacheDrawModifierNode.m3652getSizeNHjbRc()) / f));
                float halfStroke = strokeWidthPx / f;
                long topLeft = OffsetKt.Offset(halfStroke, halfStroke);
                long borderSize = SizeKt.Size(Size.m3831getWidthimpl($this$CacheDrawModifierNode.m3652getSizeNHjbRc()) - strokeWidthPx, Size.m3828getHeightimpl($this$CacheDrawModifierNode.m3652getSizeNHjbRc()) - strokeWidthPx);
                boolean fillArea = f * strokeWidthPx > Size.m3830getMinDimensionimpl($this$CacheDrawModifierNode.m3652getSizeNHjbRc());
                Outline outline = this.this$0.getShape().mo284createOutlinePq9zytI($this$CacheDrawModifierNode.m3652getSizeNHjbRc(), $this$CacheDrawModifierNode.getLayoutDirection(), $this$CacheDrawModifierNode);
                ...
                if (outline instanceof Outline.Rounded) {
                    return this.this$0.m253drawRoundRectBorderJqoCqck($this$CacheDrawModifierNode, this.this$0.getBrush(), (Outline.Rounded) outline, topLeft, borderSize, fillArea, strokeWidthPx);
                }
                if (outline instanceof Outline.Rectangle) {
                    return BorderKt.m250drawRectBorderNsqcLGU($this$CacheDrawModifierNode, this.this$0.getBrush(), topLeft, borderSize, fillArea, strokeWidthPx);
                }
    ...
    public final void m255setWidth0680j_4(float value) {
        if (!Dp.m6490equalsimpl0(this.width, value)) {
            this.width = value;
    ...
    /* JADX WARN: Type inference failed for: r19v1, types: [T, androidx.compose.ui.graphics.ImageBitmap] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final androidx.compose.ui.draw.DrawResult drawGenericBorder(androidx.compose.ui.draw.CacheDrawScope r64, final androidx.compose.ui.graphics.Brush r65, final androidx.compose.ui.graphics.Outline.Generic r66, boolean r67, float r68) throws java.lang.Throwable {
        /*
    ...
    public final DrawResult m253drawRoundRectBorderJqoCqck(CacheDrawScope $this$drawRoundRectBorder_u2dJqoCqck, final Brush brush, Outline.Rounded outline, final long topLeft, final long borderSize, final boolean fillArea, final float strokeWidth) {
        if (RoundRectKt.isSimple(outline.getRoundRect())) {
            final long cornerRadius = outline.getRoundRect().m3812getTopLeftCornerRadiuskKHJgLs();
            ...
            return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
                ...
                public final void invoke2(ContentDrawScope $this$onDrawWithContent) throws Throwable {
                    ...
                    if (fillArea) {
                        DrawScope.m4554drawRoundRectZuiqVtQ$default($this$onDrawWithContent, brush, 0L, 0L, cornerRadius, 0.0f, null, null, 0, 246, null);
                        return;
                    }
                    if (CornerRadius.m3737getXimpl(cornerRadius) < halfStroke) {
                        ContentDrawScope $this$clipRect_u2drOu3jXo$iv = $this$onDrawWithContent;
                        float left$iv = strokeWidth;
                        float top$iv = strokeWidth;
                        float right$iv = Size.m3831getWidthimpl($this$onDrawWithContent.mo4559getSizeNHjbRc()) - strokeWidth;
                        float bottom$iv = Size.m3828getHeightimpl($this$onDrawWithContent.mo4559getSizeNHjbRc()) - strokeWidth;
                        int clipOp$iv = ClipOp.INSTANCE.m3991getDifferencertfAjoo();
                        Brush brush2 = brush;
                        long j = cornerRadius;
                        DrawContext $this$withTransform_u24lambda_u246$iv$iv2 = $this$clipRect_u2drOu3jXo$iv.getDrawContext();
                        long previousSize$iv$iv2 = $this$withTransform_u24lambda_u246$iv$iv2.mo4480getSizeNHjbRc();
                        ...
                        try {
                            ...
                            $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo4483clipRectN_I0leg(left$iv, top$iv, right$iv, bottom$iv, clipOp$iv);
                            try {
                                DrawScope.m4554drawRoundRectZuiqVtQ$default($this$clipRect_u2drOu3jXo$iv, brush2, 0L, 0L, j, 0.0f, null, null, 0, 246, null);
                                $this$withTransform_u24lambda_u246$iv$iv2.getCanvas().restore();
                                $this$withTransform_u24lambda_u246$iv$iv2.mo4481setSizeuvyYCjk(previousSize$iv$iv2);
                            } catch (Throwable th) {
                                th = th;
                        ...
                        DrawScope.m4554drawRoundRectZuiqVtQ$default($this$onDrawWithContent, brush, topLeft, borderSize, BorderKt.m251shrinkKibmq7A(cornerRadius, halfStroke), 0.0f, borderStroke, null, 0, 208, null);
                    }
                }
            });
        }
        ...
        return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
            ...
            public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                $this$onDrawWithContent.drawContent();
                DrawScope.m4548drawPathGBMwjPU$default($this$onDrawWithContent, roundedRectPath, brush, 0.0f, null, null, 0, 60, null);
            }
        });
    }
}
