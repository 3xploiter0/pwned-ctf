...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m5525setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m5521getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: getConstraints-msEJaDk$ui_release, reason: not valid java name */
    public final long m5520getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult result) {
        Unit unit;
        if (result != null) {
            m5401setMeasuredSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            $this$_set__measureResult__u24lambda_u241.m5401setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6660getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo5340placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo5340placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5519placeSelfgyyYBs(position);
    ...
    private final void m5519placeSelfgyyYBs(long position) {
        if (!IntOffset.m6612equalsimpl0(getPosition(), position)) {
            m5525setPositiongyyYBs(position);
    ...
    public final void m5523placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m5519placeSelfgyyYBs(IntOffset.m6617plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m5522performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m5524positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long aggregatedOffset = IntOffset.INSTANCE.m6623getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                aggregatedOffset = IntOffset.m6617plusqkQi6aY(aggregatedOffset, lookaheadDelegate.getPosition());
            }
