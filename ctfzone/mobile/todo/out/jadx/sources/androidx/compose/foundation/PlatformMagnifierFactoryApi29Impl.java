...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo327createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        ...
        long pixelSize = density.mo374toSizeXkaWNTQ(size);
        float pixelCornerRadius = density.mo373toPx0680j_4(cornerRadius);
        float pixelElevation = density.mo373toPx0680j_4(elevation);
        ...
        if (pixelSize != InlineClassHelperKt.UnspecifiedPackedFloats) {
            $this$create_nHHXs2Y_u24lambda_u241_u24lambda_u240.setSize(MathKt.roundToInt(Size.m3831getWidthimpl(pixelSize)), MathKt.roundToInt(Size.m3828getHeightimpl(pixelSize)));
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo326updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            ...
            if (OffsetKt.m3781isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m3762getXimpl(sourceCenter), Offset.m3763getYimpl(sourceCenter), Offset.m3762getXimpl(magnifierCenter), Offset.m3763getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m3762getXimpl(sourceCenter), Offset.m3763getYimpl(sourceCenter));
            }
        }
    }
}
