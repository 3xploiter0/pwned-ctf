...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager $this$recordChanges, TextFieldCharSequence pre, TextFieldCharSequence post, TextFieldBuffer.ChangeList changes, boolean allowMerge) {
        ...
        if (changes.getChangeCount() == 1) {
            long preRange = changes.mo1106getOriginalRangejx7JFs(0);
            long postRange = changes.mo1107getRangejx7JFs(0);
            if (!TextRange.m5942getCollapsedimpl(preRange) || !TextRange.m5942getCollapsedimpl(postRange)) {
                $this$recordChanges.record(new TextUndoOperation(TextRange.m5946getMinimpl(preRange), TextRangeKt.m5955substringFDrldGo(pre, preRange), TextRangeKt.m5955substringFDrldGo(post, postRange), pre.getSelection(), post.getSelection(), 0L, allowMerge, 32, null));
            }
        }
    }
