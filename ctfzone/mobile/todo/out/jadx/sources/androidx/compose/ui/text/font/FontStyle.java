...
public final class FontStyle {
    ...
    private static final int Normal = m6056constructorimpl(0);
    private static final int Italic = m6056constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontStyle m6055boximpl(int i) {
    ...
    public static boolean m6057equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m6061unboximpl();
    }
    ...
    public static String m6060toStringimpl(int arg0) {
        return m6058equalsimpl0(arg0, Normal) ? "Normal" : m6058equalsimpl0(arg0, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6062getItalic_LCdwA$annotations() {
        }

        /* renamed from: getNormal-_-LCdwA$annotations, reason: not valid java name */
        public static /* synthetic */ void m6063getNormal_LCdwA$annotations() {
        }
        ...
        public final int m6065getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* renamed from: getItalic-_-LCdwA, reason: not valid java name */
        public final int m6064getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m6055boximpl(m6065getNormal_LCdwA()), FontStyle.m6055boximpl(m6064getItalic_LCdwA())});
        }
    }
}
