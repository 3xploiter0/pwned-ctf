...
public final class SnapshotStateObserver {
    ...
    private final Function1<Object, Unit> readObserver = new Function1<Object, Unit>() { // from class: androidx.compose.runtime.snapshots.SnapshotStateObserver$readObserver$1
        ...
        public final void invoke2(Object state) {
            if (!this.this$0.isPaused) {
                Object lock$iv = this.this$0.observedScopeMaps;
    ...
    public final void sendNotifications() {
        this.onChangedExecutor.invoke(new Function0<Unit>() { // from class: androidx.compose.runtime.snapshots.SnapshotStateObserver.sendNotifications.1
            ...
            public final void invoke2() {
                do {
                    Object lock$iv = SnapshotStateObserver.this.observedScopeMaps;
    ...
    static final class ObservedScopeMap {
        ...
        */
        ...
        /* JADX WARN: Removed duplicated region for block: B:215:0x06c3 A[EDGE_INSN: B:215:0x06c3->B:368:0x0725 BREAK  A[LOOP:14: B:202:0x066b->B:216:0x06c5], PHI: r20
          0x06c3: PHI (r20v25 'hasValues' boolean) = (r20v24 'hasValues' boolean), (r20v26 'hasValues' boolean) binds: [B:203:0x0685, B:214:0x06c1] A[DONT_GENERATE, DONT_INLINE]] */
        /* JADX WARN: Removed duplicated region for block: B:62:0x01e8 A[EDGE_INSN: B:62:0x01e8->B:336:0x024a BREAK  A[LOOP:4: B:49:0x0190->B:63:0x01ea], PHI: r35
          0x01e8: PHI (r35v20 'hasValues' boolean) = (r35v19 'hasValues' boolean), (r35v21 'hasValues' boolean) binds: [B:50:0x01aa, B:61:0x01e6] A[DONT_GENERATE, DONT_INLINE]] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        ...
        public final void rereadDerivedState(DerivedState<?> derivedState) {
            ...
            Object value$iv = this_$iv.getMap().get(derivedState);
            if (value$iv == null) {
                return;
            }
            if (!(value$iv instanceof MutableScatterSet)) {
                MutableObjectIntMap<Object> it2 = scopeToValues.get(value$iv);
                if (it2 == null) {
                    it2 = new MutableObjectIntMap(0, 1, null);
                    scopeToValues.set(value$iv, it2);
                    Unit unit = Unit.INSTANCE;
                }
                recordRead(derivedState, token, value$iv, it2);
                return;
            }
