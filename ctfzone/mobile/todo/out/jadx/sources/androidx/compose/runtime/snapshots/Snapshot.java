...
public abstract class Snapshot {
    ...
    public abstract void mo3590nestedActivated$runtime_release(Snapshot snapshot);

    /* renamed from: nestedDeactivated$runtime_release */
    public abstract void mo3591nestedDeactivated$runtime_release(Snapshot snapshot);

    public abstract void notifyObjectsInitialized$runtime_release();

    /* renamed from: recordModified$runtime_release */
    public abstract void mo3592recordModified$runtime_release(StateObject state);
        ...
        public final <T> T observe(Function1<Object, Unit> readObserver, Function1<Object, Unit> writeObserver, Function0<? extends T> block) {
            ...
            if (readObserver != null || writeObserver != null) {
                ...
                if (previous instanceof TransparentObserverMutableSnapshot) {
                    ...
                    if ($this$canBeReused$iv.getThreadId() == ActualJvm_jvmKt.currentThreadId()) {
                        ...
                        try {
                            ...
                            ((TransparentObserverMutableSnapshot) previous).setWriteObserver(SnapshotKt.mergedWriteObserver(writeObserver, previousWriteObserver));
                            return block.invoke();
                        } finally {
                ...
                if (previous == null || (previous instanceof MutableSnapshot)) {
                    snapshot = new TransparentObserverMutableSnapshot(previous instanceof MutableSnapshot ? (MutableSnapshot) previous : null, readObserver, writeObserver, true, false);
                } else {
                    if (readObserver == null) {
                        return block.invoke();
                    }
                    snapshot = previous.takeNestedSnapshot(readObserver);
                }
        ...
        */
        public final androidx.compose.runtime.snapshots.Snapshot makeCurrentNonObservable(androidx.compose.runtime.snapshots.Snapshot r11) {
            /*
                ...
                long r8 = androidx.compose.runtime.ActualJvm_jvmKt.currentThreadId()
            ...
            L25:
                ...
                r4 = r10
                r5 = 0
                long r6 = r0.getThreadId$runtime_release()
                long r8 = androidx.compose.runtime.ActualJvm_jvmKt.currentThreadId()
                int r6 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
                if (r6 != 0) goto L3b
                goto L3c
        ...
        public static final void registerApplyObserver$lambda$6(Function2 $observer) {
            Object lock$iv$iv = SnapshotKt.getLock();
            synchronized (lock$iv$iv) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void registerGlobalWriteObserver$lambda$9(Function1 $observer) throws Throwable {
            Object lock$iv$iv = SnapshotKt.getLock();
            synchronized (lock$iv$iv) {
