...
public final class SpacerKt {
    public static final void Spacer(Modifier modifier, Composer $composer, int $changed) {
        ...
        Composer $this$Layout_u24lambda_u241$iv = Updater.m3496constructorimpl($composer);
        Updater.m3503setimpl($this$Layout_u24lambda_u241$iv, spacerMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
