...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = NavigationBarTokens.INSTANCE.m3170getContainerElevationD9Ej5fM();
    ...
    public final long getContainerColor(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1528098623, $changed, -1, "androidx.compose.material3.NavigationBarDefaults.<get-containerColor> (NavigationBar.kt:278)");
        }
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1938678202, $changed, -1, "androidx.compose.material3.NavigationBarDefaults.<get-windowInsets> (NavigationBar.kt:285)");
        }
