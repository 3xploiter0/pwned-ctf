...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int compositionStart = composition != null ? TextRange.m5946getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            int compositionEnd = composition2 != null ? TextRange.m5945getMaximpl(composition2.getPackedValue()) : -1;
            inputMethodManager.updateSelection(TextRange.m5946getMinimpl(state.getSelection()), TextRange.m5945getMaximpl(state.getSelection()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5942getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            switch (editorAction) {
                case 0:
                    imeAction = ImeAction.INSTANCE.m6126getDefaulteUduSuo();
                    break;
                case 1:
                default:
                    ...
                    break;
                case 2:
                    imeAction = ImeAction.INSTANCE.m6128getGoeUduSuo();
                    break;
                case 3:
                    imeAction = ImeAction.INSTANCE.m6132getSearcheUduSuo();
                    break;
                case 4:
                    imeAction = ImeAction.INSTANCE.m6133getSendeUduSuo();
                    break;
                case 5:
                    imeAction = ImeAction.INSTANCE.m6129getNexteUduSuo();
                    break;
                case 6:
                    imeAction = ImeAction.INSTANCE.m6127getDoneeUduSuo();
                    break;
                case 7:
                    imeAction = ImeAction.INSTANCE.m6131getPreviouseUduSuo();
                    break;
            }
            this.eventCallback.mo6145onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m5946getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
