...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(final boolean isStartHandle, final ResolvedTextDirection direction, final TextFieldSelectionManager manager, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 147) != 146 || !$composer2.getSkipping()) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = manager.handleDragObserver$foundation_release(isStartHandle);
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo971provideF1C5BW0() {
                        return manager.m1403getHandlePositiontuRUvjQ$foundation_release(isStartHandle);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            boolean zM5947getReversedimpl = TextRange.m5947getReversedimpl(manager.getValue$foundation_release().getSelection());
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager $this$isSelectionHandleInVisibleBound, boolean isStartHandle) {
        ...
        if (state != null && (layoutCoordinates = state.getLayoutCoordinates()) != null && (rectVisibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates)) != null) {
            return SelectionManagerKt.m1381containsInclusiveUv8p0NA(rectVisibleBounds, $this$isSelectionHandleInVisibleBound.m1403getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
        }
        return false;
    }
    ...
    */
    public static final long m1406calculateSelectionMagnifierCenterAndroidO0kMr_c(androidx.compose.foundation.text.selection.TextFieldSelectionManager r20, long r21) {
        /*
            Method dump skipped, instructions count: 292
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt.m1406calculateSelectionMagnifierCenterAndroidO0kMr_c(androidx.compose.foundation.text.selection.TextFieldSelectionManager, long):long");
    }
}
