...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        m1755drawRipples4WTKRHQ($this$drawIndication, color);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        Offset origin = this.bounded ? Offset.m3751boximpl(interaction.getPressPosition()) : null;
    ...
    private final void m1755drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color) {
        Map $this$forEach$iv = this.ripples;
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            RippleAnimation ripple = element$iv.getValue();
            float alpha = this.rippleAlpha.getValue().getPressedAlpha();
            if (!(alpha == 0.0f)) {
                ripple.m1756draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, Color.m4001copywmQWz5c(color, (14 & 1) != 0 ? Color.m4005getAlphaimpl(color) : alpha, (14 & 2) != 0 ? Color.m4009getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(color) : 0.0f));
            }
        }
    }
