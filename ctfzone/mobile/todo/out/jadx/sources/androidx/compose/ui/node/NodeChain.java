...
public final class NodeChain {
    ...
    private final Modifier.Node padChain() {
        boolean value$iv = this.head != NodeChainKt.SentinelHead;
        if (!value$iv) {
    ...
    private final Modifier.Node trimChain(Modifier.Node paddedHead) {
        boolean value$iv = paddedHead == NodeChainKt.SentinelHead;
        if (!value$iv) {
        ...
        boolean value$iv2 = result != NodeChainKt.SentinelHead;
        if (!value$iv2) {
    ...
    */
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        for (Modifier.Node node = start.getParent(); node != null; node = node.getParent()) {
            if (node == NodeChainKt.SentinelHead) {
                ...
                if (!((this_$iv.getKindSet() & NodeKind.m5574constructorimpl(2)) != 0)) {
                    node.updateCoordinator$ui_release(coordinator);
                } else {
                    return;
                }
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((toRemove.getKindSet() & NodeKind.m5574constructorimpl(2)) != 0) {
    ...
    public final /* synthetic */ <T> T m5534firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
        int i;
        NodeChain nodeChain;
        int i2;
    ...
    public final /* synthetic */ <T> void m5537headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int i;
        NodeChain this_$iv;
        ...
        if ((this_$iv4.getAggregateChildKindSet() & type) == 0) {
            return;
        }
    ...
    public final /* synthetic */ <T> void m5539tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int mask$iv;
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> T m5538tailH91voCI$ui_release(int type) {
        int i;
        int i2;
        NodeChain nodeChain;
        int i3;
    ...
    public final /* synthetic */ <T> T m5536headH91voCI$ui_release(int type) {
        int i;
        NodeChain nodeChain;
        int i2;
        NodeChain nodeChain2;
    ...
    public final boolean m5535hasH91voCI$ui_release(int type) {
    ...
    public String toString() {
        ...
        String string = $this$toString_u24lambda_u2430.toString();
