...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6647boximpl(IntSize.INSTANCE.m6660getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo41slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m60isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6655getWidthimpl(this.m59getCurrentSizeYbymL2g()) - IntOffset.m6613getXimpl(this.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m59getCurrentSizeYbymL2g()))));
            }
        }) : m61isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6613getXimpl(this.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m59getCurrentSizeYbymL2g()))) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m55getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6654getHeightimpl(this.m59getCurrentSizeYbymL2g()) - IntOffset.m6614getYimpl(this.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m59getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m50getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6614getYimpl(this.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m59getCurrentSizeYbymL2g()))) - it));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m60isLeftgWo6LJ4(int $this$isLeft) {
        return AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m52getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m54getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m51getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m61isRightgWo6LJ4(int $this$isRight) {
        return AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m53getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m54getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m51getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m58calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3608alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo42slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m60isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6613getXimpl(this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
            }
        }) : m61isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6613getXimpl(this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m6655getWidthimpl(targetSize)));
            }
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6614getYimpl(this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m46equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m50getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6614getYimpl(this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m6654getHeightimpl(targetSize)));
            }
    ...
    public final void m63setMeasuredSizeozmzZPI$animation_release(long j) {
        ...
        $this$setValue$iv.setValue(IntSize.m6647boximpl(j));
    }
    ...
    public final long m59getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().getPackedValue() : m62getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo64measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            final Placeable placeableMo5339measureBRTryo0 = measurable.mo5339measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo123createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long initial = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long target = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo123createAnimationSpecTemP2vQ = value.mo123createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo123createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6647boximpl(m65invokeYEO4UFw(obj));
                }
                ...
                public final long m65invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6660getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            if (measureScope.isLookingAhead()) {
                packedValue = IntSizeKt.IntSize(placeableMo5339measureBRTryo0.getWidth(), placeableMo5339measureBRTryo0.getHeight());
            } else {
                packedValue = stateAnimate.getValue().getPackedValue();
            }
            int iM6655getWidthimpl = IntSize.m6655getWidthimpl(packedValue);
            int iM6654getHeightimpl = IntSize.m6654getHeightimpl(packedValue);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.layout$default(measureScope, iM6655getWidthimpl, iM6654getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope $this$layout) {
                    long offset = animatedContentTransitionScopeImpl3.getContentAlignment().mo3608alignKFBX0sM(IntSizeKt.IntSize(placeableMo5339measureBRTryo0.getWidth(), placeableMo5339measureBRTryo0.getHeight()), packedValue, LayoutDirection.Ltr);
                    Placeable.PlacementScope.m5403place70tqf50$default($this$layout, placeableMo5339measureBRTryo0, offset, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
