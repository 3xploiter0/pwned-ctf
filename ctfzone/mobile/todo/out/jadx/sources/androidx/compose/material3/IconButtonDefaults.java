...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors iconButtonColors(Composer $composer, int $changed) {
        ...
        long contentColor = ((Color) objConsume).m4013unboximpl();
        if (Color.m4004equalsimpl0(colors.getContentColor(), contentColor)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            $composer.endReplaceableGroup();
        ...
        IconButtonColors iconButtonColorsM2132copyjRlVdoo = colors.m2132copyjRlVdoo((5 & 1) != 0 ? colors.containerColor : 0L, (5 & 2) != 0 ? colors.contentColor : contentColor, (5 & 4) != 0 ? colors.disabledContainerColor : 0L, (5 & 8) != 0 ? colors.disabledContentColor : Color.m4001copywmQWz5c(contentColor, (14 & 1) != 0 ? Color.m4005getAlphaimpl(contentColor) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(contentColor) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(contentColor) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(contentColor) : 0.0f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return iconButtonColorsM2132copyjRlVdoo;
    }

    /* renamed from: iconButtonColors-ro_MJ88, reason: not valid java name */
    public final IconButtonColors m2141iconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        if ((i & 2) != 0) {
            ...
            Object objConsume = $composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd($composer);
            contentColor2 = ((Color) objConsume).m4013unboximpl();
        } else {
        ...
        IconButtonColors iconButtonColorsM2132copyjRlVdoo = getDefaultIconButtonColors(MaterialTheme.INSTANCE.getColorScheme($composer, 6), $composer, ($changed >> 9) & 112).m2132copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final IconButtonColors getDefaultIconButtonColors(ColorScheme $this$defaultIconButtonColors, Composer $composer, int $changed) {
        ...
        if (defaultIconButtonColorsCached == null) {
            ...
            Object objConsume = $composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd($composer);
            long localContentColor2 = ((Color) objConsume).m4013unboximpl();
            IconButtonColors it = new IconButtonColors(Color.INSTANCE.m4038getTransparent0d7_KjU(), localContentColor2, Color.INSTANCE.m4038getTransparent0d7_KjU(), Color.m4001copywmQWz5c(localContentColor2, (14 & 1) != 0 ? Color.m4005getAlphaimpl(localContentColor2) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(localContentColor2) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(localContentColor2) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(localContentColor2) : 0.0f), null);
    ...
    public final IconToggleButtonColors m2142iconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
        ...
        long containerColor2 = (i & 1) != 0 ? Color.INSTANCE.m4038getTransparent0d7_KjU() : containerColor;
        if ((i & 2) != 0) {
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object objConsume = $composer.consume(localContentColor);
        ...
        long disabledContainerColor2 = (i & 4) != 0 ? Color.INSTANCE.m4038getTransparent0d7_KjU() : disabledContainerColor;
        if ((i & 8) != 0) {
            long j = contentColor2;
            disabledContentColor2 = Color.m4001copywmQWz5c(j, (14 & 1) != 0 ? Color.m4005getAlphaimpl(j) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(j) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(j) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(j) : 0.0f);
        } else {
        ...
        long checkedContainerColor2 = (i & 16) != 0 ? Color.INSTANCE.m4038getTransparent0d7_KjU() : checkedContainerColor;
    ...
    public final IconButtonColors m2137filledIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            long value = ColorSchemeKt.getValue(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), $composer, 6);
            disabledContainerColor2 = Color.m4001copywmQWz5c(value, (14 & 1) != 0 ? Color.m4005getAlphaimpl(value) : 0.12f, (14 & 2) != 0 ? Color.m4009getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(value) : 0.0f);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            long value2 = ColorSchemeKt.getValue(FilledIconButtonTokens.INSTANCE.getDisabledColor(), $composer, 6);
            disabledContentColor2 = Color.m4001copywmQWz5c(value2, (14 & 1) != 0 ? Color.m4005getAlphaimpl(value2) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(value2) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(value2) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(value2) : 0.0f);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m2138filledIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long disabledContainerColor2;
        long disabledContentColor2;
        ...
        long checkedContentColor2 = (i & 32) != 0 ? ColorSchemeKt.m1942contentColorForek8zF_U(checkedContainerColor2, $composer, ($changed >> 12) & 14) : checkedContentColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconButtonColors m2139filledTonalIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long disabledContainerColor2;
        long disabledContentColor2;
        ...
        long contentColor2 = (i & 2) != 0 ? ColorSchemeKt.m1942contentColorForek8zF_U(containerColor2, $composer, $changed & 14) : contentColor;
        if ((i & 4) != 0) {
            long value = ColorSchemeKt.getValue(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), $composer, 6);
            disabledContainerColor2 = Color.m4001copywmQWz5c(value, (14 & 1) != 0 ? Color.m4005getAlphaimpl(value) : 0.12f, (14 & 2) != 0 ? Color.m4009getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(value) : 0.0f);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            long value2 = ColorSchemeKt.getValue(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), $composer, 6);
            disabledContentColor2 = Color.m4001copywmQWz5c(value2, (14 & 1) != 0 ? Color.m4005getAlphaimpl(value2) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(value2) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(value2) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(value2) : 0.0f);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
    ...
    public final IconToggleButtonColors m2140filledTonalIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long disabledContainerColor2;
        long disabledContentColor2;
    ...
    public final IconButtonColors m2143outlinedIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
    ...
    public final IconToggleButtonColors m2144outlinedIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean enabled, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            Object objConsume = $composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd($composer);
            color = ((Color) objConsume).m4013unboximpl();
            $composer.endReplaceableGroup();
        } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            long jM4013unboximpl = ((Color) objConsume2).m4013unboximpl();
            color = Color.m4001copywmQWz5c(jM4013unboximpl, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM4013unboximpl) : 0.12f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM4013unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM4013unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM4013unboximpl) : 0.0f);
            $composer.endReplaceableGroup();
        }
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = BorderStrokeKt.m263BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m3209getUnselectedOutlineWidthD9Ej5fM(), color);
