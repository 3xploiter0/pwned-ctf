...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        int iM6440getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m6440getMinWidthimpl(constraints);
        int iM6439getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m6439getMinHeightimpl(constraints) : 0;
        if (this.direction != Direction.Vertical && this.unbounded) {
            iM6438getMaxWidthimpl = Integer.MAX_VALUE;
        } else {
            iM6438getMaxWidthimpl = Constraints.m6438getMaxWidthimpl(constraints);
        }
        long wrappedConstraints = ConstraintsKt.Constraints(iM6440getMinWidthimpl, iM6438getMaxWidthimpl, iM6439getMinHeightimpl, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m6437getMaxHeightimpl(constraints) : Integer.MAX_VALUE);
        final Placeable placeable = measurable.mo5339measureBRTryo0(wrappedConstraints);
        final int wrapperWidth = RangesKt.coerceIn(placeable.getWidth(), Constraints.m6440getMinWidthimpl(constraints), Constraints.m6438getMaxWidthimpl(constraints));
        final int wrapperHeight = RangesKt.coerceIn(placeable.getHeight(), Constraints.m6439getMinHeightimpl(constraints), Constraints.m6437getMaxHeightimpl(constraints));
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, wrapperWidth, wrapperHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                long position = this.this$0.getAlignmentCallback().invoke(IntSize.m6647boximpl(IntSizeKt.IntSize(wrapperWidth - placeable.getWidth(), wrapperHeight - placeable.getHeight())), $this$measure_u2d3p2s80s.getLayoutDirection()).getPackedValue();
                Placeable.PlacementScope.m5403place70tqf50$default($this$layout, placeable, position, 0.0f, 2, null);
            }
        }, 4, null);
    }
}
