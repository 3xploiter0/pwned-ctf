    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                    ...
                    public float scrollBy(float pixels) {
                        return scrollingLogic3.reverseIfNeeded(scrollingLogic3.m498toFloatk4lQ0M(nestedScrollScope.mo455scrollByWithOverscrollOzD1aCk(scrollingLogic3.m496reverseIfNeededMKHz9U(scrollingLogic3.m499toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m5104getSideEffectWNlRxjI())));
                    }
                };
                ...
                float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m491toFloatTH1AsA0(j2));
            ...
            case 1:
                ...
                ScrollingLogic scrollingLogic4 = (ScrollingLogic) this.L$0;
                ResultKt.throwOnFailure($result);
        ...
        longRef.element = scrollingLogic.m492updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) $result).floatValue()));
