...
public final class LazyListMeasuredItem implements LazyListItemInfo, LazyLayoutMeasuredItem {
        ...
        if (updateAnimations) {
            ...
            for (int index2 = 0; index2 < placeablesCount; index2++) {
                ...
                if (animation != null) {
                    ...
                    if (getIsVertical()) {
                        iIntValue = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
                    } else {
                        int mainAxis2 = IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE$iv);
                        iIntValue = Integer.valueOf(mainAxis2 + delta).intValue();
                    }
                    if (getIsVertical()) {
                        int mainAxis3 = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
                        mainAxis = mainAxis3 + delta;
                    } else {
                        mainAxis = IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE$iv);
                    }
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        ...
        while (i3 < placeablesCount) {
            ...
            long offset = mo793getOffsetBjo55l4(index);
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), index);
            if (animation != null) {
                if (isLookingAhead) {
                    animation.m843setLookaheadOffsetgyyYBs(offset);
                } else {
                    if (!IntOffset.m6612equalsimpl0(animation.getLookaheadOffset(), LazyLayoutItemAnimation.INSTANCE.m845getNotInitializednOccac())) {
                        targetOffset = animation.getLookaheadOffset();
                    } else {
                        targetOffset = offset;
                    }
                    long animatedOffset = IntOffset.m6617plusqkQi6aY(targetOffset, animation.m840getPlacementDeltanOccac());
                    if ((m791getMainAxisgyyYBs(targetOffset) <= minOffset && m791getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m791getMainAxisgyyYBs(targetOffset) >= maxOffset && m791getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
    ...
    private final int m791getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m790copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
