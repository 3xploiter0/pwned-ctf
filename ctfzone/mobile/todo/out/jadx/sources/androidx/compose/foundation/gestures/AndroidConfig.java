...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo394calculateMouseWheelScroll8xgXZGE(Density $this$calculateMouseWheelScroll_u2d8xgXZGE, PointerEvent event, long bounds) {
        List $this$fastFold$iv = event.getChanges();
        Offset offsetM3751boximpl = Offset.m3751boximpl(Offset.INSTANCE.m3778getZeroF1C5BW0());
        Offset offsetM3751boximpl2 = offsetM3751boximpl;
        int index$iv$iv = 0;
        ...
        while (index$iv$iv < size) {
            ...
            long acc = offsetM3751boximpl2.getPackedValue();
            offsetM3751boximpl2 = Offset.m3751boximpl(Offset.m3767plusMKHz9U(acc, c.getScrollDelta()));
            index$iv$iv++;
            $this$fastFold$iv = $this$fastFold$iv;
            offsetM3751boximpl = offsetM3751boximpl;
        }
        return Offset.m3769timestuRUvjQ(offsetM3751boximpl2.getPackedValue(), -$this$calculateMouseWheelScroll_u2d8xgXZGE.mo373toPx0680j_4(Dp.m6485constructorimpl(64)));
    }
}
