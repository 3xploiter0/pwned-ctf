...
public final class PathParser {
    ...
    public final PathParser parsePathString(String pathData) throws NumberFormatException {
    ...
    public final ArrayList<PathNode> pathStringToNodes(String pathData, ArrayList<PathNode> nodes) throws NumberFormatException {
        int i;
        int index;
        char c;
        int start;
                        ...
                        if (index >= end || Intrinsics.compare((int) pathData.charAt(index), i) > 0) {
                            ...
                            if (Float.isNaN(value)) {
                                ...
                                if (dataCount2 < this.nodeData.length) {
                                    ...
                                    start = start2;
                                    int start3 = src$iv.length;
                                    ArraysKt.copyInto(src$iv, fArr, 0, 0, start3);
                                }
