...
public final /* data */ class FlowLayoutOverflowState {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[this.type.ordinal()]) {
            ...
            case 4:
                ...
                if (!hasNext) {
                    ...
                    ellipsisSize = this.collapseSize;
                    ...
                    if (function22 == null || (measurableInvoke2 = function22.invoke(true, Integer.valueOf(getNoOfItemsShown$foundation_layout_release()))) == null) {
                        measurableInvoke2 = this.seeMoreMeasurable;
                    }
                    measurable = measurableInvoke2;
    ...
    public final void m611setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        ...
        long orientationIndependentConstraints = OrientationIndependentConstraints.m650constructorimpl(constraints, orientation);
        if (seeMoreMeasurable != null) {
            int mainAxisSize = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m6437getMaxHeightimpl(orientationIndependentConstraints));
        ...
        if (collapseMeasurable != null) {
            int mainAxisSize2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m6437getMaxHeightimpl(orientationIndependentConstraints));
    ...
    public final void m610setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        ...
        LayoutOrientation orientation = isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM650constructorimpl = OrientationIndependentConstraints.m650constructorimpl(constraints, orientation);
        long orientationIndependentConstraints = OrientationIndependentConstraints.m651copyyUG9Ft0(jM650constructorimpl, (10 & 1) != 0 ? Constraints.m6440getMinWidthimpl(jM650constructorimpl) : 0, (10 & 2) != 0 ? Constraints.m6438getMaxWidthimpl(jM650constructorimpl) : 0, (10 & 4) != 0 ? Constraints.m6439getMinHeightimpl(jM650constructorimpl) : 0, (10 & 8) != 0 ? Constraints.m6437getMaxHeightimpl(jM650constructorimpl) : 0);
        long finalConstraints = OrientationIndependentConstraints.m663toBoxConstraintsOenEA2s(orientationIndependentConstraints, orientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m607measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, finalConstraints, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.seeMoreSize = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(mainAxisSize, crossAxisSize));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m607measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, finalConstraints, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.collapseSize = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(mainAxisSize, crossAxisSize));
    ...
    public final void m612setOverflowMeasurablesVKLhPVY$foundation_layout_release(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        ...
        m610setOverflowMeasurableshBUhpc$foundation_layout_release(measurePolicy, seeMoreMeasurable, collapseMeasurable, constraints);
    }
}
