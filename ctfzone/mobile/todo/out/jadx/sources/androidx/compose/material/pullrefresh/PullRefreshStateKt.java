...
public final class PullRefreshStateKt {
    ...
    public static final PullRefreshState m1753rememberPullRefreshStateUuyPYSY(final boolean refreshing, Function0<Unit> function0, float refreshThreshold, float refreshingOffset, Composer $composer, int $changed, int i) {
        ...
        float refreshThreshold2 = (i & 4) != 0 ? PullRefreshDefaults.INSTANCE.m1746getRefreshThresholdD9Ej5fM() : refreshThreshold;
        float refreshingOffset2 = (i & 8) != 0 ? PullRefreshDefaults.INSTANCE.m1747getRefreshingOffsetD9Ej5fM() : refreshingOffset;
        ...
        int $this$dp$iv = Dp.m6484compareTo0680j_4(refreshThreshold2, Dp.m6485constructorimpl(0));
        if (!($this$dp$iv > 0)) {
        ...
        thresholdPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.mo373toPx0680j_4(refreshThreshold2);
        refreshingOffsetPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.mo373toPx0680j_4(refreshingOffset2);
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new PullRefreshState(scope, onRefreshState, refreshThreshold3, refreshingOffset3);
