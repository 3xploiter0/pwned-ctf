...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m4340constructorimpl(0);
    private static final int Rotate = m4340constructorimpl(1);
    private static final int Morph = m4340constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m4339boximpl(int i) {
    ...
    public static final boolean m4342equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static final class Companion {
        ...
        public final int m4348getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m4347getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m4346getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4344toStringimpl(int arg0) {
        return m4342equalsimpl0(arg0, Translate) ? "Translate" : m4342equalsimpl0(arg0, Rotate) ? "Rotate" : m4342equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }
