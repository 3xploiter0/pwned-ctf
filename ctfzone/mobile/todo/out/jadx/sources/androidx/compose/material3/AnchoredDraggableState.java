...
public final class AnchoredDraggableState<T> {
    ...
    static final class C04421 extends ContinuationImpl {
        ...
        C04421(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C04421> continuation) {
            super(continuation);
    ...
    public AnchoredDraggableState(T t, Function1<? super Float, Float> function1, Function0<Float> function0, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> function12) {
        ...
        this.targetValue = SnapshotStateKt.derivedStateOf(new Function0<T>(this) { // from class: androidx.compose.material3.AnchoredDraggableState$targetValue$2
            ...
            public final T invoke() {
                ...
                if (!Float.isNaN(offset)) {
                    currentValue = anchoredDraggableState.computeTarget(offset, anchoredDraggableState.getCurrentValue(), 0.0f);
                } else {
        ...
        this.closestValue = SnapshotStateKt.derivedStateOf(new Function0<T>(this) { // from class: androidx.compose.material3.AnchoredDraggableState$closestValue$2
            ...
            public final T invoke() {
                ...
                float offset = anchoredDraggableState.getOffset();
                if (!Float.isNaN(offset)) {
                    currentValue = anchoredDraggableState.computeTargetWithoutThresholds(offset, anchoredDraggableState.getCurrentValue());
                } else {
                    currentValue = anchoredDraggableState.getCurrentValue();
                }
                return currentValue;
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i & 16) == 0) {
            ...
            function13 = new Function1<T, Boolean>() { // from class: androidx.compose.material3.AnchoredDraggableState.1
                /* JADX WARN: Can't rename method to resolve collision */
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, DraggableAnchors draggableAnchors, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i & 32) == 0) {
            ...
            function13 = new Function1<T, Boolean>() { // from class: androidx.compose.material3.AnchoredDraggableState.2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(T t) {
                    return true;
        ...
        if (!(currentAnchorPosition == offset) && !Float.isNaN(currentAnchorPosition)) {
            if (currentAnchorPosition < offset) {
                if (velocity >= velocityThresholdPx) {
                    T tClosestAnchor = currentAnchors.closestAnchor(offset, true);
                    Intrinsics.checkNotNull(tClosestAnchor);
                    return tClosestAnchor;
                }
                T tClosestAnchor2 = currentAnchors.closestAnchor(offset, true);
                Intrinsics.checkNotNull(tClosestAnchor2);
                float distance = Math.abs(currentAnchors.positionOf(tClosestAnchor2) - currentAnchorPosition);
                ...
                if (velocity <= (-velocityThresholdPx)) {
                    T tClosestAnchor3 = currentAnchors.closestAnchor(offset, false);
                    Intrinsics.checkNotNull(tClosestAnchor3);
                    return tClosestAnchor3;
                }
                T tClosestAnchor4 = currentAnchors.closestAnchor(offset, false);
                Intrinsics.checkNotNull(tClosestAnchor4);
                float distance2 = Math.abs(currentAnchorPosition - currentAnchors.positionOf(tClosestAnchor4));
    ...
    public final T computeTargetWithoutThresholds(float offset, T currentValue) {
        ...
        if (!(currentAnchorPosition == offset) && !Float.isNaN(currentAnchorPosition)) {
            if (currentAnchorPosition < offset) {
                ...
                T tClosestAnchor2 = currentAnchors.closestAnchor(offset, false);
    ...
    */
    public final java.lang.Object anchoredDrag(androidx.compose.foundation.MutatePriority r8, kotlin.jvm.functions.Function3<? super androidx.compose.material3.AnchoredDragScope, ? super androidx.compose.material3.DraggableAnchors<T>, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        /*
            r7 = this;
            boolean r0 = r10 instanceof androidx.compose.material3.AnchoredDraggableState.C04421
            if (r0 == 0) goto L14
            r0 = r10
            androidx.compose.material3.AnchoredDraggableState$anchoredDrag$1 r0 = (androidx.compose.material3.AnchoredDraggableState.C04421) r0
            int r1 = r0.label
        ...
        L2f:
            ...
            androidx.compose.material3.AnchoredDraggableState r8 = (androidx.compose.material3.AnchoredDraggableState) r8
        ...
        L39:
            ...
            r2 = r7
            androidx.compose.material3.InternalMutatorMutex r4 = r2.dragMutex     // Catch: java.lang.Throwable -> L8d
            androidx.compose.material3.AnchoredDraggableState$anchoredDrag$2 r5 = new androidx.compose.material3.AnchoredDraggableState$anchoredDrag$2     // Catch: java.lang.Throwable -> L8d
            r6 = 0
            ...
            r10.L$0 = r2     // Catch: java.lang.Throwable -> L8d
            r6 = 1
            r10.label = r6     // Catch: java.lang.Throwable -> L8d
            java.lang.Object r4 = r4.mutate(r8, r5, r10)     // Catch: java.lang.Throwable -> L8d
            if (r4 != r1) goto L54
            return r1
        L54:
            r8 = r2
        L55:
            androidx.compose.material3.DraggableAnchors r9 = r8.getAnchors()
            float r1 = r8.getOffset()
            java.lang.Object r9 = r9.closestAnchor(r1)
            if (r9 == 0) goto L89
            float r1 = r8.getOffset()
            androidx.compose.material3.DraggableAnchors r2 = r8.getAnchors()
        ...
        L8d:
            ...
            r8 = r2
        L8f:
            androidx.compose.material3.DraggableAnchors r1 = r8.getAnchors()
            float r2 = r8.getOffset()
            java.lang.Object r1 = r1.closestAnchor(r2)
            if (r1 == 0) goto Lc3
            float r2 = r8.getOffset()
            androidx.compose.material3.DraggableAnchors r4 = r8.getAnchors()
    ...
    static final class C04432 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04432(AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C04432> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04432(this.this$0, this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C04432) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C01002 extends SuspendLambda implements Function2<DraggableAnchors<T>, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> $block;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01002(Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C01002> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01002 c01002 = new C01002(this.$block, this.this$0, continuation);
                c01002.L$0 = obj;
                return c01002;
            }
            ...
            public final Object invoke(DraggableAnchors<T> draggableAnchors, Continuation<? super Unit> continuation) {
                return ((C01002) create(draggableAnchors, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    }, new C01002(this.$block, this.this$0, null), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object anchoredDrag(T r9, androidx.compose.foundation.MutatePriority r10, kotlin.jvm.functions.Function4<? super androidx.compose.material3.AnchoredDragScope, ? super androidx.compose.material3.DraggableAnchors<T>, ? super T, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) throws java.lang.Throwable {
        /*
            r8 = this;
            boolean r0 = r12 instanceof androidx.compose.material3.AnchoredDraggableState.AnonymousClass3
            if (r0 == 0) goto L14
            r0 = r12
        ...
        L30:
            ...
            androidx.compose.material3.AnchoredDraggableState r9 = (androidx.compose.material3.AnchoredDraggableState) r9
        ...
        L3a:
            kotlin.ResultKt.throwOnFailure(r0)
            r2 = r8
            androidx.compose.material3.DraggableAnchors r5 = r2.getAnchors()
            boolean r5 = r5.hasAnchorFor(r9)
            if (r5 == 0) goto Ld1
        L49:
            androidx.compose.material3.InternalMutatorMutex r5 = r2.dragMutex     // Catch: java.lang.Throwable -> L97
            androidx.compose.material3.AnchoredDraggableState$anchoredDrag$4 r6 = new androidx.compose.material3.AnchoredDraggableState$anchoredDrag$4     // Catch: java.lang.Throwable -> L97
            ...
            r12.L$0 = r2     // Catch: java.lang.Throwable -> L97
            r7 = 1
            r12.label = r7     // Catch: java.lang.Throwable -> L97
            java.lang.Object r5 = r5.mutate(r10, r6, r12)     // Catch: java.lang.Throwable -> L97
            if (r5 != r1) goto L5e
            return r1
        L5e:
            r9 = r2
        L5f:
            r9.setDragTarget(r4)
            androidx.compose.material3.DraggableAnchors r10 = r9.getAnchors()
            float r11 = r9.getOffset()
            java.lang.Object r10 = r10.closestAnchor(r11)
            if (r10 == 0) goto L96
            float r11 = r9.getOffset()
            androidx.compose.material3.DraggableAnchors r1 = r9.getAnchors()
        ...
        L99:
            r9.setDragTarget(r4)
            androidx.compose.material3.DraggableAnchors r11 = r9.getAnchors()
            float r1 = r9.getOffset()
            java.lang.Object r11 = r11.closestAnchor(r1)
            if (r11 == 0) goto Ld0
            float r1 = r9.getOffset()
            androidx.compose.material3.DraggableAnchors r2 = r9.getAnchors()
