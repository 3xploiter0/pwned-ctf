...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        this.minIntrinsicWidth = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$minIntrinsicWidth$2
            ...
            public final Float invoke() {
                ...
                List $this$fastMaxBy$iv = this.this$0.getInfoList$ui_text_release();
        ...
        while (index$iv$iv$iv < size) {
            ...
            target$iv$iv.add(new ParagraphIntrinsicInfo(ParagraphIntrinsicsKt.ParagraphIntrinsics(annotatedString$iv.getText(), style.merge(currentParagraphStyle), annotatedString$iv.getSpanStyles(), (List<AnnotatedString.Range<Placeholder>>) MultiParagraphIntrinsicsKt.getLocalPlaceholders(getPlaceholders(), paragraphStyleRange$iv.getStart(), paragraphStyleRange$iv.getEnd()), density, fontFamilyResolver), paragraphStyleRange$iv.getStart(), paragraphStyleRange$iv.getEnd()));
            index$iv$iv$iv++;
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        if (TextDirection.m6362equalsimpl0(style.getTextDirection(), TextDirection.INSTANCE.m6371getUnspecifieds_7Xco())) {
            return style.m5847copyykzQM6k((509 & 1) != 0 ? style.textAlign : 0, (509 & 2) != 0 ? style.textDirection : defaultStyle.getTextDirection(), (509 & 4) != 0 ? style.lineHeight : 0L, (509 & 8) != 0 ? style.textIndent : null, (509 & 16) != 0 ? style.platformStyle : null, (509 & 32) != 0 ? style.lineHeightStyle : null, (509 & 64) != 0 ? style.lineBreak : 0, (509 & 128) != 0 ? style.hyphens : 0, (509 & 256) != 0 ? style.textMotion : null);
        }
        return style;
    }
}
