...
public final class VectorConvertersKt {
    ...
    private static final TwoWayConverter<Dp, AnimationVector1D> DpToVector = TwoWayConverter(new Function1<Dp, AnimationVector1D>() { // from class: androidx.compose.animation.core.VectorConvertersKt$DpToVector$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector1D invoke(Dp dp) {
            return m193invoke0680j_4(dp.m6499unboximpl());
        }

        /* renamed from: invoke-0680j_4, reason: not valid java name */
        public final AnimationVector1D m193invoke0680j_4(float it) {
            return new AnimationVector1D(it);
        }
        ...
        public /* bridge */ /* synthetic */ Dp invoke(AnimationVector1D animationVector1D) {
            return Dp.m6483boximpl(m194invokeu2uoSUM(animationVector1D));
        }

        /* renamed from: invoke-u2uoSUM, reason: not valid java name */
        public final float m194invokeu2uoSUM(AnimationVector1D it) {
            return Dp.m6485constructorimpl(it.getValue());
        }
    });
    private static final TwoWayConverter<DpOffset, AnimationVector2D> DpOffsetToVector = TwoWayConverter(new Function1<DpOffset, AnimationVector2D>() { // from class: androidx.compose.animation.core.VectorConvertersKt$DpOffsetToVector$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(DpOffset dpOffset) {
            return m191invokejoFl9I(dpOffset.getPackedValue());
        }

        /* renamed from: invoke-jo-Fl9I, reason: not valid java name */
        public final AnimationVector2D m191invokejoFl9I(long it) {
            return new AnimationVector2D(DpOffset.m6546getXD9Ej5fM(it), DpOffset.m6548getYD9Ej5fM(it));
        }
        ...
        public /* bridge */ /* synthetic */ DpOffset invoke(AnimationVector2D animationVector2D) {
            return DpOffset.m6540boximpl(m192invokegVRvYmI(animationVector2D));
        }

        /* renamed from: invoke-gVRvYmI, reason: not valid java name */
        public final long m192invokegVRvYmI(AnimationVector2D it) {
            float $this$dp$iv = it.getV1();
            float $this$dp$iv2 = Dp.m6485constructorimpl($this$dp$iv);
            float $this$dp$iv3 = it.getV2();
            return DpKt.m6506DpOffsetYgX7TsA($this$dp$iv2, Dp.m6485constructorimpl($this$dp$iv3));
        }
    });
    private static final TwoWayConverter<Size, AnimationVector2D> SizeToVector = TwoWayConverter(new Function1<Size, AnimationVector2D>() { // from class: androidx.compose.animation.core.VectorConvertersKt$SizeToVector$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(Size size) {
            return m201invokeuvyYCjk(size.getPackedValue());
        }

        /* renamed from: invoke-uvyYCjk, reason: not valid java name */
        public final AnimationVector2D m201invokeuvyYCjk(long it) {
            return new AnimationVector2D(Size.m3831getWidthimpl(it), Size.m3828getHeightimpl(it));
        }
        ...
        public /* bridge */ /* synthetic */ Size invoke(AnimationVector2D animationVector2D) {
            return Size.m3819boximpl(m202invoke7Ah8Wj8(animationVector2D));
        }

        /* renamed from: invoke-7Ah8Wj8, reason: not valid java name */
        public final long m202invoke7Ah8Wj8(AnimationVector2D it) {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> OffsetToVector = TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.animation.core.VectorConvertersKt$OffsetToVector$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(Offset offset) {
            return m199invokek4lQ0M(offset.getPackedValue());
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final AnimationVector2D m199invokek4lQ0M(long it) {
            return new AnimationVector2D(Offset.m3762getXimpl(it), Offset.m3763getYimpl(it));
        }
        ...
        public /* bridge */ /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m3751boximpl(m200invoketuRUvjQ(animationVector2D));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m200invoketuRUvjQ(AnimationVector2D it) {
    ...
    private static final TwoWayConverter<IntOffset, AnimationVector2D> IntOffsetToVector = TwoWayConverter(new Function1<IntOffset, AnimationVector2D>() { // from class: androidx.compose.animation.core.VectorConvertersKt$IntOffsetToVector$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(IntOffset intOffset) {
            return m195invokegyyYBs(intOffset.getPackedValue());
        }

        /* renamed from: invoke--gyyYBs, reason: not valid java name */
        public final AnimationVector2D m195invokegyyYBs(long it) {
            return new AnimationVector2D(IntOffset.m6613getXimpl(it), IntOffset.m6614getYimpl(it));
        }
        ...
        public /* bridge */ /* synthetic */ IntOffset invoke(AnimationVector2D animationVector2D) {
            return IntOffset.m6604boximpl(m196invokeBjo55l4(animationVector2D));
        }

        /* renamed from: invoke-Bjo55l4, reason: not valid java name */
        public final long m196invokeBjo55l4(AnimationVector2D it) {
            float $this$fastRoundToInt$iv = it.getV1();
            int iRound = Math.round($this$fastRoundToInt$iv);
            float $this$fastRoundToInt$iv2 = it.getV2();
            return IntOffsetKt.IntOffset(iRound, Math.round($this$fastRoundToInt$iv2));
        }
    });
    private static final TwoWayConverter<IntSize, AnimationVector2D> IntSizeToVector = TwoWayConverter(new Function1<IntSize, AnimationVector2D>() { // from class: androidx.compose.animation.core.VectorConvertersKt$IntSizeToVector$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(IntSize intSize) {
            return m197invokeozmzZPI(intSize.getPackedValue());
        }

        /* renamed from: invoke-ozmzZPI, reason: not valid java name */
        public final AnimationVector2D m197invokeozmzZPI(long it) {
            return new AnimationVector2D(IntSize.m6655getWidthimpl(it), IntSize.m6654getHeightimpl(it));
        }
        ...
        public /* bridge */ /* synthetic */ IntSize invoke(AnimationVector2D animationVector2D) {
            return IntSize.m6647boximpl(m198invokeYEO4UFw(animationVector2D));
        }

        /* renamed from: invoke-YEO4UFw, reason: not valid java name */
        public final long m198invokeYEO4UFw(AnimationVector2D it) {
            float $this$fastRoundToInt$iv = it.getV1();
            int iCoerceAtLeast = RangesKt.coerceAtLeast(Math.round($this$fastRoundToInt$iv), 0);
            float $this$fastRoundToInt$iv2 = it.getV2();
            return IntSizeKt.IntSize(iCoerceAtLeast, RangesKt.coerceAtLeast(Math.round($this$fastRoundToInt$iv2), 0));
        }
    });
