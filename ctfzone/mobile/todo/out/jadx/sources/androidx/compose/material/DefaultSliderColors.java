...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1733795637, $changed, -1, "androidx.compose.material.DefaultSliderColors.thumbColor (Slider.kt:1090)");
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3993boximpl(enabled ? this.thumbColor : this.disabledThumbColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> trackColor(boolean enabled, boolean active, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1575395620, $changed, -1, "androidx.compose.material.DefaultSliderColors.trackColor (Slider.kt:1095)");
        }
        if (enabled) {
    ...
    public State<Color> tickColor(boolean enabled, boolean active, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1491563694, $changed, -1, "androidx.compose.material.DefaultSliderColors.tickColor (Slider.kt:1106)");
        }
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4004equalsimpl0(this.thumbColor, ((DefaultSliderColors) other).thumbColor) && Color.m4004equalsimpl0(this.disabledThumbColor, ((DefaultSliderColors) other).disabledThumbColor) && Color.m4004equalsimpl0(this.activeTrackColor, ((DefaultSliderColors) other).activeTrackColor) && Color.m4004equalsimpl0(this.inactiveTrackColor, ((DefaultSliderColors) other).inactiveTrackColor) && Color.m4004equalsimpl0(this.disabledActiveTrackColor, ((DefaultSliderColors) other).disabledActiveTrackColor) && Color.m4004equalsimpl0(this.disabledInactiveTrackColor, ((DefaultSliderColors) other).disabledInactiveTrackColor) && Color.m4004equalsimpl0(this.activeTickColor, ((DefaultSliderColors) other).activeTickColor) && Color.m4004equalsimpl0(this.inactiveTickColor, ((DefaultSliderColors) other).inactiveTickColor) && Color.m4004equalsimpl0(this.disabledActiveTickColor, ((DefaultSliderColors) other).disabledActiveTickColor) && Color.m4004equalsimpl0(this.disabledInactiveTickColor, ((DefaultSliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((result * 31) + Color.m4010hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4010hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4010hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4010hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4010hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4010hashCodeimpl(this.activeTickColor)) * 31) + Color.m4010hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4010hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4010hashCodeimpl(this.disabledInactiveTickColor);
    }
}
