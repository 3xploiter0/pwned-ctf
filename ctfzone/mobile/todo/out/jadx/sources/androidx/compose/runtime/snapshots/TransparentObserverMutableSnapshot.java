...
public final class TransparentObserverMutableSnapshot extends MutableSnapshot {
    ...
    public TransparentObserverMutableSnapshot(MutableSnapshot parentSnapshot, Function1<Object, Unit> function1, Function1<Object, Unit> function12, boolean mergeParentObservers, boolean ownsParentSnapshot) {
        ...
        super(0, SnapshotIdSet.INSTANCE.getEMPTY(), SnapshotKt.mergedReadObserver(function1, (parentSnapshot == null || (readObserver = parentSnapshot.getReadObserver()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getReadObserver() : readObserver, mergeParentObservers), SnapshotKt.mergedWriteObserver(function12, (parentSnapshot == null || (writeObserver$runtime_release = parentSnapshot.getWriteObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getWriteObserver$runtime_release() : writeObserver$runtime_release));
    ...
    public void mo3592recordModified$runtime_release(StateObject state) {
        getCurrentSnapshot().mo3592recordModified$runtime_release(state);
    }
    ...
    public Void mo3590nestedActivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
    ...
    public Void mo3591nestedDeactivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
}
