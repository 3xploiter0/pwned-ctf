...
public final class TextFieldState {
    ...
    private TextFieldState(String initialText, long initialSelection, TextUndoManager initialTextUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(initialText, TextRangeKt.m5954coerceIn8ffj60Q(initialSelection, 0, initialText.length()), (DefaultConstructorMarker) null);
    ...
    public final long m1111getSelectiond9O1mEE() {
        return getValue$foundation_release().getSelection();
    }

    /* renamed from: getComposition-MzsxiRA, reason: not valid java name */
    public final TextRange m1110getCompositionMzsxiRA() {
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m5951toStringimpl(m1111getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean selectionChanged = true ^ TextRange.m5941equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1143getSelectiond9O1mEE());
        if (textChanged) {
            this.textUndoManager.clearHistory();
        }
        m1112syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, textChanged, selectionChanged);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        TextFieldCharSequence afterEditValue = new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1143getSelectiond9O1mEE(), getMainBuffer().m1142getCompositionMzsxiRA(), null, 8, null);
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m5941equalsimpl0(beforeEditValue.getSelection(), this.mainBuffer.m1143getSelectiond9O1mEE())) {
            if (!Intrinsics.areEqual(beforeEditValue.getComposition(), this.mainBuffer.m1142getCompositionMzsxiRA()) || !Intrinsics.areEqual(beforeEditValue.getHighlight(), this.mainBuffer.getHighlight())) {
                updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1143getSelectiond9O1mEE(), this.mainBuffer.m1142getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
                return;
            }
            return;
        }
        TextFieldCharSequence afterEditValue = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1143getSelectiond9O1mEE(), this.mainBuffer.m1142getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean selectionChangedByFilter = !TextRange.m5941equalsimpl0(textFieldBuffer.getSelectionInChars(), afterEditValue.getSelection());
        if (textChangedByFilter || selectionChangedByFilter) {
            m1112syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, textChangedByFilter, selectionChangedByFilter);
        } else {
            updateValueAndNotifyListeners(beforeEditValue, TextFieldBuffer.m1101toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer, 0L, afterEditValue.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1112syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String bufferString = this.mainBuffer.toString();
        TextFieldCharSequence bufferState = new TextFieldCharSequence(bufferString, this.mainBuffer.m1143getSelectiond9O1mEE(), this.mainBuffer.m1142getCompositionMzsxiRA(), null, 8, null);
        boolean compositionChanged = !Intrinsics.areEqual(newComposition, this.mainBuffer.m1142getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m5948getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m5943getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m5942getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m5946getMinimpl(newComposition.getPackedValue()), TextRange.m5945getMaximpl(newComposition.getPackedValue()));
        }
        if (textChanged || (!selectionChanged && compositionChanged)) {
            this.mainBuffer.commitComposition();
        }
        TextFieldCharSequence finalValue = new TextFieldCharSequence(textChanged ? textFieldBuffer.toString() : bufferString, this.mainBuffer.m1143getSelectiond9O1mEE(), this.mainBuffer.m1142getCompositionMzsxiRA(), null, 8, null);
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope $this$save, TextFieldState value) {
            ...
            Integer numValueOf = Integer.valueOf(TextRange.m5948getStartimpl(value.m1111getSelectiond9O1mEE()));
            Integer numValueOf2 = Integer.valueOf(TextRange.m5943getEndimpl(value.m1111getSelectiond9O1mEE()));
