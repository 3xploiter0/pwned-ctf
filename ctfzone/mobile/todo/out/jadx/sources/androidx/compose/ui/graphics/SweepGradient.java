...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo3972createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3783isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m3841getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset((Offset.m3762getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m3762getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m3831getWidthimpl(size) : Offset.m3762getXimpl(this.center), Offset.m3763getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3828getHeightimpl(size) : Offset.m3763getYimpl(this.center));
        }
        return ShaderKt.m4322SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m3759equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m3764hashCodeimpl(this.center);
