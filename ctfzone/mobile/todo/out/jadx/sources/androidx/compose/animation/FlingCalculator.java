...
public final class FlingCalculator {
    ...
    public final long flingDuration(float velocity) {
        ...
        double decelMinusOne = FlingCalculatorKt.DecelerationRate - 1.0d;
    ...
    public final float flingDistance(float velocity) {
        double l = getSplineDeceleration(velocity);
        double decelMinusOne = FlingCalculatorKt.DecelerationRate - 1.0d;
        return (float) (this.friction * this.magicPhysicalCoefficient * Math.exp((FlingCalculatorKt.DecelerationRate / decelMinusOne) * l));
    }

    public final FlingInfo flingInfo(float velocity) {
        double l = getSplineDeceleration(velocity);
        double decelMinusOne = FlingCalculatorKt.DecelerationRate - 1.0d;
        return new FlingInfo(velocity, (float) (this.friction * this.magicPhysicalCoefficient * Math.exp((FlingCalculatorKt.DecelerationRate / decelMinusOne) * l)), (long) (Math.exp(l / decelMinusOne) * 1000.0d));
    }
