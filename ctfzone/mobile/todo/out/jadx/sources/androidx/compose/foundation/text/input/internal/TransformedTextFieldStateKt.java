...
public final class TransformedTextFieldStateKt {
    public static final <R> R getIndexTransformationType(TransformedTextFieldState $this$getIndexTransformationType, int transformedQueryIndex, Function3<? super IndexTransformationType, ? super TextRange, ? super TextRange, ? extends R> function3) {
        ...
        long untransformed = $this$getIndexTransformationType.m1229mapFromTransformedjx7JFs(transformedQueryIndex);
        long retransformed = $this$getIndexTransformationType.m1232mapToTransformedGEjPoXI(untransformed);
        if (TextRange.m5942getCollapsedimpl(untransformed) && TextRange.m5942getCollapsedimpl(retransformed)) {
            type = IndexTransformationType.Untransformed;
        } else if (!TextRange.m5942getCollapsedimpl(untransformed) && !TextRange.m5942getCollapsedimpl(retransformed)) {
        ...
        return function3.invoke(type, TextRange.m5936boximpl(untransformed), TextRange.m5936boximpl(retransformed));
    }
}
