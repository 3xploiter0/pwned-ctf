...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo4456drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4456drawArcillE91I(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4457drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4457drawArcyD3GUKo(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4458drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4458drawCircleV9BoPsw(brush, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4459drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4459drawCircleVaOC9Bg(color, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public /* synthetic */ void mo4460drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4460drawImage9jGpkUE(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4461drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.mo4461drawImageAZ2fEMs(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }
    ...
    public void mo4462drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4462drawImagegbVJVH8(image, topLeft, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4463drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4463drawLine1RTmtNc(brush, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4464drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4464drawLineNGM6Ib0(color, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4465drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4465drawOvalAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4466drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4466drawOvalnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4467drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4467drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4468drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4468drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4469drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4469drawPointsF8ZwMP8(points, pointMode, color, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4470drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4470drawPointsGsft0Ws(points, pointMode, brush, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4471drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4471drawRectAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4472drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4472drawRectnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4473drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4473drawRoundRectZuiqVtQ(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4474drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4474drawRoundRectuAw5IA(color, topLeft, size, cornerRadius, style, alpha, colorFilter, blendMode);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo4558getCenterF1C5BW0() {
        return this.canvasDrawScope.mo4558getCenterF1C5BW0();
    }
    ...
    public long mo4559getSizeNHjbRc() {
        return this.canvasDrawScope.mo4559getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: record-JVtK1S4 */
    public void mo4560recordJVtK1S4(GraphicsLayer graphicsLayer, long j, Function1<? super DrawScope, Unit> function1) {
        this.canvasDrawScope.mo4560recordJVtK1S4(graphicsLayer, j, function1);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo366roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo366roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo367roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo367roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo368toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo368toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo369toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo369toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo370toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo370toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo371toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo371toDpSizekrfVVM(j);
    }
    ...
    public long mo374toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo374toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo375toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo375toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo376toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo376toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo377toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo377toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (nodeNextDrawNode == null) {
            NodeCoordinator nodeCoordinatorM5461requireCoordinator64DMado = DelegatableNodeKt.m5461requireCoordinator64DMado(drawModifierNode, NodeKind.m5574constructorimpl(4));
            if (nodeCoordinatorM5461requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                wrapped = nodeCoordinatorM5461requireCoordinator64DMado.getWrapped();
                Intrinsics.checkNotNull(wrapped);
            } else {
                wrapped = nodeCoordinatorM5461requireCoordinator64DMado;
            }
            wrapped.performDraw(canvas, getDrawContext().getGraphicsLayer());
            return;
        }
        int iM5574constructorimpl = NodeKind.m5574constructorimpl(4);
        MutableVector mutableVector2 = null;
        Modifier.Node nodePop = nodeNextDrawNode;
        while (nodePop != 0) {
            if (nodePop instanceof DrawModifierNode) {
                layoutNodeDrawScope3.performDraw(nodePop, canvas, getDrawContext().getGraphicsLayer());
                layoutNodeDrawScope = layoutNodeDrawScope4;
                i = i3;
            } else {
                int i4 = 1;
                if (((nodePop.getKindSet() & iM5574constructorimpl) != 0 ? 1 : null) == null || !(nodePop instanceof DelegatingNode)) {
                    layoutNodeDrawScope = layoutNodeDrawScope4;
                    i = i3;
                } else {
                    int i5 = 0;
                    ...
                    while (delegate != null) {
                        ...
                        if (((node.getKindSet() & iM5574constructorimpl) != 0 ? i4 : 0) == 0) {
    ...
    public final void performDraw(DrawModifierNode $this$performDraw, Canvas canvas, GraphicsLayer layer) {
        NodeCoordinator coordinator = DelegatableNodeKt.m5461requireCoordinator64DMado($this$performDraw, NodeKind.m5574constructorimpl(4));
        long size = IntSizeKt.m6667toSizeozmzZPI(coordinator.mo5347getSizeYbymL2g());
        LayoutNodeDrawScope drawScope = coordinator.getLayoutNode().getMDrawScope$ui_release();
        drawScope.m5502drawDirecteZhPAX0$ui_release(canvas, size, coordinator, $this$performDraw, layer);
    }
    ...
    public final void m5501draweZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode, GraphicsLayer layer) {
        int i;
        int i2;
        MutableVector mutableVector;
        int iM5574constructorimpl = NodeKind.m5574constructorimpl(4);
        ...
        while (nodePop != 0) {
            if (nodePop instanceof DrawModifierNode) {
                m5502drawDirecteZhPAX0$ui_release(canvas, size, coordinator, nodePop, layer);
                ...
                if (((nodePop.getKindSet() & iM5574constructorimpl) != 0 ? 1 : null) == null || !(nodePop instanceof DelegatingNode)) {
                    ...
                    while (delegate != null) {
                        Modifier.Node node = delegate;
                        if (((node.getKindSet() & iM5574constructorimpl) != 0 ? i3 : 0) == 0) {
    ...
    public final void m5502drawDirecteZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode, GraphicsLayer layer) {
        ...
        $this$draw_ymL40Pk_u24lambda_u247$iv.mo4481setSizeuvyYCjk(size);
        ...
        try {
            ...
            $this$draw_ymL40Pk_u24lambda_u248$iv2.mo4481setSizeuvyYCjk(prevSize$iv);
