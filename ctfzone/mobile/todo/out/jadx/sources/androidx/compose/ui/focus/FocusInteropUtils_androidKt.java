...
public final class FocusInteropUtils_androidKt {
    public static final FocusDirection toFocusDirection(int androidDirection) {
        switch (androidDirection) {
            case 1:
                return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3685getPreviousdhqQ8s());
            case 2:
                return FocusDirection.m3671boximpl(FocusDirection.INSTANCE.m3684getNextdhqQ8s());
            case 17:
    ...
    public static final Integer m3688toAndroidFocusDirection3ESFkO8(int $this$toAndroidFocusDirection_u2d3ESFkO8) {
        if (FocusDirection.m3674equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3687getUpdhqQ8s())) {
            return 33;
        }
        if (FocusDirection.m3674equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3680getDowndhqQ8s())) {
            return 130;
        }
        if (FocusDirection.m3674equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3683getLeftdhqQ8s())) {
            return 17;
        }
        if (FocusDirection.m3674equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3686getRightdhqQ8s())) {
            return 66;
        }
        if (FocusDirection.m3674equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3684getNextdhqQ8s())) {
            return 2;
        }
        return FocusDirection.m3674equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3685getPreviousdhqQ8s()) ? 1 : null;
    }
    ...
    public static final boolean requestInteropFocus(View $this$requestInteropFocus, Integer direction, android.graphics.Rect rect) {
        ...
        if ((!((ViewGroup) $this$requestInteropFocus).isFocusable() || $this$requestInteropFocus.hasFocus()) && !($this$requestInteropFocus instanceof AndroidComposeView)) {
            if (rect != null) {
                ...
                return viewFindNextFocusFromRect != null ? viewFindNextFocusFromRect.requestFocus(direction.intValue(), rect) : $this$requestInteropFocus.requestFocus(direction.intValue(), rect);
            }
