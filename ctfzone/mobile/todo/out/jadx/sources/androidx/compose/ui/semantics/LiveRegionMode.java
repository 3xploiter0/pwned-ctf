...
public final class LiveRegionMode {
    ...
    private static final int Polite = m5743constructorimpl(0);
    private static final int Assertive = m5743constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m5742boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5743constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5744equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5745equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5746hashCodeimpl(int i) {
    ...
    public static String m5747toStringimpl(int arg0) {
        return m5745equalsimpl0(arg0, Polite) ? "Polite" : m5745equalsimpl0(arg0, Assertive) ? "Assertive" : "Unknown";
    }
