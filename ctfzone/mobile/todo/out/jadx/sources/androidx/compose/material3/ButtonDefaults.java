...
public final class ButtonDefaults {
    ...
    private static final float ButtonHorizontalPadding = Dp.m6485constructorimpl(24);
    ...
    private static final float ButtonWithIconHorizontalStartPadding = Dp.m6485constructorimpl(16);
    private static final PaddingValues ButtonWithIconContentPadding = PaddingKt.m677PaddingValuesa9UjIt4(ButtonWithIconHorizontalStartPadding, ButtonVerticalPadding, ButtonHorizontalPadding, ButtonVerticalPadding);
    private static final float TextButtonHorizontalPadding = Dp.m6485constructorimpl(12);
    ...
    private static final float TextButtonWithIconHorizontalEndPadding = Dp.m6485constructorimpl(16);
    private static final PaddingValues TextButtonWithIconContentPadding = PaddingKt.m677PaddingValuesa9UjIt4(TextButtonHorizontalPadding, ContentPadding.getTop(), TextButtonWithIconHorizontalEndPadding, ContentPadding.getBottom());
    private static final float MinWidth = Dp.m6485constructorimpl(58);
    private static final float MinHeight = Dp.m6485constructorimpl(40);
    private static final float IconSize = FilledButtonTokens.INSTANCE.m3095getIconSizeD9Ej5fM();
    ...
    public final float m1823getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final Shape getShape(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1234923021, $changed, -1, "androidx.compose.material3.ButtonDefaults.<get-shape> (Button.kt:527)");
        }
    ...
    public final Shape getElevatedShape(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2143958791, $changed, -1, "androidx.compose.material3.ButtonDefaults.<get-elevatedShape> (Button.kt:530)");
        }
    ...
    public final Shape getFilledTonalShape(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-886584987, $changed, -1, "androidx.compose.material3.ButtonDefaults.<get-filledTonalShape> (Button.kt:533)");
        }
    ...
    public final Shape getOutlinedShape(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2045213065, $changed, -1, "androidx.compose.material3.ButtonDefaults.<get-outlinedShape> (Button.kt:536)");
        }
    ...
    public final Shape getTextShape(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-349121587, $changed, -1, "androidx.compose.material3.ButtonDefaults.<get-textShape> (Button.kt:539)");
        }
    ...
    public final ButtonColors buttonColors(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1449248637, $changed, -1, "androidx.compose.material3.ButtonDefaults.buttonColors (Button.kt:546)");
        }
    ...
    public final ButtonColors m1816buttonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-339300779, $changed, -1, "androidx.compose.material3.ButtonDefaults.buttonColors (Button.kt:563)");
        }
        ButtonColors buttonColorsM1811copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1811copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return buttonColorsM1811copyjRlVdoo;
    }

    public final ButtonColors getDefaultButtonColors$material3_release(ColorScheme $this$defaultButtonColors) {
        ButtonColors defaultButtonColorsCached = $this$defaultButtonColors.getDefaultButtonColorsCached();
        if (defaultButtonColorsCached == null) {
            ...
            long jM4001copywmQWz5c = Color.m4001copywmQWz5c(jFromToken3, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken3) : 0.12f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken3) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken3) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken3) : 0.0f);
            long jFromToken4 = ColorSchemeKt.fromToken($this$defaultButtonColors, FilledButtonTokens.INSTANCE.getDisabledLabelTextColor());
            ButtonColors it = new ButtonColors(jFromToken, jFromToken2, jM4001copywmQWz5c, Color.m4001copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken4) : 0.0f), null);
            $this$defaultButtonColors.setDefaultButtonColorsCached$material3_release(it);
            return it;
        }
    ...
    public final ButtonColors elevatedButtonColors(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2025043443, $changed, -1, "androidx.compose.material3.ButtonDefaults.elevatedButtonColors (Button.kt:589)");
        }
    ...
    public final ButtonColors m1818elevatedButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1507908383, $changed, -1, "androidx.compose.material3.ButtonDefaults.elevatedButtonColors (Button.kt:606)");
        }
        ButtonColors buttonColorsM1811copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1811copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultElevatedButtonColors$material3_release(ColorScheme $this$defaultElevatedButtonColors) {
        ButtonColors defaultElevatedButtonColorsCached = $this$defaultElevatedButtonColors.getDefaultElevatedButtonColorsCached();
        if (defaultElevatedButtonColorsCached == null) {
            ...
            ButtonColors it = new ButtonColors(jFromToken, jFromToken2, jM4001copywmQWz5c, Color.m4001copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken4) : 0.0f), null);
            $this$defaultElevatedButtonColors.setDefaultElevatedButtonColorsCached$material3_release(it);
            return it;
        }
    ...
    public final ButtonColors filledTonalButtonColors(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(824987837, $changed, -1, "androidx.compose.material3.ButtonDefaults.filledTonalButtonColors (Button.kt:632)");
        }
    ...
    public final ButtonColors m1820filledTonalButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1670757653, $changed, -1, "androidx.compose.material3.ButtonDefaults.filledTonalButtonColors (Button.kt:649)");
        }
        ButtonColors buttonColorsM1811copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1811copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultFilledTonalButtonColors$material3_release(ColorScheme $this$defaultFilledTonalButtonColors) {
        ButtonColors defaultFilledTonalButtonColorsCached = $this$defaultFilledTonalButtonColors.getDefaultFilledTonalButtonColorsCached();
        if (defaultFilledTonalButtonColorsCached == null) {
            ...
            ButtonColors it = new ButtonColors(jFromToken, jFromToken2, jM4001copywmQWz5c, Color.m4001copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken4) : 0.0f), null);
            $this$defaultFilledTonalButtonColors.setDefaultFilledTonalButtonColorsCached$material3_release(it);
            return it;
        }
    ...
    public final ButtonColors outlinedButtonColors(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1344886725, $changed, -1, "androidx.compose.material3.ButtonDefaults.outlinedButtonColors (Button.kt:675)");
        }
    ...
    public final ButtonColors m1826outlinedButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1778526249, $changed, -1, "androidx.compose.material3.ButtonDefaults.outlinedButtonColors (Button.kt:692)");
        }
        ButtonColors buttonColorsM1811copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1811copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme $this$defaultOutlinedButtonColors) {
        ButtonColors defaultOutlinedButtonColorsCached = $this$defaultOutlinedButtonColors.getDefaultOutlinedButtonColorsCached();
    ...
    public final ButtonColors textButtonColors(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1880341584, $changed, -1, "androidx.compose.material3.ButtonDefaults.textButtonColors (Button.kt:717)");
        }
    ...
    public final ButtonColors m1827textButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1402274782, $changed, -1, "androidx.compose.material3.ButtonDefaults.textButtonColors (Button.kt:734)");
        }
        ButtonColors buttonColorsM1811copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1811copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultTextButtonColors$material3_release(ColorScheme $this$defaultTextButtonColors) {
        ButtonColors defaultTextButtonColorsCached = $this$defaultTextButtonColors.getDefaultTextButtonColorsCached();
        ...
        ButtonColors it = new ButtonColors(jM4038getTransparent0d7_KjU, jFromToken, jM4038getTransparent0d7_KjU2, Color.m4001copywmQWz5c(jFromToken2, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken2) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken2) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken2) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken2) : 0.0f), null);
        $this$defaultTextButtonColors.setDefaultTextButtonColorsCached$material3_release(it);
        return it;
    }

    /* renamed from: buttonElevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m1817buttonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilledButtonTokens.INSTANCE.m3090getContainerElevationD9Ej5fM() : defaultElevation;
        float pressedElevation2 = (i & 2) != 0 ? FilledButtonTokens.INSTANCE.m3096getPressedContainerElevationD9Ej5fM() : pressedElevation;
        float focusedElevation2 = (i & 4) != 0 ? FilledButtonTokens.INSTANCE.m3093getFocusContainerElevationD9Ej5fM() : focusedElevation;
        float hoveredElevation2 = (i & 8) != 0 ? FilledButtonTokens.INSTANCE.m3094getHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float disabledElevation2 = (i & 16) != 0 ? FilledButtonTokens.INSTANCE.m3092getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, $changed, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:772)");
        }
    ...
    public final ButtonElevation m1819elevatedButtonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m3006getContainerElevationD9Ej5fM() : defaultElevation;
        float pressedElevation2 = (i & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m3012getPressedContainerElevationD9Ej5fM() : pressedElevation;
        float focusedElevation2 = (i & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m3009getFocusContainerElevationD9Ej5fM() : focusedElevation;
        float hoveredElevation2 = (i & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m3010getHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float disabledElevation2 = (i & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m3008getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1065482445, $changed, -1, "androidx.compose.material3.ButtonDefaults.elevatedButtonElevation (Button.kt:798)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(defaultElevation2, pressedElevation2, focusedElevation2, hoveredElevation2, disabledElevation2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final ButtonElevation m1821filledTonalButtonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m3113getContainerElevationD9Ej5fM() : defaultElevation;
        float pressedElevation2 = (i & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m3119getPressedContainerElevationD9Ej5fM() : pressedElevation;
        float focusedElevation2 = (i & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m3116getFocusContainerElevationD9Ej5fM() : focusedElevation;
        float hoveredElevation2 = (i & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m3117getHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float disabledElevation2 = (i & 16) != 0 ? Dp.m6485constructorimpl(0) : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(5982871, $changed, -1, "androidx.compose.material3.ButtonDefaults.filledTonalButtonElevation (Button.kt:825)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(defaultElevation2, pressedElevation2, focusedElevation2, hoveredElevation2, disabledElevation2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-563957672, $changed, -1, "androidx.compose.material3.ButtonDefaults.<get-outlinedButtonBorder> (Button.kt:836)");
        }
        BorderStroke borderStrokeM263BorderStrokecXLIe8U = BorderStrokeKt.m263BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m3198getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), $composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
