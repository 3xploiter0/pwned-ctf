...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4234constructorimpl$default(null, 1, null);
    ...
    public final void requestUpdates(int cursorUpdateMode) {
        ...
        boolean includeLineBounds2 = false;
        if (Build.VERSION.SDK_INT < 33) {
            includeCharacterBounds = true;
            includeEditorBounds = false;
            includeLineBounds = false;
        } else {
            includeInsertionMarker = (cursorUpdateMode & 16) != 0;
            boolean includeCharacterBounds2 = (cursorUpdateMode & 8) != 0;
            boolean includeEditorBounds2 = (cursorUpdateMode & 4) != 0;
            if (Build.VERSION.SDK_INT >= 34) {
                includeLineBounds2 = (cursorUpdateMode & 32) != 0;
            }
            if (!includeInsertionMarker && !includeCharacterBounds2 && !includeEditorBounds2 && !includeLineBounds2) {
                ...
                includeEditorBounds = includeEditorBounds2;
                includeLineBounds = includeLineBounds2;
            }
        }
        requestUpdates(immediate, monitor, includeInsertionMarker, includeCharacterBounds, includeEditorBounds, includeLineBounds);
    }
        ...
        if (textLayoutCoordinates != null) {
            ...
            if (textLayoutCoordinates != null && (coreCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreCoordinates != null && (decorationBoxCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4243resetimpl(this.matrix);
                    textLayoutCoordinates.mo5355transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m3873setFromEL8BTi8(this.androidMatrix, this.matrix);
                    Rect innerTextFieldBounds = SelectionManagerKt.visibleBounds(coreCoordinates).m3799translatek4lQ0M(textLayoutCoordinates.mo5348localPositionOfR5De75A(coreCoordinates, Offset.INSTANCE.m3778getZeroF1C5BW0()));
                    Rect decorationBoxBounds = SelectionManagerKt.visibleBounds(decorationBoxCoordinates).m3799translatek4lQ0M(textLayoutCoordinates.mo5348localPositionOfR5De75A(decorationBoxCoordinates, Offset.INSTANCE.m3778getZeroF1C5BW0()));
                    return CursorAnchorInfoBuilder_androidKt.m1140buildvxqZcH0(this.builder, text, text.getSelection(), text.getComposition(), textLayoutResult, this.androidMatrix, innerTextFieldBounds, decorationBoxBounds, this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
                return null;
            }
            return null;
