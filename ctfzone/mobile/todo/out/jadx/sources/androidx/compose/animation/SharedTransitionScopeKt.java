...
public final class SharedTransitionScopeKt {
        ...
        if (($dirty & 19) != 18 || !$composer2.getSkipping()) {
            ...
            SharedTransitionScope(ComposableLambdaKt.rememberComposableLambda(-130587847, true, new Function4<SharedTransitionScope, Modifier, Composer, Integer, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt.SharedTransitionLayout.1
                ...
                public final void invoke(SharedTransitionScope $this$SharedTransitionScope, Modifier sharedTransitionModifier, Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C115@5633L78:SharedTransitionScope.kt#xbi5r1");
                    int $dirty2 = $changed2;
                    if (($changed2 & 6) == 0) {
                    ...
                    if (($dirty2 & 147) != 146 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-130587847, $dirty2, -1, "androidx.compose.animation.SharedTransitionLayout.<anonymous> (SharedTransitionScope.kt:115)");
                        }
                        ...
                        int i4 = ((0 >> 6) & 112) | 6;
                        ComposerKt.sourceInformationMarkerStart($composer3, -1574472691, "C116@5692L9:SharedTransitionScope.kt#xbi5r1");
                        function32.invoke($this$SharedTransitionScope, $composer3, Integer.valueOf($dirty2 & 14));
            ...
            LookaheadScopeKt.LookaheadScope(ComposableLambdaKt.rememberComposableLambda(-863967934, true, new Function3<LookaheadScope, Composer, Integer, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt.SharedTransitionScope.1
                ...
                public final void invoke(LookaheadScope $this$LookaheadScope, Composer $composer3, int $changed2) {
                    ...
                    if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv2 = new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.SharedTransitionScopeKt$SharedTransitionScope$1$1$1
                            {
                                super(3);
                            }
                            ...
                            public final MeasureResult m111invoke3p2s80s(final MeasureScope $this$layout, Measurable measurable, long constraints) {
                                final Placeable p = measurable.mo5339measureBRTryo0(constraints);
                                int width = p.getWidth();
                                int height = p.getHeight();
                                final SharedTransitionScopeImpl sharedTransitionScopeImpl = sharedScope;
                                    ...
                                    public final void invoke2(Placeable.PlacementScope $this$layout2) {
                                        ...
                                        if (coords != null) {
                                            if (!$this$layout.isLookingAhead()) {
                                                sharedTransitionScopeImpl.setRoot$animation_release(coords);
                                            } else {
                                                sharedTransitionScopeImpl.setNullableLookaheadRoot$animation_release(coords);
                                            }
                                        }
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer3);
                    Modifier modifierLayout = LayoutModifierKt.layout(companion, (Function3) value$iv2);
                    ComposerKt.sourceInformationMarkerStart($composer3, -538748457, "CC(remember):SharedTransitionScope.kt#9igjgp");
                    Object it$iv3 = $composer3.rememberedValue();
                    if (it$iv3 == Composer.INSTANCE.getEmpty()) {
                        value$iv3 = new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt$SharedTransitionScope$1$2$1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(ContentDrawScope $this$drawWithContent) {
                                ...
                                sharedScope.drawInOverlay$animation_release($this$drawWithContent);
                            }
                        };
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer3);
                    function42.invoke(sharedScope, DrawModifierKt.drawWithContent(modifierLayout, (Function1) value$iv3), $composer3, 6);
                    ...
                    if (it$iv4 == Composer.INSTANCE.getEmpty()) {
                        value$iv4 = new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.animation.SharedTransitionScopeKt$SharedTransitionScope$1$3$1
                            {
                                super(1);
                            }
                            ...
                            public final DisposableEffectResult invoke(DisposableEffectScope $this$DisposableEffect) {
                                ...
                                return new DisposableEffectResult() { // from class: androidx.compose.animation.SharedTransitionScopeKt$SharedTransitionScope$1$3$1$invoke$$inlined$onDispose$1
                                    ...
                                    public void dispose() {
                                        SharedTransitionScopeKt.getSharedTransitionObserver().clear(sharedTransitionScopeImpl);
                                    }
                                };
                            }
                        };
    ...
    public static final Modifier createContentScaleModifier(Modifier $this$createContentScaleModifier, ScaleToBoundsImpl scaleToBounds, final Function0<Boolean> function0) {
        ...
        return $this$createContentScaleModifier.then(companionGraphicsLayer).then(new SkipToLookaheadElement(scaleToBounds, function0));
    }
