...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m224constructorimpl(0);
    private static final int MediaOverlay = m224constructorimpl(1);
    private static final int OnTop = m224constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m223boximpl(int i) {
    ...
    public static boolean m225equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m229unboximpl();
    }
    ...
    public static String m228toStringimpl(int i) {
        return "AndroidExternalSurfaceZOrder(zOrder=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m225equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m227hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m228toStringimpl(this.zOrder);
    }
