...
public final class PaintingStyle {
    ...
    private static final int Fill = m4264constructorimpl(0);
    private static final int Stroke = m4264constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m4263boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4270getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m4271getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4268toStringimpl(int arg0) {
        return m4266equalsimpl0(arg0, Fill) ? "Fill" : m4266equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }
