...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (enforcement) {
            width = Math.max(placeable.getWidth(), $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(DpSize.m6583getWidthD9Ej5fM(size)));
        } else {
            width = placeable.getWidth();
        }
        final int width2 = width;
        if (enforcement) {
            height = Math.max(placeable.getHeight(), $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(DpSize.m6581getHeightD9Ej5fM(size)));
        } else {
            height = placeable.getHeight();
        }
        final int height2 = height;
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width2, height2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveModifierNode$measure$1
