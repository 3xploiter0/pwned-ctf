...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m3495boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3496constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3497equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3498equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3499hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3504toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3497equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3499hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3504toStringimpl(this.composer);
    }
    ...
    public static final void m3502setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m3503setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m3505updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m3506updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = arg0.getInserting();
    ...
    public static final void m3500initimpl(Composer arg0, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3501reconcileimpl(Composer arg0, final Function1<? super T, Unit> function1) {
