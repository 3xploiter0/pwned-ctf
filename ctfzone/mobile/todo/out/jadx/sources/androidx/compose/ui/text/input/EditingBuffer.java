...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m5946getMinimpl(selection);
        this.selectionEnd = TextRange.m5945getMaximpl(selection);
    ...
    public final TextRange m6107getCompositionMzsxiRA$ui_text_release() {
    ...
    public final long m6108getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m6109updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m5946getMinimpl(newSelection));
        setSelectionEnd(TextRange.m5945getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m6109updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
