...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl.sort.1
                ...
                public final Integer invoke(Selectable a, Selectable b) {
                    ...
                    if (layoutCoordinatesA != null) {
                        positionA = containerLayoutCoordinates.mo5348localPositionOfR5De75A(layoutCoordinatesA, Offset.INSTANCE.m3778getZeroF1C5BW0());
                    } else {
                        positionA = Offset.INSTANCE.m3778getZeroF1C5BW0();
                    }
                    if (layoutCoordinatesB != null) {
                        positionB = containerLayoutCoordinates.mo5348localPositionOfR5De75A(layoutCoordinatesB, Offset.INSTANCE.m3778getZeroF1C5BW0());
                    } else {
                        positionB = Offset.INSTANCE.m3778getZeroF1C5BW0();
                    }
                    if (Offset.m3763getYimpl(positionA) == Offset.m3763getYimpl(positionB)) {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m3762getXimpl(positionA)), Float.valueOf(Offset.m3762getXimpl(positionB)));
                    } else {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m3763getYimpl(positionA)), Float.valueOf(Offset.m3763getYimpl(positionB)));
                    }
    ...
    public void mo1391notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m3751boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1390notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m3751boximpl(newPosition), Offset.m3751boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
