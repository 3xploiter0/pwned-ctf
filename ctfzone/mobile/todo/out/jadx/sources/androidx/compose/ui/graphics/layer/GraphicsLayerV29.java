...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m3840getZeroNHjbRc();
        this.renderNode.setClipToBounds(false);
        m4675applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m4639getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo4668setBlendModes9anfk8(int value) {
        ...
        $this$setBlendMode_s9anfk8_u24lambda_u240.setBlendMode(AndroidBlendMode_androidKt.m3854toAndroidBlendModes9anfk8(value));
    ...
    public void mo4667setAmbientShadowColor8_81llA(long value) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4057toArgb8_81llA(value));
    }
    ...
    public void mo4673setSpotShadowColor8_81llA(long value) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4057toArgb8_81llA(value));
    }
    ...
    private final void m4675applyCompositingStrategyZ1X6vPc(RenderNode $this$applyCompositingStrategy_u2dZ1X6vPc, int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4675applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w());
        } else {
            m4675applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo4672setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m6655getWidthimpl(size) + x, IntSize.m6654getHeightimpl(size) + y);
        this.size = IntSizeKt.m6667toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            it.mo4481setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4635equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
