...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m3778getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo1060onStartk4lQ0M(long startPoint) {
                ...
                if (this.this$0.getEnabled() && this.this$0.getDraggingHandle() == null) {
                    ...
                    if (!((state == null || (layoutResult2 = state.getLayoutResult()) == null || !layoutResult2.m1092isPositionOnTextk4lQ0M(startPoint)) ? false : true)) {
                        LegacyTextFieldState state2 = this.this$0.getState();
                        if (state2 != null && (layoutResult = state2.getLayoutResult()) != null) {
                            TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                            int transformedOffset = TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                            int offset = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(transformedOffset);
                            TextFieldValue newValue = textFieldSelectionManager.m1395createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getText(), TextRangeKt.TextRange(offset, offset));
                        ...
                        long adjustedStartSelection = this.this$0.m1398updateSelection8UEBfa8(TextFieldValue.m6190copy3r_uNRQ$default(this.this$0.getValue$foundation_release(), (AnnotatedString) null, TextRange.INSTANCE.m5953getZerod9O1mEE(), (TextRange) null, 5, (Object) null), startPoint, true, false, SelectionAdjustment.INSTANCE.getWord(), true);
                        this.this$0.dragBeginOffsetInText = Integer.valueOf(TextRange.m5948getStartimpl(adjustedStartSelection));
                    }
                    this.this$0.setHandleState(HandleState.None);
                    this.this$0.dragBeginPosition = startPoint;
                    this.this$0.m1397setCurrentDragPosition_kEHs6E(Offset.m3751boximpl(this.this$0.dragBeginPosition));
                    this.this$0.dragTotalDistance = Offset.INSTANCE.m3778getZeroF1C5BW0();
                }
            }
            ...
            */
            public void mo1059onDragk4lQ0M(long r14) {
                /*
                    r13 = this;
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager r0 = r13.this$0
                ...
                L22:
                    ...
                    long r2 = androidx.compose.ui.geometry.Offset.m3767plusMKHz9U(r2, r14)
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$setDragTotalDistance$p(r0, r2)
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager r0 = r13.this$0
                    androidx.compose.foundation.text.LegacyTextFieldState r0 = r0.getState()
                    if (r0 == 0) goto L118
                    androidx.compose.foundation.text.TextLayoutResultProxy r0 = r0.getLayoutResult()
                    if (r0 == 0) goto L118
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager r2 = r13.this$0
                    r10 = 0
                    long r3 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginPosition$p(r2)
                    long r5 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragTotalDistance$p(r2)
                    long r3 = androidx.compose.ui.geometry.Offset.m3767plusMKHz9U(r3, r5)
                    androidx.compose.ui.geometry.Offset r3 = androidx.compose.ui.geometry.Offset.m3751boximpl(r3)
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1393access$setCurrentDragPosition_kEHs6E(r2, r3)
                    java.lang.Integer r3 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginOffsetInText$p(r2)
                    if (r3 != 0) goto Lc5
                    androidx.compose.ui.geometry.Offset r3 = r2.m1401getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r3)
                    long r3 = r3.getPackedValue()
                    boolean r3 = r0.m1092isPositionOnTextk4lQ0M(r3)
                    if (r3 != 0) goto Lc5
                    androidx.compose.ui.text.input.OffsetMapping r9 = r2.getOffsetMapping()
                    long r4 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginPosition$p(r2)
                    r7 = 2
                    r8 = 0
                    r6 = 0
                    r3 = r0
                    int r3 = androidx.compose.foundation.text.TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(r3, r4, r6, r7, r8)
                    int r11 = r9.transformedToOriginal(r3)
                    androidx.compose.ui.text.input.OffsetMapping r9 = r2.getOffsetMapping()
                    androidx.compose.ui.geometry.Offset r3 = r2.m1401getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r3)
                    ...
                    r3 = r0
                    int r3 = androidx.compose.foundation.text.TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(r3, r4, r6, r7, r8)
                    int r12 = r9.transformedToOriginal(r3)
                    if (r11 != r12) goto La1
                    androidx.compose.foundation.text.selection.SelectionAdjustment$Companion r3 = androidx.compose.foundation.text.selection.SelectionAdjustment.INSTANCE
                    androidx.compose.foundation.text.selection.SelectionAdjustment r3 = r3.getNone()
                    r8 = r3
                    goto La8
                La1:
                    androidx.compose.foundation.text.selection.SelectionAdjustment$Companion r3 = androidx.compose.foundation.text.selection.SelectionAdjustment.INSTANCE
                    androidx.compose.foundation.text.selection.SelectionAdjustment r3 = r3.getWord()
                    r8 = r3
                La8:
                    androidx.compose.ui.text.input.TextFieldValue r3 = r2.getValue$foundation_release()
                    androidx.compose.ui.geometry.Offset r4 = r2.m1401getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r4)
                    long r4 = r4.getPackedValue()
                    r6 = 0
                    r7 = 0
                    r9 = 1
                    long r2 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1394access$updateSelection8UEBfa8(r2, r3, r4, r6, r7, r8, r9)
                    goto L114
                Lc5:
                    java.lang.Integer r3 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginOffsetInText$p(r2)
                    if (r3 == 0) goto Ld0
                ...
                Ld0:
                    long r3 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginPosition$p(r2)
                    int r3 = r0.m1091getOffsetForPosition3MmeM6k(r3, r1)
                Ld9:
                    r11 = r3
                    androidx.compose.ui.geometry.Offset r3 = r2.m1401getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r3)
                    long r3 = r3.getPackedValue()
                    int r12 = r0.m1091getOffsetForPosition3MmeM6k(r3, r1)
                    java.lang.Integer r3 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginOffsetInText$p(r2)
                    if (r3 != 0) goto Lf4
                    if (r11 != r12) goto Lf4
                    return
                Lf4:
                    ...
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r4)
                    long r4 = r4.getPackedValue()
                    androidx.compose.foundation.text.selection.SelectionAdjustment$Companion r6 = androidx.compose.foundation.text.selection.SelectionAdjustment.INSTANCE
                    androidx.compose.foundation.text.selection.SelectionAdjustment r8 = r6.getWord()
                    r6 = 0
                    r7 = 0
                    r9 = 1
                    long r2 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1394access$updateSelection8UEBfa8(r2, r3, r4, r6, r7, r8, r9)
                L114:
                    androidx.compose.ui.text.TextRange.m5936boximpl(r2)
                L118:
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager r0 = r13.this$0
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$updateFloatingToolbar(r0, r1)
                    return
                L11f:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1.mo1059onDragk4lQ0M(long):void");
            }
            ...
            private final void onEnd() {
                ...
                this.this$0.m1397setCurrentDragPosition_kEHs6E(null);
                this.this$0.updateFloatingToolbar(true);
                this.this$0.dragBeginOffsetInText = null;
                boolean collapsed = TextRange.m5942getCollapsedimpl(this.this$0.getValue$foundation_release().getSelection());
                this.this$0.setHandleState(collapsed ? HandleState.Cursor : HandleState.Selection);
                LegacyTextFieldState state = this.this$0.getState();
                if (state != null) {
                    state.setShowSelectionHandleStart(!collapsed && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, true));
                }
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
                    state2.setShowSelectionHandleEnd(!collapsed && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, false));
                }
                LegacyTextFieldState state3 = this.this$0.getState();
                if (state3 != null) {
                    state3.setShowCursorHandle(collapsed && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, true));
                }
            }
        };
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo1273onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                LegacyTextFieldState state;
                if (this.this$0.getEnabled()) {
                    if ((this.this$0.getValue$foundation_release().getText().length() == 0) || (state = this.this$0.getState()) == null || state.getLayoutResult() == null) {
                        return false;
            ...
            public final void updateMouseSelection(TextFieldValue value, long currentPosition, boolean isStartOfSelection, SelectionAdjustment adjustment) {
                long newSelection = this.this$0.m1398updateSelection8UEBfa8(value, currentPosition, isStartOfSelection, false, adjustment, false);
                this.this$0.setHandleState(TextRange.m5942getCollapsedimpl(newSelection) ? HandleState.Cursor : HandleState.Selection);
            }
    ...
    public final void m1397setCurrentDragPosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.currentDragPosition;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1401getCurrentDragPosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo1058onDownk4lQ0M(long point) {
                ...
                long handleCoordinates = SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(this.this$0.m1403getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
                long translatedPosition = layoutResult.m1094translateInnerToDecorationCoordinatesMKHz9U$foundation_release(handleCoordinates);
                this.this$0.dragBeginPosition = translatedPosition;
                this.this$0.m1397setCurrentDragPosition_kEHs6E(Offset.m3751boximpl(translatedPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m3778getZeroF1C5BW0();
                this.this$0.previousRawDragOffset = -1;
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
            ...
            public void mo1059onDragk4lQ0M(long delta) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m3767plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                this.this$0.m1397setCurrentDragPosition_kEHs6E(Offset.m3751boximpl(Offset.m3767plusMKHz9U(this.this$0.dragBeginPosition, this.this$0.dragTotalDistance)));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                TextFieldValue value$foundation_release = this.this$0.getValue$foundation_release();
                Offset offsetM1401getCurrentDragPosition_m7T9E = this.this$0.m1401getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E);
                textFieldSelectionManager2.m1398updateSelection8UEBfa8(value$foundation_release, offsetM1401getCurrentDragPosition_m7T9E.getPackedValue(), false, isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate(), true);
                this.this$0.updateFloatingToolbar(false);
            }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo1060onStartk4lQ0M(long startPoint) {
                TextLayoutResultProxy layoutResult;
                long handleCoordinates = SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(this.this$0.m1403getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
            ...
            public void mo1059onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                    textFieldSelectionManager2.m1397setCurrentDragPosition_kEHs6E(Offset.m3751boximpl(Offset.m3767plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                    OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                    Offset offsetM1401getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m1401getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E);
                    int offset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1401getCurrentDragPosition_m7T9E.getPackedValue(), false, 2, null));
                    long newSelection = TextRangeKt.TextRange(offset, offset);
                    if (TextRange.m5941equalsimpl0(newSelection, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                        return;
                    }
                    ...
                    textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m1395createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getText(), newSelection));
                }
            }
    ...
    public static /* synthetic */ void m1396deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m1400deselect_kEHs6E$foundation_release(offset);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m1400deselect_kEHs6E$foundation_release(androidx.compose.ui.geometry.Offset r10) {
        /*
            r9 = this;
            androidx.compose.ui.text.input.TextFieldValue r0 = r9.getValue$foundation_release()
            long r0 = r0.getSelection()
            boolean r0 = androidx.compose.ui.text.TextRange.m5942getCollapsedimpl(r0)
            if (r0 != 0) goto L51
        ...
        L18:
            ...
            r4 = 0
            r1 = r0
            int r1 = androidx.compose.foundation.text.TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(r1, r2, r4, r5, r6)
        ...
        L2f:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m5945getMaximpl(r1)
        L3b:
            ...
            r3 = 0
            r6 = 0
            androidx.compose.ui.text.input.TextFieldValue r2 = androidx.compose.ui.text.input.TextFieldValue.m6190copy3r_uNRQ$default(r2, r3, r4, r6, r7, r8)
        ...
        L6e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1400deselect_kEHs6E$foundation_release(androidx.compose.ui.geometry.Offset):void");
    }

    /* renamed from: setSelectionPreviewHighlight-5zc-tL8$foundation_release, reason: not valid java name */
    public final void m1405setSelectionPreviewHighlight5zctL8$foundation_release(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1021setSelectionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1018setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5953getZerod9O1mEE());
        }
        if (!TextRange.m5942getCollapsedimpl(range)) {
            exitSelectionMode$foundation_release();
        }
    }

    /* renamed from: setDeletionPreviewHighlight-5zc-tL8$foundation_release, reason: not valid java name */
    public final void m1404setDeletionPreviewHighlight5zctL8$foundation_release(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1018setDeletionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1021setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5953getZerod9O1mEE());
        }
        if (!TextRange.m5942getCollapsedimpl(range)) {
            exitSelectionMode$foundation_release();
        }
    ...
    public final void clearPreviewHighlight$foundation_release() {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1018setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5953getZerod9O1mEE());
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 == null) {
            return;
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        if (TextRange.m5942getCollapsedimpl(getValue$foundation_release().getSelection())) {
            return;
        }
        ...
        if (cancelSelection) {
            int newCursorOffset = TextRange.m5945getMaximpl(getValue$foundation_release().getSelection());
            TextFieldValue newValue = m1395createTextFieldValueFDrldGo(getValue$foundation_release().getText(), TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
    ...
    public final void paste$foundation_release() {
        ...
        int newCursorOffset = TextRange.m5946getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        TextFieldValue newValue = m1395createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int newCursorOffset = TextRange.m5946getMinimpl(getValue$foundation_release().getSelection());
        TextFieldValue newValue = m1395createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue newValue = m1395createTextFieldValueFDrldGo(getValue$foundation_release().getText(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(newValue);
        this.oldValue = TextFieldValue.m6190copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, newValue.getSelection(), (TextRange) null, 5, (Object) null);
        enterSelectionMode$foundation_release(true);
    }

    /* renamed from: getHandlePosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m1403getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        TextLayoutResultProxy layoutResult;
        ...
        int offset = isStartHandle ? TextRange.m5948getStartimpl(selection) : TextRange.m5943getEndimpl(selection);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(textLayoutResult, this.offsetMapping.originalToTransformed(offset), isStartHandle, TextRange.m5947getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m1402getCursorPositiontuRUvjQ$foundation_release(Density density) {
        int offset = this.offsetMapping.originalToTransformed(TextRange.m5948getStartimpl(getValue$foundation_release().getSelection()));
        LegacyTextFieldState legacyTextFieldState = this.state;
        ...
        float x = cursorRect.getLeft() + (density.mo373toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2);
    ...
    */
    public final void showSelectionToolbar$foundation_release() {
        ...
        L19:
            ...
            boolean r3 = androidx.compose.ui.text.TextRange.m5942getCollapsedimpl(r3)
            r4 = 0
            if (r3 != 0) goto L37
            if (r0 != 0) goto L37
        ...
        L38:
            ...
            boolean r3 = androidx.compose.ui.text.TextRange.m5942getCollapsedimpl(r5)
            if (r3 != 0) goto L58
        ...
        L78:
            ...
            long r1 = r1.getSelection()
            int r1 = androidx.compose.ui.text.TextRange.m5944getLengthimpl(r1)
    ...
    public final void m1399contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null && (layoutResult = legacyTextFieldState.getLayoutResult()) != null) {
            int offset = TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
            if (!TextRange.m5939containsimpl(getValue$foundation_release().getSelection(), offset)) {
                this.previousRawDragOffset = -1;
                m1398updateSelection8UEBfa8(getValue$foundation_release(), position, true, false, SelectionAdjustment.INSTANCE.getWord(), false);
            }
        }
    }
    ...
    private final Rect getContentRect() {
        ...
        if (it != null) {
            ...
            if (it != null) {
                int transformedStart = this.offsetMapping.originalToTransformed(TextRange.m5948getStartimpl(getValue$foundation_release().getSelection()));
                int transformedEnd = this.offsetMapping.originalToTransformed(TextRange.m5943getEndimpl(getValue$foundation_release().getSelection()));
                LegacyTextFieldState legacyTextFieldState = this.state;
                long startOffset = (legacyTextFieldState == null || (layoutCoordinates4 = legacyTextFieldState.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m3778getZeroF1C5BW0() : layoutCoordinates4.mo5350localToRootMKHz9U(m1403getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState legacyTextFieldState2 = this.state;
                long endOffset = (legacyTextFieldState2 == null || (layoutCoordinates3 = legacyTextFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m3778getZeroF1C5BW0() : layoutCoordinates3.mo5350localToRootMKHz9U(m1403getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (legacyTextFieldState3 == null || (layoutCoordinates2 = legacyTextFieldState3.getLayoutCoordinates()) == null) {
                    ...
                    startTop = Offset.m3763getYimpl(layoutCoordinates2.mo5350localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(transformedStart)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (legacyTextFieldState4 != null && (layoutCoordinates = legacyTextFieldState4.getLayoutCoordinates()) != null) {
                    ...
                    endTop = Offset.m3763getYimpl(layoutCoordinates.mo5350localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(transformedEnd)) == null) ? 0.0f : cursorRect.getTop())));
                }
                float left = Math.min(Offset.m3762getXimpl(startOffset), Offset.m3762getXimpl(endOffset));
                float right = Math.max(Offset.m3762getXimpl(startOffset), Offset.m3762getXimpl(endOffset));
                float top = Math.min(startTop, endTop);
                float bottom = Math.max(Offset.m3763getYimpl(startOffset), Offset.m3763getYimpl(endOffset)) + (Dp.m6485constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final long m1398updateSelection8UEBfa8(androidx.compose.ui.text.input.TextFieldValue r26, long r27, boolean r29, boolean r30, androidx.compose.foundation.text.selection.SelectionAdjustment r31, boolean r32) {
        /*
            Method dump skipped, instructions count: 432
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1398updateSelection8UEBfa8(androidx.compose.ui.text.input.TextFieldValue, long, boolean, boolean, androidx.compose.foundation.text.selection.SelectionAdjustment, boolean):long");
    }
    ...
    public final TextFieldValue m1395createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
