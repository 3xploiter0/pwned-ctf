...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo64measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        long childConstraints = Constraints.m6428copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6440getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6438getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6439getMinHeightimpl(constraints) : height, (11 & 8) != 0 ? Constraints.m6437getMaxHeightimpl(constraints) : height);
