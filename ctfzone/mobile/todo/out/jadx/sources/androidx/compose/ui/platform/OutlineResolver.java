...
public final class OutlineResolver {
    ...
    public OutlineResolver() {
        ...
        this.rectTopLeft = Offset.INSTANCE.m3778getZeroF1C5BW0();
        this.rectSize = Size.INSTANCE.m3840getZeroNHjbRc();
    }
    ...
    public final boolean m5730updateS_szKao(androidx.compose.ui.graphics.Outline outline, float alpha, boolean clipToOutline, float elevation, long size) {
    ...
    public final boolean m5729isInOutlinek4lQ0M(long position) {
        androidx.compose.ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.outline) != null) {
            return ShapeContainingUtilKt.isInOutline(outline, Offset.m3762getXimpl(position), Offset.m3763getYimpl(position), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (targetPath != null) {
            Canvas.m3974clipPathmtrdDE$default(canvas, targetPath, 0, 2, null);
            return;
        }
        if (this.roundedCornerRadius > 0.0f) {
            Path roundRectClipPath = this.tmpPath;
            RoundRect roundRect = this.tmpRoundRect;
            if (roundRectClipPath == null || !m5728isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, this.roundedCornerRadius)) {
                RoundRect roundRect2 = RoundRectKt.m3816RoundRectgG7oq9Y(Offset.m3762getXimpl(this.rectTopLeft), Offset.m3763getYimpl(this.rectTopLeft), Offset.m3762getXimpl(this.rectTopLeft) + Size.m3831getWidthimpl(this.rectSize), Offset.m3763getYimpl(this.rectTopLeft) + Size.m3828getHeightimpl(this.rectSize), CornerRadiusKt.CornerRadius$default(this.roundedCornerRadius, 0.0f, 2, null));
            ...
            Canvas.m3974clipPathmtrdDE$default(canvas, roundRectClipPath, 0, 2, null);
            return;
        }
        Canvas.m3975clipRectN_I0leg$default(canvas, Offset.m3762getXimpl(this.rectTopLeft), Offset.m3763getYimpl(this.rectTopLeft), Offset.m3762getXimpl(this.rectTopLeft) + Size.m3831getWidthimpl(this.rectSize), Offset.m3763getYimpl(this.rectTopLeft) + Size.m3828getHeightimpl(this.rectSize), 0, 16, null);
    }
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (outline != null && this.outlineNeeded && Size.m3831getWidthimpl(this.rectSize) > 0.0f && Size.m3828getHeightimpl(this.rectSize) > 0.0f) {
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float radius = CornerRadius.m3737getXimpl(roundRect.m3812getTopLeftCornerRadiuskKHJgLs());
        ...
        if (RoundRectKt.isSimple(roundRect)) {
            ...
            int $i$f$fastRoundToInt4 = Math.round($this$fastRoundToInt$iv4);
            outline.setRoundRect($i$f$fastRoundToInt, $i$f$fastRoundToInt2, $i$f$fastRoundToInt3, $i$f$fastRoundToInt4, radius);
    ...
    private final boolean m5728isSameBounds4L21HEs(RoundRect $this$isSameBounds_u2d4L21HEs, long offset, long size, float radius) {
        if ($this$isSameBounds_u2d4L21HEs == null || !RoundRectKt.isSimple($this$isSameBounds_u2d4L21HEs)) {
            return false;
        }
        if ($this$isSameBounds_u2d4L21HEs.getLeft() == Offset.m3762getXimpl(offset)) {
            if ($this$isSameBounds_u2d4L21HEs.getTop() == Offset.m3763getYimpl(offset)) {
                if ($this$isSameBounds_u2d4L21HEs.getRight() == Offset.m3762getXimpl(offset) + Size.m3831getWidthimpl(size)) {
                    if ($this$isSameBounds_u2d4L21HEs.getBottom() == Offset.m3763getYimpl(offset) + Size.m3828getHeightimpl(size)) {
                        return (CornerRadius.m3737getXimpl($this$isSameBounds_u2d4L21HEs.m3812getTopLeftCornerRadiuskKHJgLs()) > radius ? 1 : (CornerRadius.m3737getXimpl($this$isSameBounds_u2d4L21HEs.m3812getTopLeftCornerRadiuskKHJgLs()) == radius ? 0 : -1)) == 0;
                    }
                    return false;
                }
                return false;
