...
public final class Oklab extends ColorSpace {
    ...
    public Oklab(String name, int id) {
        super(name, ColorModel.INSTANCE.m4416getLabxdoWZVw(), id, null);
    }
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        float minimumValue$iv2 = $this$fastCoerceAtLeast$iv$iv2;
        ...
        float minimumValue$iv3 = $this$fastCoerceAtLeast$iv$iv3;
        float[] lhs$iv = InverseM2;
        float v01 = (lhs$iv[0] * minimumValue$iv) + (lhs$iv[3] * minimumValue$iv2) + (lhs$iv[6] * minimumValue$iv3);
        float[] lhs$iv2 = InverseM2;
        float v11 = (lhs$iv2[1] * minimumValue$iv) + (lhs$iv2[4] * minimumValue$iv2) + (lhs$iv2[7] * minimumValue$iv3);
        float[] lhs$iv3 = InverseM2;
        float v21 = (lhs$iv3[2] * minimumValue$iv) + (lhs$iv3[5] * minimumValue$iv2) + (lhs$iv3[8] * minimumValue$iv3);
    ...
    public long mo4420xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        float[] lhs$iv = M1;
