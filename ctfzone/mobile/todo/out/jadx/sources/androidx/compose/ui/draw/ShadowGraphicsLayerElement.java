...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m3658copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return shadowGraphicsLayerElement.m3662copygNMxBKI(f, shape2, z2, j3, j2);
    }
    ...
    public final ShadowGraphicsLayerElement m3662copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6490equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m4004equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m4004equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m6491hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + Color.m4010hashCodeimpl(this.ambientColor)) * 31) + Color.m4010hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m6496toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m4011toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m4011toStringimpl(this.spotColor)) + ')';
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m3664getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m3663getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m3665getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement.createBlock.1
            ...
            public final void invoke2(GraphicsLayerScope $this$null) {
                $this$null.setShadowElevation($this$null.mo373toPx0680j_4(ShadowGraphicsLayerElement.this.m3664getElevationD9Ej5fM()));
                $this$null.setShape(ShadowGraphicsLayerElement.this.getShape());
                $this$null.setClip(ShadowGraphicsLayerElement.this.getClip());
                $this$null.mo4193setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m3663getAmbientColor0d7_KjU());
                $this$null.mo4195setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m3665getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("elevation", Dp.m6483boximpl(this.elevation));
        ...
        $this$inspectableProperties.getProperties().set("ambientColor", Color.m3993boximpl(this.ambientColor));
        $this$inspectableProperties.getProperties().set("spotColor", Color.m3993boximpl(this.spotColor));
    }
}
