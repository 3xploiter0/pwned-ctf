...
public final class ContentDataType {
    ...
    private static final int Text = m3621constructorimpl(1);
    private static final int List = m3621constructorimpl(3);
    private static final int Date = m3621constructorimpl(4);
    private static final int Toggle = m3621constructorimpl(2);
    private static final int None = m3621constructorimpl(0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ContentDataType m3620boximpl(int i) {
        return new ContentDataType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3621constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3622equalsimpl(int i, Object obj) {
        return (obj instanceof ContentDataType) && i == ((ContentDataType) obj).m3626unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3623equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3624hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m3622equalsimpl(this.dataType, obj);
    }

    public int hashCode() {
        return m3624hashCodeimpl(this.dataType);
    }

    public String toString() {
        return m3625toStringimpl(this.dataType);
    }
