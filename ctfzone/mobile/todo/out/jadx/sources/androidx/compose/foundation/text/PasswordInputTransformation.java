...
public final class PasswordInputTransformation implements InputTransformation {
    ...
    public void transformInput(TextFieldBuffer $this$transformInput) {
        boolean singleCharacterInsertion = $this$transformInput.getChanges().getChangeCount() == 1 && TextRange.m5944getLengthimpl($this$transformInput.getChanges().mo1107getRangejx7JFs(0)) == 1 && TextRange.m5944getLengthimpl($this$transformInput.getChanges().mo1106getOriginalRangejx7JFs(0)) == 0;
        if (!singleCharacterInsertion || $this$transformInput.hasSelection()) {
            setRevealCodepointIndex(-1);
            return;
        }
        int insertionPoint = TextRange.m5946getMinimpl($this$transformInput.getChanges().mo1107getRangejx7JFs(0));
