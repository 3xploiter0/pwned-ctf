...
public final class InfiniteTransitionKt {
    ...
    public static final <T, V extends AnimationVector> State<T> animateValue(final InfiniteTransition $this$animateValue, final T t, final T t2, TwoWayConverter<T, V> twoWayConverter, final InfiniteRepeatableSpec<T> infiniteRepeatableSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv;
        Object value$iv2;
        ...
        if (value$iv3 == Composer.INSTANCE.getEmpty()) {
            value$iv3 = $this$animateValue.new TransitionAnimationState(t, t2, twoWayConverter, infiniteRepeatableSpec, label2);
            $composer.updateRememberedValue(value$iv3);
        }
        final InfiniteTransition.TransitionAnimationState transitionAnimation = (InfiniteTransition.TransitionAnimationState) value$iv3;
        ComposerKt.sourceInformationMarkerEnd($composer);
        ComposerKt.sourceInformationMarkerStart($composer, 1444229998, "CC(remember):InfiniteTransition.kt#9igjgp");
        boolean z = true;
        boolean z2 = (((($changed & 112) ^ 48) > 32 && $composer.changedInstance(t)) || ($changed & 48) == 32) | (((($changed & 896) ^ 384) > 256 && $composer.changedInstance(t2)) || ($changed & 384) == 256);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = (Function0) new Function0<Unit>() { // from class: androidx.compose.animation.core.InfiniteTransitionKt$animateValue$1$1
                ...
                public final void invoke2() {
                    if (!Intrinsics.areEqual(t, transitionAnimation.getInitialValue$animation_core_release()) || !Intrinsics.areEqual(t2, transitionAnimation.getTargetValue$animation_core_release())) {
                        transitionAnimation.updateValues$animation_core_release(t, t2, infiniteRepeatableSpec);
                    }
                }
            };
            $composer.updateRememberedValue(value$iv);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.SideEffect((Function0) value$iv, $composer, 0);
        ComposerKt.sourceInformationMarkerStart($composer, 1444242260, "CC(remember):InfiniteTransition.kt#9igjgp");
        boolean invalid$iv2 = $composer.changedInstance($this$animateValue);
        Object it$iv2 = $composer.rememberedValue();
        if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.animation.core.InfiniteTransitionKt$animateValue$2$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.DisposableEffect(transitionAnimation, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) value$iv2, $composer, 6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
