...
final /* data */ class FlowMeasureLazyPolicy implements FlowLineMeasurePolicy {
    ...
    public String toString() {
        ...
        sb.append("FlowMeasureLazyPolicy(isHorizontal=").append(this.isHorizontal).append(", horizontalArrangement=").append(this.horizontalArrangement).append(", verticalArrangement=").append(this.verticalArrangement).append(", mainAxisSpacing=").append((Object) Dp.m6496toStringimpl(this.mainAxisSpacing)).append(", crossAxisAlignment=").append(this.crossAxisAlignment).append(", crossAxisArrangementSpacing=").append((Object) Dp.m6496toStringimpl(this.crossAxisArrangementSpacing)).append(", itemCount=").append(this.itemCount).append(", maxLines=").append(this.maxLines).append(", maxItemsInMainAxis=").append(this.maxItemsInMainAxis).append(", overflow=").append(this.overflow).append(", overflowComposables=").append(this.overflowComposables).append(", getComposable=");
    ...
    public final Function2<SubcomposeMeasureScope, Constraints, MeasureResult> getMeasurePolicy() {
        return new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy.getMeasurePolicy.1
            ...
            public final MeasureResult m624invoke0kLqBqw(SubcomposeMeasureScope measureScope, long constraints) {
                return FlowMeasureLazyPolicy.this.m622measure0kLqBqw(measureScope, constraints);
            }
        };
    }
    ...
    public final MeasureResult m622measure0kLqBqw(final SubcomposeMeasureScope $this$measure_u2d0kLqBqw, long constraints) {
        LayoutOrientation layoutOrientation;
        if (this.itemCount <= 0 || this.maxLines == 0 || this.maxItemsInMainAxis == 0 || (Constraints.m6437getMaxHeightimpl(constraints) == 0 && this.overflow.getType$foundation_layout_release() != FlowLayoutOverflow.OverflowType.Visible)) {
        ...
        ContextualFlowItemIterator measurablesIterator = new ContextualFlowItemIterator(this.itemCount, new Function2<Integer, FlowLineInfo, List<? extends Measurable>>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$measure$measurablesIterator$1
            ...
            public final List<Measurable> invoke(final int index, final FlowLineInfo info) {
                ...
                return subcomposeMeasureScope.subcompose(numValueOf, ComposableLambdaKt.composableLambdaInstance(-195060736, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$measure$measurablesIterator$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
                    }
                    ...
                    public final void invoke(Composer $composer, int $changed) {
                        ...
                        if (($changed & 3) != 2 || !$composer.getSkipping()) {
                            ...
                            flowMeasureLazyPolicy.getComposable.invoke(Integer.valueOf(index), info, $composer, 0);
                            if (ComposerKt.isTraceInProgress()) {
        ...
        this.overflow.m612setOverflowMeasurablesVKLhPVY$foundation_layout_release(this, constraints, new Function2<Boolean, Integer, Measurable>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final Measurable invoke(boolean z, int i) {
                ...
                return (Measurable) CollectionsKt.getOrNull($this$measure_u2d0kLqBqw.subcompose(new StringBuilder().append(z).append(this.this$0.itemCount).append(i).toString(), function2), 0);
            }
        });
        SubcomposeMeasureScope subcomposeMeasureScope = $this$measure_u2d0kLqBqw;
        ...
        return FlowLayoutKt.m606breakDownItemsdi9J0FM(subcomposeMeasureScope, flowMeasureLazyPolicy, contextualFlowItemIterator, f, f2, OrientationIndependentConstraints.m650constructorimpl(constraints, layoutOrientation), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }
}
