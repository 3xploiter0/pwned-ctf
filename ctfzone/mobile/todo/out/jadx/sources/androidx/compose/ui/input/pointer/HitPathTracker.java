...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m5137addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m5138addHitPathQJqDSyo(j, list, z);
    }
    ...
    */
    public final void m5138addHitPathQJqDSyo(long r26, java.util.List<? extends androidx.compose.ui.Modifier.Node> r28, boolean r29) {
        /*
            Method dump skipped, instructions count: 381
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.HitPathTracker.m5138addHitPathQJqDSyo(long, java.util.List, boolean):void");
    }
