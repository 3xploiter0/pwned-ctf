...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m6485constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m6485constructorimpl((float) 4.0d);
    ...
    public final float m3150getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
