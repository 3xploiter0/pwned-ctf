...
public final class NodeMeasuringIntrinsics {
    ...
    public interface ApproachMeasureBlock {
        ...
        MeasureResult mo5315measure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);
    }
    ...
    public interface MeasureBlock {
        /* renamed from: measure-3p2s80s */
        MeasureResult mo5484measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui_release(ApproachMeasureBlock measureBlock, ApproachIntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        MeasureResult layoutResult = measureBlock.mo5315measure3p2s80s(new ApproachIntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
    ...
    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        DefaultIntrinsicMeasurable measurable = new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width);
        long constraints = ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null);
        MeasureResult layoutResult = measureBlock.mo5484measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
        return layoutResult.get$w();
    }
    ...
    private static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public Placeable mo5339measureBRTryo0(long constraints) {
            ...
            int iM6438getMaxWidthimpl = LayoutKt.LargeDimension;
            if (intrinsicWidthHeight == intrinsicWidthHeight2) {
                if (this.minMax == IntrinsicMinMax.Max) {
                    width = this.measurable.maxIntrinsicWidth(Constraints.m6437getMaxHeightimpl(constraints));
                } else {
                    width = this.measurable.minIntrinsicWidth(Constraints.m6437getMaxHeightimpl(constraints));
                }
                if (Constraints.m6433getHasBoundedHeightimpl(constraints)) {
                    iM6438getMaxWidthimpl = Constraints.m6437getMaxHeightimpl(constraints);
                }
                int height2 = iM6438getMaxWidthimpl;
                return new EmptyPlaceable(width, height2);
            }
            if (this.minMax == IntrinsicMinMax.Max) {
                height = this.measurable.maxIntrinsicHeight(Constraints.m6438getMaxWidthimpl(constraints));
            } else {
                height = this.measurable.minIntrinsicHeight(Constraints.m6438getMaxWidthimpl(constraints));
            }
            if (Constraints.m6434getHasBoundedWidthimpl(constraints)) {
                iM6438getMaxWidthimpl = Constraints.m6438getMaxWidthimpl(constraints);
            }
            int width2 = iM6438getMaxWidthimpl;
            return new EmptyPlaceable(width2, height);
        }
