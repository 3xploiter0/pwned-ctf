...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean bounded, float radius, State<Color> state, State<RippleAlpha> state2, ViewGroup view) {
        ...
        this.rippleSize = Size.INSTANCE.m3840getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        int iRoundToInt;
        this.rippleSize = $this$drawIndication.mo4559getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m1757getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo4559getSizeNHjbRc()));
        } else {
            iRoundToInt = $this$drawIndication.mo367roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = iRoundToInt;
        long color = this.color.getValue().m4013unboximpl();
        float alpha = this.rippleAlpha.getValue().getPressedAlpha();
        $this$drawIndication.drawContent();
        m1762drawStateLayerH2RKhps($this$drawIndication, this.radius, color);
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1761updateRipplePropertiesbiQXAtU($this$drawIndication.mo4559getSizeNHjbRc(), this.rippleRadius, color, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m1760addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4013unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
