...
public final class ContextMenuUi_androidKt {
    ...
    static {
        long jM4040getWhite0d7_KjU = Color.INSTANCE.m4040getWhite0d7_KjU();
        long jM4029getBlack0d7_KjU = Color.INSTANCE.m4029getBlack0d7_KjU();
        long jM4029getBlack0d7_KjU2 = Color.INSTANCE.m4029getBlack0d7_KjU();
        long jM4029getBlack0d7_KjU3 = Color.INSTANCE.m4029getBlack0d7_KjU();
        long jM4001copywmQWz5c = Color.m4001copywmQWz5c(jM4029getBlack0d7_KjU3, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM4029getBlack0d7_KjU3) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM4029getBlack0d7_KjU3) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM4029getBlack0d7_KjU3) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM4029getBlack0d7_KjU3) : 0.0f);
        long jM4029getBlack0d7_KjU4 = Color.INSTANCE.m4029getBlack0d7_KjU();
        DefaultContextMenuColors = new ContextMenuColors(jM4040getWhite0d7_KjU, jM4029getBlack0d7_KjU, jM4029getBlack0d7_KjU2, jM4001copywmQWz5c, Color.m4001copywmQWz5c(jM4029getBlack0d7_KjU4, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM4029getBlack0d7_KjU4) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM4029getBlack0d7_KjU4) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM4029getBlack0d7_KjU4) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM4029getBlack0d7_KjU4) : 0.0f), null);
    }
    ...
    public static final void ContextMenuPopup(final PopupPositionProvider popupPositionProvider, final Function0<Unit> function0, Modifier modifier, final Function1<? super ContextMenuScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(712057293, $dirty, -1, "androidx.compose.foundation.contextmenu.ContextMenuPopup (ContextMenuUi.android.kt:103)");
            }
            ContextMenuPopup(popupPositionProvider, function0, modifier4, computeContextMenuColors(0, 0, $composer2, 0, 3), function1, $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | (($dirty << 3) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuUi_androidKt.ContextMenuPopup.1
                ...
                public final void invoke(Composer composer, int i3) {
                    ContextMenuUi_androidKt.ContextMenuPopup(popupPositionProvider, function0, modifier5, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void ContextMenuPopup(final PopupPositionProvider popupPositionProvider, final Function0<Unit> function0, Modifier modifier, final ContextMenuColors colors, final Function1<? super ContextMenuScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuUi_androidKt.ContextMenuPopup.3
                ...
                public final void invoke(Composer composer, int i3) {
                    ContextMenuUi_androidKt.ContextMenuPopup(popupPositionProvider, function0, modifier4, colors, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void ContextMenuColumn(final ContextMenuColors colors, Modifier modifier, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        Modifier modifier3;
        Composer $composer2 = $composer.startRestartGroup(-921259293);
        ComposerKt.sourceInformation($composer2, "C(ContextMenuColumn)P(!1,2)154@5499L21,145@5128L427:ContextMenuUi.android.kt#3xeu6s");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            Modifier.Companion modifier4 = i2 != 0 ? Modifier.INSTANCE : modifier2;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-921259293, $dirty2, -1, "androidx.compose.foundation.contextmenu.ContextMenuColumn (ContextMenuUi.android.kt:144)");
            }
            Modifier modifier$iv = ScrollKt.verticalScroll$default(PaddingKt.m683paddingVpY3zN4$default(IntrinsicKt.width(BackgroundKt.m236backgroundbw27NRU$default(ShadowKt.m3666shadows4CzXII(modifier4, ContextMenuSpec.INSTANCE.m356getMenuContainerElevationD9Ej5fM(), (24 & 2) != 0 ? RectangleShapeKt.getRectangleShape() : RoundedCornerShapeKt.m964RoundedCornerShape0680j_4(ContextMenuSpec.INSTANCE.m348getCornerRadiusD9Ej5fM()), (24 & 4) != 0 ? Dp.m6484compareTo0680j_4(24, Dp.m6485constructorimpl((float) 0)) > 0 : false, (24 & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (24 & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L), colors.getBackgroundColor(), null, 2, null), IntrinsicSize.Max), 0.0f, ContextMenuSpec.INSTANCE.m357getVerticalPaddingD9Ej5fM(), 1, null), ScrollKt.rememberScrollState(0, $composer2, 0, 1), false, null, false, 14, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuUi_androidKt.ContextMenuColumn.1
                ...
                public final void invoke(Composer composer, int i4) {
                    ContextMenuUi_androidKt.ContextMenuColumn(colors, modifier6, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void ContextMenuItem(final String label, final boolean enabled, final ContextMenuColors colors, Modifier modifier, Function3<? super Color, ? super Composer, ? super Integer, Unit> function3, final Function0<Unit> function0, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            leadingIcon = i3 != 0 ? null : function32;
            if (ComposerKt.isTraceInProgress()) {
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM561spacedBy0680j_4 = Arrangement.INSTANCE.m561spacedBy0680j_4(ContextMenuSpec.INSTANCE.m350getHorizontalPaddingD9Ej5fM());
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new Function0<Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuUi_androidKt$ContextMenuItem$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            Modifier modifier5 = modifier4;
            Modifier modifierM683paddingVpY3zN4$default = PaddingKt.m683paddingVpY3zN4$default(SizeKt.m729sizeInqDBjuR0(SizeKt.fillMaxWidth$default(ClickableKt.m269clickableXHw0xAI$default(modifier4, enabled, label, null, (Function0) value$iv, 4, null), 0.0f, 1, null), ContextMenuSpec.INSTANCE.m347getContainerWidthMinD9Ej5fM(), ContextMenuSpec.INSTANCE.m355getListItemHeightD9Ej5fM(), ContextMenuSpec.INSTANCE.m346getContainerWidthMaxD9Ej5fM(), ContextMenuSpec.INSTANCE.m355getListItemHeightD9Ej5fM()), ContextMenuSpec.INSTANCE.m350getHorizontalPaddingD9Ej5fM(), 0.0f, 2, null);
            ComposerKt.sourceInformationMarkerStart($composer2, 693286680, "CC(Row)P(2,1,3)99@5018L58,100@5081L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv = RowKt.rowMeasurePolicy(horizontalOrVerticalM561spacedBy0680j_4, labelVerticalTextAlignment, $composer2, ((432 >> 3) & 14) | ((432 >> 3) & 112));
            ...
            if (leadingIcon == null) {
                ...
                Function3 icon = leadingIcon;
                Modifier modifier$iv = SizeKt.m722requiredSizeInqDBjuR0$default(Modifier.INSTANCE, ContextMenuSpec.INSTANCE.m351getIconSizeD9Ej5fM(), 0.0f, ContextMenuSpec.INSTANCE.m351getIconSizeD9Ej5fM(), ContextMenuSpec.INSTANCE.m351getIconSizeD9Ej5fM(), 2, null);
                ...
                icon.invoke(Color.m3993boximpl(enabled ? colors.getIconColor() : colors.getDisabledIconColor()), $composer2, 0);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endNode();
                ComposerKt.sourceInformationMarkerEnd($composer2);
            ...
            BasicTextKt.m977BasicTextVhcvRP8(label, $this$ContextMenuItem_u24lambda_u243.weight(Modifier.INSTANCE, 1.0f, true), ContextMenuSpec.INSTANCE.m358textStyle8_81llA(enabled ? colors.getTextColor() : colors.getDisabledTextColor()), (Function1<? super TextLayoutResult, Unit>) null, 0, false, 1, 0, (ColorProducer) null, $composer2, ($dirty2 & 14) | 1572864, 440);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            final Modifier modifier6 = modifier3;
            final Function3 function33 = leadingIcon;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuUi_androidKt.ContextMenuItem.3
                ...
                public final void invoke(Composer composer, int i8) {
                    ContextMenuUi_androidKt.ContextMenuItem(label, enabled, colors, modifier6, function33, function0, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final ContextMenuColors computeContextMenuColors(int backgroundStyleId, int foregroundStyleId, Composer $composer, int $changed, int i) throws Resources.NotFoundException {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            long backgroundColor = m362resolveColorg2O1Hgs(context, backgroundStyleId2, R.attr.colorBackground, DefaultContextMenuColors.getBackgroundColor());
            ColorStateList textColorStateList = resolveColorStateList(context, foregroundStyleId2, R.attr.textColorPrimary);
            long enabledColor = m361enabledColor4WTKRHQ(textColorStateList, DefaultContextMenuColors.getTextColor());
            long disabledColor = m360disabledColor4WTKRHQ(textColorStateList, DefaultContextMenuColors.getDisabledTextColor());
    ...
    private static final long m362resolveColorg2O1Hgs(Context $this$resolveColor_u2dg2O1Hgs, int resId, int attrId, long defaultColor) throws Resources.NotFoundException {
        TypedArray typedArray = $this$resolveColor_u2dg2O1Hgs.obtainStyledAttributes(resId, new int[]{attrId});
        int defaultColorAndroid = ColorKt.m4057toArgb8_81llA(defaultColor);
    ...
    private static final long m361enabledColor4WTKRHQ(ColorStateList $this$enabledColor_u2d4WTKRHQ, long defaultColor) {
        int defaultColorArgb = ColorKt.m4057toArgb8_81llA(defaultColor);
    ...
    private static final long m360disabledColor4WTKRHQ(ColorStateList $this$disabledColor_u2d4WTKRHQ, long defaultColor) {
        int defaultColorArgb = ColorKt.m4057toArgb8_81llA(defaultColor);
