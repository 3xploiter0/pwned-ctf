...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter(GroupComponent root) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3819boximpl(Size.INSTANCE.m3840getZeroNHjbRc()), null, 2, null);
    ...
    public final long m4713getSizeNHjbRc$ui_release() {
        State $this$getValue$iv = this.size;
        return ((Size) $this$getValue$iv.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4715setSizeuvyYCjk$ui_release(long j) {
    ...
    public final long m4714getViewportSizeNHjbRc$ui_release() {
        return this.vector.m4705getViewportSizeNHjbRc$ui_release();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4716setViewportSizeuvyYCjk$ui_release(long value) {
        this.vector.m4706setViewportSizeuvyYCjk$ui_release(value);
    }
    ...
    public final int m4712getBitmapConfig_sVssgQ$ui_release() {
        return this.vector.m4704getCacheBitmapConfig_sVssgQ$ui_release();
    }
    ...
    public long getIntrinsicSize() {
        return m4713getSizeNHjbRc$ui_release();
    }
    ...
    protected void onDraw(DrawScope $this$onDraw) throws Throwable {
        ...
        if (intrinsicColorFilter$ui_release == null) {
            intrinsicColorFilter$ui_release = $this$onDraw_u24lambda_u242.getIntrinsicColorFilter$ui_release();
        }
        ColorFilter filter = intrinsicColorFilter$ui_release;
        if (!getAutoMirror$ui_release() || $this$onDraw.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long pivot$iv$iv = $this$onDraw.mo4558getCenterF1C5BW0();
            DrawContext $this$withTransform_u24lambda_u246$iv$iv$iv = $this$onDraw.getDrawContext();
            long previousSize$iv$iv$iv = $this$withTransform_u24lambda_u246$iv$iv$iv.mo4480getSizeNHjbRc();
            ...
            try {
                ...
                $this$scale_Fgt4K4Q_u24lambda_u242$iv$iv.mo4487scale0AR0LA0(-1.0f, 1.0f, pivot$iv$iv);
                try {
                    $this$onDraw_u24lambda_u242.draw($this$onDraw, this.currentAlpha, filter);
                    $this$withTransform_u24lambda_u246$iv$iv$iv.getCanvas().restore();
                    $this$withTransform_u24lambda_u246$iv$iv$iv.mo4481setSizeuvyYCjk(previousSize$iv$iv$iv);
                } catch (Throwable th) {
                    th = th;
                    $this$withTransform_u24lambda_u246$iv$iv$iv.getCanvas().restore();
                    $this$withTransform_u24lambda_u246$iv$iv$iv.mo4481setSizeuvyYCjk(previousSize$iv$iv$iv);
