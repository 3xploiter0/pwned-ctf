...
public final class SegmentedButtonColors {
    ...
    public static /* synthetic */ SegmentedButtonColors m2351copy2qZNXz8$default(SegmentedButtonColors segmentedButtonColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
        ...
        return segmentedButtonColors.m2355copy2qZNXz8(j15, j16, j17, j18, j19, j20, j21, j22, j23, j24, j13, j14);
    }

    /* renamed from: copy-2qZNXz8, reason: not valid java name */
    public final SegmentedButtonColors m2355copy2qZNXz8(long activeContainerColor, long activeContentColor, long activeBorderColor, long inactiveContainerColor, long inactiveContentColor, long inactiveBorderColor, long disabledActiveContainerColor, long disabledActiveContentColor, long disabledActiveBorderColor, long disabledInactiveContainerColor, long disabledInactiveContentColor, long disabledInactiveBorderColor) {
        return new SegmentedButtonColors((activeContainerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (activeContainerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeContainerColor : this.activeContainerColor, (activeContentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (activeContentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeContentColor : this.activeContentColor, (activeBorderColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (activeBorderColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeBorderColor : this.activeBorderColor, (inactiveContainerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (inactiveContainerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveContainerColor : this.inactiveContainerColor, (inactiveContentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (inactiveContentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveContentColor : this.inactiveContentColor, (inactiveBorderColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (inactiveBorderColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveBorderColor : this.inactiveBorderColor, (disabledActiveContainerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (disabledActiveContainerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveContainerColor : this.disabledActiveContainerColor, (disabledActiveContentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (disabledActiveContentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveContentColor : this.disabledActiveContentColor, (disabledActiveBorderColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (disabledActiveBorderColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveBorderColor : this.disabledActiveBorderColor, (disabledInactiveContainerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (disabledInactiveContainerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledInactiveContainerColor : this.disabledInactiveContainerColor, (disabledInactiveContentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (disabledInactiveContentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledInactiveContentColor : this.disabledInactiveContentColor, disabledInactiveBorderColor != Color.INSTANCE.m4039getUnspecified0d7_KjU() ? disabledInactiveBorderColor : this.disabledInactiveBorderColor, null);
    }

    /* renamed from: borderColor-WaAFU9c$material3_release, reason: not valid java name */
    public final long m2352borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m2354contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2353containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4004equalsimpl0(this.activeBorderColor, ((SegmentedButtonColors) other).activeBorderColor) && Color.m4004equalsimpl0(this.activeContentColor, ((SegmentedButtonColors) other).activeContentColor) && Color.m4004equalsimpl0(this.activeContainerColor, ((SegmentedButtonColors) other).activeContainerColor) && Color.m4004equalsimpl0(this.inactiveBorderColor, ((SegmentedButtonColors) other).inactiveBorderColor) && Color.m4004equalsimpl0(this.inactiveContentColor, ((SegmentedButtonColors) other).inactiveContentColor) && Color.m4004equalsimpl0(this.inactiveContainerColor, ((SegmentedButtonColors) other).inactiveContainerColor) && Color.m4004equalsimpl0(this.disabledActiveBorderColor, ((SegmentedButtonColors) other).disabledActiveBorderColor) && Color.m4004equalsimpl0(this.disabledActiveContentColor, ((SegmentedButtonColors) other).disabledActiveContentColor) && Color.m4004equalsimpl0(this.disabledActiveContainerColor, ((SegmentedButtonColors) other).disabledActiveContainerColor) && Color.m4004equalsimpl0(this.disabledInactiveBorderColor, ((SegmentedButtonColors) other).disabledInactiveBorderColor) && Color.m4004equalsimpl0(this.disabledInactiveContentColor, ((SegmentedButtonColors) other).disabledInactiveContentColor) && Color.m4004equalsimpl0(this.disabledInactiveContainerColor, ((SegmentedButtonColors) other).disabledInactiveContainerColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4010hashCodeimpl(this.activeBorderColor);
        return (((((((((((((((((((((result * 31) + Color.m4010hashCodeimpl(this.activeContentColor)) * 31) + Color.m4010hashCodeimpl(this.activeContainerColor)) * 31) + Color.m4010hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m4010hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m4010hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m4010hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m4010hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m4010hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m4010hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m4010hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m4010hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
