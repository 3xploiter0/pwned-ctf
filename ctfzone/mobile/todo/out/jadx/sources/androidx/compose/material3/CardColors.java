...
public final class CardColors {
    ...
    public final CardColors m1832copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
        return new CardColors((containerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (contentColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (contentColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? contentColor : this.contentColor, (disabledContainerColor > Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 1 : (disabledContainerColor == Color.INSTANCE.m4039getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledContainerColor : this.disabledContainerColor, disabledContentColor != Color.INSTANCE.m4039getUnspecified0d7_KjU() ? disabledContentColor : this.disabledContentColor, null);
    }

    /* renamed from: containerColor-vNxB06k$material3_release, reason: not valid java name */
    public final long m1830containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1831contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardColors) && Color.m4004equalsimpl0(this.containerColor, ((CardColors) other).containerColor) && Color.m4004equalsimpl0(this.contentColor, ((CardColors) other).contentColor) && Color.m4004equalsimpl0(this.disabledContainerColor, ((CardColors) other).disabledContainerColor) && Color.m4004equalsimpl0(this.disabledContentColor, ((CardColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m4010hashCodeimpl(this.contentColor)) * 31) + Color.m4010hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4010hashCodeimpl(this.disabledContentColor);
    }
}
