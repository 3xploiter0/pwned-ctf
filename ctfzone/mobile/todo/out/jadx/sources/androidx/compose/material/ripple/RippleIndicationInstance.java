...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public RippleIndicationInstance(boolean bounded, State<RippleAlpha> state) {
        this.stateLayer = new StateLayer(bounded, state);
    }
    ...
    public final void m1762drawStateLayerH2RKhps(DrawScope $this$drawStateLayer_u2dH2RKhps, float radius, long color) {
        StateLayer $this$drawStateLayer_H2RKhps_u24lambda_u240 = this.stateLayer;
        $this$drawStateLayer_H2RKhps_u24lambda_u240.m1766drawStateLayerH2RKhps($this$drawStateLayer_u2dH2RKhps, radius, color);
    }
}
