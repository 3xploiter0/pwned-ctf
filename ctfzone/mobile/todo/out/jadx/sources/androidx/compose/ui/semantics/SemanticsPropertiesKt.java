...
public final class SemanticsPropertiesKt {
    ...
    public static final void m5776setLiveRegionhR3wRGc(SemanticsPropertyReceiver $this$liveRegion, int i) {
        SemanticsProperties.INSTANCE.getLiveRegion().setValue($this$liveRegion, $$delegatedProperties[3], LiveRegionMode.m5742boximpl(i));
    }
    ...
    public static final int getContentDataType(SemanticsPropertyReceiver $this$contentDataType) {
        return SemanticsProperties.INSTANCE.getContentDataType$ui_release().getValue($this$contentDataType, $$delegatedProperties[8]).m3626unboximpl();
    }

    /* renamed from: setContentDataType-NTL_tik, reason: not valid java name */
    public static final void m5774setContentDataTypeNTL_tik(SemanticsPropertyReceiver $this$contentDataType, int i) {
        SemanticsProperties.INSTANCE.getContentDataType$ui_release().setValue($this$contentDataType, $$delegatedProperties[8], ContentDataType.m3620boximpl(i));
    }
    ...
    public static final void m5777setRolekuIjeqM(SemanticsPropertyReceiver $this$role, int i) {
        SemanticsProperties.INSTANCE.getRole().setValue($this$role, $$delegatedProperties[12], Role.m5751boximpl(i));
    }
    ...
    public static final void m5778setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver $this$textSelectionRange, long j) {
        SemanticsProperties.INSTANCE.getTextSelectionRange().setValue($this$textSelectionRange, $$delegatedProperties[17], TextRange.m5936boximpl(j));
    }
    ...
    public static final void m5775setImeAction4L7nppU(SemanticsPropertyReceiver $this$imeAction, int i) {
        SemanticsProperties.INSTANCE.getImeAction().setValue($this$imeAction, $$delegatedProperties[18], ImeAction.m6110boximpl(i));
    }
    ...
    public static /* synthetic */ void m5773onImeAction9UiTYpY$default(SemanticsPropertyReceiver semanticsPropertyReceiver, int i, String str, Function0 function0, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            str = null;
        }
        m5772onImeAction9UiTYpY(semanticsPropertyReceiver, i, str, function0);
    }

    /* renamed from: onImeAction-9UiTYpY, reason: not valid java name */
    public static final void m5772onImeAction9UiTYpY(SemanticsPropertyReceiver $this$onImeAction_u2d9UiTYpY, int imeActionType, String label, Function0<Boolean> function0) {
        $this$onImeAction_u2d9UiTYpY.set(SemanticsProperties.INSTANCE.getImeAction(), ImeAction.m6110boximpl(imeActionType));
