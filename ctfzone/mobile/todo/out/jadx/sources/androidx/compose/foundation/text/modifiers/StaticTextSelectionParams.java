...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        return (it == null || TextOverflow.m6394equalsimpl0(it.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6403getVisiblegIe3tQ8()) || !it.getHasVisualOverflow()) ? false : true;
    }
