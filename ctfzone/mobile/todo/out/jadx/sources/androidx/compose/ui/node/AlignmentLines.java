...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5446calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = mo5446calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            $this$fastRoundToInt$iv = Offset.m3763getYimpl(position);
        } else {
            $this$fastRoundToInt$iv = Offset.m3762getXimpl(position);
        }
