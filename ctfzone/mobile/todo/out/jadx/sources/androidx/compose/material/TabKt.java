...
public final class TabKt {
    ...
    private static final float SmallTabHeight = Dp.m6485constructorimpl(48);
    ...
    public static final void m1692Tab0nDMI0(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        boolean enabled2;
        ...
        if (($changed & 29360128) == 0) {
            $dirty2 |= ((i & 128) == 0 && $composer2.changed(selectedContentColor)) ? 8388608 : 4194304;
        }
        if ((234881024 & $changed) == 0) {
            if ((i & 256) == 0) {
                j = unselectedContentColor;
                int i7 = $composer2.changed(j) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
                $dirty2 |= i7;
            } else {
                j = unselectedContentColor;
            }
        ...
        if ((191739611 & $dirty2) == 38347922 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                boolean enabled5 = i3 != 0 ? true : enabled2;
                text = i4 != 0 ? null : function2;
                Function2 icon3 = i5 != 0 ? null : function23;
                if (i6 != 0) {
                ...
                if ((i & 256) != 0) {
                    ...
                    unselectedContentColor2 = Color.m4001copywmQWz5c(j2, (14 & 1) != 0 ? Color.m4005getAlphaimpl(j2) : ContentAlpha.INSTANCE.getMedium($composer2, 6), (14 & 2) != 0 ? Color.m4009getRedimpl(j2) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(j2) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(j2) : 0.0f);
                ...
                styledText = ComposableLambdaKt.composableLambda($composer2, -1729014781, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$styledText$1$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            TextStyle style = TextStyle.m5961copyp1EtxEg$default(MaterialTheme.INSTANCE.getTypography($composer3, 6).getButton(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.INSTANCE.m6352getCentere0LSkKk(), 0, 0L, null, null, null, 0, 0, null, 16744447, null);
            ...
            m1693TabEVJuX4I(selected, function0, modifier3, enabled2, interactionSource3, selectedContentColor3, unselectedContentColor2, ComposableLambdaKt.composableLambda($composer2, -178151495, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            final long j3 = selectedContentColor4;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$3
                ...
                public final void invoke(Composer composer, int i8) {
                    TabKt.m1692Tab0nDMI0(selected, function0, modifier6, z, function24, function25, mutableInteractionSource, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1691LeadingIconTab0nDMI0(final boolean selected, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        boolean enabled2;
        MutableInteractionSource interactionSource2;
        int $dirty;
        ...
        if (($dirty & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            final Indication ripple = RippleKt.m1763rememberRipple9IZ8Weo(true, 0.0f, selectedContentColor3, $composer2, (($dirty2 >> 15) & 896) | 6, 2);
            final Modifier modifier5 = modifier3;
            final MutableInteractionSource mutableInteractionSource = interactionSource3;
            modifier4 = modifier3;
            final boolean z = enabled3;
            int $dirty5 = $dirty2;
            m1694TabTransitionKlgxPg(selectedContentColor3, unselectedContentColor2, selected, ComposableLambdaKt.composableLambda($composer2, 866677691, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C169@7535L843:Tab.kt#jmzs0o");
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(866677691, $changed2, -1, "androidx.compose.material.LeadingIconTab.<anonymous> (Tab.kt:169)");
                        }
                        Modifier modifier$iv = SizeKt.fillMaxWidth$default(PaddingKt.m683paddingVpY3zN4$default(SelectableKt.m932selectableO2vRcR0(SizeKt.m712height3ABfNKs(modifier5, TabKt.SmallTabHeight), selected, mutableInteractionSource, ripple, z, Role.m5751boximpl(Role.INSTANCE.m5764getTabo7Vup1c()), function0), TabKt.HorizontalTextPadding, 0.0f, 2, null), 0.0f, 1, null);
                        ...
                        int i7 = ((432 >> 6) & 112) | 6;
                        ComposerKt.sourceInformationMarkerStart($composer3, 106889785, "C185@8147L6,186@8166L59,187@8264L10,188@8329L39:Tab.kt#jmzs0o");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$3
                ...
                public final void invoke(Composer composer, int i6) {
                    TabKt.m1691LeadingIconTab0nDMI0(selected, function0, function2, function22, modifier6, z2, mutableInteractionSource2, j2, j3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1693TabEVJuX4I(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        boolean enabled2;
        MutableInteractionSource interactionSource2;
        long selectedContentColor2;
        ...
        if ((458752 & $changed) == 0) {
            if ((i & 32) == 0) {
                selectedContentColor2 = selectedContentColor;
                int i5 = $composer2.changed(selectedContentColor2) ? 131072 : 65536;
                $dirty4 |= i5;
            } else {
                selectedContentColor2 = selectedContentColor;
            }
        ...
        if ((3670016 & $changed) == 0) {
            if ((i & 64) == 0) {
                $dirty3 = $dirty4;
                int i6 = $composer2.changed(unselectedContentColor) ? 1048576 : 524288;
                $dirty = $dirty3 | i6;
            } else {
                $dirty3 = $dirty4;
            }
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            final Indication ripple = RippleKt.m1763rememberRipple9IZ8Weo(true, 0.0f, selectedContentColor3, $composer2, (($dirty2 >> 9) & 896) | 6, 2);
            final Modifier modifier5 = modifier3;
            final MutableInteractionSource mutableInteractionSource = interactionSource3;
            final boolean z = enabled3;
            m1694TabTransitionKlgxPg(selectedContentColor3, unselectedContentColor2, selected, ComposableLambdaKt.composableLambda($composer2, -1237246709, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$5
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ComposerKt.sourceInformation($composer3, "C239@10750L532:Tab.kt#jmzs0o");
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1237246709, $changed2, -1, "androidx.compose.material.Tab.<anonymous> (Tab.kt:239)");
                        }
                        Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m932selectableO2vRcR0(modifier5, selected, mutableInteractionSource, ripple, z, Role.m5751boximpl(Role.INSTANCE.m5764getTabo7Vup1c()), function0), 0.0f, 1, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$6
                ...
                public final void invoke(Composer composer, int i7) {
                    TabKt.m1693TabEVJuX4I(selected, function0, modifier6, z2, mutableInteractionSource2, j2, j3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1694TabTransitionKlgxPg(final long activeColor, final long inactiveColor, final boolean selected, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        long j;
        long j2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            $composer2.endReplaceableGroup();
            ColorSpace colorSpace$iv = Color.m4007getColorSpaceimpl(j3);
            ...
            $composer2.endReplaceableGroup();
            Object initialValue$iv$iv = Color.m3993boximpl(j4);
            ...
            $composer2.endReplaceableGroup();
            Object targetValue$iv$iv = Color.m3993boximpl(j5);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{localContentColor.provides(Color.m3993boximpl(Color.m4001copywmQWz5c(jTabTransition_Klgx_Pg$lambda$5, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jTabTransition_Klgx_Pg$lambda$5) : 1.0f, (14 & 2) != 0 ? Color.m4009getRedimpl(jTabTransition_Klgx_Pg$lambda$5) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jTabTransition_Klgx_Pg$lambda$5) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jTabTransition_Klgx_Pg$lambda$5) : 0.0f))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m4005getAlphaimpl(TabTransition_Klgx_Pg$lambda$5(color$delegate))))}, function2, $composer2, (($dirty >> 6) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$TabTransition$1
                ...
                public final void invoke(Composer composer, int i) {
                    TabKt.m1694TabTransitionKlgxPg(activeColor, inactiveColor, selected, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(TabBaselineLayout)P(1)305@12901L1917:Tab.kt#jmzs0o");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1249848471, $dirty, -1, "androidx.compose.material.TabBaselineLayout (Tab.kt:304)");
            }
            $composer2.startReplaceableGroup(782580000);
            boolean invalid$iv = $composer2.changedInstance(function2) | $composer2.changedInstance(function22);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material.TabKt$TabBaselineLayout$2$1
                    ...
                    public final MeasureResult mo38measure3p2s80s(final MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        final int tabHeight = $this$Layout.mo367roundToPx0680j_4((textPlaceable == null || iconPlaceable == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
                        ...
                        final Placeable placeable = textPlaceable;
                        final Placeable placeable2 = iconPlaceable;
                        return MeasureScope.layout$default($this$Layout, tabWidth, tabHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabKt$TabBaselineLayout$2$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope $this$layout) {
                                if (placeable != null && placeable2 != null) {
                                    ...
                                    TabKt.placeTextAndIcon($this$layout, measureScope, placeable3, placeable4, i, i2, iIntValue, num2.intValue());
                                    return;
                                }
                                if (placeable != null) {
                                    TabKt.placeTextOrIcon($this$layout, placeable, tabHeight);
                                } else if (placeable2 != null) {
                                    TabKt.placeTextOrIcon($this$layout, placeable2, tabHeight);
                                }
                            }
                        }, 4, null);
                    }
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -2141028410, "C:Tab.kt#jmzs0o");
            $composer2.startReplaceableGroup(-2141028410);
            ComposerKt.sourceInformation($composer2, "308@12967L123");
            if (function2 != null) {
                ...
                int i3 = ((6 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer2, -1952926210, "C310@13082L6:Tab.kt#jmzs0o");
            ...
            $composer2.endReplaceableGroup();
            $composer2.startReplaceableGroup(448373087);
            ComposerKt.sourceInformation($composer2, "313@13153L41");
            if (function22 != null) {
                ...
                int i5 = ((6 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer2, -1952926106, "C313@13186L6:Tab.kt#jmzs0o");
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo367roundToPx0680j_4(baselineOffset) + density.mo367roundToPx0680j_4(TabRowDefaults.INSTANCE.m1702getIndicatorHeightD9Ej5fM());
