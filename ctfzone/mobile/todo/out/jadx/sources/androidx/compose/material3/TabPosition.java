...
public final class TabPosition {
    ...
    public final float m2568getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m6490equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m6490equalsimpl0(this.width, ((TabPosition) other).width) && Dp.m6490equalsimpl0(this.contentWidth, ((TabPosition) other).contentWidth);
    }

    public int hashCode() {
        int result = Dp.m6491hashCodeimpl(this.left);
        return (((result * 31) + Dp.m6491hashCodeimpl(this.width)) * 31) + Dp.m6491hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m6496toStringimpl(this.left)) + ", right=" + ((Object) Dp.m6496toStringimpl(m2568getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m6496toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m6496toStringimpl(this.contentWidth)) + ')';
    }
}
