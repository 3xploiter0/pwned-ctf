...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1090getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1091getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1091getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long coercedPosition = coerceInVisibleBounds ? m1089coercedInVisibleBoundsOfInputTextMKHz9U(position) : position;
        long relativePosition = m1093translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition);
        return this.value.m5920getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        long coercedPosition = m1089coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical));
        float relativeVertical = Offset.m3763getYimpl(m1093translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition));
    ...
    public final boolean m1092isPositionOnTextk4lQ0M(long offset) {
        long visibleOffset = m1089coercedInVisibleBoundsOfInputTextMKHz9U(offset);
        long relativeOffset = m1093translateDecorationToInnerCoordinatesMKHz9U$foundation_release(visibleOffset);
        int line = this.value.getLineForVerticalPosition(Offset.m3763getYimpl(relativeOffset));
        return Offset.m3762getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m3762getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1093translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        if (innerCoords != null) {
            ...
            if (innerCoords != null && (it = this.decorationBoxCoordinates) != null) {
                ...
                if (layoutCoordinates != null) {
                    ...
                    return innerCoords.mo5348localPositionOfR5De75A(decorationCoords, offset);
                }
            }
            return offset;
        }
    ...
    public final long m1094translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates it;
        LayoutCoordinates innerCoords = this.innerTextFieldCoordinates;
        if (innerCoords != null) {
            if (!innerCoords.isAttached()) {
            ...
            if (innerCoords != null && (it = this.decorationBoxCoordinates) != null) {
                ...
                if (layoutCoordinates != null) {
                    LayoutCoordinates decorationCoords = layoutCoordinates;
                    return decorationCoords.mo5348localPositionOfR5De75A(innerCoords, offset);
                }
            }
            return offset;
        }
    ...
    */
    private final long m1089coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L26:
            r0 = r3
            long r1 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m1095access$coerceIn3MmeM6k(r7, r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m1089coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
