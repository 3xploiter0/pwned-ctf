...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
                if (this.$this_run.getChildCount() == 0) {
                    return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m6440getMinWidthimpl(constraints), Constraints.m6439getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        @Override // kotlin.jvm.functions.Function1
                ...
                if (Constraints.m6440getMinWidthimpl(constraints) != 0) {
                    this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m6440getMinWidthimpl(constraints));
                }
                if (Constraints.m6439getMinHeightimpl(constraints) != 0) {
                    this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m6439getMinHeightimpl(constraints));
                }
                AndroidViewHolder androidViewHolder = this.$this_run;
                ...
                int iObtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(iM6440getMinWidthimpl, iM6438getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder3 = this.$this_run;
                int iM6439getMinHeightimpl = Constraints.m6439getMinHeightimpl(constraints);
                ...
                androidViewHolder.measure(iObtainMeasureSpec, androidViewHolder3.obtainMeasureSpec(iM6439getMinHeightimpl, iM6437getMaxHeightimpl, layoutParams2.height));
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        if (isNestedScrollingEnabled()) {
            long consumedByParent = this.dispatcher.m5087dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3762getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3763getYimpl(consumedByParent));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m5087dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        if (isNestedScrollingEnabled()) {
            long consumedByParent = this.dispatcher.m5089dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dx), AndroidViewHolder_androidKt.toComposeOffset(dy)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3762getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3763getYimpl(consumedByParent));
        }
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!this.$consumed) {
                        this.label = 1;
                        if (this.this$0.dispatcher.m5086dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m6733getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                            break;
                        } else {
                        ...
                        this.label = 2;
                        if (this.this$0.dispatcher.m5086dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m6733getZero9UxMQ8M(), this) != coroutine_suspended) {
                            break;
                        } else {
                            return coroutine_suspended;
                        }
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C06431(toBeConsumed, null), 3, null);
        return false;
    }
    ...
    static final class C06431 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidViewHolder.this.new C06431(this.$toBeConsumed, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    this.label = 1;
                    if (AndroidViewHolder.this.dispatcher.m5088dispatchPreFlingQWom1Mo(this.$toBeConsumed, this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
