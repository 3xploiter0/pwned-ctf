...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean useEmojiCompat) {
        ...
        if (useEmojiCompat && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch emojiSupportMatch = (platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m5800boximpl(paragraphSyle.getEmojiSupportMatch());
            if (emojiSupportMatch == null ? false : EmojiSupportMatch.m5803equalsimpl0(emojiSupportMatch.getValue(), EmojiSupportMatch.INSTANCE.m5807getAll_3YsG6Y())) {
                replaceStrategy = 1;
            } else {
                replaceStrategy = 0;
            }
        ...
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m6696isUnspecifiedR2X_6o(contextTextStyle.m5987getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m6230setLineHeightr9BaKPg(spannableString2, contextTextStyle.m5987getLineHeightXSAIIZE(), contextFontSize, density);
        } else {
            ...
            SpannableExtensions_androidKt.m6229setLineHeightKmRG4DE(spannableString2, contextTextStyle.m5987getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }
