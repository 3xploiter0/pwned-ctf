...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m6439getMinHeightimpl(this.constraints) == 0 && Constraints.m6440getMinWidthimpl(this.constraints) == 0)) {
        ...
        if (AndroidParagraph_androidKt.shouldAttachIndentationFixSpan(style, this.ellipsis)) {
            charSequence = AndroidParagraph_androidKt.attachIndentationFixSpan(this.paragraphIntrinsics.getCharSequence());
        } else {
            charSequence = this.paragraphIntrinsics.getCharSequence();
        }
        this.charSequence = charSequence;
        int alignment = AndroidParagraph_androidKt.m5793toLayoutAlignaXe7zB0(style.m5989getTextAligne0LSkKk());
        int justificationMode = TextAlign.m6348equalsimpl0(style.m5989getTextAligne0LSkKk(), TextAlign.INSTANCE.m6354getJustifye0LSkKk()) ? 1 : 0;
        int hyphens = AndroidParagraph_androidKt.m5795toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int breakStrategy = AndroidParagraph_androidKt.m5794toLayoutBreakStrategyxImikfE(LineBreak.m6272getStrategyfcGXIks(style.m5986getLineBreakrAG3T2k()));
        int lineBreakStyle = AndroidParagraph_androidKt.m5796toLayoutLineBreakStylehpcqdu8(LineBreak.m6273getStrictnessusljTpc(style.m5986getLineBreakrAG3T2k()));
        int lineBreakWordStyle = AndroidParagraph_androidKt.m5797toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m6274getWordBreakjp8hJ3c(style.m5986getLineBreakrAG3T2k()));
        if (this.ellipsis) {
        ...
        if (this.ellipsis && firstLayout.getHeight() > Constraints.m6437getMaxHeightimpl(this.constraints) && this.maxLines > 1) {
            int calculatedMaxLines = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m6437getMaxHeightimpl(this.constraints));
        ...
        getTextPaint$ui_text_release().m6215setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ...
        if (shaderBrushSpans != null) {
            ...
            while (it.hasNext()) {
                ShaderBrushSpan shaderBrushSpan = (ShaderBrushSpan) it.next();
                shaderBrushSpan.m6235setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
            }
        }
        CharSequence $this$placeholderRects_u24lambda_u245 = this.charSequence;
        int i3 = 0;
        if ($this$placeholderRects_u24lambda_u245 instanceof Spanned) {
            Object[] $this$map$iv = ((Spanned) $this$placeholderRects_u24lambda_u245).getSpans(i, $this$placeholderRects_u24lambda_u245.length(), PlaceholderSpan.class);
            int $i$f$map = 0;
            ...
            while (i4 < length) {
                ...
                int start = ((Spanned) $this$placeholderRects_u24lambda_u245).getSpanStart(span);
                int end = ((Spanned) $this$placeholderRects_u24lambda_u245).getSpanEnd(span);
                CharSequence $this$placeholderRects_u24lambda_u2452 = $this$placeholderRects_u24lambda_u245;
                ...
                if (isPlaceholderSpanEllipsized || isPlaceholderSpanTruncated || exceedsMaxLines) {
                    ...
                    i4++;
                    $this$placeholderRects_u24lambda_u245 = $this$placeholderRects_u24lambda_u2452;
                    i3 = i5;
                    ...
                    TextLayout $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243 = this.layout;
                    $this$mapTo$iv$iv = $this$mapTo$iv$iv2;
                    switch (span.getVerticalAlign()) {
                        case 0:
                            $i$f$mapTo = $i$f$mapTo2;
                            i2 = length;
                            lineBaseline = $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineBaseline(line) - span.getHeightPx();
                            break;
                        case 1:
                            $i$f$mapTo = $i$f$mapTo2;
                            i2 = length;
                            lineBaseline = $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineTop(line);
                            break;
                        case 2:
                            $i$f$mapTo = $i$f$mapTo2;
                            i2 = length;
                            lineBaseline = $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineBottom(line) - span.getHeightPx();
                            break;
                        case 3:
                            $i$f$mapTo = $i$f$mapTo2;
                            i2 = length;
                            lineBaseline = (($this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineTop(line) + $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineBottom(line)) - span.getHeightPx()) / 2;
                            break;
                        case 4:
                            $i$f$mapTo = $i$f$mapTo2;
                            i2 = length;
                            lineBaseline = $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineBaseline(line) + span.getFontMetrics().ascent;
                            break;
                        case 5:
                            $i$f$mapTo = $i$f$mapTo2;
                            i2 = length;
                            lineBaseline = (span.getFontMetrics().descent + $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineBaseline(line)) - span.getHeightPx();
                            break;
                        case 6:
                            Paint.FontMetricsInt $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243_u24lambda_u242 = span.getFontMetrics();
                            $i$f$mapTo = $i$f$mapTo2;
                            int $i$f$mapTo3 = $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243_u24lambda_u242.ascent;
                            i2 = length;
                            lineBaseline = ((($i$f$mapTo3 + $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243_u24lambda_u242.descent) - span.getHeightPx()) / 2) + $this$placeholderRects_u24lambda_u245_u24lambda_u244_u24lambda_u243.getLineBaseline(line);
                            break;
                        default:
    ...
    public float getWidth() {
        return Constraints.m6438getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5781getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m3763getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m3762getXimpl(position));
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public long mo5782getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] range = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m5798toLayoutTextGranularityduNsdkg(granularity), new Function2<RectF, RectF, Boolean>() { // from class: androidx.compose.ui.text.AndroidParagraph$getRangeForRect$range$1
            {
                super(2);
            }
            ...
            public final Boolean invoke(RectF segmentBounds, RectF area) {
                return Boolean.valueOf(inclusionStrategy.isIncluded(RectHelper_androidKt.toComposeRect(segmentBounds), RectHelper_androidKt.toComposeRect(area)));
            }
        });
        if (range == null) {
    ...
    public void mo5779fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5946getMinimpl(range), TextRange.m5945getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5783getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5785paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u2410.m6217setColor8_81llA(color);
    ...
    public void mo5784paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        $this$paint_LG529CI_u24lambda_u2411.m6217setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u2411.m6214setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m6214setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5786painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int currBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2412 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2412.m6215setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2412.m6214setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m6214setBlendModes9anfk8(currBlendMode);
    }
