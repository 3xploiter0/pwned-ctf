...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m752onlybOOhFvg(WindowInsets $this$only_u2dbOOhFvg, int sides) {
    ...
    public static final WindowInsets m750WindowInsetsa9UjIt4(float left, float top, float right, float bottom) {
