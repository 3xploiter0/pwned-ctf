...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    public static final class SlideDirection {
        ...
        public static String m48toStringimpl(int arg0) {
            return m46equalsimpl0(arg0, Left) ? "Left" : m46equalsimpl0(arg0, Right) ? "Right" : m46equalsimpl0(arg0, Up) ? "Up" : m46equalsimpl0(arg0, Down) ? "Down" : m46equalsimpl0(arg0, Start) ? "Start" : m46equalsimpl0(arg0, End) ? "End" : "Invalid";
        }
    }
    ...
    static /* synthetic */ EnterTransition m39slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        ...
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m6604boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
