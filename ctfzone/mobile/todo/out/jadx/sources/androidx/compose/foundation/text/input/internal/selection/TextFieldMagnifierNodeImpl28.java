...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6647boximpl(IntSize.INSTANCE.m6660getZeroYbymL2g()), null, 2, null);
    private final MagnifierNode magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3751boximpl(m1251invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1251invoketuRUvjQ(Density $this$$receiver) {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m1252invokeEaSLcWc(dpSize.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1252invokeEaSLcWc(long size) {
            ...
            textFieldMagnifierNodeImpl28.m1250setMagnifierSizeozmzZPI(IntSizeKt.IntSize($this$invoke_EaSLcWc_u24lambda_u240.mo367roundToPx0680j_4(DpSize.m6583getWidthD9Ej5fM(size)), $this$invoke_EaSLcWc_u24lambda_u240.mo367roundToPx0680j_4(DpSize.m6581getHeightD9Ej5fM(size))));
        }
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean visible) {
        ...
        this.animatable = new Animatable<>(Offset.m3751boximpl(TextFieldMagnifierKt.m1246calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1249getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m3751boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getMagnifierSize-YbymL2g, reason: not valid java name */
    public final long m1249getMagnifierSizeYbymL2g() {
    ...
    public final void m1250setMagnifierSizeozmzZPI(long j) {
                ...
                case 0:
                    ...
                    Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.1
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke() {
                            return Offset.m3751boximpl(m1253invokeF1C5BW0());
                        }

                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                        public final long m1253invokeF1C5BW0() {
                            ...
                            return TextFieldMagnifierKt.m1246calculateSelectionMagnifierCenterAndroidhUlJWOE(textFieldMagnifierNodeImpl28.textFieldState, textFieldMagnifierNodeImpl28.textFieldSelectionState, textFieldMagnifierNodeImpl28.textLayoutState, textFieldMagnifierNodeImpl28.m1249getMagnifierSizeYbymL2g());
                        }
                    });
                    ...
                    if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                        ...
                        public /* bridge */ /* synthetic */ Object emit(Object value, Continuation $completion) {
                            return m1254emit3MmeM6k(((Offset) value).getPackedValue(), $completion);
                        }

                        /* renamed from: emit-3MmeM6k, reason: not valid java name */
                        public final Object m1254emit3MmeM6k(long targetValue, Continuation<? super Unit> continuation) {
                            if (OffsetKt.m3781isSpecifiedk4lQ0M(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) && OffsetKt.m3781isSpecifiedk4lQ0M(targetValue)) {
                                if (!(Offset.m3763getYimpl(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) == Offset.m3763getYimpl(targetValue))) {
                                    BuildersKt__Builders_commonKt.launch$default(animationScope, null, null, new C00541(textFieldMagnifierNodeImpl282, targetValue, null), 3, null);
                                    return Unit.INSTANCE;
                                }
                            }
                            Object objSnapTo = textFieldMagnifierNodeImpl282.animatable.snapTo(Offset.m3751boximpl(targetValue), continuation);
                        ...
                        static final class C00541 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            C00541(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28, long j, Continuation<? super C00541> continuation) {
                                super(2, continuation);
                            ...
                            public final Object invokeSuspend(Object $result) {
                                ...
                                switch (this.label) {
                                    case 0:
                                        ...
                                        Offset offsetM3751boximpl = Offset.m3751boximpl(this.$targetValue);
                                        SpringSpec<Offset> magnifierSpringSpec = SelectionMagnifierKt.getMagnifierSpringSpec();
                                        this.label = 1;
                                        if (animatable.animateTo(offsetM3751boximpl, (4 & 2) != 0 ? animatable.defaultSpringSpec : magnifierSpringSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, this) != coroutine_suspended) {
                                            break;
                                        } else {
