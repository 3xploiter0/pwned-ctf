...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    private final DragAndDropModifierNode dragAndDropNode = (DragAndDropModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
        ...
        public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
            ...
            if (receiveContentConfiguration != null) {
                TransferableContent transferableContent = new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m337getDragAndDropkB6V9T0(), null, 8, null);
            ...
            if (plainText != null) {
                String p0 = plainText;
                TransformedTextFieldState.replaceSelectedText$default(this.this$0.getTextFieldState(), p0, false, null, 6, null);
            }
            return true;
        }
        ...
        public final void invoke2(DragAndDropEvent it) {
            if (ReceiveContentConfigurationKt.getReceiveContentConfiguration(this.this$0) != null) {
                DragAndDropRequestPermission_androidKt.dragAndDropRequestPermission(this.this$0, it);
            }
        }
        ...
        public final void invoke2(DragAndDropEvent it) {
            ...
            this.this$0.getInteractionSource().tryEmit(it2);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m1203invokek4lQ0M(offset.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1203invokek4lQ0M(long position) {
            long positionOnTextField = TextLayoutStateKt.m1224fromWindowToDecorationUv8p0NA(this.this$0.getTextLayoutState(), position);
            int cursorPosition = TextLayoutState.m1214getOffsetForPosition3MmeM6k$default(this.this$0.getTextLayoutState(), positionOnTextField, false, 2, null);
            this.this$0.getTextFieldState().m1234selectCharsIn5zctL8(TextRangeKt.TextRange(cursorPosition));
            this.this$0.getTextFieldSelectionState().m1271updateHandleDraggingUv8p0NA(Handle.Cursor, positionOnTextField);
        }
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation filter, boolean enabled, boolean readOnly, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean singleLine, MutableInteractionSource interactionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m6166equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6185getPasswordPjHm6EE()) && !KeyboardType.m6166equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6184getNumberPasswordPjHm6EE()) && (stylusHandwritingTrigger = this.this$0.getStylusHandwritingTrigger()) != null) {
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        ...
        SemanticsPropertiesKt.m5778setTextSelectionRangeFDrldGo($this$applySemantics, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default($this$applySemantics, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.4
            ...
            public final Boolean invoke(int start, int end, boolean relativeToOriginal) {
                ...
                if (relativeToOriginal) {
                    ...
                    text2 = TextFieldDecoratorModifierNode.this.getTextFieldState().getVisualText();
                }
                ...
                if (start == TextRange.m5948getStartimpl(selection2) && end == TextRange.m5943getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (relativeToOriginal) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1235selectUntransformedCharsIn5zctL8(selectionRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1234selectCharsIn5zctL8(selectionRange);
                }
                return true;
            }
        }, 1, null);
        final int effectiveImeAction = this.keyboardOptions.m1012getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m5773onImeAction9UiTYpY$default($this$applySemantics, effectiveImeAction, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1202onImeActionPerformedKlQnJC8(effectiveImeAction);
                return true;
            }
        }, 2, null);
        ...
        if (!TextRange.m5942getCollapsedimpl(selection)) {
    ...
    public final void onFocusChange() {
        ...
        if (isFocused() && this.observeChangesJob == null) {
            this.observeChangesJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03431(null), 3, null);
        } else if (!isFocused()) {
    ...
    static final class C03431 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03431(continuation);
        }
    ...
    public void mo209onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.stylusHandwritingNode.mo209onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputNode.mo209onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo210onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1135onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onKeyEvent-ZmokQxo */
    public boolean mo208onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1134onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                this.this$0.m1202onImeActionPerformedKlQnJC8(this.this$0.getKeyboardOptions().m1012getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation_release()) {
            ...
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03451(receiveContentConfiguration, null), 3, null);
        }
    }
    ...
    static final class C03451 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03451(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C03451> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03451(this.$receiveContentConfiguration, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    this.label = 1;
                    if (PlatformTextInputModifierNodeKt.establishTextInputSession(TextFieldDecoratorModifierNode.this, new C00511(TextFieldDecoratorModifierNode.this, this.$receiveContentConfiguration, null), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
        ...
        static final class C00511 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            final /* synthetic */ ReceiveContentConfiguration $receiveContentConfiguration;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00511(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C00511> continuation) {
                super(2, continuation);
            ...
            /* synthetic */ class C00521 extends FunctionReferenceImpl implements Function1<ImeAction, Unit> {
                C00521(Object obj) {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                    m1204invokeKlQnJC8(imeAction.getValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-KlQnJC8, reason: not valid java name */
                public final void m1204invokeKlQnJC8(int p0) {
                    ((TextFieldDecoratorModifierNode) this.receiver).m1202onImeActionPerformedKlQnJC8(p0);
                }
            }
        }
    }
    ...
    public final void m1202onImeActionPerformedKlQnJC8(final int imeAction) {
        if (ImeAction.m6113equalsimpl0(imeAction, ImeAction.INSTANCE.m6130getNoneeUduSuo()) || ImeAction.m6113equalsimpl0(imeAction, ImeAction.INSTANCE.m6126getDefaulteUduSuo()) || this.keyboardActionHandler == null) {
            this.keyboardActionScope.mo998defaultKeyboardActionKlQnJC8(imeAction);
            return;
        }
        ...
        if (keyboardActionHandler != null) {
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.keyboardActionScope.mo998defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
