...
public final class DraggableKt {
    ...
    public static final float m446toFloat3MmeM6k(long $this$toFloat_u2d3MmeM6k, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3763getYimpl($this$toFloat_u2d3MmeM6k) : Offset.m3762getXimpl($this$toFloat_u2d3MmeM6k);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m447toFloatsFctU(long $this$toFloat_u2dsF_u2dc_u2dtU, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6723getYimpl($this$toFloat_u2dsF_u2dc_u2dtU) : Velocity.m6722getXimpl($this$toFloat_u2dsF_u2dc_u2dtU);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m448toValidVelocityTH1AsA0(long $this$toValidVelocity_u2dTH1AsA0) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6722getXimpl($this$toValidVelocity_u2dTH1AsA0)) ? 0.0f : Velocity.m6722getXimpl($this$toValidVelocity_u2dTH1AsA0), Float.isNaN(Velocity.m6723getYimpl($this$toValidVelocity_u2dTH1AsA0)) ? 0.0f : Velocity.m6723getYimpl($this$toValidVelocity_u2dTH1AsA0));
    }
}
