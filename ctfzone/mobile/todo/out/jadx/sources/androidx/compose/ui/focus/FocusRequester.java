...
public final class FocusRequester {
    ...
    public final boolean findFocusTargetNode$ui_release(Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        boolean zM3723findChildCorrespondingToFocusEnterOMvw8;
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv$iv.getAggregateChildKindSet() & iM5574constructorimpl) != 0) {
                                ...
                                while (nodePop != null) {
                                    ...
                                    if (nodePop instanceof FocusTargetNode) {
                                        ...
                                        if (it$iv.fetchFocusProperties$ui_release().getCanFocus()) {
                                            zM3723findChildCorrespondingToFocusEnterOMvw8 = function1.invoke(it$iv).booleanValue();
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                        } else {
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                            zM3723findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m3723findChildCorrespondingToFocusEnterOMvw8(it$iv, FocusDirection.INSTANCE.m3681getEnterdhqQ8s(), function1);
                                        }
                                        if (zM3723findChildCorrespondingToFocusEnterOMvw8) {
                                            success$iv = true;
                                            break;
                                        }
                                    } else {
                                        ...
                                        if (((this_$iv$iv$iv$iv3.getKindSet() & iM5574constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
                                            ...
                                            while (node$iv$iv$iv$iv != null) {
                                                ...
                                                if ((next$iv$iv$iv.getKindSet() & iM5574constructorimpl) != 0) {
                                                    count$iv$iv$iv2++;
        ...
        if (size$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv3.getAggregateChildKindSet() & iM5574constructorimpl) != 0) {
                        ...
                        DelegatableNodeKt.addLayoutNodeChildren(branches$iv$iv, branch$iv$iv3);
                    }
                }
                i$iv++;
                if (i$iv >= size$iv) {
