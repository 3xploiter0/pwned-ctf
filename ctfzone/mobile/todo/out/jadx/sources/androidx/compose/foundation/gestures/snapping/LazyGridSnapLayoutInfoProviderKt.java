...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyGridState lazyGridState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                Density $this$calculateSnapOffset_u24lambda_u242 = lazyGridState.getDensity$foundation_release();
                return SnapFlingBehaviorKt.m527calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem($this$calculateSnapOffset_u24lambda_u242, velocity), distanceFromItemBeforeTarget, distanceFromItemAfterTarget);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo $this$singleAxisViewportSize) {
        if ($this$singleAxisViewportSize.getOrientation() == Orientation.Vertical) {
            return IntSize.m6654getHeightimpl($this$singleAxisViewportSize.mo821getViewportSizeYbymL2g());
        }
        return IntSize.m6655getWidthimpl($this$singleAxisViewportSize.mo821getViewportSizeYbymL2g());
    }

    public static final int sizeOnMainAxis(LazyGridItemInfo $this$sizeOnMainAxis, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntSize.m6654getHeightimpl($this$sizeOnMainAxis.getSize());
        }
        return IntSize.m6655getWidthimpl($this$sizeOnMainAxis.getSize());
    }

    public static final int offsetOnMainAxis(LazyGridItemInfo $this$offsetOnMainAxis, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntOffset.m6614getYimpl($this$offsetOnMainAxis.getOffset());
        }
        return IntOffset.m6613getXimpl($this$offsetOnMainAxis.getOffset());
    }
}
