...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    public ClockDialNode(TimePickerState state, boolean autoSwitchToMinute) {
        this.state = state;
    ...
    public final float getMaxDist() {
        ...
        return $this$_get_maxDist__u24lambda_u240.mo373toPx0680j_4(TimePickerKt.MaxDistance);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo363onRemeasuredozmzZPI(long size) {
        this.state.m2723setCentergyyYBs$material3_release(IntSizeKt.m6661getCenterozmzZPI(size));
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* renamed from: onPointerEvent-H0pRuoY */
    public void mo209onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo209onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo209onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
