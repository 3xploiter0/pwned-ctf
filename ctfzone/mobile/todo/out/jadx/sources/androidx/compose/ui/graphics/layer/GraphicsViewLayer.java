...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer layerContainer, long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3778getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    public void mo4668setBlendModes9anfk8(int value) {
        ...
        $this$setBlendMode_s9anfk8_u24lambda_u240.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m3855toPorterDuffModes9anfk8(value)));
    ...
    private final void m4676applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4676applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w());
        } else {
            m4676applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4635equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m3914equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m3945getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo4671setPivotOffsetk4lQ0M(long value) {
        ...
        if (OffsetKt.m3783isUnspecifiedk4lQ0M(value)) {
            ...
            this.viewLayer.setPivotX(IntSize.m6655getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m6654getHeightimpl(this.size) / 2.0f);
            return;
        }
        this.shouldManuallySetCenterPivot = false;
        this.viewLayer.setPivotX(Offset.m3762getXimpl(value));
        this.viewLayer.setPivotY(Offset.m3763getYimpl(value));
    }
    ...
    public void mo4667setAmbientShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m4057toArgb8_81llA(value));
        }
    }
    ...
    public void mo4673setSpotShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m4057toArgb8_81llA(value));
        }
    }
    ...
    public void mo4672setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m6653equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m6655getWidthimpl(size) + x, IntSize.m6654getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m6655getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m6654getHeightimpl(size) / 2.0f);
            }
        } else {
            if (this.x != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (p != null) {
                Canvas pictureCanvas = p.beginRecording(IntSize.m6655getWidthimpl(this.size), IntSize.m6654getHeightimpl(this.size));
                try {
                    ...
                    if (this_$iv != null) {
                        ...
                        CanvasDrawScope this_$iv2 = this.pictureDrawScope;
                        if (this_$iv2 != null) {
                            long size$iv = IntSizeKt.m6667toSizeozmzZPI(this.size);
                            CanvasDrawScope.DrawParams drawParams = this_$iv2.getDrawParams();
                            ...
                            CanvasDrawScope.DrawParams $this$draw_yzxVdVo_u24lambda_u240$iv = this_$iv2.getDrawParams();
                            ...
                            $this$draw_yzxVdVo_u24lambda_u240$iv.m4479setSizeuvyYCjk(size$iv);
                            $this$record_u24lambda_u244_u24lambda_u243.save();
                            block.invoke(this_$iv2);
                            $this$record_u24lambda_u244_u24lambda_u243.restore();
                            CanvasDrawScope.DrawParams $this$draw_yzxVdVo_u24lambda_u241$iv = this_$iv2.getDrawParams();
                            ...
                            $this$draw_yzxVdVo_u24lambda_u241$iv.m4479setSizeuvyYCjk(prevSize$iv);
                        }
