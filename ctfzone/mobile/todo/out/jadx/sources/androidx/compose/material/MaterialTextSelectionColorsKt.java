...
public final class MaterialTextSelectionColorsKt {
    ...
    public static final SelectionColors rememberTextSelectionColors(Colors colors, Composer $composer, int $changed) {
        ...
        long primaryColor = colors.m1496getPrimary0d7_KjU();
        long backgroundColor = colors.m1489getBackground0d7_KjU();
        $composer.startReplaceableGroup(35572910);
        ComposerKt.sourceInformation($composer, "*43@1845L7");
        long $this$takeOrElse_u2dDxMtmZc$iv = ColorsKt.m1513contentColorFor4WTKRHQ(colors, backgroundColor);
        if ($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m4039getUnspecified0d7_KjU()) {
            jM4013unboximpl = $this$takeOrElse_u2dDxMtmZc$iv;
        } else {
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object objConsume = $composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd($composer);
            jM4013unboximpl = ((Color) objConsume).m4013unboximpl();
        }
        $composer.endReplaceableGroup();
        long textColorWithLowestAlpha = Color.m4001copywmQWz5c(jM4013unboximpl, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM4013unboximpl) : ContentAlpha.INSTANCE.getMedium($composer, 6), (14 & 2) != 0 ? Color.m4009getRedimpl(jM4013unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM4013unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM4013unboximpl) : 0.0f);
        Object key1$iv = Color.m3993boximpl(primaryColor);
        Object key2$iv = Color.m3993boximpl(backgroundColor);
        Object key3$iv = Color.m3993boximpl(textColorWithLowestAlpha);
        ...
        if (invalid$iv$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new SelectionColors(colors.m1496getPrimary0d7_KjU(), m1594calculateSelectionBackgroundColorysEtTa8(primaryColor, textColorWithLowestAlpha, backgroundColor), null);
    ...
    public static final long m1594calculateSelectionBackgroundColorysEtTa8(long selectionColor, long textColor, long backgroundColor) {
        ...
        return Color.m4001copywmQWz5c(selectionColor, (14 & 1) != 0 ? Color.m4005getAlphaimpl(selectionColor) : alpha, (14 & 2) != 0 ? Color.m4009getRedimpl(selectionColor) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(selectionColor) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(selectionColor) : 0.0f);
    }
    ...
    private static final float m1593calculateContrastRationb2GgbA(long selectionColor, float selectionColorAlpha, long textColor, long backgroundColor) {
        long compositeBackground = ColorKt.m4048compositeOverOWjLjI(Color.m4001copywmQWz5c(selectionColor, (14 & 1) != 0 ? Color.m4005getAlphaimpl(selectionColor) : selectionColorAlpha, (14 & 2) != 0 ? Color.m4009getRedimpl(selectionColor) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(selectionColor) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(selectionColor) : 0.0f), backgroundColor);
        long compositeTextColor = ColorKt.m4048compositeOverOWjLjI(textColor, compositeBackground);
    ...
    public static final float m1592calculateContrastRatioOWjLjI(long foreground, long background) {
        float foregroundLuminance = ColorKt.m4055luminance8_81llA(foreground) + 0.05f;
        float backgroundLuminance = ColorKt.m4055luminance8_81llA(background) + 0.05f;
