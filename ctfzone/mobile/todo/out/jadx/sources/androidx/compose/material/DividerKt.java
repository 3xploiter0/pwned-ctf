...
public final class DividerKt {
    ...
    public static final void m1537DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        float f2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    long jM1495getOnSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer2, 6).m1495getOnSurface0d7_KjU();
                    color2 = Color.m4001copywmQWz5c(jM1495getOnSurface0d7_KjU, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM1495getOnSurface0d7_KjU) : 0.12f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM1495getOnSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM1495getOnSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM1495getOnSurface0d7_KjU) : 0.0f);
                    $dirty &= -113;
                } else {
                    color2 = j;
                }
                thickness2 = i4 != 0 ? Dp.m6485constructorimpl(1) : f;
                startIndent2 = i5 != 0 ? Dp.m6485constructorimpl(0) : f2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
                    $dirty &= -113;
            ...
            Modifier.Companion indentMod = !((startIndent2 > 0.0f ? 1 : (startIndent2 == 0.0f ? 0 : -1)) == 0) ? PaddingKt.m685paddingqDBjuR0$default(Modifier.INSTANCE, startIndent2, 0.0f, 0.0f, 0.0f, 14, null) : Modifier.INSTANCE;
            ...
            BoxKt.Box(BackgroundKt.m236backgroundbw27NRU$default(SizeKt.m712height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, 1, null), targetThickness), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer, int i6) {
                    DividerKt.m1537DivideroMI9zvI(modifier5, j2, f3, f4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
