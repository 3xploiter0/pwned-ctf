...
public final class Color {
    ...
    public static final /* synthetic */ Color m3993boximpl(long j) {
        return new Color(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3999constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4003equalsimpl(long j, Object obj) {
        return (obj instanceof Color) && j == ((Color) obj).m4013unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4004equalsimpl0(long j, long j2) {
        return ULong.m7137equalsimpl0(j, j2);
    }
    ...
    public static int m4010hashCodeimpl(long j) {
        return ULong.m7142hashCodeimpl(j);
    }

    public boolean equals(Object obj) {
        return m4003equalsimpl(this.value, obj);
    }
    ...
    public final /* synthetic */ long m4013unboximpl() {
        return this.value;
    }
    ...
    public static final ColorSpace m4007getColorSpaceimpl(long arg0) {
        ColorSpaces this_$iv = ColorSpaces.INSTANCE;
        int id$iv = (int) ULong.m7130constructorimpl(63 & arg0);
        return this_$iv.getColorSpacesArray$ui_graphics_release()[id$iv];
    }

    /* renamed from: convert-vNxB06k, reason: not valid java name */
    public static final long m4000convertvNxB06k(long arg0, ColorSpace colorSpace) {
        Connector connector = ColorSpaceKt.m4422connectYBCOT_4$default(m4007getColorSpaceimpl(arg0), colorSpace, 0, 2, null);
        return connector.mo4425transformToColorl2rxGTc$ui_graphics_release(arg0);
    }

    /* renamed from: getRed-impl, reason: not valid java name */
    public static final float m4009getRedimpl(long arg0) {
        if (ULong.m7130constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 48) & 255))) / 255.0f;
        }
        short h$iv = (short) ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 48) & 65535);
    ...
    public static final float m4008getGreenimpl(long arg0) {
        if (ULong.m7130constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 40) & 255))) / 255.0f;
        }
        short h$iv = (short) ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 32) & 65535);
        int bits$iv = 65535 & h$iv;
        int s$iv = 32768 & bits$iv;
        int e$iv = (bits$iv >>> 10) & 31;
        int m$iv = bits$iv & 1023;
    ...
    public static final float m4006getBlueimpl(long arg0) {
        if (ULong.m7130constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 32) & 255))) / 255.0f;
        }
        short h$iv = (short) ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 16) & 65535);
        int bits$iv = 65535 & h$iv;
        int s$iv = 32768 & bits$iv;
        int e$iv = (bits$iv >>> 10) & 31;
        int m$iv = bits$iv & 1023;
    ...
    public static final float m4005getAlphaimpl(long arg0) {
        if (ULong.m7130constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 56) & 255))) / 255.0f;
        }
        return ((float) UnsignedKt.ulongToDouble(ULong.m7130constructorimpl(ULong.m7130constructorimpl(arg0 >>> 6) & 1023))) / 1023.0f;
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m3994component1impl(long arg0) {
        return m4009getRedimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3995component2impl(long arg0) {
        return m4008getGreenimpl(arg0);
    }

    /* renamed from: component3-impl, reason: not valid java name */
    public static final float m3996component3impl(long arg0) {
        return m4006getBlueimpl(arg0);
    }

    /* renamed from: component4-impl, reason: not valid java name */
    public static final float m3997component4impl(long arg0) {
        return m4005getAlphaimpl(arg0);
    }

    /* renamed from: component5-impl, reason: not valid java name */
    public static final ColorSpace m3998component5impl(long arg0) {
        return m4007getColorSpaceimpl(arg0);
    }

    /* renamed from: copy-wmQWz5c, reason: not valid java name */
    public static final long m4001copywmQWz5c(long arg0, float alpha, float red, float green, float blue) {
        return ColorKt.Color(red, green, blue, alpha, m4007getColorSpaceimpl(arg0));
    }
    ...
    public static String m4011toStringimpl(long arg0) {
        return "Color(" + m4009getRedimpl(arg0) + ", " + m4008getGreenimpl(arg0) + ", " + m4006getBlueimpl(arg0) + ", " + m4005getAlphaimpl(arg0) + ", " + m4007getColorSpaceimpl(arg0).getName() + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4029getBlack0d7_KjU() {
            return Color.Black;
        }

        /* renamed from: getDarkGray-0d7_KjU, reason: not valid java name */
        public final long m4032getDarkGray0d7_KjU() {
            return Color.DarkGray;
        }

        /* renamed from: getGray-0d7_KjU, reason: not valid java name */
        public final long m4033getGray0d7_KjU() {
            return Color.Gray;
        }

        /* renamed from: getLightGray-0d7_KjU, reason: not valid java name */
        public final long m4035getLightGray0d7_KjU() {
            return Color.LightGray;
        }

        /* renamed from: getWhite-0d7_KjU, reason: not valid java name */
        public final long m4040getWhite0d7_KjU() {
            return Color.White;
        }

        /* renamed from: getRed-0d7_KjU, reason: not valid java name */
        public final long m4037getRed0d7_KjU() {
            return Color.Red;
        }

        /* renamed from: getGreen-0d7_KjU, reason: not valid java name */
        public final long m4034getGreen0d7_KjU() {
            return Color.Green;
        }

        /* renamed from: getBlue-0d7_KjU, reason: not valid java name */
        public final long m4030getBlue0d7_KjU() {
            return Color.Blue;
        }

        /* renamed from: getYellow-0d7_KjU, reason: not valid java name */
        public final long m4041getYellow0d7_KjU() {
            return Color.Yellow;
        }

        /* renamed from: getCyan-0d7_KjU, reason: not valid java name */
        public final long m4031getCyan0d7_KjU() {
            return Color.Cyan;
        }

        /* renamed from: getMagenta-0d7_KjU, reason: not valid java name */
        public final long m4036getMagenta0d7_KjU() {
            return Color.Magenta;
        }

        /* renamed from: getTransparent-0d7_KjU, reason: not valid java name */
        public final long m4038getTransparent0d7_KjU() {
            return Color.Transparent;
        }

        /* renamed from: getUnspecified-0d7_KjU, reason: not valid java name */
        public final long m4039getUnspecified0d7_KjU() {
            return Color.Unspecified;
        }

        /* renamed from: hsv-JlNiLsg$default, reason: not valid java name */
        public static /* synthetic */ long m4028hsvJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            float f5;
            Rgb srgb;
            if ((i & 8) == 0) {
                f5 = f4;
            ...
            return companion.m4043hsvJlNiLsg(f, f2, f3, f5, srgb);
        }

        /* renamed from: hsv-JlNiLsg, reason: not valid java name */
        public final long m4043hsvJlNiLsg(float hue, float saturation, float value, float alpha, Rgb colorSpace) {
            boolean z = false;
        ...
        public static /* synthetic */ long m4027hslJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            float f5;
            Rgb srgb;
            if ((i & 8) == 0) {
                f5 = f4;
            ...
            return companion.m4042hslJlNiLsg(f, f2, f3, f5, srgb);
        }
        ...
        */
        public final long m4042hslJlNiLsg(float r7, float r8, float r9, float r10, androidx.compose.ui.graphics.colorspace.Rgb r11) {
            /*
                r6 = this;
                r0 = 0
            ...
            L30:
                ...
                androidx.compose.ui.graphics.InlineClassHelperKt.throwIllegalArgumentException(r2)
            L64:
                ...
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.Color.Companion.m4042hslJlNiLsg(float, float, float, float, androidx.compose.ui.graphics.colorspace.Rgb):long");
        }
