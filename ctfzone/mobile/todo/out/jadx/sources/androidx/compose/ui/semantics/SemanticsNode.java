...
public final class SemanticsNode {
    ...
    public final long m5769getSizeYbymL2g() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null ? nodeCoordinatorFindCoordinatorToGetBounds$ui_release.mo5347getSizeYbymL2g() : IntSize.INSTANCE.m6660getZeroYbymL2g();
    }
    ...
    public final long m5766getPositionInRootF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m5767getPositionInWindowF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m5768getPositionOnScreenF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final Rect getBoundsInParent$ui_release() {
        ...
        if (it != null) {
            ...
            if (it != null && (currentCoordinates = it.getCoordinates()) != null) {
                return LayoutCoordinates.localBoundingBoxOf$default(DelegatableNodeKt.m5461requireCoordinator64DMado(parent.outerSemanticsNode, NodeKind.m5574constructorimpl(8)), currentCoordinates, false, 2, null);
            }
        }
        return Rect.INSTANCE.getZero();
    }
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode $this$fillOneLayerOfSemanticsWrappers, List<SemanticsNode> list, boolean includeDeactivatedNodes) {
        ...
        do {
            ...
            if (child.isAttached() && (includeDeactivatedNodes || !child.getIsDeactivated())) {
                if (child.getNodes().m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8))) {
    ...
    public final SemanticsNode getParent() {
        ...
        if (node == null) {
            node = SemanticsNodeKt.findClosestParentNode(this.layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.semantics.SemanticsNode$parent$2
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(LayoutNode it) {
                    return Boolean.valueOf(it.getNodes().m5535hasH91voCI$ui_release(NodeKind.m5574constructorimpl(8)));
                }
            });
        }
        if (node == null) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m5461requireCoordinator64DMado(semanticsModifierNode, NodeKind.m5574constructorimpl(8));
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (nodeRole != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && !unmergedChildren.isEmpty()) {
            SemanticsNode fakeNode = m5765fakeSemanticsNodeypyhhiA(nodeRole, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver $this$fakeSemanticsNode) {
                    SemanticsPropertiesKt.m5777setRolekuIjeqM($this$fakeSemanticsNode, nodeRole.getValue());
                }
            });
        ...
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !unmergedChildren.isEmpty() && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (contentDescription != null) {
                SemanticsNode fakeNode2 = m5765fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m5765fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
