...
public final class Font extends AndroidPreloadedFont {
    ...
    public /* synthetic */ Font(AssetManager assetManager, String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i2 & 8) == 0) {
            iM6065getNormal_LCdwA = i;
        } else {
            iM6065getNormal_LCdwA = FontStyle.INSTANCE.m6065getNormal_LCdwA();
        }
        this(assetManager, str, normal, iM6065getNormal_LCdwA, settings, null);
    }
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m6060toStringimpl(getStyle())) + ')';
    }
