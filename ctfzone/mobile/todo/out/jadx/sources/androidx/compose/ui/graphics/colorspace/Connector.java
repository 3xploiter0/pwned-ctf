...
public class Connector {
    ...
    private Connector(ColorSpace source, ColorSpace destination, int intent) {
        ...
        ColorSpace colorSpaceAdapt$default2 = ColorModel.m4410equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4417getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(source, Illuminant.INSTANCE.getD50(), null, 2, null) : source;
        if (ColorModel.m4410equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4417getRgbxdoWZVw())) {
        ...
        this(source, destination, colorSpaceAdapt$default2, colorSpaceAdapt$default, intent, INSTANCE.m4427computeTransformYBCOT_4(source, destination, intent), null);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb mSource, Rgb mDestination, int intent) {
            ...
            this.mTransform = m4428computeTransformYBCOT_4(this.mSource, this.mDestination, intent);
        }
        ...
        private final float[] m4428computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m4433equalsimpl0(intent, RenderIntent.INSTANCE.m4437getAbsoluteuksYyKA())) {
        ...
        public long mo4425transformToColorl2rxGTc$ui_graphics_release(long color) {
            float r = Color.m4009getRedimpl(color);
            float g = Color.m4008getGreenimpl(color);
            float b = Color.m4006getBlueimpl(color);
            float a = Color.m4005getAlphaimpl(color);
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m4427computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m4433equalsimpl0(intent, RenderIntent.INSTANCE.m4437getAbsoluteuksYyKA())) {
                return null;
            }
            boolean srcRGB = ColorModel.m4410equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4417getRgbxdoWZVw());
            boolean dstRGB = ColorModel.m4410equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4417getRgbxdoWZVw());
            if (srcRGB && dstRGB) {
                return null;
            }
            if (!srcRGB && !dstRGB) {
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int iM4439getRelativeuksYyKA = RenderIntent.INSTANCE.m4439getRelativeuksYyKA();
            return new Connector(source, iM4439getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                {
                    super(source, source, iM4439getRelativeuksYyKA, null);
                }
    ...
    public long mo4425transformToColorl2rxGTc$ui_graphics_release(long color) {
        ...
        if (this.transform != null) {
            x *= this.transform[0];
            y = y2 * this.transform[1];
            z = z2 * this.transform[2];
        } else {
            y = y2;
            z = z2;
        }
        return this.transformDestination.mo4420xyzaToColorJlNiLsg$ui_graphics_release(x, y, z, a, this.destination);
    }
}
