...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6485constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6485constructorimpl((float) 24.0d);
    ...
    public final float m3207getContainerSizeD9Ej5fM() {
    ...
    public final float m3208getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3209getUnselectedOutlineWidthD9Ej5fM() {
