...
final class AndroidFlingSpline {
    ...
    public final long m551flingPositionLfoxSSI(float time) {
        float f = 100;
        ...
        return FlingResult.m553constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m552boximpl(long j) {
        ...
        public static boolean m554equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).getPackedValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m555equalsimpl0(long j, long j2) {
            return j == j2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m558hashCodeimpl(long j) {
            return Long.hashCode(j);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m559toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m554equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m558hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m559toStringimpl(this.packedValue);
        }
        ...
        public static final float m556getDistanceCoefficientimpl(long arg0) {
        ...
        public static final float m557getVelocityCoefficientimpl(long arg0) {
