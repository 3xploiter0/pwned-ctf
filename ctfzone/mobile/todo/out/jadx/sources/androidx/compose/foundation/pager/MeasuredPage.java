...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < size) {
            ...
            long offset = m916getOffsetBjo55l4(index);
            if (this.reverseLayout) {
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m6613getXimpl(offset);
                } else {
                    int mainAxisOffset2 = IntOffset.m6613getXimpl(offset);
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m6614getYimpl(offset);
                    iM6614getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    iM6614getYimpl = IntOffset.m6614getYimpl(offset);
                }
                long $this$copy_u2d4Tuh3kE$iv = IntOffsetKt.IntOffset(mainAxisOffset, iM6614getYimpl);
    ...
    private final long m915copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m6613getXimpl($this$copy_u2d4Tuh3kE))).intValue(), this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m6614getYimpl($this$copy_u2d4Tuh3kE));
    }
}
