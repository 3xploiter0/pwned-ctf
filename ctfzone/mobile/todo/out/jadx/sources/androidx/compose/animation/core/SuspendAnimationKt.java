...
public final class SuspendAnimationKt {
    ...
    public static final Object animateDecay(float initialValue, float initialVelocity, FloatDecayAnimationSpec animationSpec, final Function2<? super Float, ? super Float, Unit> function2, Continuation<? super Unit> continuation) {
        ...
        Object objAnimate$default = animate$default(AnimationStateKt.AnimationState$default(initialValue, initialVelocity, 0L, 0L, false, 28, null), anim, 0L, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.animation.core.SuspendAnimationKt.animateDecay.2
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:45:0x0129 A[Catch: CancellationException -> 0x015a, TRY_LEAVE, TryCatch #5 {CancellationException -> 0x015a, blocks: (B:43:0x011c, B:45:0x0129), top: B:79:0x011c }] */
