...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m3714customFocusSearchOMvw8(FocusTargetNode $this$customFocusSearch_u2d_u2dOM_u2dvw8, int focusDirection, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3684getNextdhqQ8s())) {
            return focusProperties.getNext();
        }
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3685getPreviousdhqQ8s())) {
            return focusProperties.getPrevious();
        }
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3687getUpdhqQ8s())) {
            return focusProperties.getUp();
        }
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3680getDowndhqQ8s())) {
            return focusProperties.getDown();
        }
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3683getLeftdhqQ8s())) {
        ...
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3686getRightdhqQ8s())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
        ...
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3681getEnterdhqQ8s())) {
            return focusProperties.getEnter().invoke(FocusDirection.m3671boximpl(focusDirection));
        }
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3682getExitdhqQ8s())) {
            return focusProperties.getExit().invoke(FocusDirection.m3671boximpl(focusDirection));
        }
        throw new IllegalStateException("invalid FocusDirection".toString());
    }

    /* renamed from: focusSearch-0X8WOeE, reason: not valid java name */
    public static final Boolean m3715focusSearch0X8WOeE(FocusTargetNode $this$focusSearch_u2d0X8WOeE, int focusDirection, LayoutDirection layoutDirection, Rect previouslyFocusedRect, Function1<? super FocusTargetNode, Boolean> function1) {
        int direction;
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3684getNextdhqQ8s()) ? true : FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3685getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m3718oneDimensionalFocusSearchOMvw8($this$focusSearch_u2d0X8WOeE, focusDirection, function1));
        }
        if (FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3683getLeftdhqQ8s()) ? true : FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3686getRightdhqQ8s()) ? true : FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3687getUpdhqQ8s()) ? true : FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3680getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m3727twoDimensionalFocusSearchsMXa3k8($this$focusSearch_u2d0X8WOeE, focusDirection, previouslyFocusedRect, function1);
        }
        if (!FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3681getEnterdhqQ8s())) {
            if (!FocusDirection.m3674equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3682getExitdhqQ8s())) {
                throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m3676toStringimpl(focusDirection))).toString());
            }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
            case 1:
                direction = FocusDirection.INSTANCE.m3686getRightdhqQ8s();
                break;
            case 2:
                direction = FocusDirection.INSTANCE.m3683getLeftdhqQ8s();
                break;
            default:
                throw new NoWhenBranchMatchedException();
        }
        ...
        if (focusTargetNodeFindActiveFocusNode2 != null) {
            return TwoDimensionalFocusSearchKt.m3727twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode2, direction, previouslyFocusedRect, function1);
        }
        return null;
    }
    ...
    private static final FocusTargetNode findNonDeactivatedParent(FocusTargetNode $this$findNonDeactivatedParent) {
        ...
        int type$iv4 = NodeKind.m5574constructorimpl(1024);
