...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier $this$border, BorderStroke border, Shape shape) {
        return m249borderziNgDLE($this$border, border.getWidth(), border.getBrush(), shape);
    }
    ...
    public static final Modifier m247borderxT4_qwU(Modifier $this$border_u2dxT4_qwU, float width, long color, Shape shape) {
        return m249borderziNgDLE($this$border_u2dxT4_qwU, width, new SolidColor(color, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m249borderziNgDLE(Modifier $this$border_u2dziNgDLE, float width, Brush brush, Shape shape) {
    ...
    public static final DrawResult m250drawRectBorderNsqcLGU(CacheDrawScope $this$drawRectBorder_u2dNsqcLGU, final Brush brush, long topLeft, long borderSize, boolean fillArea, float strokeWidthPx) {
        final long rectTopLeft = fillArea ? Offset.INSTANCE.m3778getZeroF1C5BW0() : topLeft;
        final long size = fillArea ? $this$drawRectBorder_u2dNsqcLGU.m3652getSizeNHjbRc() : borderSize;
        ...
        return $this$drawRectBorder_u2dNsqcLGU.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                $this$onDrawWithContent.drawContent();
                DrawScope.m4552drawRectAsUm42w$default($this$onDrawWithContent, brush, rectTopLeft, size, 0.0f, style, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            Path $this$createRoundRectPath_u24lambda_u241_u24lambda_u240 = AndroidPath_androidKt.Path();
            Path.addRoundRect$default($this$createRoundRectPath_u24lambda_u241_u24lambda_u240, createInsetRoundedRect(strokeWidth, roundedRect), null, 2, null);
            targetPath.mo3895opN5in7k0(targetPath, $this$createRoundRectPath_u24lambda_u241_u24lambda_u240, PathOperation.INSTANCE.m4295getDifferenceb3I0S0c());
        }
        return targetPath;
    }

    private static final RoundRect createInsetRoundedRect(float widthPx, RoundRect roundedRect) {
        return new RoundRect(widthPx, widthPx, roundedRect.getWidth() - widthPx, roundedRect.getHeight() - widthPx, m251shrinkKibmq7A(roundedRect.m3812getTopLeftCornerRadiuskKHJgLs(), widthPx), m251shrinkKibmq7A(roundedRect.m3813getTopRightCornerRadiuskKHJgLs(), widthPx), m251shrinkKibmq7A(roundedRect.m3811getBottomRightCornerRadiuskKHJgLs(), widthPx), m251shrinkKibmq7A(roundedRect.m3810getBottomLeftCornerRadiuskKHJgLs(), widthPx), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m251shrinkKibmq7A(long $this$shrink_u2dKibmq7A, float value) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m3737getXimpl($this$shrink_u2dKibmq7A) - value), Math.max(0.0f, CornerRadius.m3738getYimpl($this$shrink_u2dKibmq7A) - value));
    }
}
