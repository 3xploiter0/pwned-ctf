...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3487boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3488constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3489equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3490equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3491hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3492toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3489equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3491hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3492toStringimpl(this.composer);
    }
    ...
    public static final void m3493updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> function1) {
        arg0.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3495boximpl(Updater.m3496constructorimpl(arg0)));
