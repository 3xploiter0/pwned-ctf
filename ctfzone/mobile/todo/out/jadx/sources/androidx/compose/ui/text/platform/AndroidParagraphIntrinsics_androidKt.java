...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m6207resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m6206resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m6206resolveTextDirectionHeuristicsHklW4sA(int textDirection, LocaleList localeList) {
        Locale currentLocale;
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6367getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6368getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6369getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6370getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6366getContents_7Xco()) ? true : TextDirection.m6362equalsimpl0(textDirection, TextDirection.INSTANCE.m6371getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle $this$hasEmojiCompat) {
        ...
        return !(((platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m5800boximpl(paragraphSyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m5803equalsimpl0(r0.getValue(), EmojiSupportMatch.INSTANCE.m5809getNone_3YsG6Y()));
    }
}
