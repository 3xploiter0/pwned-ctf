...
public final class LockKt {
    ...
    public static final ImageVector getLock(Icons.Outlined $this$Lock) {
        ...
        ImageVector.Builder $this$_get_Lock__u24lambda_u241 = new ImageVector.Builder("Outlined.Lock", Dp.m6485constructorimpl(24.0f), Dp.m6485constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _lock = ImageVector.Builder.m4694addPathoIyEayM$default($this$_get_Lock__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
