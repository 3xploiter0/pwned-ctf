...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4092getAutoNrFUSI();
    private long size = Size.INSTANCE.m3839getUnspecifiedNHjbRc();
    ...
    public void mo4193setAmbientShadowColor8_81llA(long value) {
        if (!Color.m4004equalsimpl0(this.ambientShadowColor, value)) {
    ...
    public void mo4195setSpotShadowColor8_81llA(long value) {
        if (!Color.m4004equalsimpl0(this.spotShadowColor, value)) {
    ...
    public void mo4196setTransformOrigin__ExYCQ(long value) {
        if (!TransformOrigin.m4388equalsimpl0(this.transformOrigin, value)) {
    ...
    public void mo4194setCompositingStrategyaDBOjCE(int value) {
        if (!CompositingStrategy.m4088equalsimpl0(this.compositingStrategy, value)) {
    ...
    public void m4315setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo4193setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4195setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4196setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4394getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo4194setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4092getAutoNrFUSI());
        m4315setSizeuvyYCjk(Size.INSTANCE.m3839getUnspecifiedNHjbRc());
        this.outline = null;
