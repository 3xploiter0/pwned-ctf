...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3751boximpl(Offset.INSTANCE.m3778getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3751boximpl(Offset.INSTANCE.m3778getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1376invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1376invokeRg1IO4c(boolean isInTouchMode, LayoutCoordinates layoutCoordinates, long rawPosition, SelectionAdjustment selectionMode) {
                long position;
                long $this$invoke_Rg1IO4c_u24lambda_u240 = layoutCoordinates.mo5347getSizeYbymL2g();
                Rect textRect = new Rect(0.0f, 0.0f, IntSize.m6655getWidthimpl($this$invoke_Rg1IO4c_u24lambda_u240), IntSize.m6654getHeightimpl($this$invoke_Rg1IO4c_u24lambda_u240));
                if (SelectionManagerKt.m1381containsInclusiveUv8p0NA(textRect, rawPosition)) {
                    position = rawPosition;
                } else {
                    position = TextLayoutStateKt.m1221coerceIn3MmeM6k(rawPosition, textRect);
                }
                long positionInContainer = SelectionManager.this.m1360convertToContainerCoordinatesR5De75A(layoutCoordinates, position);
                if (OffsetKt.m3781isSpecifiedk4lQ0M(positionInContainer)) {
                    SelectionManager.this.setInTouchMode(isInTouchMode);
                    SelectionManager.this.m1367startSelection9KIMszo(positionInContainer, false, selectionMode);
        ...
        this.selectionRegistrar.setOnSelectionUpdateSelectAll$foundation_release(new Function2<Boolean, Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.3
            ...
            public final void invoke(boolean isInTouchMode, long selectableId) {
                Pair<Selection, LongObjectMap<Selection>> pairSelectAllInSelectable$foundation_release = SelectionManager.this.selectAllInSelectable$foundation_release(selectableId, SelectionManager.this.getSelection());
                Selection newSelection = pairSelectAllInSelectable$foundation_release.component1();
                LongObjectMap newSubselection = pairSelectAllInSelectable$foundation_release.component2();
        ...
        this.selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1377invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1377invokepGV3PM0(boolean isInTouchMode, LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment selectionMode) {
                long newPositionInContainer = SelectionManager.this.m1360convertToContainerCoordinatesR5De75A(layoutCoordinates, newPosition);
                long previousPositionInContainer = SelectionManager.this.m1360convertToContainerCoordinatesR5De75A(layoutCoordinates, previousPosition);
                SelectionManager.this.setInTouchMode(isInTouchMode);
                return Boolean.valueOf(SelectionManager.this.m1375updateSelectionqNKwrvQ$foundation_release(Offset.m3751boximpl(newPositionInContainer), previousPositionInContainer, isStartHandle, selectionMode));
            }
        });
        this.selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1362setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        this.selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long selectableId) {
                ...
                if ((selection == null || (start = selection.getStart()) == null || selectableId != start.getSelectableId()) ? false : true) {
                    SelectionManager.this.m1366setStartHandlePosition_kEHs6E(null);
                }
                ...
                if ((selection2 == null || (end = selection2.getEnd()) == null || selectableId != end.getSelectableId()) ? false : true) {
                    SelectionManager.this.m1365setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().contains(selectableId)) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1378invokeZmokQxo(keyEvent.m5057unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1378invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                if (SelectionManager_androidKt.m1383isCopyKeyEventZmokQxo(it)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates value) {
        ...
        if (getHasFocus() && getSelection() != null) {
            Offset positionInWindow = value != null ? Offset.m3751boximpl(LayoutCoordinatesKt.positionInWindow(value)) : null;
    ...
    public final void m1363setDragBeginPositionk4lQ0M(long j) {
        MutableState $this$setValue$iv = this.dragBeginPosition;
        $this$setValue$iv.setValue(Offset.m3751boximpl(j));
    }

    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1370getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1364setDragTotalDistancek4lQ0M(long j) {
        MutableState $this$setValue$iv = this.dragTotalDistance;
        $this$setValue$iv.setValue(Offset.m3751boximpl(j));
    }

    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1371getDragTotalDistanceF1C5BW0$foundation_release() {
    ...
    public final void m1366setStartHandlePosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.startHandlePosition;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1373getStartHandlePosition_m7T9E() {
    ...
    public final void m1365setEndHandlePosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.endHandlePosition;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1372getEndHandlePosition_m7T9E() {
    ...
    public final void m1362setCurrentDragPosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.currentDragPosition;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1369getCurrentDragPosition_m7T9E() {
    ...
    public final void updateHandleOffsets() {
        ...
        if (selection == null || containerCoordinates == null || !containerCoordinates.isAttached() || (startLayoutCoordinates == null && endLayoutCoordinates == null)) {
            m1366setStartHandlePosition_kEHs6E(null);
            m1365setEndHandlePosition_kEHs6E(null);
            return;
        }
        ...
        if (startLayoutCoordinates != null) {
            ...
            long handlePosition = startSelectable.mo1329getHandlePositiondBAh8RU(selection, true);
            if (OffsetKt.m3783isUnspecifiedk4lQ0M(handlePosition)) {
                offsetM3751boximpl = null;
            } else {
                long position = containerCoordinates.mo5348localPositionOfR5De75A(handleCoordinates, handlePosition);
                offsetM3751boximpl = Offset.m3751boximpl(position);
                long it = offsetM3751boximpl.getPackedValue();
                if (!(getDraggingHandle() == Handle.SelectionStart || SelectionManagerKt.m1381containsInclusiveUv8p0NA(visibleBounds, it))) {
                    offsetM3751boximpl = null;
                }
            }
            offset = offsetM3751boximpl;
        ...
        m1366setStartHandlePosition_kEHs6E(offset);
        if (endLayoutCoordinates != null) {
            LayoutCoordinates handleCoordinates2 = endLayoutCoordinates;
            long handlePosition2 = endSelectable.mo1329getHandlePositiondBAh8RU(selection, false);
            if (OffsetKt.m3783isUnspecifiedk4lQ0M(handlePosition2)) {
                offset2 = null;
            } else {
                long position2 = containerCoordinates.mo5348localPositionOfR5De75A(handleCoordinates2, handlePosition2);
                Offset offsetM3751boximpl2 = Offset.m3751boximpl(position2);
                long it2 = offsetM3751boximpl2.getPackedValue();
                if (!(getDraggingHandle() == Handle.SelectionEnd || SelectionManagerKt.m1381containsInclusiveUv8p0NA(visibleBounds, it2))) {
                    offsetM3751boximpl2 = null;
                }
                offset2 = offsetM3751boximpl2;
            }
        } else {
            offset2 = null;
        }
        m1365setEndHandlePosition_kEHs6E(offset2);
    }
    ...
    public final Pair<Selection, LongObjectMap<Selection>> selectAllInSelectable$foundation_release(long selectableId, Selection previousSelection) {
        ...
        List $this$fastForEach$iv$iv2 = $this$fastFold$iv;
        int index$iv$iv = 0;
    ...
    public final boolean isEntireContainerSelected$foundation_release() {
        ...
        List selectables2 = selectionManager.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        boolean z = true;
    ...
    public final void selectAll$foundation_release() {
        ...
        MutableLongObjectMap $this$selectAll_u24lambda_u2411 = LongObjectMapKt.mutableLongObjectMapOf();
        int index$iv = 0;
        int size = selectables2.size();
        while (index$iv < size) {
            ...
            if (subSelection == null) {
                ...
                selectables = selectables2;
                $this$selectAll_u24lambda_u2411.put(selectable.getSelectableId(), subSelection);
                selection = selection;
            }
            index$iv++;
            selectables2 = selectables;
        }
        if ($this$selectAll_u24lambda_u2411.isEmpty()) {
            return;
        }
        ...
        this.selectionRegistrar.setSubselections($this$selectAll_u24lambda_u2411);
    ...
    public final boolean isNonEmptySelection$foundation_release() {
        ...
        while (index$iv$iv < size) {
            ...
            boolean z = ($this$isNonEmptySelection_u24lambda_u2413_u24lambda_u2412 == null || $this$isNonEmptySelection_u24lambda_u2413_u24lambda_u2412.getStart().getOffset() == $this$isNonEmptySelection_u24lambda_u2413_u24lambda_u2412.getEnd().getOffset()) ? false : true;
            if (z) {
                return true;
            }
            index$iv$iv++;
    ...
    public final AnnotatedString getSelectedText$foundation_release() {
        ...
        List $this$fastForEach$iv = selectionManager.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int index$iv = 0;
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode()) {
                ...
                TextToolbar.showMenu$default(textToolbar, rect, isNonEmptySelection$foundation_release() ? new C03771(this) : null, null, null, isEntireContainerSelected$foundation_release() ? null : new C03782(this), 12, null);
                return;
            }
    ...
    /* synthetic */ class C03771 extends FunctionReferenceImpl implements Function0<Unit> {
        C03771(Object obj) {
    ...
    /* synthetic */ class C03782 extends FunctionReferenceImpl implements Function0<Unit> {
        C03782(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        Rect rootRect = visibleRect.m3799translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(containerCoordinates));
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1058onDownk4lQ0M(long point) {
                ...
                Offset offsetM1373getStartHandlePosition_m7T9E = isStartHandle ? this.m1373getStartHandlePosition_m7T9E() : this.m1372getEndHandlePosition_m7T9E();
                if (offsetM1373getStartHandlePosition_m7T9E == null) {
                    return;
                }
                offsetM1373getStartHandlePosition_m7T9E.getPackedValue();
                ...
                long handlePosition = selectable.mo1329getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3783isUnspecifiedk4lQ0M(handlePosition)) {
                    return;
                }
                long beginCoordinates = SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(handlePosition);
                this.m1362setCurrentDragPosition_kEHs6E(Offset.m3751boximpl(this.requireContainerCoordinates$foundation_release().mo5348localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates)));
            ...
            public void mo1060onStartk4lQ0M(long startPoint) {
                ...
                long handlePosition = selectable2.mo1329getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3783isUnspecifiedk4lQ0M(handlePosition)) {
                    return;
                }
                long beginCoordinates = SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(handlePosition);
                this.m1363setDragBeginPositionk4lQ0M(this.requireContainerCoordinates$foundation_release().mo5348localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates));
                this.m1364setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3778getZeroF1C5BW0());
            }
            ...
            public void mo1059onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1364setDragTotalDistancek4lQ0M(Offset.m3767plusMKHz9U(selectionManager.m1371getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long endPosition = Offset.m3767plusMKHz9U(this.m1370getDragBeginPositionF1C5BW0$foundation_release(), this.m1371getDragTotalDistanceF1C5BW0$foundation_release());
                boolean consumed = this.m1375updateSelectionqNKwrvQ$foundation_release(Offset.m3751boximpl(endPosition), this.m1370getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate());
                if (consumed) {
                    this.m1363setDragBeginPositionk4lQ0M(endPosition);
                    this.m1364setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3778getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1362setCurrentDragPosition_kEHs6E(null);
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c03742 = this;
                    AwaitPointerEventScope $this$awaitEachGesture = (AwaitPointerEventScope) c03742.L$0;
                    c03742.label = 1;
                    Object objWaitForUpOrCancellation$default = TapGestureDetectorKt.waitForUpOrCancellation$default($this$awaitEachGesture, null, c03742, 1, null);
            ...
            if (it != null) {
                c03742.$onTap.invoke(Offset.m3751boximpl(it.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope $this$detectNonConsumingTap, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture($this$detectNonConsumingTap, new C03742(function1, null), continuation);
                ...
                case 0:
                    ...
                    if (selectionManager.detectNonConsumingTap($this$pointerInput, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m1379invokek4lQ0M(offset.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                        public final void m1379invokek4lQ0M(long it) {
                            function0.invoke();
                        }
    ...
    private final Modifier onClearSelectionRequested(Modifier $this$onClearSelectionRequested, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput($this$onClearSelectionRequested, Unit.INSTANCE, new C03761(function0, null)) : $this$onClearSelectionRequested;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: convertToContainerCoordinates-R5De75A, reason: not valid java name */
    public final long m1360convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates coordinates = this.containerLayoutCoordinates;
        if (coordinates == null || !coordinates.isAttached()) {
            return Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo5348localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1367startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1374updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3777getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1375updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1374updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1374updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1362setCurrentDragPosition_kEHs6E(Offset.m3751boximpl(position));
        SelectionLayout selectionLayout = m1361getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
    ...
    private final SelectionLayout m1361getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
        ...
        Selection previousSelection = OffsetKt.m3783isUnspecifiedk4lQ0M(previousHandlePosition) ? null : getSelection();
    ...
    public final void m1368contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        boolean isEmptySelection = selection != null ? TextRange.m5942getCollapsedimpl(selection.m1335toTextRanged9O1mEE()) : true;
        if (isEmptySelection) {
            m1367startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
