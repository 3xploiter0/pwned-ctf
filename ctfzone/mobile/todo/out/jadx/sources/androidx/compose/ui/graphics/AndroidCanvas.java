...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo3858concat58bKbWc(float[] matrix) {
        if (!MatrixKt.m4258isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m3873setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo3857clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m3866toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo3856clipPathmtrdDE(Path path, int clipOp) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m3866toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m3866toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m3987equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.INSTANCE.m3991getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo3862drawLineWko1d7g(long p1, long p2, Paint paint) {
        this.internalCanvas.drawLine(Offset.m3762getXimpl(p1), Offset.m3763getYimpl(p1), Offset.m3762getXimpl(p2), Offset.m3763getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo3859drawCircle9KIMszo(long center, float radius, Paint paint) {
        this.internalCanvas.drawCircle(Offset.m3762getXimpl(center), Offset.m3763getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo3860drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m3762getXimpl(topLeftOffset), Offset.m3763getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo3861drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m6613getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m6614getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m6613getXimpl(srcOffset) + IntSize.m6655getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m6614getYimpl(srcOffset) + IntSize.m6654getHeightimpl(srcSize);
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m6613getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m6614getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m6613getXimpl(dstOffset) + IntSize.m6655getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m6614getYimpl(dstOffset) + IntSize.m6654getHeightimpl(dstSize);
    ...
    public void mo3863drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        if (!PointMode.m4304equalsimpl0(pointMode, PointMode.INSTANCE.m4308getLinesr_lszbg())) {
            if (!PointMode.m4304equalsimpl0(pointMode, PointMode.INSTANCE.m4310getPolygonr_lszbg())) {
                if (PointMode.m4304equalsimpl0(pointMode, PointMode.INSTANCE.m4309getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            this.internalCanvas.drawPoint(Offset.m3762getXimpl(point), Offset.m3763getYimpl(point), paint.getInternalPaint());
        }
    }
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m3762getXimpl(p1), Offset.m3763getYimpl(p1), Offset.m3762getXimpl(p2), Offset.m3763getYimpl(p2), frameworkPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo3864drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
    ...
    public void mo3865drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m3909toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
}
