...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2<SaverScope, TextFieldValue, Object>() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope $this$Saver, TextFieldValue it) {
            return CollectionsKt.arrayListOf(SaversKt.save(it.getText(), SaversKt.getAnnotatedStringSaver(), $this$Saver), SaversKt.save(TextRange.m5936boximpl(it.getSelection()), SaversKt.getSaver(TextRange.INSTANCE), $this$Saver));
        }
        ...
        public final TextFieldValue invoke(Object it) {
            ...
            AnnotatedString annotatedStringRestore = ((!Intrinsics.areEqual(value$iv, (Object) false) || (saver$iv instanceof NonNullValueClassSaver)) && value$iv != null) ? saver$iv.restore(value$iv) : null;
            ...
            if ((!Intrinsics.areEqual(value$iv2, (Object) false) || (saver$iv2 instanceof NonNullValueClassSaver)) && value$iv2 != null) {
                textRangeRestore = saver$iv2.restore(value$iv2);
            }
    ...
    private TextFieldValue(AnnotatedString annotatedString, long selection, TextRange composition) {
        ...
        this.selection = TextRangeKt.m5954coerceIn8ffj60Q(selection, 0, getText().length());
        this.composition = composition != null ? TextRange.m5936boximpl(TextRangeKt.m5954coerceIn8ffj60Q(composition.getPackedValue(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM5953getZerod9O1mEE;
        TextRange textRange2;
        if ((i & 2) == 0) {
            jM5953getZerod9O1mEE = j;
        } else {
            jM5953getZerod9O1mEE = TextRange.INSTANCE.m5953getZerod9O1mEE();
        }
        if ((i & 4) == 0) {
        ...
        this(annotatedString, jM5953getZerod9O1mEE, textRange2, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.INSTANCE.m5953getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    private TextFieldValue(String text, long selection, TextRange composition) {
        DefaultConstructorMarker defaultConstructorMarker = null;
        this(new AnnotatedString(text, null, null, 6, defaultConstructorMarker), selection, composition, defaultConstructorMarker);
    }
    ...
    public static /* synthetic */ TextFieldValue m6190copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m6192copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m6192copy3r_uNRQ(AnnotatedString annotatedString, long selection, TextRange composition) {
        return new TextFieldValue(annotatedString, selection, composition, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default, reason: not valid java name */
    public static /* synthetic */ TextFieldValue m6191copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m6193copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m6193copy3r_uNRQ(String text, long selection, TextRange composition) {
        DefaultConstructorMarker defaultConstructorMarker = null;
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TextFieldValue) {
            return TextRange.m5941equalsimpl0(this.selection, ((TextFieldValue) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldValue) other).composition) && Intrinsics.areEqual(this.text, ((TextFieldValue) other).text);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m5949hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result2 + (textRange != null ? TextRange.m5949hashCodeimpl(textRange.getPackedValue()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.text) + "', selection=" + ((Object) TextRange.m5951toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
