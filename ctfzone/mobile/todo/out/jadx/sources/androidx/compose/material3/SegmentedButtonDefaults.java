...
public final class SegmentedButtonDefaults {
    ...
    private static final float BorderWidth = OutlinedSegmentedButtonTokens.INSTANCE.m3212getOutlineWidthD9Ej5fM();
    private static final float IconSize = OutlinedSegmentedButtonTokens.INSTANCE.m3211getIconSizeD9Ej5fM();
    ...
    public final SegmentedButtonColors m2370colorsXqyqHi0(long activeContainerColor, long activeContentColor, long activeBorderColor, long inactiveContainerColor, long inactiveContentColor, long inactiveBorderColor, long disabledActiveContainerColor, long disabledActiveContentColor, long disabledActiveBorderColor, long disabledInactiveContainerColor, long disabledInactiveContentColor, long disabledInactiveBorderColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long activeContainerColor2 = (i & 1) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : activeContainerColor;
        long activeContentColor2 = (i & 2) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : activeContentColor;
        long activeBorderColor2 = (i & 4) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : activeBorderColor;
        long inactiveContainerColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : inactiveContainerColor;
        long inactiveContentColor2 = (i & 16) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : inactiveContentColor;
        long inactiveBorderColor2 = (i & 32) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : inactiveBorderColor;
        long disabledActiveContainerColor2 = (i & 64) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledActiveContainerColor;
        long disabledActiveContentColor2 = (i & 128) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledActiveContentColor;
        long disabledActiveBorderColor2 = (i & 256) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledActiveBorderColor;
        long disabledInactiveContainerColor2 = (i & 512) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledInactiveContainerColor;
        long disabledInactiveContentColor2 = (i & 1024) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledInactiveContentColor;
        long disabledInactiveBorderColor2 = (i & 2048) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledInactiveBorderColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SegmentedButtonColors getDefaultSegmentedButtonColors$material3_release(ColorScheme $this$defaultSegmentedButtonColors) {
        ...
        if (defaultSegmentedButtonColorsCached == null) {
            ...
            long jM4001copywmQWz5c = Color.m4001copywmQWz5c(jFromToken7, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken7) : OutlinedSegmentedButtonTokens.INSTANCE.getDisabledLabelTextOpacity(), (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken7) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken7) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken7) : 0.0f);
            ...
            SegmentedButtonColors it = new SegmentedButtonColors(jFromToken, jFromToken2, jFromToken3, surface, jFromToken4, jFromToken5, jFromToken6, jM4001copywmQWz5c, Color.m4001copywmQWz5c(jFromToken8, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken8) : OutlinedSegmentedButtonTokens.INSTANCE.getDisabledOutlineOpacity(), (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken8) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken8) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken8) : 0.0f), $this$defaultSegmentedButtonColors.getSurface(), ColorSchemeKt.fromToken($this$defaultSegmentedButtonColors, OutlinedSegmentedButtonTokens.INSTANCE.getDisabledLabelTextColor()), ColorSchemeKt.fromToken($this$defaultSegmentedButtonColors, OutlinedSegmentedButtonTokens.INSTANCE.getOutlineColor()), null);
    ...
    public final float m2371getBorderWidthD9Ej5fM() {
        return BorderWidth;
    }
    ...
    public final float m2372getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final void ActiveIcon(Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 3) != 2 || !$composer2.getSkipping()) {
            ...
            IconKt.m2147Iconww6aTOc(CheckKt.getCheck(Icons.Filled.INSTANCE), (String) null, SizeKt.m726size3ABfNKs(Modifier.INSTANCE, IconSize), 0L, $composer2, 48, 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public final void Icon(final boolean active, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed, final int i) {
        ...
        Function2 inactiveContent;
        int $dirty;
        Function2 activeContent;
        ...
        if (i3 != 0) {
            $dirty2 |= 384;
            inactiveContent = function22;
        } else if (($changed & 384) == 0) {
            inactiveContent = function22;
            $dirty2 |= $composer2.changedInstance(inactiveContent) ? 256 : 128;
        } else {
            inactiveContent = function22;
        }
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            final Function2 activeContent2 = i2 != 0 ? ComposableSingletons$SegmentedButtonKt.INSTANCE.m1982getLambda1$material3_release() : function23;
            final Function2 inactiveContent2 = i3 != 0 ? null : inactiveContent;
            if (ComposerKt.isTraceInProgress()) {
            ...
            if (inactiveContent2 == null) {
                ...
                $dirty = $dirty2;
                AnimatedVisibilityKt.AnimatedVisibility(active, (Modifier) null, EnterExitTransitionKt.fadeIn$default(AnimationSpecKt.tween$default(350, 0, null, 6, null), 0.0f, 2, null).plus(EnterExitTransitionKt.m73scaleInL8ZKhE(AnimationSpecKt.tween$default(350, 0, null, 6, null), 0.0f, TransformOriginKt.TransformOrigin(0.0f, 1.0f))), ExitTransition.INSTANCE.getNone(), (String) null, ComposableLambdaKt.composableLambda($composer2, -750750819, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonDefaults.Icon.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            inactiveContent = inactiveContent2;
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = $composer2.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup != null) {
            final Function2 function24 = activeContent;
            final Function2 function25 = inactiveContent;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonDefaults.Icon.3
                ...
                public final void invoke(Composer composer, int i4) {
                    SegmentedButtonDefaults.this.Icon(active, function24, function25, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static /* synthetic */ BorderStroke m2368borderStrokel07J4OM$default(SegmentedButtonDefaults segmentedButtonDefaults, long j, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            f = BorderWidth;
        }
        return segmentedButtonDefaults.m2369borderStrokel07J4OM(j, f);
    }

    /* renamed from: borderStroke-l07J4OM, reason: not valid java name */
    public final BorderStroke m2369borderStrokel07J4OM(long color, float width) {
