...
public final class FontMatcher {
    ...
    public final List<Font> m6054matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        List list;
        ...
        while (true) {
            ...
            Font it = font;
            if (Intrinsics.areEqual(it.getWeight(), fontWeight) && FontStyle.m6058equalsimpl0(it.getStyle(), fontStyle)) {
                z = true;
            }
            if (z) {
                target$iv.add(font);
        ...
        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
            ...
            if (FontStyle.m6058equalsimpl0(it3.getStyle(), fontStyle)) {
                target$iv2.add(it3);
            }
        }
    ...
    public static /* synthetic */ List filterByClosestWeight$ui_text_release$default(FontMatcher $this, List $receiver, FontWeight fontWeight, boolean preferBelow, FontWeight minSearchRange, FontWeight maxSearchRange, int i, Object obj) {
        ...
        while (index$iv$iv < size2) {
            ...
            FontWeight minSearchRange3 = minSearchRange2;
            FontWeight minSearchRange4 = it.getWeight();
            if (Intrinsics.areEqual(minSearchRange4, bestWeight)) {
    ...
    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m6052matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m6053matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
    }

    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m6053matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        return m6054matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }
}
