...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo3608alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long remaining = IntSizeKt.IntSize(IntSize.m6655getWidthimpl(space) - IntSize.m6655getWidthimpl(size), IntSize.m6654getHeightimpl(space) - IntSize.m6654getHeightimpl(size));
        float centerX = IntSize.m6655getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m6654getHeightimpl(remaining) / 2.0f;
        float f = 1;
