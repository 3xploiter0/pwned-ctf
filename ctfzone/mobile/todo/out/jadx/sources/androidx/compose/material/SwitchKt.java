...
public final class SwitchKt {
    ...
    private static final float TrackWidth = Dp.m6485constructorimpl(34);
    private static final float TrackStrokeWidth = Dp.m6485constructorimpl(14);
    private static final float ThumbDiameter = Dp.m6485constructorimpl(20);
    private static final float ThumbRippleRadius = Dp.m6485constructorimpl(24);
    private static final float DefaultSwitchPadding = Dp.m6485constructorimpl(2);
    ...
    */
    ...
    public static final void SwitchImpl(final BoxScope $this$SwitchImpl, final boolean checked, final boolean enabled, final SwitchColors colors, final Function0<Float> function0, final InteractionSource interactionSource, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.SwitchKt$SwitchImpl$2$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        SwitchKt.m1689drawTrackRPmYEkk($this$Canvas, SwitchKt.SwitchImpl$lambda$15(trackColor$delegate), $this$Canvas.mo373toPx0680j_4(SwitchKt.getTrackWidth()), $this$Canvas.mo373toPx0680j_4(SwitchKt.getTrackStrokeWidth()));
                    }
                };
            ...
            float absoluteElevation = Dp.m6485constructorimpl(arg0$iv + elevation);
            $composer2.startReplaceableGroup(-539243554);
            ComposerKt.sourceInformation($composer2, "253@10467L36");
            if (Color.m4004equalsimpl0(SwitchImpl$lambda$17(thumbColor$delegate), MaterialTheme.INSTANCE.getColors($composer2, 6).m1500getSurface0d7_KjU()) && elevationOverlay != null) {
                jSwitchImpl$lambda$17 = elevationOverlay.mo1536apply7g2Lkgo(SwitchImpl$lambda$17(thumbColor$delegate), absoluteElevation, $composer2, 0);
            } else {
                jSwitchImpl$lambda$17 = SwitchImpl$lambda$17(thumbColor$delegate);
            }
            $composer2.endReplaceableGroup();
            State resolvedThumbColor$delegate = SingleValueAnimationKt.m114animateColorAsStateeuL9pac(jSwitchImpl$lambda$17, null, null, null, $composer2, 0, 14);
            ...
            if (invalid$iv3 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv3 = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material.SwitchKt$SwitchImpl$3$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
                        return IntOffset.m6604boximpl(m1690invokeBjo55l4(density));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m1690invokeBjo55l4(Density $this$offset) {
            ...
            $composer2.endReplaceableGroup();
            SpacerKt.Spacer(BackgroundKt.m235backgroundbw27NRU(ShadowKt.m3666shadows4CzXII(SizeKt.m718requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(modifierAlign, (Function1) value$iv3), interactionSource, RippleKt.m1763rememberRipple9IZ8Weo(false, ThumbRippleRadius, 0L, $composer2, 54, 4)), ThumbDiameter), elevation, (24 & 2) != 0 ? RectangleShapeKt.getRectangleShape() : RoundedCornerShapeKt.getCircleShape(), (24 & 4) != 0 ? Dp.m6484compareTo0680j_4(24, Dp.m6485constructorimpl((float) 0)) > 0 : false, (24 & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (24 & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L), SwitchImpl$lambda$18(resolvedThumbColor$delegate), RoundedCornerShapeKt.getCircleShape()), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1689drawTrackRPmYEkk(DrawScope $this$drawTrack_u2dRPmYEkk, long trackColor, float trackWidth, float strokeWidth) {
        float strokeRadius = strokeWidth / 2;
        DrawScope.m4545drawLineNGM6Ib0$default($this$drawTrack_u2dRPmYEkk, trackColor, androidx.compose.ui.geometry.OffsetKt.Offset(strokeRadius, Offset.m3763getYimpl($this$drawTrack_u2dRPmYEkk.mo4558getCenterF1C5BW0())), androidx.compose.ui.geometry.OffsetKt.Offset(trackWidth - strokeRadius, Offset.m3763getYimpl($this$drawTrack_u2dRPmYEkk.mo4558getCenterF1C5BW0())), strokeWidth, StrokeCap.INSTANCE.m4357getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
    }

    static {
        float arg0$iv = TrackWidth;
        float other$iv = ThumbDiameter;
        ThumbPathLength = Dp.m6485constructorimpl(arg0$iv - other$iv);
        AnimationSpec = new TweenSpec<>(100, 0, null, 6, null);
        ThumbDefaultElevation = Dp.m6485constructorimpl(1);
        ThumbPressedElevation = Dp.m6485constructorimpl(6);
        SwitchVelocityThreshold = Dp.m6485constructorimpl(125);
    }
