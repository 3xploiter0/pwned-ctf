...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, boolean ellipsis) {
        ...
        int i = 0;
        if (!(Constraints.m6440getMinWidthimpl(constraints) == 0 && Constraints.m6439getMinHeightimpl(constraints) == 0)) {
        ...
        while (index < size) {
            ...
            if (Constraints.m6433getHasBoundedHeightimpl(constraints)) {
                iM6437getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m6437getMaxHeightimpl(constraints) - ParagraphKt.ceilToInt(currentHeight), i);
            } else {
                iM6437getMaxHeightimpl = Constraints.m6437getMaxHeightimpl(constraints);
            }
            Paragraph paragraph = ParagraphKt.m5832Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, iM6438getMaxWidthimpl, 0, iM6437getMaxHeightimpl, 5, null), this.maxLines - currentLineCount2, ellipsis);
        ...
        this.width = Constraints.m6438getMaxWidthimpl(constraints);
        ...
        if (it3.size() < this.intrinsics.getPlaceholders().size()) {
            ...
            listPlus = CollectionsKt.plus((Collection) list, (Iterable) arrayList2);
        } else {
            listPlus = it3;
        }
    ...
    public final /* synthetic */ void m5818paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.getParagraph().mo5785paintRPmYEkk(canvas, color, shadow, decoration);
    ...
    public final void m5817paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List $this$fastForEach$iv = this.paragraphInfoList;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = $this$fastForEach$iv.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo5784paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m5819painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m6202drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m5820findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph.getPathForRange.2
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                Path.m4273addPathUv8p0NA$default(path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(start), paragraphInfo.toLocalIndex(end))), 0L, 2, null);
            }
        });
        return path;
    }
    ...
    public final int m5814getOffsetForPositionk4lQ0M(long position) {
        int paragraphIndex = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m3763getYimpl(position));
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.getParagraph().mo5781getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.m5829toLocalMKHz9U(position)));
    }

    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m5815getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(firstParagraph).getBottom() >= rect.getBottom() || firstParagraph == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m5827toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u2412, $this$getRangeForRect_8_6BmAI_u24lambda_u2412.getParagraph().mo5782getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u2412.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int lastParagraph = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long startRange = TextRange.INSTANCE.m5953getZerod9O1mEE();
        while (TextRange.m5941equalsimpl0(startRange, TextRange.INSTANCE.m5953getZerod9O1mEE()) && firstParagraph <= lastParagraph) {
            ParagraphInfo $this$getRangeForRect_8_6BmAI_u24lambda_u2413 = this.paragraphInfoList.get(firstParagraph);
            startRange = ParagraphInfo.m5827toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u2413, $this$getRangeForRect_8_6BmAI_u24lambda_u2413.getParagraph().mo5782getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u2413.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            firstParagraph++;
        }
        if (TextRange.m5941equalsimpl0(startRange, TextRange.INSTANCE.m5953getZerod9O1mEE())) {
            return TextRange.INSTANCE.m5953getZerod9O1mEE();
        }
        long endRange = TextRange.INSTANCE.m5953getZerod9O1mEE();
        while (TextRange.m5941equalsimpl0(endRange, TextRange.INSTANCE.m5953getZerod9O1mEE()) && firstParagraph <= lastParagraph) {
            ParagraphInfo $this$getRangeForRect_8_6BmAI_u24lambda_u2414 = this.paragraphInfoList.get(lastParagraph);
            endRange = ParagraphInfo.m5827toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u2414, $this$getRangeForRect_8_6BmAI_u24lambda_u2414.getParagraph().mo5782getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u2414.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            lastParagraph--;
        }
        return TextRange.m5941equalsimpl0(endRange, TextRange.INSTANCE.m5953getZerod9O1mEE()) ? startRange : TextRangeKt.TextRange(TextRange.m5948getStartimpl(startRange), TextRange.m5943getEndimpl(endRange));
    }
    ...
    public final float[] m5813fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m5946getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m5945getMaximpl(range));
        ...
        MultiParagraphKt.m5820findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph$fillBoundingBoxes$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                ...
                int paragraphStart = paragraphInfo.getStartIndex() > TextRange.m5946getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m5946getMinimpl(j);
                int paragraphEnd = paragraphInfo.getEndIndex() < TextRange.m5945getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m5945getMaximpl(j);
                long finalRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphStart), paragraphInfo.toLocalIndex(paragraphEnd));
                paragraphInfo.getParagraph().mo5779fillBoundingBoxes8ffj60Q(finalRange, fArr, intRef.element);
                int currentArrayEnd = intRef.element + (TextRange.m5944getLengthimpl(finalRange) * 4);
    ...
    public final long m5816getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            paragraphIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        return $this$getWordBoundary__jx7JFs_u24lambda_u2419.m5828toGlobalxdX6G0($this$getWordBoundary__jx7JFs_u24lambda_u2419.getParagraph().mo5783getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u2419.toLocalIndex(offset)), false);
    }
