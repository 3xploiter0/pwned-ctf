...
public final class ComposerKt {
    ...
    public static final <K, V> MutableScatterMap<K, Object> multiMap(int initialCapacity) {
        return MutableScatterMultiMap.m3477constructorimpl(new MutableScatterMap(initialCapacity));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int InvalidationLocationAscending$lambda$15(Invalidation i1, Invalidation i2) {
