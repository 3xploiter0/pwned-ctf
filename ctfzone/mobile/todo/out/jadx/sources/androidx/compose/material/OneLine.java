...
final class OneLine {
    ...
    private static final float MinHeight = Dp.m6485constructorimpl(48);
    private static final float MinHeightWithIcon = Dp.m6485constructorimpl(56);
    private static final float IconMinPaddedWidth = Dp.m6485constructorimpl(40);
    private static final float IconLeftPadding = Dp.m6485constructorimpl(16);
    private static final float IconVerticalPadding = Dp.m6485constructorimpl(8);
    private static final float ContentLeftPadding = Dp.m6485constructorimpl(16);
    private static final float ContentRightPadding = Dp.m6485constructorimpl(16);
    private static final float TrailingRightPadding = Dp.m6485constructorimpl(16);
    ...
    public final void ListItem(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer $composer, final int $changed, final int i) {
        ...
        if ((46811 & $dirty2) == 9362 && $composer3.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1884451315, $dirty2, -1, "androidx.compose.material.OneLine.ListItem (ListItem.kt:143)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart($composer3, 1825884439, "C158@6124L262:ListItem.kt#jmzs0o");
            $composer3.startReplaceableGroup(1825884439);
            ComposerKt.sourceInformation($composer3, "147@5637L460");
            if (function2 != null) {
                ...
                Modifier modifier$iv2 = PaddingKt.m685paddingqDBjuR0$default(SizeKt.m733widthInVpY3zN4$default(modifierAlign, Dp.m6485constructorimpl(arg0$iv + other$iv), 0.0f, 2, null), IconLeftPadding, IconVerticalPadding, 0.0f, IconVerticalPadding, 4, null);
                ...
                int i6 = ((48 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer3, 1962585120, "C156@6089L6:ListItem.kt#jmzs0o");
            ...
            $composer3.endReplaceableGroup();
            Modifier modifier$iv3 = PaddingKt.m685paddingqDBjuR0$default($this$ListItem_u24lambda_u243.align(RowScope.weight$default($this$ListItem_u24lambda_u243, Modifier.INSTANCE, 1.0f, false, 2, null), Alignment.INSTANCE.getCenterVertically()), ContentLeftPadding, 0.0f, ContentRightPadding, 0.0f, 10, null);
            ...
            int i8 = ((48 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer3, 1962585409, "C163@6378L6:ListItem.kt#jmzs0o");
            ...
            $composer3.endReplaceableGroup();
            $composer3.endReplaceableGroup();
            $composer3.startReplaceableGroup(-2068381292);
            ComposerKt.sourceInformation($composer3, "165@6439L186");
            if (function23 != null) {
                Modifier modifier$iv4 = PaddingKt.m685paddingqDBjuR0$default($this$ListItem_u24lambda_u243.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterVertically()), 0.0f, 0.0f, TrailingRightPadding, 0.0f, 11, null);
                $composer3.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer3, "CC(Box)P(2,1,3)71@3309L67,72@3381L130:Box.kt#2w3rfo");
                ...
                int i10 = ((0 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer3, 1962585644, "C169@6613L10:ListItem.kt#jmzs0o");
                function23.invoke($composer3, Integer.valueOf(($dirty2 >> 9) & 14));
                ComposerKt.sourceInformationMarkerEnd($composer3);
                ComposerKt.sourceInformationMarkerEnd($composer3);
                $composer3.endReplaceableGroup();
                $composer3.endNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.OneLine.ListItem.2
                ...
                public final void invoke(Composer composer, int i11) {
                    OneLine.this.ListItem(modifier5, function2, function22, function23, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
