...
public final class AnchoredDraggableKt {
    ...
    static final class C04391<I> extends ContinuationImpl {
        int label;
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        static final class C00981 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00981(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C00981> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00981(this.$state, this.$velocity, continuation);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$draggable, null, null, new C00981(this.$state, velocity, null), 3, null);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
    ...
    static final class C04412<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        ...
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, T t, Continuation<? super Unit> continuation) {
            C04412 c04412 = new C04412(continuation);
            c04412.L$0 = anchoredDragScope;
            c04412.L$1 = draggableAnchors;
            c04412.L$2 = t;
            return c04412.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object snapTo(AnchoredDraggableState<T> anchoredDraggableState, T t, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C04412(null), continuation, 2, null);
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!Float.isNaN(targetOffset)) {
                        ...
                        this.L$1 = null;
                        this.label = 1;
                        if (SuspendAnimationKt.animate(prev.element, targetOffset, this.$velocity, this.$this_animateTo.getAnimationSpec(), new Function2<Float, Float, Unit>() { // from class: androidx.compose.material3.AnchoredDraggableKt.animateTo.2.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(2);
                            }
    ...
    */
    public static final <I> java.lang.Object restartable(kotlin.jvm.functions.Function0<? extends I> r4, kotlin.jvm.functions.Function2<? super I, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            boolean r0 = r6 instanceof androidx.compose.material3.AnchoredDraggableKt.C04391
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.material3.AnchoredDraggableKt$restartable$1 r0 = (androidx.compose.material3.AnchoredDraggableKt.C04391) r0
            int r1 = r0.label
        ...
        L25:
            ...
            throw r4
        L2d:
            kotlin.ResultKt.throwOnFailure(r0)     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L31
            goto L49
        L31:
            r4 = move-exception
            goto L4a
        L33:
            ...
            androidx.compose.material3.AnchoredDraggableKt$restartable$2 r2 = new androidx.compose.material3.AnchoredDraggableKt$restartable$2     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L31
            r3 = 0
            r2.<init>(r4, r5, r3)     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L31
            kotlin.jvm.functions.Function2 r2 = (kotlin.jvm.functions.Function2) r2     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L31
            r3 = 1
            r6.label = r3     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L31
            java.lang.Object r2 = kotlinx.coroutines.CoroutineScopeKt.coroutineScope(r2, r6)     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L31
            if (r2 != r1) goto L49
            return r1
        L49:
        L4a:
    ...
    static final class C04402 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04402(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C04402> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04402 c04402 = new C04402(this.$inputs, this.$block, continuation);
            c04402.L$0 = obj;
            return c04402;
        }
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            */
            public final java.lang.Object emit(I r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
                /*
                    r9 = this;
                    boolean r0 = r11 instanceof androidx.compose.material3.AnchoredDraggableKt$restartable$2$1$emit$1
                    if (r0 == 0) goto L14
                    r0 = r11
                ...
                L2d:
                    ...
                    androidx.compose.material3.AnchoredDraggableKt$restartable$2$1 r2 = (androidx.compose.material3.AnchoredDraggableKt.C04402.AnonymousClass1) r2
                    kotlin.ResultKt.throwOnFailure(r0)
                    goto L66
                L3c:
                    kotlin.ResultKt.throwOnFailure(r0)
                    ...
                    r4 = r3
                    r5 = 0
                    androidx.compose.material3.AnchoredDragFinishedSignal r6 = new androidx.compose.material3.AnchoredDragFinishedSignal
                    r6.<init>()
                ...
                L68:
                    ...
                    return r1
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AnchoredDraggableKt.C04402.AnonymousClass1.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
            ...
            static final class C00992 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00992(Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, I i, CoroutineScope coroutineScope, Continuation<? super C00992> continuation) {
                    super(2, continuation);
                    this.$block = function2;
                    this.$latestInputs = i;
                    this.$$this$coroutineScope = coroutineScope;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00992(this.$block, this.$latestInputs, this.$$this$coroutineScope, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                    return ((C00992) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    CoroutineScopeKt.cancel(c00992.$$this$coroutineScope, new AnchoredDragFinishedSignal());
                    return Unit.INSTANCE;
                }
            }
        }
