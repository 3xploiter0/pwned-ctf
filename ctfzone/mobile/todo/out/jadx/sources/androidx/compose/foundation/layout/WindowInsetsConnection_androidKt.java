...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final Modifier imeNestedScroll(Modifier $this$imeNestedScroll) {
        ...
        return ComposedModifierKt.composed($this$imeNestedScroll, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                NestedScrollConnection nestedScrollConnection = WindowInsetsConnection_androidKt.m749rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.INSTANCE.current($composer, 6).getIme(), WindowInsetsSides.INSTANCE.m772getBottomJoeWqyM(), $composer, 48);
    ...
    public static final NestedScrollConnection m749rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int side, Composer $composer, int $changed) {
        Object value$iv;
        Object value$iv2;
        ...
        SideCalculator sideCalculator = SideCalculator.INSTANCE.m709chooseCalculatorni1skBw(side, layoutDirection);
        ...
        if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$rememberWindowInsetsConnection$1$1
                {
                    super(1);
                }
