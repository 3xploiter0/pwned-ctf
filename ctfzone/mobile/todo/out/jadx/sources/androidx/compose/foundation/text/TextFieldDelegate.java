...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m1065layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            ...
            return companion.m1068layout_EkL_Y$foundation_release(textDelegate, j, layoutDirection, textLayoutResult2);
        }
        ...
        public final Triple<Integer, Integer, TextLayoutResult> m1068layout_EkL_Y$foundation_release(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            TextLayoutResult layoutResult = textDelegate.m1055layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf(IntSize.m6655getWidthimpl(layoutResult.getSize())), Integer.valueOf(IntSize.m6654getHeightimpl(layoutResult.getSize())), layoutResult);
        }
        ...
        public final void m1067drawQ1vqE60$foundation_release(Canvas canvas, TextFieldValue value, long selectionPreviewHighlightRange, long deletionPreviewHighlightRange, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint highlightPaint, long selectionBackgroundColor) {
            if (!TextRange.m5942getCollapsedimpl(selectionPreviewHighlightRange)) {
                highlightPaint.mo3882setColor8_81llA(selectionBackgroundColor);
                m1064drawHighlightLepunE(canvas, selectionPreviewHighlightRange, offsetMapping, textLayoutResult, highlightPaint);
            } else if (!TextRange.m5942getCollapsedimpl(deletionPreviewHighlightRange)) {
                Color colorM3993boximpl = Color.m3993boximpl(textLayoutResult.getLayoutInput().getStyle().m5978getColor0d7_KjU());
                long it = colorM3993boximpl.m4013unboximpl();
                if (it == 16) {
                    colorM3993boximpl = null;
                }
                long textColor = colorM3993boximpl != null ? colorM3993boximpl.m4013unboximpl() : Color.INSTANCE.m4029getBlack0d7_KjU();
                highlightPaint.mo3882setColor8_81llA(Color.m4001copywmQWz5c(textColor, (14 & 1) != 0 ? Color.m4005getAlphaimpl(textColor) : Color.m4005getAlphaimpl(textColor) * 0.2f, (14 & 2) != 0 ? Color.m4009getRedimpl(textColor) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(textColor) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(textColor) : 0.0f));
                m1064drawHighlightLepunE(canvas, deletionPreviewHighlightRange, offsetMapping, textLayoutResult, highlightPaint);
            } else if (!TextRange.m5942getCollapsedimpl(value.getSelection())) {
                highlightPaint.mo3882setColor8_81llA(selectionBackgroundColor);
        ...
        private final void m1064drawHighlightLepunE(Canvas canvas, long range, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint paint) {
            int start = offsetMapping.originalToTransformed(TextRange.m5946getMinimpl(range));
            int end = offsetMapping.originalToTransformed(TextRange.m5945getMaximpl(range));
            if (start != end) {
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            ...
            int focusOffsetInTransformed = offsetMapping.originalToTransformed(TextRange.m5945getMaximpl(value.getSelection()));
            if (focusOffsetInTransformed < textLayoutResult.getLayoutInput().getText().length()) {
                ...
                bbox = new Rect(0.0f, 0.0f, 1.0f, IntSize.m6654getHeightimpl(defaultSize));
            }
            long globalLT = layoutCoordinates.mo5350localToRootMKHz9U(OffsetKt.Offset(bbox.getLeft(), bbox.getTop()));
            textInputSession.notifyFocusedRect(RectKt.m3802Recttz77jQw(OffsetKt.Offset(Offset.m3762getXimpl(globalLT), Offset.m3763getYimpl(globalLT)), SizeKt.Size(bbox.getWidth(), bbox.getHeight())));
        }
            ...
            if (innerTextFieldCoordinates != null && innerTextFieldCoordinates.isAttached() && (decorationBoxCoordinates = textLayoutResult.getDecorationBoxCoordinates()) != null) {
                textInputSession.updateTextLayoutResult(textFieldValue, offsetMapping, textLayoutResult.getValue(), new Function1<Matrix, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$updateTextLayoutResult$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
                        m1070invoke58bKbWc(matrix.m4255unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-58bKbWc, reason: not valid java name */
                    public final void m1070invoke58bKbWc(float[] matrix) {
                        if (innerTextFieldCoordinates.isAttached()) {
                            LayoutCoordinatesKt.findRootCoordinates(innerTextFieldCoordinates).mo5354transformFromEL8BTi8(innerTextFieldCoordinates, matrix);
                        }
                    }
        ...
        public final void m1069setCursorOffsetULxng0E$foundation_release(long position, TextLayoutResultProxy textLayoutResult, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            int offset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1090getOffsetForPosition3MmeM6k$default(textLayoutResult, position, false, 2, null));
            onValueChange.invoke(TextFieldValue.m6190copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offset), (TextRange) null, 5, (Object) null));
        }
        ...
        public final TextInputSession restartInput$foundation_release(TextInputService textInputService, TextFieldValue value, final EditProcessor editProcessor, ImeOptions imeOptions, final Function1<? super TextFieldValue, Unit> onValueChange, Function1<? super ImeAction, Unit> onImeActionPerformed) {
            ...
            session.element = textInputService.startInput(value, imeOptions, new Function1<List<? extends EditCommand>, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$restartInput$1
                ...
                public final void invoke2(List<? extends EditCommand> list) {
                    TextFieldDelegate.INSTANCE.onEditCommand$foundation_release(list, editProcessor, onValueChange, session.element);
                }
        ...
        public final void onBlur$foundation_release(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.m6190copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null));
        ...
        public final TransformedText m1066applyCompositionDecoration72CqOWE(long compositionRange, TransformedText transformed) {
            int startPositionTransformed = transformed.getOffsetMapping().originalToTransformed(TextRange.m5948getStartimpl(compositionRange));
            int endPositionTransformed = transformed.getOffsetMapping().originalToTransformed(TextRange.m5943getEndimpl(compositionRange));
