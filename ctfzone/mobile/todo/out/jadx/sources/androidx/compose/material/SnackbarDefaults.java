...
public final class SnackbarDefaults {
    ...
    public final long getPrimaryActionColor(Composer $composer, int $changed) {
        ...
        if (colors.isLight()) {
            long primary2 = colors.m1496getPrimary0d7_KjU();
            long jM1500getSurface0d7_KjU = colors.m1500getSurface0d7_KjU();
            long overlayColor = Color.m4001copywmQWz5c(jM1500getSurface0d7_KjU, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM1500getSurface0d7_KjU) : 0.6f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM1500getSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM1500getSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM1500getSurface0d7_KjU) : 0.0f);
            primary = ColorKt.m4048compositeOverOWjLjI(overlayColor, primary2);
        } else {
            primary = colors.m1497getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
