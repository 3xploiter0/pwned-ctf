...
final class DrawStretchOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    public void draw(ContentDrawScope $this$draw) throws Throwable {
        ...
        this.overscrollEffect.m220updateSizeuvyYCjk$foundation_release($this$draw.mo4559getSizeNHjbRc());
        if (Size.m3833isEmptyimpl($this$draw.mo4559getSizeNHjbRc())) {
            $this$draw.drawContent();
            return;
        }
        this.overscrollEffect.getRedrawSignal$foundation_release().getValue();
        float maxElevation = $this$draw.mo373toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        Canvas canvas = AndroidCanvas_androidKt.getNativeCanvas($this$draw.getDrawContext().getCanvas());
        boolean needsInvalidate3 = false;
        ...
        if ($this$draw_u24lambda_u244.isLeftAnimating()) {
            ...
            boolean needsInvalidate4 = drawLeftStretch(leftEffect, recordingCanvas);
            if ($this$draw_u24lambda_u244.isLeftStretched()) {
                float displacementY = Offset.m3763getYimpl(this.overscrollEffect.m219displacementF1C5BW0$foundation_release());
                needsInvalidate2 = needsInvalidate4;
        ...
        if ($this$draw_u24lambda_u244.isTopAnimating()) {
            ...
            needsInvalidate3 = drawTopStretch(topEffect, recordingCanvas) || needsInvalidate3;
            if ($this$draw_u24lambda_u244.isTopStretched()) {
                float displacementX = Offset.m3762getXimpl(this.overscrollEffect.m219displacementF1C5BW0$foundation_release());
        ...
        if ($this$draw_u24lambda_u244.isRightAnimating()) {
            ...
            needsInvalidate3 = drawRightStretch(rightEffect, recordingCanvas) || needsInvalidate3;
            if ($this$draw_u24lambda_u244.isRightStretched()) {
                float displacementY2 = Offset.m3763getYimpl(this.overscrollEffect.m219displacementF1C5BW0$foundation_release());
        ...
        if ($this$draw_u24lambda_u244.isBottomAnimating()) {
            ...
            boolean needsInvalidate5 = drawBottomStretch(bottomEffect, recordingCanvas) || needsInvalidate3;
            if ($this$draw_u24lambda_u244.isBottomStretched()) {
                float displacementX2 = Offset.m3762getXimpl(this.overscrollEffect.m219displacementF1C5BW0$foundation_release());
            ...
            needsInvalidate = needsInvalidate5;
        } else {
        ...
        long size$iv = $this$draw.mo4559getSizeNHjbRc();
        ...
        long prevSize$iv = $this$draw_u2dymL40Pk_u24default$iv.getDrawContext().mo4480getSizeNHjbRc();
            ...
            try {
                ...
                try {
                    try {
                        ...
                        th = th4;
                        canvas$iv.restore();
                        DrawContext $this$draw_ymL40Pk_u24lambda_u248$iv22 = $this$draw_u2dymL40Pk_u24default$iv.getDrawContext();
                        $this$draw_ymL40Pk_u24lambda_u248$iv22.setDensity(prevDensity$iv);
                        $this$draw_ymL40Pk_u24lambda_u248$iv22.setLayoutDirection(prevLayoutDirection$iv);
                        $this$draw_ymL40Pk_u24lambda_u248$iv22.setCanvas(prevCanvas$iv);
                        $this$draw_ymL40Pk_u24lambda_u248$iv22.mo4481setSizeuvyYCjk(prevSize$iv);
                        $this$draw_ymL40Pk_u24lambda_u248$iv22.setGraphicsLayer(prevLayer$iv);
                        throw th;
                    }
                } catch (Throwable th5) {
                    th = th5;
