                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 3) != 2 || !$composer.getSkipping()) {
                        ...
                        if (index != -1) {
                            ...
                            LazyLayoutItemContentFactoryKt.m849SkippableItemJVlU9Rs(itemProvider, StableValue.m869constructorimpl(lazyLayoutItemContentFactory.saveableStateHolder), index, StableValue.m869constructorimpl(this.getKey()), $composer, 0);
                        ...
                        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                            value$iv = new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactory$CachedItemContent$createContentLambda$1$1$1
                                {
                                    super(1);
                                }
