...
public final class NavigationRailDefaults {
    ...
    public final float m1603getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(840451581, $changed, -1, "androidx.compose.material.NavigationRailDefaults.<get-windowInsets> (NavigationRail.kt:275)");
        }
        WindowInsets windowInsetsM752onlybOOhFvg = WindowInsetsKt.m752onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.m764plusgK_yJZ4(WindowInsetsSides.INSTANCE.m779getVerticalJoeWqyM(), WindowInsetsSides.INSTANCE.m777getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
