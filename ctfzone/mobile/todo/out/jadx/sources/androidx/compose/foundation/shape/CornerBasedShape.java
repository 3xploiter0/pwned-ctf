...
public abstract class CornerBasedShape implements Shape {
    ...
    public final Outline mo284createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        float topEnd;
        float bottomEnd;
        float topStart2 = this.topStart.mo955toPxTmRCtEA(size, density);
        float topEnd2 = this.topEnd.mo955toPxTmRCtEA(size, density);
        float bottomEnd2 = this.bottomEnd.mo955toPxTmRCtEA(size, density);
        float bottomStart2 = this.bottomStart.mo955toPxTmRCtEA(size, density);
        float minDimension = Size.m3830getMinDimensionimpl(size);
        ...
        if (topStart >= 0.0f && topEnd >= 0.0f && bottomEnd >= 0.0f && bottomStart >= 0.0f) {
            return mo947createOutlineLjSzlW0(size, topStart, topEnd, bottomEnd, bottomStart, layoutDirection);
        }
