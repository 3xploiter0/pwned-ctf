...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m3500initimpl(composerM3496constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m3503setimpl(composerM3496constructorimpl, lookaheadScopeImpl2, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final long m5368localLookaheadPositionOfFgt4K4Q(LookaheadScope $this$localLookaheadPositionOf_u2dFgt4K4Q, LayoutCoordinates coordinates, LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        ...
        if (lookaheadCoords instanceof LookaheadLayoutCoordinates) {
            return lookaheadCoords.mo5349localPositionOfS_NoaFU(source, relativeToSource, includeMotionFrameOfReference);
        }
        if (source instanceof LookaheadLayoutCoordinates) {
            return Offset.m3771unaryMinusF1C5BW0(source.mo5349localPositionOfS_NoaFU(lookaheadCoords, relativeToSource, includeMotionFrameOfReference));
        }
        return lookaheadCoords.mo5349localPositionOfS_NoaFU(lookaheadCoords, relativeToSource, includeMotionFrameOfReference);
    }
}
