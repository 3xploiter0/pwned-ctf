...
public final class SelectableChipElevation {
    ...
    public final float m2387tonalElevationu2uoSUM$material3_release(boolean enabled) {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1888175651, $changed, -1, "androidx.compose.material3.SelectableChipElevation.shadowElevation (Chip.kt:2251)");
        }
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(664514136, $changed, -1, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:2259)");
        }
        ...
        if (it$iv4 == Composer.INSTANCE.getEmpty()) {
            value$iv4 = new Animatable(Dp.m6483boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        if (invalid$iv2 || value$iv5 == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv5 = new SelectableChipElevation$animateElevation$2$1(animatable2, target, enabled, interaction, lastInteraction$delegate, null);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m6490equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m6490equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m6490equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m6490equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m6490equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m6491hashCodeimpl(this.elevation);
