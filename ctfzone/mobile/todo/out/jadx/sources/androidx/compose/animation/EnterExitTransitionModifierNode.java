...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m90setLookaheadConstraintsBRTryo0(long value) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            ...
            case 2:
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m6647boximpl(fullSize)).getPackedValue();
                }
                break;
            case 3:
                ChangeSize changeSize2 = this.exit.getData().getChangeSize();
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m6647boximpl(fullSize)).getPackedValue();
                }
                break;
            default:
        ...
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
                ...
                case 3:
                    ...
                    if (it != null) {
                        long endSize = it.getSize().invoke(IntSize.m6647boximpl(fullSize)).getPackedValue();
                        Alignment alignment = getAlignment();
                        Intrinsics.checkNotNull(alignment);
                        long targetOffset = alignment.mo3608alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                        Alignment alignment2 = this.currentAlignment;
                        Intrinsics.checkNotNull(alignment2);
                        long currentOffset = alignment2.mo3608alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                        return IntOffset.m6616minusqkQi6aY(targetOffset, currentOffset);
                    }
                    return IntOffset.INSTANCE.m6623getZeronOccac();
                default:
                    throw new NoWhenBranchMatchedException();
    ...
    public MeasureResult mo91measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            m90setLookaheadConstraintsBRTryo0(constraints);
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6655getWidthimpl(measuredSize), IntSize.m6654getHeightimpl(measuredSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (!this.isEnabled.invoke().booleanValue()) {
            final Placeable $this$measure_3p2s80s_u24lambda_u242 = measurable.mo5339measureBRTryo0(constraints);
        ...
        final Placeable placeable2 = measurable.mo5339measureBRTryo0(constraints);
        ...
        State animSize = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m6647boximpl(m95invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m95invokeYEO4UFw(EnterExitState it) {
                return this.this$0.m92sizeByStateUzc_VyU(it, target);
            }
        }) : null;
        long currentSize = ConstraintsKt.m6452constrain4WqzIAM(constraints, animSize != null ? animSize.getValue().getPackedValue() : measuredSize2);
        ...
        final long offsetDelta = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m6604boximpl(m96invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m96invokeBjo55l4(EnterExitState it) {
                return this.this$0.m94targetOffsetByStateoFUgxo0(it, target);
            }
        })) == null) ? IntOffset.INSTANCE.m6623getZeronOccac() : stateAnimate2.getValue().getPackedValue();
        ...
        long slideOffset = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m6604boximpl(m97invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m97invokeBjo55l4(EnterExitState it) {
                return this.this$0.m93slideTargetValueByStateoFUgxo0(it, target);
            }
        })) == null) ? IntOffset.INSTANCE.m6623getZeronOccac() : stateAnimate.getValue().getPackedValue();
        Alignment alignment2 = this.currentAlignment;
        final long offset = IntOffset.m6617plusqkQi6aY(alignment2 != null ? alignment2.mo3608alignKFBX0sM(target, currentSize, LayoutDirection.Ltr) : IntOffset.INSTANCE.m6623getZeronOccac(), slideOffset);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6655getWidthimpl(currentSize), IntSize.m6654getHeightimpl(currentSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                $this$layout.placeWithLayer(placeable2, IntOffset.m6613getXimpl(offsetDelta) + IntOffset.m6613getXimpl(offset), IntOffset.m6614getYimpl(offsetDelta) + IntOffset.m6614getYimpl(offset), 0.0f, layerBlock);
            }
        }, 4, null);
    }
    ...
    public final long m93slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long preEnter = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6623getZeronOccac() : slideOffset2.invoke(IntSize.m6647boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long postExit = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6623getZeronOccac() : slideOffset.invoke(IntSize.m6647boximpl(fullSize)).getPackedValue();
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            case 1:
                return IntOffset.INSTANCE.m6623getZeronOccac();
            case 2:
