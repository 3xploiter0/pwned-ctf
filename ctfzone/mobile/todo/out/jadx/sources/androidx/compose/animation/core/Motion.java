...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m158boximpl(long j) {
        return new Motion(j);
    }
    ...
    public static boolean m162equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m168unboximpl();
    }
    ...
    public static String m167toStringimpl(long j) {
        return "Motion(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m162equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m166hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m167toStringimpl(this.packedValue);
    }
    ...
    public static final float m164getValueimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m165getVelocityimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: copy-XB9eQnU, reason: not valid java name */
    public static final long m160copyXB9eQnU(long arg0, float value, float velocity) {
        return SpringSimulationKt.Motion(value, velocity);
    }

    /* renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m161copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m164getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m165getVelocityimpl(j);
        }
        return m160copyXB9eQnU(j, f, f2);
    }
}
