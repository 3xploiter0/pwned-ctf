...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        node.m645setX0680j_4(this.x);
        node.m646setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6490equalsimpl0(this.x, otherModifierElement.x) && Dp.m6490equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m6491hashCodeimpl(this.x);
        return (((result * 31) + Dp.m6491hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m6496toStringimpl(this.x)) + ", y=" + ((Object) Dp.m6496toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
