...
public final class AndroidSelectionHandles_androidKt {
    ...
    */
    public static final void m1324SelectionHandlepzduO1o(final androidx.compose.foundation.text.selection.OffsetProvider r20, final boolean r21, final androidx.compose.ui.text.style.ResolvedTextDirection r22, final boolean r23, long r24, final androidx.compose.ui.Modifier r26, androidx.compose.runtime.Composer r27, final int r28, final int r29) {
        /*
            Method dump skipped, instructions count: 503
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.m1324SelectionHandlepzduO1o(androidx.compose.foundation.text.selection.OffsetProvider, boolean, androidx.compose.ui.text.style.ResolvedTextDirection, boolean, long, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean isLeft, Composer $composer, final int $changed) {
        ...
        if (($dirty & 147) != 146 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m728sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, isLeft), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
                            float radius = Size.m3831getWidthimpl($this$drawWithCache.m3652getSizeNHjbRc()) / 2.0f;
                            ...
                            return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope $this$onDrawWithContent) throws Throwable {
                                    ...
                                    if (z2) {
                                        ...
                                        long pivot$iv = $this$scale_u2dFgt4K4Q_u24default$iv.mo4558getCenterF1C5BW0();
                                        ...
                                        try {
                                            ...
                                            try {
                                                DrawScope.m4543drawImagegbVJVH8$default($this$scale_u2dFgt4K4Q_u24default$iv, imageBitmap, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                        ...
                                        DrawScope.m4543drawImagegbVJVH8$default($this$onDrawWithContent, handleImage, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge > imageBitmap2.getWidth() || edge > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m4229ImageBitmapx__hDU$default(edge, edge, ImageBitmapConfig.INSTANCE.m4223getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        DrawScope.m4553drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u241, Color.INSTANCE.m4029getBlack0d7_KjU(), 0L, $this$createHandleImage_u24lambda_u241.mo4559getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m3918getClear0nO6VwU(), 58, null);
        DrawScope.m4553drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u241, ColorKt.Color(4278190080L), Offset.INSTANCE.m3778getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(radius, radius), 0.0f, null, null, 0, 120, null);
        DrawScope.m4540drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u241, ColorKt.Color(4278190080L), radius, OffsetKt.Offset(radius, radius), 0.0f, null, null, 0, 120, null);
        canvas.restore();
