...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5707calculateMatrixGrdbGEg(T target) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m4234constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
        ...
        if (prevMatrix == null || !Intrinsics.areEqual(it2, prevMatrix)) {
            AndroidMatrixConversions_androidKt.m3874setFromtUYjHk(it, it2);
    ...
    public final float[] m5706calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m5707calculateMatrixGrdbGEg(target);
            this.isInverseValid = InvertMatrixKt.m5704invertToJiSxe2E(normalMatrix, it);
