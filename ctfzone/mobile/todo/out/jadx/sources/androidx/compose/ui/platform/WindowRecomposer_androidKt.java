...
public final class WindowRecomposer_androidKt {
    ...
    public static final StateFlow<Float> getAnimationScaleFlowFor(Context applicationContext) {
        ...
        synchronized (lock$iv) {
            ...
            StateFlow<Float> stateFlow2 = $this$getOrPut$iv.get(applicationContext);
            if (stateFlow2 == null) {
                ...
                stateFlowStateIn = FlowKt.stateIn(FlowKt.flow(new WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1(resolver, animationScaleUri, new ContentObserver(handlerCreateAsync) { // from class: androidx.compose.ui.platform.WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1
                    ...
                    public void onChange(boolean selfChange, Uri uri) {
                        channel.mo8459trySendJP2dKIU(Unit.INSTANCE);
                    }
                ...
                $this$getOrPut$iv.put(applicationContext, stateFlowStateIn);
            } else {
    ...
    /* JADX WARN: Type inference failed for: r0v32, types: [T, androidx.compose.ui.platform.MotionDurationScaleImpl] */
