...
public final class TextRangeKt {
    ...
    public static final String m5955substringFDrldGo(CharSequence $this$substring_u2dFDrldGo, long range) {
        return $this$substring_u2dFDrldGo.subSequence(TextRange.m5946getMinimpl(range), TextRange.m5945getMaximpl(range)).toString();
    }

    public static final long TextRange(int start, int end) {
        return TextRange.m5937constructorimpl(packWithCheck(start, end));
    }
    ...
    public static final long m5954coerceIn8ffj60Q(long $this$coerceIn_u2d8ffj60Q, int minimumValue, int maximumValue) {
        int newStart = RangesKt.coerceIn(TextRange.m5948getStartimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        int newEnd = RangesKt.coerceIn(TextRange.m5943getEndimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        if (newStart != TextRange.m5948getStartimpl($this$coerceIn_u2d8ffj60Q) || newEnd != TextRange.m5943getEndimpl($this$coerceIn_u2d8ffj60Q)) {
