...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5953getZerod9O1mEE();
    ...
    public final void m1084setPreviousSelection5zctL8(long j) {
    ...
    */
    ...
    public final int m1082getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5948getStartimpl(selection) != TextRange.m5948getStartimpl(this.previousSelection) ? TextRange.m5948getStartimpl(selection) : TextRange.m5943getEndimpl(selection) != TextRange.m5943getEndimpl(this.previousSelection) ? TextRange.m5943getEndimpl(selection) : TextRange.m5946getMinimpl(selection);
    }
