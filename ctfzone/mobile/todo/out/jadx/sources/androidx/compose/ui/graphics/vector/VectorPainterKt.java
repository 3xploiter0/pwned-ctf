...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m4722rememberVectorPaintermlNsNFs(float defaultWidth, float defaultHeight, float viewportWidth, float viewportHeight, String name, long tintColor, int tintBlendMode, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer $composer, int $changed, int i) {
        ...
        long tintColor2 = (i & 32) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : tintColor;
        int tintBlendMode2 = (i & 64) != 0 ? BlendMode.INSTANCE.m3943getSrcIn0nO6VwU() : tintBlendMode;
        ...
        VectorPainter vectorPainterM4723rememberVectorPaintervIP8VLU = m4723rememberVectorPaintervIP8VLU(defaultWidth, defaultHeight, viewportWidth2, viewportHeight2, name2, tintColor2, tintBlendMode2, false, function4, $composer, ($changed & 14) | 12582912 | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed) | (($changed << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return vectorPainterM4723rememberVectorPaintervIP8VLU;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:102:0x0222  */
    /* JADX WARN: Removed duplicated region for block: B:65:0x0173 A[PHI: r0
      0x0173: PHI (r0v16 'viewportWidth' float) = (r0v5 'viewportWidth' float), (r0v17 'viewportWidth' float) binds: [B:64:0x0171, B:60:0x016a] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:75:0x018d  */
    /* JADX WARN: Removed duplicated region for block: B:76:0x018f  */
    /* JADX WARN: Removed duplicated region for block: B:79:0x019b  */
    /* JADX WARN: Removed duplicated region for block: B:82:0x01a4  */
    /* JADX WARN: Removed duplicated region for block: B:85:0x01a9 A[PHI: r11
      0x01a9: PHI (r11v13 kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>) = 
      (r11v11 kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>)
      (r11v14 kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>)
     binds: [B:84:0x01a7, B:80:0x01a1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final androidx.compose.ui.graphics.vector.VectorPainter m4723rememberVectorPaintervIP8VLU(float r26, float r27, float r28, float r29, java.lang.String r30, long r31, int r33, boolean r34, kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, androidx.compose.runtime.Composer r36, int r37, int r38) {
        /*
            Method dump skipped, instructions count: 553
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.vector.VectorPainterKt.m4723rememberVectorPaintervIP8VLU(float, float, float, float, java.lang.String, long, int, boolean, kotlin.jvm.functions.Function4, androidx.compose.runtime.Composer, int, int):androidx.compose.ui.graphics.vector.VectorPainter");
    }
    ...
    private static final void mirror(DrawScope $this$mirror, Function1<? super DrawScope, Unit> function1) throws Throwable {
        long pivot$iv = $this$mirror.mo4558getCenterF1C5BW0();
        ...
        try {
            ...
            $this$scale_Fgt4K4Q_u24lambda_u242$iv.mo4487scale0AR0LA0(-1.0f, 1.0f, pivot$iv);
            try {
    ...
    private static final long m4720obtainSizePxVpY3zN4(Density $this$obtainSizePx_u2dVpY3zN4, float defaultWidth, float defaultHeight) {
        return SizeKt.Size($this$obtainSizePx_u2dVpY3zN4.mo373toPx0680j_4(defaultWidth), $this$obtainSizePx_u2dVpY3zN4.mo373toPx0680j_4(defaultHeight));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m4721obtainViewportSizePq9zytI(long defaultSize, float viewportWidth, float viewportHeight) {
        return SizeKt.Size(Float.isNaN(viewportWidth) ? Size.m3831getWidthimpl(defaultSize) : viewportWidth, Float.isNaN(viewportHeight) ? Size.m3828getHeightimpl(defaultSize) : viewportHeight);
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m4719createColorFilterxETnrds(long tintColor, int tintBlendMode) {
        if (tintColor != 16) {
            return ColorFilter.INSTANCE.m4047tintxETnrds(tintColor, tintBlendMode);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8$default, reason: not valid java name */
    public static /* synthetic */ VectorPainter m4718configureVectorPainterT4PVSW8$default(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z, int i, Object obj) {
        String str2;
        boolean z2;
        if ((i & 4) == 0) {
            str2 = str;
        ...
        return m4717configureVectorPainterT4PVSW8(vectorPainter, j, j2, str2, colorFilter, z2);
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m4717configureVectorPainterT4PVSW8(VectorPainter $this$configureVectorPainter_u2dT4PVSW8, long defaultSize, long viewportSize, String name, ColorFilter intrinsicColorFilter, boolean autoMirror) {
        $this$configureVectorPainter_u2dT4PVSW8.m4715setSizeuvyYCjk$ui_release(defaultSize);
        ...
        $this$configureVectorPainter_u2dT4PVSW8.m4716setViewportSizeuvyYCjk$ui_release(viewportSize);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent root) {
        long defaultSize = m4720obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        long viewport = m4721obtainViewportSizePq9zytI(defaultSize, imageVector.getViewportWidth(), imageVector.getViewportHeight());
        return m4717configureVectorPainterT4PVSW8(new VectorPainter(root), defaultSize, viewport, imageVector.getName(), m4719createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent $this$createGroupComponent, VectorGroup currentGroup) {
        ...
        for (int index = 0; index < size; index++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                $this$createGroupComponent_u24lambda_u247.m4701setPathFillTypeoQ8Xj4U(((VectorPath) vectorNode).getPathFillType());
                ...
                $this$createGroupComponent_u24lambda_u247.m4702setStrokeLineCapBeK7IIE(((VectorPath) vectorNode).getStrokeLineCap());
                $this$createGroupComponent_u24lambda_u247.m4703setStrokeLineJoinWw9F2mQ(((VectorPath) vectorNode).getStrokeLineJoin());
    ...
    public static final void RenderVectorGroup(final VectorGroup group, Map<String, ? extends VectorConfig> map, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 19) == 18 && $composer3.getSkipping()) {
            ...
            Map configs2 = i2 != 0 ? MapsKt.emptyMap() : map2;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-446179233, $dirty2, -1, "androidx.compose.ui.graphics.vector.RenderVectorGroup (VectorPainter.kt:430)");
            }
            Iterator<VectorNode> it = group.iterator();
            while (it.hasNext()) {
                final VectorNode vectorNode = it.next();
                if (vectorNode instanceof VectorPath) {
                    $composer3.startReplaceGroup(-23647808);
                    ComposerKt.sourceInformation($composer3, "434@16086L1719");
                    ...
                    if (vectorNode instanceof VectorGroup) {
                        $composer5.startReplaceGroup(-21815553);
                        ComposerKt.sourceInformation($composer5, "513@19224L88,479@17944L1368");
                        ...
                        VectorComposeKt.Group(((VectorGroup) vectorNode).getName(), ((Number) config2.getOrDefault(VectorProperty.Rotation.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getRotation()))).floatValue(), ((Number) config2.getOrDefault(VectorProperty.PivotX.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getPivotX()))).floatValue(), ((Number) config2.getOrDefault(VectorProperty.PivotY.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getPivotY()))).floatValue(), ((Number) config2.getOrDefault(VectorProperty.ScaleX.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getScaleX()))).floatValue(), ((Number) config2.getOrDefault(VectorProperty.ScaleY.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getScaleY()))).floatValue(), ((Number) config2.getOrDefault(VectorProperty.TranslateX.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getTranslationX()))).floatValue(), ((Number) config2.getOrDefault(VectorProperty.TranslateY.INSTANCE, Float.valueOf(((VectorGroup) vectorNode).getTranslationY()))).floatValue(), (List) config2.getOrDefault(VectorProperty.PathData.INSTANCE, ((VectorGroup) vectorNode).getClipPathData()), ComposableLambdaKt.rememberComposableLambda(1450046638, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt.RenderVectorGroup.1
                            ...
                            public final void invoke(Composer $composer6, int $changed2) {
                                ...
                                VectorPainterKt.RenderVectorGroup((VectorGroup) vectorNode, configs3, $composer6, 0, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        }, $composer5, 54), $composer5, 805306368, 0);
                        ...
                        $composer5.startReplaceGroup(-20402883);
                        $composer5.endReplaceGroup();
                        configs2 = configs3;
                        $composer3 = $composer5;
                        $dirty2 = $dirty3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt.RenderVectorGroup.2
                ...
                public final void invoke(Composer composer, int i3) {
                    VectorPainterKt.RenderVectorGroup(group, configs, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
