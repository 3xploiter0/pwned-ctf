...
public final class AlignmentOffsetPositionProvider implements PopupPositionProvider {
    ...
    public long mo345calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long anchorAlignmentPoint = this.alignment.mo3608alignKFBX0sM(IntSize.INSTANCE.m6660getZeroYbymL2g(), anchorBounds.m6639getSizeYbymL2g(), layoutDirection);
        long popupAlignmentPoint = IntOffset.m6621unaryMinusnOccac(this.alignment.mo3608alignKFBX0sM(IntSize.INSTANCE.m6660getZeroYbymL2g(), popupContentSize, layoutDirection));
        long resolvedUserOffset = IntOffsetKt.IntOffset(IntOffset.m6613getXimpl(this.offset) * (layoutDirection == LayoutDirection.Ltr ? 1 : -1), IntOffset.m6614getYimpl(this.offset));
        return IntOffset.m6617plusqkQi6aY(IntOffset.m6617plusqkQi6aY(IntOffset.m6617plusqkQi6aY(anchorBounds.m6641getTopLeftnOccac(), anchorAlignmentPoint), popupAlignmentPoint), resolvedUserOffset);
    }
}
