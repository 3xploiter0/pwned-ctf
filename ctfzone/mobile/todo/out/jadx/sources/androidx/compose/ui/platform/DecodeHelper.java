...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte == 1) {
                ...
                mutableSpanStyle.m5717setColor8_81llA(m5685decodeColor0d7_KjU());
            } else if (bDecodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m5718setFontSizeR2X_6o(m5688decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m5719setFontStylemLjRB2g(FontStyle.m6055boximpl(m5686decodeFontStyle_LCdwA()));
            } else if (bDecodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m5720setFontSynthesistDdu0R4(FontSynthesis.m6066boximpl(m5687decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m5721setLetterSpacingR2X_6o(m5688decodeTextUnitXSAIIZE());
            } else if (bDecodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m5716setBaselineShift_isdbwI(BaselineShift.m6236boximpl(m5683decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m5715setBackground8_81llA(m5685decodeColor0d7_KjU());
    ...
    public final long m5685decodeColor0d7_KjU() {
        return Color.m3999constructorimpl(m5684decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m5688decodeTextUnitXSAIIZE() {
        long type;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            type = TextUnitType.INSTANCE.m6711getSpUIouoOA();
        } else {
            type = bDecodeByte == 2 ? TextUnitType.INSTANCE.m6710getEmUIouoOA() : TextUnitType.INSTANCE.m6712getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m6706equalsimpl0(type, TextUnitType.INSTANCE.m6712getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m6689getUnspecifiedXSAIIZE();
        }
        float value = decodeFloat();
        return TextUnitKt.m6690TextUnitanM5pPY(value, type);
    }
    ...
    public final int m5686decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        return bDecodeByte == 0 ? FontStyle.INSTANCE.m6065getNormal_LCdwA() : bDecodeByte == 1 ? FontStyle.INSTANCE.m6064getItalic_LCdwA() : FontStyle.INSTANCE.m6065getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5687decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        return bDecodeByte == 0 ? FontSynthesis.INSTANCE.m6076getNoneGVVA2EU() : bDecodeByte == 1 ? FontSynthesis.INSTANCE.m6075getAllGVVA2EU() : bDecodeByte == 3 ? FontSynthesis.INSTANCE.m6077getStyleGVVA2EU() : bDecodeByte == 2 ? FontSynthesis.INSTANCE.m6078getWeightGVVA2EU() : FontSynthesis.INSTANCE.m6076getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m5683decodeBaselineShifty9eOQZs() {
        return BaselineShift.m6237constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m5685decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m5684decodeULongsVKNKU() {
        return ULong.m7130constructorimpl(this.parcel.readLong());
    }
