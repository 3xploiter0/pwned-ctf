...
public final class LazyListState implements ScrollableState {
    ...
    public LazyListState(final int firstVisibleItemIndex, int firstVisibleItemScrollOffset, LazyListPrefetchStrategy prefetchStrategy) {
        ...
        this.prefetchState = new LazyLayoutPrefetchState(this.prefetchStrategy.getPrefetchScheduler(), new Function1<NestedPrefetchScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListState$prefetchState$1
            ...
            public final void invoke2(NestedPrefetchScope $this$$receiver) {
                LazyListPrefetchStrategy $this$invoke_u24lambda_u241 = this.this$0.prefetchStrategy;
        ...
        this.prefetchScope = new LazyListPrefetchScope() { // from class: androidx.compose.foundation.lazy.LazyListState$prefetchScope$1
            ...
            public LazyLayoutPrefetchState.PrefetchHandle schedulePrefetch(int index) {
                ...
                Snapshot newSnapshot$iv = this_$iv.makeCurrentNonObservable(previousSnapshot$iv);
                try {
                    long constraints = ((LazyListMeasureResult) lazyListState.layoutInfoState.getValue()).getChildConstraints();
                    this_$iv.restoreNonObservable(previousSnapshot$iv, newSnapshot$iv, observer$iv);
                    return this.this$0.getPrefetchState().m853schedulePrefetch0kLqBqw(index, constraints);
                } catch (Throwable th) {
                    this_$iv.restoreNonObservable(previousSnapshot$iv, newSnapshot$iv, observer$iv);
                    throw th;
                }
    ...
    public final MutableState<Unit> m798getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00321 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
            int label;
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (ScrollableState.scroll$default(LazyListState.this, null, new C00321(null), this, 1, null) != coroutine_suspended) {
                        break;
                    } else {
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r7, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r6 = this;
            boolean r0 = r9 instanceof androidx.compose.foundation.lazy.LazyListState.C02941
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.foundation.lazy.LazyListState$scroll$1 r0 = (androidx.compose.foundation.lazy.LazyListState.C02941) r0
            int r1 = r0.label
    ...
    public final MutableState<Unit> m799getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final Object animateScrollToItem(int index, int scrollOffset, Continuation<? super Unit> continuation) {
        Object objAnimateScrollToItem = LazyAnimateScrollKt.animateScrollToItem(this.animateScrollScope, index, scrollOffset, 100, getDensity$foundation_release(), continuation);
    ...
    private final void updateScrollDeltaForPostLookahead(float delta, Density density, CoroutineScope coroutineScope) {
        if (delta <= density.mo373toPx0680j_4(LazyListStateKt.DeltaThresholdForScrollAnimation)) {
            return;
        }
        Snapshot.Companion this_$iv = Snapshot.INSTANCE;
        Snapshot previousSnapshot$iv = this_$iv.getCurrentThreadSnapshot();
