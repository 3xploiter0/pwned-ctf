...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1768setColorDxMtmZc(long color, float alpha) {
        long newColor = m1767calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m4004equalsimpl0(color2.m4013unboximpl(), newColor))) {
            this.rippleColor = Color.m3993boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m4057toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1767calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        return Color.m4001copywmQWz5c(color, (14 & 1) != 0 ? Color.m4005getAlphaimpl(color) : transformedAlpha, (14 & 2) != 0 ? Color.m4009getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(color) : 0.0f);
    }
