...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope $this$save, TextUndoOperation value) {
            return CollectionsKt.listOf(Integer.valueOf(value.getIndex()), value.getPreText(), value.getPostText(), Integer.valueOf(TextRange.m5948getStartimpl(value.getPreSelection())), Integer.valueOf(TextRange.m5943getEndimpl(value.getPreSelection())), Integer.valueOf(TextRange.m5948getStartimpl(value.getPostSelection())), Integer.valueOf(TextRange.m5943getEndimpl(value.getPostSelection())), Long.valueOf(value.getTimeInMillis()));
        }
    ...
    */
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m5942getCollapsedimpl(this.postSelection)) {
            if (TextRange.m5942getCollapsedimpl(this.preSelection)) {
                if (TextRange.m5948getStartimpl(this.preSelection) > TextRange.m5948getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m5948getStartimpl(this.preSelection) == TextRange.m5948getStartimpl(this.postSelection) && TextRange.m5948getStartimpl(this.preSelection) == this.index) {
