...
final class FloatingActionButtonElevationAnimatable {
    ...
    static final class C04961 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    private FloatingActionButtonElevationAnimatable(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation) {
        ...
        this.animatable = new Animatable<>(Dp.m6483boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m2122calculateTargetu2uoSUM(Interaction $this$calculateTarget_u2du2uoSUM) {
    ...
    public final Object m2123updateElevationlDy3nrA(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = defaultElevation;
        this.pressedElevation = pressedElevation;
        this.hoveredElevation = hoveredElevation;
        this.focusedElevation = focusedElevation;
    ...
    */
    public final java.lang.Object snapElevation(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) throws java.lang.Throwable {
        /*
            r8 = this;
            boolean r0 = r9 instanceof androidx.compose.material3.FloatingActionButtonElevationAnimatable.C04961
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.material3.FloatingActionButtonElevationAnimatable$snapElevation$1 r0 = (androidx.compose.material3.FloatingActionButtonElevationAnimatable.C04961) r0
            int r1 = r0.label
        ...
        L37:
            ...
            float r3 = r2.m2122calculateTargetu2uoSUM(r3)
            ...
            float r4 = r4.m6499unboximpl()
            boolean r4 = androidx.compose.ui.unit.Dp.m6490equalsimpl0(r4, r3)
            if (r4 != 0) goto L75
        L54:
            ...
            androidx.compose.ui.unit.Dp r5 = androidx.compose.ui.unit.Dp.m6483boximpl(r3)     // Catch: java.lang.Throwable -> L6c
            r9.L$0 = r2     // Catch: java.lang.Throwable -> L6c
            r6 = 1
            r9.label = r6     // Catch: java.lang.Throwable -> L6c
            java.lang.Object r4 = r4.snapTo(r5, r9)     // Catch: java.lang.Throwable -> L6c
            if (r4 != r1) goto L66
            return r1
        L66:
            r1 = r2
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object animateElevation(androidx.compose.foundation.interaction.Interaction r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        /*
            r8 = this;
            boolean r0 = r10 instanceof androidx.compose.material3.FloatingActionButtonElevationAnimatable.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r10
        ...
        L3b:
            kotlin.ResultKt.throwOnFailure(r0)
            r2 = r8
            float r3 = r2.m2122calculateTargetu2uoSUM(r9)
            ...
            float r4 = r4.m6499unboximpl()     // Catch: java.lang.Throwable -> L74
            boolean r4 = androidx.compose.ui.unit.Dp.m6490equalsimpl0(r4, r3)     // Catch: java.lang.Throwable -> L74
            if (r4 != 0) goto L6e
            androidx.compose.animation.core.Animatable<androidx.compose.ui.unit.Dp, androidx.compose.animation.core.AnimationVector1D> r4 = r2.animatable     // Catch: java.lang.Throwable -> L74
            androidx.compose.foundation.interaction.Interaction r5 = r2.lastTargetInteraction     // Catch: java.lang.Throwable -> L74
            r10.L$0 = r2     // Catch: java.lang.Throwable -> L74
            r10.L$1 = r9     // Catch: java.lang.Throwable -> L74
            r6 = 1
            r10.label = r6     // Catch: java.lang.Throwable -> L74
            java.lang.Object r3 = androidx.compose.material3.ElevationKt.m2089animateElevationrAjV9yQ(r4, r3, r5, r9, r10)     // Catch: java.lang.Throwable -> L74
            if (r3 != r1) goto L6c
            return r1
        L6c:
            r1 = r2
