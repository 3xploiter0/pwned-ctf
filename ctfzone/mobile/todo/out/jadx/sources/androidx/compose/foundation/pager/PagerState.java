...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int currentPage, float currentPageOffsetFraction, PrefetchScheduler prefetchScheduler) {
        ...
        this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3751boximpl(Offset.INSTANCE.m3778getZeroF1C5BW0()), null, 2, null);
        ...
        this.settledPage = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<Integer>() { // from class: androidx.compose.foundation.pager.PagerState$settledPage$2
            ...
            public final Integer invoke() {
                ...
                if (this.this$0.isScrollInProgress()) {
                    currentPage2 = this.this$0.getSettledPageState();
                } else {
            ...
            public final Integer invoke() {
                ...
                if (this.this$0.isScrollInProgress()) {
                    if (this.this$0.getProgrammaticScrollTargetPage() != -1) {
                        finalPage = this.this$0.getProgrammaticScrollTargetPage();
                        ...
                        if (this.this$0.getLastScrolledForward()) {
                            finalPage = this.this$0.getFirstVisiblePage() + 1;
                        } else {
                            finalPage = this.this$0.getFirstVisiblePage();
                        }
                    } else {
        ...
        this.placementScopeInvalidator = ObservableScopeInvalidator.m858constructorimpl$default(null, 1, null);
        this.measurementScopeInvalidator = ObservableScopeInvalidator.m858constructorimpl$default(null, 1, null);
    ...
    public final long m929getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m931setUpDownDifferencek4lQ0M$foundation_release(long j) {
    ...
    public final float performScroll(float delta) {
        ...
        if (layoutInfo.tryToApplyScrollWithoutRemeasure(-((int) scrollDelta))) {
            ...
            ObservableScopeInvalidator.m862invalidateScopeimpl(this.placementScopeInvalidator);
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        ...
        float minThreshold = Math.min($this$_get_positionThresholdFraction__u24lambda_u244.mo373toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f);
    ...
    public final void m930setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final void snapToItem$foundation_release(int page, float offsetFraction, boolean forceRemeasure) {
        ...
        ObservableScopeInvalidator.m862invalidateScopeimpl(this.measurementScopeInvalidator);
    }
    ...
    static final class C03211 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PagerState.this.new C03211(continuation);
        }
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        if (isScrollInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new C03211(null), 3, null);
        }
    ...
    */
    static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            boolean r0 = r8 instanceof androidx.compose.foundation.pager.PagerState.C03221
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.pager.PagerState$scroll$1 r0 = (androidx.compose.foundation.pager.PagerState.C03221) r0
            int r1 = r0.label
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        return (getLayoutInfo().getOrientation() == Orientation.Vertical ? (Math.signum(scrollDelta) > Math.signum(-Offset.m3763getYimpl(m929getUpDownDifferenceF1C5BW0$foundation_release())) ? 1 : (Math.signum(scrollDelta) == Math.signum(-Offset.m3763getYimpl(m929getUpDownDifferenceF1C5BW0$foundation_release())) ? 0 : -1)) == 0 : (Math.signum(scrollDelta) > Math.signum(-Offset.m3762getXimpl(m929getUpDownDifferenceF1C5BW0$foundation_release())) ? 1 : (Math.signum(scrollDelta) == Math.signum(-Offset.m3762getXimpl(m929getUpDownDifferenceF1C5BW0$foundation_release())) ? 0 : -1)) == 0) || isNotGestureAction();
    }

    private final boolean isNotGestureAction() {
        return ((int) Offset.m3762getXimpl(m929getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m3763getYimpl(m929getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
        ...
        if (this.prefetchingEnabled && !info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (z) {
                if (indexToPrefetch != this.indexToPrefetch) {
                    ...
                    this.currentPrefetchHandle = this.prefetchState.m853schedulePrefetch0kLqBqw(indexToPrefetch, this.premeasureConstraints);
                }
                if (isPrefetchingForward) {
