...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo6085createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m6103getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo6086createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m6103getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo6200getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m6103getFontStyle_LCdwA(), typefaceRequest.m6104getFontSynthesisGVVA2EU());
        }
