...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m5272boximpl(int i) {
        return new PointerKeyboardModifiers(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5273constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m5274equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m5276hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5277toStringimpl(this.packedValue);
    }
