...
public final class LazyStaggeredGridDslKt {
    ...
    public static final void m877LazyVerticalStaggeredGridzadm560(final StaggeredGridCells columns, Modifier modifier, LazyStaggeredGridState state, PaddingValues contentPadding, boolean reverseLayout, float verticalItemSpacing, Arrangement.Horizontal horizontalArrangement, FlingBehavior flingBehavior, boolean userScrollEnabled, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 384) == 0) {
            $dirty2 |= ((i & 4) == 0 && $composer2.changedInstance(state)) ? 256 : 128;
        }
        int i3 = i & 8;
        if (i3 != 0) {
            $dirty2 |= 3072;
        ...
        if (i5 != 0) {
            ...
            verticalItemSpacing2 = verticalItemSpacing;
            $dirty2 |= $composer2.changed(verticalItemSpacing2) ? 131072 : 65536;
        } else {
            verticalItemSpacing2 = verticalItemSpacing;
        }
        int i6 = i & 64;
        if (i6 != 0) {
            ...
            $dirty2 |= $composer2.changed(horizontalArrangement) ? 1048576 : 524288;
        }
        ...
        if (($dirty2 & 306783379) == 306783378 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    verticalItemSpacing2 = Dp.m6485constructorimpl(0);
                }
                horizontalArrangement2 = i6 != 0 ? Arrangement.INSTANCE.m561spacedBy0680j_4(Dp.m6485constructorimpl(0)) : horizontalArrangement;
                if ((i & 128) != 0) {
            ...
            LazyStaggeredGridKt.m882LazyStaggeredGridLJWHXA8(state2, Orientation.Vertical, rememberColumnSlots(columns, horizontalArrangement2, contentPadding2, $composer2, ($dirty & 14) | (($dirty >> 15) & 112) | (($dirty >> 3) & 896)), modifier3, contentPadding2, reverseLayout2, flingBehavior2, userScrollEnabled2, verticalItemSpacing2, horizontalArrangement2.getSpacing(), function1, $composer2, (($dirty >> 6) & 14) | 48 | (($dirty << 6) & 7168) | (($dirty << 3) & 57344) | (($dirty << 3) & 458752) | (($dirty >> 3) & 3670016) | (($dirty >> 3) & 29360128) | (($dirty << 9) & 234881024), ($dirty >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            final float f = verticalItemSpacing3;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$LazyVerticalStaggeredGrid$1
                ...
                public final void invoke(Composer composer, int i9) {
                    LazyStaggeredGridDslKt.m877LazyVerticalStaggeredGridzadm560(columns, modifier6, lazyStaggeredGridState, paddingValues, z, f, horizontal, flingBehavior4, z2, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final LazyGridStaggeredGridSlotsProvider rememberColumnSlots(final StaggeredGridCells columns, final Arrangement.Horizontal horizontalArrangement, final PaddingValues contentPadding, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberColumnSlots$1$1
                ...
                public final LazyStaggeredGridSlots m878invoke0kLqBqw(Density $this$$receiver, long constraints) {
                    ...
                    int[] sizes = $this$invoke_0kLqBqw_u24lambda_u243.calculateCrossAxisCellSizes($this$$receiver, gridWidth, $this$$receiver.mo367roundToPx0680j_4($this$invoke_0kLqBqw_u24lambda_u243_u24lambda_u242_u24lambda_u241.getSpacing()));
    ...
    public static final void m876LazyHorizontalStaggeredGridcJHQLPU(final StaggeredGridCells rows, Modifier modifier, LazyStaggeredGridState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Vertical verticalArrangement, float horizontalItemSpacing, FlingBehavior flingBehavior, boolean userScrollEnabled, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (i5 != 0) {
            ...
            verticalArrangement2 = verticalArrangement;
            $dirty2 |= $composer2.changed(verticalArrangement2) ? 131072 : 65536;
        } else {
            verticalArrangement2 = verticalArrangement;
        }
        int i6 = i & 64;
        if (i6 != 0) {
            ...
            $dirty2 |= $composer2.changed(horizontalItemSpacing) ? 1048576 : 524288;
        }
        if (($changed & 12582912) == 0) {
            $dirty2 |= ((i & 128) == 0 && $composer2.changed(flingBehavior)) ? 8388608 : 4194304;
        }
        ...
        if (($dirty2 & 306783379) == 306783378 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    verticalArrangement2 = Arrangement.INSTANCE.m561spacedBy0680j_4(Dp.m6485constructorimpl(0));
                }
                horizontalItemSpacing2 = i6 != 0 ? Dp.m6485constructorimpl(0) : horizontalItemSpacing;
                if ((i & 128) != 0) {
                    flingBehavior2 = ScrollableDefaults.INSTANCE.flingBehavior($composer2, 6);
                    $dirty2 &= -29360129;
                } else {
            ...
            LazyStaggeredGridKt.m882LazyStaggeredGridLJWHXA8(state2, Orientation.Horizontal, rememberRowSlots(rows, verticalArrangement2, contentPadding2, $composer2, ($dirty & 14) | (($dirty >> 12) & 112) | (($dirty >> 3) & 896)), modifier3, contentPadding2, reverseLayout2, flingBehavior2, userScrollEnabled2, horizontalItemSpacing2, verticalArrangement2.getSpacing(), function1, $composer2, (($dirty >> 6) & 14) | 48 | (($dirty << 6) & 7168) | (($dirty << 3) & 57344) | (($dirty << 3) & 458752) | (($dirty >> 3) & 3670016) | (($dirty >> 3) & 29360128) | (($dirty << 6) & 234881024), ($dirty >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$LazyHorizontalStaggeredGrid$1
                ...
                public final void invoke(Composer composer, int i9) {
                    LazyStaggeredGridDslKt.m876LazyHorizontalStaggeredGridcJHQLPU(rows, modifier6, lazyStaggeredGridState, paddingValues, z, vertical, f, flingBehavior4, z2, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final LazyGridStaggeredGridSlotsProvider rememberRowSlots(final StaggeredGridCells rows, final Arrangement.Vertical verticalArrangement, final PaddingValues contentPadding, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberRowSlots$1$1
                ...
                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridSlots m879invoke0kLqBqw(Density $this$$receiver, long constraints) {
                    ...
                    int[] sizes = $this$invoke_0kLqBqw_u24lambda_u243.calculateCrossAxisCellSizes($this$$receiver, gridHeight, $this$$receiver.mo367roundToPx0680j_4($this$invoke_0kLqBqw_u24lambda_u243_u24lambda_u242_u24lambda_u241.getSpacing()));
                    int[] positions = new int[sizes.length];
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyStaggeredGridScope $this$itemsIndexed_u24default, List items, Function2 key, Function2 contentType, Function2 span, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.size(), key != null ? new LazyStaggeredGridDslKt$itemsIndexed$2$1(key, items) : null, new C03163(contentType, items), span != null ? new LazyStaggeredGridDslKt$itemsIndexed$4$1(span, items) : null, ComposableLambdaKt.composableLambdaInstance(284833944, true, new C03175(itemContent, items)));
    }
    ...
    public static final class C03163 extends Lambda implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C03163(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
            super(1);
    ...
    public static final <T> void itemsIndexed(LazyStaggeredGridScope $this$itemsIndexed, List<? extends T> list, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function2<? super Integer, ? super T, StaggeredGridItemSpan> function23, Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        ...
        C03163 c03163 = new C03163(function22, list);
        if (function23 == null) {
        ...
        $this$itemsIndexed.items(size, lazyStaggeredGridDslKt$itemsIndexed$2$1, c03163, lazyStaggeredGridDslKt$itemsIndexed$4$1, ComposableLambdaKt.composableLambdaInstance(284833944, true, new C03175(function5, list)));
    }
    ...
    public static final class C03175 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C03175(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, List<? extends T> list) {
            super(4);
    ...
    public static final class C03198 extends Lambda implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ T[] $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C03198(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            super(1);
            this.$contentType = function2;
            this.$items = tArr;
        }
    ...
    public static final <T> void itemsIndexed(LazyStaggeredGridScope $this$itemsIndexed, T[] tArr, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function2<? super Integer, ? super T, StaggeredGridItemSpan> function23, Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        ...
        C03198 c03198 = new C03198(function22, tArr);
        if (function23 == null) {
        ...
        $this$itemsIndexed.items(length, lazyStaggeredGridDslKt$itemsIndexed$7$1, c03198, lazyStaggeredGridDslKt$itemsIndexed$9$1, ComposableLambdaKt.composableLambdaInstance(-804487775, true, new C031510(function5, tArr)));
    }
    ...
    public static final class C031510 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ T[] $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C031510(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
            super(4);
            this.$itemContent = function5;
            this.$items = tArr;
        }
