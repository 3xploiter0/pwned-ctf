...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m157usingngzHuyU(KeyframeEntity<T> keyframeEntity, int arcMode) {
            keyframeEntity.m156setArcModeRur9ykg$animation_core_release(arcMode);
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
        ...
        timestamps.sort();
        return new VectorizedKeyframesSpec<>(timestamps, timeToInfoMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.INSTANCE.m152getArcLinear9TMq4(), null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof KeyframeEntity) {
                return Intrinsics.areEqual(((KeyframeEntity) other).getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual(((KeyframeEntity) other).getEasing(), getEasing()) && ArcMode.m146equalsimpl0(((KeyframeEntity) other).arcMode, this.arcMode);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            return (((result * 31) + ArcMode.m147hashCodeimpl(this.arcMode)) * 31) + getEasing().hashCode();
        }
    }
}
