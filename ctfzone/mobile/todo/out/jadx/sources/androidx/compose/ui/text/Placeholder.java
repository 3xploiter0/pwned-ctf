...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (TextUnitKt.m6696isUnspecifiedR2X_6o(this.width)) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (TextUnitKt.m6696isUnspecifiedR2X_6o(this.height)) {
    ...
    public final Placeholder m5859copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Placeholder) && TextUnit.m6675equalsimpl0(this.width, ((Placeholder) other).width) && TextUnit.m6675equalsimpl0(this.height, ((Placeholder) other).height) && PlaceholderVerticalAlign.m5866equalsimpl0(this.placeholderVerticalAlign, ((Placeholder) other).placeholderVerticalAlign);
    }

    public int hashCode() {
        int result = TextUnit.m6679hashCodeimpl(this.width);
        return (((result * 31) + TextUnit.m6679hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m5867hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m6685toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m6685toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m5868toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
