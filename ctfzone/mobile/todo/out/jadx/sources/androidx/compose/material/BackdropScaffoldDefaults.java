...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m6485constructorimpl(56);
    private static final float HeaderHeight = Dp.m6485constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m6485constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m1430getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }

    /* renamed from: getHeaderHeight-D9Ej5fM, reason: not valid java name */
    public final float m1429getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m956CornerSize0680j_4(Dp.m6485constructorimpl(16)), CornerSizeKt.m956CornerSize0680j_4(Dp.m6485constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m1428getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        long jM1500getSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer, 6).m1500getSurface0d7_KjU();
        long jM4001copywmQWz5c = Color.m4001copywmQWz5c(jM1500getSurface0d7_KjU, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jM1500getSurface0d7_KjU) : 0.6f, (14 & 2) != 0 ? Color.m4009getRedimpl(jM1500getSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jM1500getSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jM1500getSurface0d7_KjU) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
