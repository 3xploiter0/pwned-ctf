...
final class PaddingValues implements WindowInsets {
    ...
    public String toString() {
        ...
        float start = this.paddingValues.mo632calculateLeftPaddingu2uoSUM(layoutDirection);
        float top = this.paddingValues.getTop();
        float end = this.paddingValues.mo633calculateRightPaddingu2uoSUM(layoutDirection);
        float bottom = this.paddingValues.getBottom();
        return "PaddingValues(" + ((Object) Dp.m6496toStringimpl(start)) + ", " + ((Object) Dp.m6496toStringimpl(top)) + ", " + ((Object) Dp.m6496toStringimpl(end)) + ", " + ((Object) Dp.m6496toStringimpl(bottom)) + ')';
    }
