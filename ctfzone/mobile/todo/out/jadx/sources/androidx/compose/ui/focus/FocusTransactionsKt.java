...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode $this$requestFocus) {
        Boolean boolM3713requestFocusMxy_nc0 = m3713requestFocusMxy_nc0($this$requestFocus, FocusDirection.INSTANCE.m3681getEnterdhqQ8s());
        if (boolM3713requestFocusMxy_nc0 != null) {
            return boolM3713requestFocusMxy_nc0.booleanValue();
        }
        return false;
    }

    /* renamed from: requestFocus-Mxy_nc0, reason: not valid java name */
    public static final Boolean m3713requestFocusMxy_nc0(final FocusTargetNode $this$requestFocus_u2dMxy_nc0, int focusDirection) {
        Boolean boolValueOf;
        ...
        try {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[m3712performCustomRequestFocusMxy_nc0($this$requestFocus_u2dMxy_nc0, focusDirection).ordinal()]) {
                case 1:
                                ...
                                if ((node$iv$iv$iv.getKindSet() & iM5574constructorimpl) != 0) {
                                    ...
                                    while (nodePop != null) {
                                        if (nodePop instanceof FocusTargetNode) {
                                            ...
                                            if (((this_$iv$iv$iv$iv.getKindSet() & iM5574constructorimpl) != 0 ? z4 : false) && (nodePop instanceof DelegatingNode)) {
                                                ...
                                                while (node$iv$iv$iv$iv != null) {
                                                    ...
                                                    if ((next$iv$iv$iv.getKindSet() & iM5574constructorimpl) != 0 ? z4 : false) {
                                                        count$iv$iv$iv2++;
    ...
    private static final boolean requestFocusForChild(FocusTargetNode $this$requestFocusForChild, FocusTargetNode childNode) {
        ...
        int type$iv8 = NodeKind.m5574constructorimpl(1024);
        int i5 = 0;
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[$this$requestFocusForChild.getFocusState().ordinal()]) {
            ...
            case 4:
                ...
                int type$iv9 = NodeKind.m5574constructorimpl(1024);
    ...
    private static final boolean requestFocusForOwner(FocusTargetNode $this$requestFocusForOwner) {
        return DelegatableNodeKt.requireOwner($this$requestFocusForOwner).getFocusOwner().mo3695requestFocusForOwner7o62pno(null, null);
    }
    ...
    public static final CustomDestinationResult m3712performCustomRequestFocusMxy_nc0(FocusTargetNode $this$performCustomRequestFocus_u2dMxy_nc0, int focusDirection) {
        int i;
        int i2;
        Modifier.Node node;
        DelegatableNode $this$nearestAncestor_u2d64DMado$iv;
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[$this$performCustomRequestFocus_u2dMxy_nc0.getFocusState().ordinal()]) {
            ...
            case 3:
                return m3709performCustomClearFocusMxy_nc0(requireActiveChild($this$performCustomRequestFocus_u2dMxy_nc0), focusDirection);
            case 4:
                ...
                switch (WhenMappings.$EnumSwitchMapping$1[focusParent.getFocusState().ordinal()]) {
                    case 1:
                        return m3710performCustomEnterMxy_nc0(focusParent, focusDirection);
                    case 2:
                        return CustomDestinationResult.Cancelled;
                    case 3:
                        return m3712performCustomRequestFocusMxy_nc0(focusParent, focusDirection);
                    case 4:
                        CustomDestinationResult it = m3712performCustomRequestFocusMxy_nc0(focusParent, focusDirection);
                        CustomDestinationResult customDestinationResult = (it == CustomDestinationResult.None ? i : i2) == 0 ? it : null;
                        return customDestinationResult == null ? m3710performCustomEnterMxy_nc0(focusParent, focusDirection) : customDestinationResult;
                    default:
                        throw new NoWhenBranchMatchedException();
                }
            default:
    ...
    public static final CustomDestinationResult m3709performCustomClearFocusMxy_nc0(FocusTargetNode $this$performCustomClearFocus_u2dMxy_nc0, int focusDirection) {
        switch (WhenMappings.$EnumSwitchMapping$1[$this$performCustomClearFocus_u2dMxy_nc0.getFocusState().ordinal()]) {
            ...
            case 2:
                return CustomDestinationResult.Cancelled;
            case 3:
                CustomDestinationResult it = m3709performCustomClearFocusMxy_nc0(requireActiveChild($this$performCustomClearFocus_u2dMxy_nc0), focusDirection);
                if (it == CustomDestinationResult.None) {
                    it = null;
                }
                if (it == null) {
                    return m3711performCustomExitMxy_nc0($this$performCustomClearFocus_u2dMxy_nc0, focusDirection);
                }
                return it;
            default:
                throw new NoWhenBranchMatchedException();
    ...
    private static final CustomDestinationResult m3710performCustomEnterMxy_nc0(FocusTargetNode $this$performCustomEnter_u2dMxy_nc0, int focusDirection) {
        ...
        if (!$this$performCustomEnter_u2dMxy_nc0.isProcessingCustomEnter) {
            ...
            try {
                FocusRequester it$iv = $this$performCustomEnter_u2dMxy_nc0.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3671boximpl(focusDirection));
    ...
    private static final CustomDestinationResult m3711performCustomExitMxy_nc0(FocusTargetNode $this$performCustomExit_u2dMxy_nc0, int focusDirection) {
        CustomDestinationResult customDestinationResult;
        if (!$this$performCustomExit_u2dMxy_nc0.isProcessingCustomExit) {
            $this$performCustomExit_u2dMxy_nc0.isProcessingCustomExit = true;
            try {
                FocusRequester it$iv = $this$performCustomExit_u2dMxy_nc0.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3671boximpl(focusDirection));
                if (it$iv != FocusRequester.INSTANCE.getDefault()) {
                    if (it$iv == FocusRequester.INSTANCE.getCancel()) {
                        customDestinationResult = CustomDestinationResult.Cancelled;
                    } else {
