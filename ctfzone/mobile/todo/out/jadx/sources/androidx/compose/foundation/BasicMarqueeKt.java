...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m242basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        int i6;
        if ((i5 & 1) != 0) {
            i = MarqueeDefaults.INSTANCE.getIterations();
        }
        int iM314getImmediatelyZbEOnfQ = (i5 & 2) != 0 ? MarqueeAnimationMode.INSTANCE.m314getImmediatelyZbEOnfQ() : i2;
        int repeatDelayMillis = (i5 & 4) != 0 ? MarqueeDefaults.INSTANCE.getRepeatDelayMillis() : i3;
        if ((i5 & 8) != 0) {
            i6 = MarqueeAnimationMode.m310equalsimpl0(iM314getImmediatelyZbEOnfQ, MarqueeAnimationMode.INSTANCE.m314getImmediatelyZbEOnfQ()) ? repeatDelayMillis : 0;
        } else {
            i6 = i4;
        }
        return m241basicMarquee1Mj1MLw(modifier, i, iM314getImmediatelyZbEOnfQ, repeatDelayMillis, i6, (i5 & 16) != 0 ? MarqueeDefaults.INSTANCE.getSpacing() : marqueeSpacing, (i5 & 32) != 0 ? MarqueeDefaults.INSTANCE.m316getVelocityD9Ej5fM() : f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m241basicMarquee1Mj1MLw(Modifier $this$basicMarquee_u2d1Mj1MLw, int iterations, int animationMode, int repeatDelayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
    ...
    public static final AnimationSpec<Float> m243createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        float pxPerSec = density.mo373toPx0680j_4(velocity);
        TweenSpec singleSpec = velocityBasedTween(Math.abs(pxPerSec), targetValue, delayMillis);
        long startOffset = StartOffset.m174constructorimpl$default((-delayMillis) + initialDelayMillis, 0, 2, null);
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m139infiniteRepeatable9IiC70o$default(singleSpec, null, startOffset, 2, null);
        }
        return AnimationSpecKt.m141repeatable91I0pcU$default(iterations, singleSpec, null, startOffset, 4, null);
    }
    ...
    public static final MarqueeSpacing m239MarqueeSpacing0680j_4(final float spacing) {
    ...
    public static final int MarqueeSpacing_0680j_4$lambda$1(float $spacing, Density $this$MarqueeSpacing, int i, int i2) {
        return $this$MarqueeSpacing.mo367roundToPx0680j_4($spacing);
    }
}
