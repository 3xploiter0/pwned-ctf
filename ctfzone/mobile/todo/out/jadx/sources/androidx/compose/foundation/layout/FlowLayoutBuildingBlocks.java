...
public final class FlowLayoutBuildingBlocks {
    ...
    public final WrapInfo m604getWrapInfoOpUlnko(boolean nextItemHasNext, int nextIndexInLine, long leftOver, IntIntPair nextSize, int lineIndex, int totalCrossAxisSize, int currentLineCrossAxisSize, boolean isWrappingRound, boolean isEllipsisWrap) {
        boolean z;
        boolean z2;
        IntIntPair intIntPairM609ellipsisSizeF35zmw$foundation_layout_release;
        boolean z3;
        ...
        if (shouldWrapItem) {
            ...
            return new WrapInfo(true, m604getWrapInfoOpUlnko(nextItemHasNext, 0, IntIntPair.m24constructorimpl(Constraints.m6438getMaxWidthimpl(arg0$iv), (IntIntPair.m29getSecondimpl(leftOver) - this.crossAxisSpacing) - currentLineCrossAxisSize), IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(IntIntPair.m28getFirstimpl(nextSize.getPackedValue()) - this.mainAxisSpacing, IntIntPair.m29getSecondimpl(nextSize.getPackedValue()))), lineIndex + 1, totalContainerCrossAxisSize, 0, true, false).getIsLastItemInContainer());
        }
        ...
        if (isEllipsisWrap) {
            intIntPairM609ellipsisSizeF35zmw$foundation_layout_release = null;
        } else {
            intIntPairM609ellipsisSizeF35zmw$foundation_layout_release = this.overflow.m609ellipsisSizeF35zmw$foundation_layout_release(nextItemHasNext, lineIndex, totalContainerCrossAxisSize2);
        }
        IntIntPair ellipsis = intIntPairM609ellipsisSizeF35zmw$foundation_layout_release;
        if (ellipsis != null) {
        ...
        if (shouldWrapEllipsis) {
            ...
            WrapInfo wrapInfo = m604getWrapInfoOpUlnko(false, 0, IntIntPair.m24constructorimpl(Constraints.m6438getMaxWidthimpl(arg0$iv2), (IntIntPair.m29getSecondimpl(leftOver) - this.crossAxisSpacing) - Math.max(currentLineCrossAxisSize, IntIntPair.m29getSecondimpl(nextSize.getPackedValue()))), ellipsis, lineIndex + 1, totalContainerCrossAxisSize2, 0, true, true);
