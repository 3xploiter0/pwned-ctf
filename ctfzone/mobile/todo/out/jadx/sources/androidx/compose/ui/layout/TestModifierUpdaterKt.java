...
public final class TestModifierUpdaterKt {
    ...
    public static final void TestModifierUpdaterLayout(final Function1<? super TestModifierUpdater, Unit> function1, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(TestModifierUpdaterLayout)50@1816L23,54@1971L330:TestModifierUpdater.kt#80mrfh");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (($dirty & 3) != 2 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1673066036, $dirty, -1, "androidx.compose.ui.layout.TestModifierUpdaterLayout (TestModifierUpdater.kt:49)");
            }
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1
                ...
                public final MeasureResult mo38measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long constraints) {
                    return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m6438getMaxWidthimpl(constraints), Constraints.m6437getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1.1
            ...
            Composer $this$TestModifierUpdaterLayout_u24lambda_u240 = Updater.m3496constructorimpl($composer2);
            Updater.m3503setimpl($this$TestModifierUpdaterLayout_u24lambda_u240, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            if ($this$TestModifierUpdaterLayout_u24lambda_u240.getInserting() || !Intrinsics.areEqual($this$TestModifierUpdaterLayout_u24lambda_u240.rememberedValue(), Integer.valueOf(compositeKeyHash))) {
                ...
                $this$TestModifierUpdaterLayout_u24lambda_u240.apply(Integer.valueOf(compositeKeyHash), block$iv);
            }
            Updater.m3500initimpl($this$TestModifierUpdaterLayout_u24lambda_u240, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$1$1
