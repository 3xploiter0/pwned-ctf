...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(Function0<Unit> function0, String testTag, View composeView, Density density, PopupPositionProvider initialPositionProvider, UUID popupId) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m1743getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        ...
        this.dismissOnOutsideClick = new Function2<Offset, IntRect, Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$dismissOnOutsideClick$1
            ...
            public final Boolean invoke(Offset offset, IntRect bounds) {
                boolean z = false;
                if (offset != null && (Offset.m3762getXimpl(offset.getPackedValue()) < bounds.getLeft() || Offset.m3762getXimpl(offset.getPackedValue()) > bounds.getRight() || Offset.m3763getYimpl(offset.getPackedValue()) < bounds.getTop() || Offset.m3763getYimpl(offset.getPackedValue()) > bounds.getBottom())) {
                    z = true;
                }
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopup_androidKt.INSTANCE.m1741getLambda1$material_release(), null, 2, null);
    }
    ...
    public final IntSize m1743getPopupContentSizebOM6tXw() {
        State $this$getValue$iv = this.popupContentSize;
        return (IntSize) $this$getValue$iv.getValue();
    }

    /* renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m1744setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public void Content(Composer $composer, final int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-864350873, $changed, -1, "androidx.compose.material.internal.PopupLayout.Content (ExposedDropdownMenuPopup.android.kt:301)");
        }
    ...
    public final void updatePosition() {
        IntSize intSizeM1743getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM1743getPopupContentSizebOM6tXw = m1743getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = intSizeM1743getPopupContentSizebOM6tXw.getPackedValue();
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        L61:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m3751boximpl(r6)
            goto L75
        L74:
            r1 = 0
        L75:
