...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        int width = Constraints.m6436getHasFixedWidthimpl(constraints) ? Constraints.m6438getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m6435getHasFixedHeightimpl(constraints) ? Constraints.m6437getMaxHeightimpl(constraints) : 0;
