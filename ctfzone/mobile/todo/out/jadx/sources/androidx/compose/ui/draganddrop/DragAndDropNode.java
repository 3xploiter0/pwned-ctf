...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode {
    ...
    public void mo3634drag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        DelegatableNodeKt.requireOwner(this).getDragAndDropManager().mo3633drag12SF9DM(transferData, decorationSize, drawDragDecoration);
    }
    ...
    public void onMoved(final DragAndDropEvent event) {
        ...
        boolean z = false;
        if (currentChildNode != null && DragAndDropNodeKt.m3636containsUv8p0NA(currentChildNode, DragAndDrop_androidKt.getPositionInRoot(event))) {
            z = true;
        }
        if (z) {
            dragAndDropModifierNode = currentChildNode;
        } else {
            ...
            if ($this$firstDescendantOrNull$iv.getNode().getIsAttached()) {
                ...
                TraversableNodeKt.traverseDescendants($this$firstDescendantOrNull$iv, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                    ...
                    public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode) {
                        ...
                        if (DelegatableNodeKt.requireOwner(this).getDragAndDropManager().isInterestedNode(child) && DragAndDropNodeKt.m3636containsUv8p0NA(child, DragAndDrop_androidKt.getPositionInRoot(event))) {
            ...
            dragAndDropModifierNode = (DragAndDropModifierNode) obj;
        }
        DragAndDropModifierNode newChildNode = dragAndDropModifierNode;
