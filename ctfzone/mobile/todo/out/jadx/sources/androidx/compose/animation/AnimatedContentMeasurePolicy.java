...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    /* JADX WARN: Type inference failed for: r11v1, types: [kotlin.collections.IntIterator] */
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        long targetSize = IntSize.INSTANCE.m6660getZeroYbymL2g();
        ...
        while (true) {
            ...
            if (z) {
                Placeable it = measurable.mo5339measureBRTryo0(constraints);
                $this$fastForEachIndexed$iv = $this$fastForEachIndexed$iv2;
                int width = it.getWidth();
                $i$f$fastForEachIndexed = $i$f$fastForEachIndexed2;
                int $i$f$fastForEachIndexed3 = it.getHeight();
                targetSize = IntSizeKt.IntSize(width, $i$f$fastForEachIndexed3);
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.mo5339measureBRTryo0(constraints);
            }
        }
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            maxWidth = IntSize.m6655getWidthimpl(targetSize);
        } else {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            height = IntSize.m6654getHeightimpl(targetSize);
        } else {
            if (placeables.length == 0) {
                placeable2 = null;
            } else {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, maxWidth, maxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                for (Placeable placeable5 : placeableArr) {
                    if (placeable5 != null) {
                        long offset = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3608alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default($this$layout, placeable5, IntOffset.m6613getXimpl(offset), IntOffset.m6614getYimpl(offset), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
