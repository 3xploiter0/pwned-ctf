...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds($this$_get_targetBounds__u24lambda_u241 != null ? RectKt.m3802Recttz77jQw($this$_get_targetBounds__u24lambda_u241.m106calculateLookaheadOffsetF1C5BW0(), $this$_get_targetBounds__u24lambda_u241.m107getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void updateMatch() {
        ...
        if (this.states.size() > 1 && hasVisibleContent) {
            setFoundMatch(true);
        } else if (!this.scope.isTransitionActive() || !hasVisibleContent) {
            setFoundMatch(false);
        }
    ...
    public final void m105onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM3751boximpl = rect != null ? Offset.m3751boximpl(rect.m3797getTopLeftF1C5BW0()) : null;
            if (offsetM3751boximpl == null ? false : Offset.m3759equalsimpl0(offsetM3751boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM3819boximpl = rect2 != null ? Size.m3819boximpl(rect2.m3795getSizeNHjbRc()) : null;
                if (sizeM3819boximpl != null ? Size.m3827equalsimpl0(sizeM3819boximpl.getPackedValue(), lookaheadSize) : false) {
                    return;
                }
            }
            Rect target = RectKt.m3802Recttz77jQw(topLeft, lookaheadSize);
    ...
    public final void addState(SharedElementInternalState sharedElementState) throws Throwable {
