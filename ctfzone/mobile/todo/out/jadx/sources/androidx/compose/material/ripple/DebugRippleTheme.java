...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1590defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1765defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1765defaultRippleColor5vOe2sY(Color.INSTANCE.m4029getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha rippleAlphaM1764defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1764defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4029getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
