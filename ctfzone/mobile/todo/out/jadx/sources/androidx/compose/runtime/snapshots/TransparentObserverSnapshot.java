...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    public TransparentObserverSnapshot(Snapshot previousSnapshot, Function1<Object, Unit> function1, boolean mergeParentObservers, boolean ownsPreviousSnapshot) {
        ...
        this.readObserver = SnapshotKt.mergedReadObserver(function1, (snapshot == null || (readObserver = snapshot.getReadObserver()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getReadObserver() : readObserver, this.mergeParentObservers);
