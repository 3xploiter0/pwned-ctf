...
public final class NavigationBarItemDefaults {
    ...
    public final NavigationBarItemColors m2237colors69fazGs(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor, Composer $composer, int $changed, int i) {
        ...
        long selectedIconColor2 = (i & 1) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : selectedIconColor;
        long selectedTextColor2 = (i & 2) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : selectedTextColor;
        long indicatorColor2 = (i & 4) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : indicatorColor;
        long unselectedIconColor2 = (i & 8) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : unselectedIconColor;
        long unselectedTextColor2 = (i & 16) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : unselectedTextColor;
        long disabledIconColor2 = (i & 32) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledIconColor;
        long disabledTextColor2 = (i & 64) != 0 ? Color.INSTANCE.m4039getUnspecified0d7_KjU() : disabledTextColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        NavigationBarItemColors navigationBarItemColorsM2228copy4JmcsL4 = getDefaultNavigationBarItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2228copy4JmcsL4(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, disabledIconColor2, disabledTextColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return navigationBarItemColorsM2228copy4JmcsL4;
    }
    ...
    public final NavigationBarItemColors getDefaultNavigationBarItemColors$material3_release(ColorScheme $this$defaultNavigationBarItemColors) {
        ...
        if (defaultNavigationBarItemColorsCached == null) {
            ...
            NavigationBarItemColors it = new NavigationBarItemColors(jFromToken, jFromToken2, jFromToken3, jFromToken4, jFromToken5, jM4001copywmQWz5c, Color.m4001copywmQWz5c(jFromToken7, (14 & 1) != 0 ? Color.m4005getAlphaimpl(jFromToken7) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(jFromToken7) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(jFromToken7) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(jFromToken7) : 0.0f), null);
    ...
    public final /* synthetic */ NavigationBarItemColors m2238colorszjMxDiM(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, Composer $composer, int $changed, int i) {
        ...
        NavigationBarItemColors navigationBarItemColors = new NavigationBarItemColors(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, jM4001copywmQWz5c, Color.m4001copywmQWz5c(j2, (14 & 1) != 0 ? Color.m4005getAlphaimpl(j2) : 0.38f, (14 & 2) != 0 ? Color.m4009getRedimpl(j2) : 0.0f, (14 & 4) != 0 ? Color.m4008getGreenimpl(j2) : 0.0f, (14 & 8) != 0 ? Color.m4006getBlueimpl(j2) : 0.0f), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
