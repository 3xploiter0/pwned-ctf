...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m5529updateRootConstraintsBRTryo0(long constraints) {
        ...
        if (!(constraints2 == null ? false : Constraints.m6431equalsimpl0(constraints2.getValue(), constraints))) {
            ...
            this.rootConstraints = Constraints.m6426boximpl(constraints);
    ...
    */
    ...
    private final boolean m5526doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean lookaheadSizeChanged;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            lookaheadSizeChanged = layoutNode.m5493lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            lookaheadSizeChanged = LayoutNode.m5489lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    private final boolean m5527doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean sizeChanged;
        if (constraints != null) {
            sizeChanged = layoutNode.m5494remeasure_Sx5XlM$ui_release(constraints);
        } else {
            sizeChanged = LayoutNode.m5490remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    public final void m5528measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean lookaheadSizeChanged = m5526doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6426boximpl(constraints));
                ...
                m5527doRemeasuresdFAvZA(layoutNode, Constraints.m6426boximpl(constraints));
        ...
        if (layoutNode.isPlaced() || layoutNode.isPlacedByParent() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (affectsLookahead) {
                if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                    sizeChanged = m5526doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                }
                ...
                if (layoutNode.getMeasurePending$ui_release()) {
                    sizeChanged = m5527doRemeasuresdFAvZA(layoutNode, constraints);
                }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m5526doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m5527doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
