...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m2427boximpl(long j) {
    ...
    public static boolean m2429equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m2435unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2430equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m2433hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m2429equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2433hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m2435unboximpl() {
    ...
    public static final float m2432getStartimpl(long arg0) {
        if (!(arg0 != Unspecified)) {
    ...
    public static final float m2431getEndInclusiveimpl(long arg0) {
        if (!(arg0 != Unspecified)) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2436getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m2437getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2434toStringimpl(long arg0) {
        if (SliderKt.m2421isSpecifiedIf1S1O4(arg0)) {
            return m2432getStartimpl(arg0) + ".." + m2431getEndInclusiveimpl(arg0);
        }
        return "FloatRange.Unspecified";
    }

    public String toString() {
        return m2434toStringimpl(this.packedValue);
    }
}
