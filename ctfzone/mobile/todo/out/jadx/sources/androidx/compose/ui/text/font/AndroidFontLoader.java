...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) throws Resources.NotFoundException {
        Object objM6956constructorimpl;
        ...
        } else if (FontLoadingStrategy.m6045equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6051getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.INSTANCE;
                AndroidFontLoader $this$loadBlocking_u24lambda_u240 = this;
                objM6956constructorimpl = Result.m6956constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, $this$loadBlocking_u24lambda_u240.context));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6956constructorimpl = Result.m6956constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m6962isFailureimpl(objM6956constructorimpl) ? null : objM6956constructorimpl);
        } else {
            if (FontLoadingStrategy.m6045equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6049getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m6047toStringimpl(font.getLoadingStrategy())));
        }
    ...
    */
    public java.lang.Object awaitLoad(androidx.compose.ui.text.font.Font r8, kotlin.coroutines.Continuation<? super android.graphics.Typeface> r9) throws android.content.res.Resources.NotFoundException {
        /*
            r7 = this;
