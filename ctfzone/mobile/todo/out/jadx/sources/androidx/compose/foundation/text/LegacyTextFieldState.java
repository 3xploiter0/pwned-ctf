...
public final class LegacyTextFieldState {
    ...
    private final Function1<TextFieldValue, Unit> onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
        ...
        public final void invoke2(TextFieldValue it) {
            ...
            this.this$0.m1021setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5953getZerod9O1mEE());
            this.this$0.m1018setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5953getZerod9O1mEE());
    ...
    private final Function1<ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
        ...
        public final void m1023invokeKlQnJC8(int imeAction) {
            this.this$0.keyboardActionRunner.m999runActionKlQnJC8(imeAction);
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m4039getUnspecified0d7_KjU();

    /* renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m5936boximpl(TextRange.INSTANCE.m5953getZerod9O1mEE()), null, 2, null);

    /* renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m5936boximpl(TextRange.INSTANCE.m5953getZerod9O1mEE()), null, 2, null);
    ...
    public final void m1021setSelectionPreviewHighlightRange5zctL8(long j) {
        ...
        $this$setValue$iv.setValue(TextRange.m5936boximpl(j));
    }
    ...
    public final boolean hasHighlight() {
        return (TextRange.m5942getCollapsedimpl(m1017getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m5942getCollapsedimpl(m1014getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }
    ...
    public final void m1022updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate newTextDelegate = TextDelegateKt.m1056updateTextDelegaterm0N8CA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (448 & 32) != 0 ? true : softWrap, (448 & 64) != 0 ? TextOverflow.INSTANCE.m6401getClipgIe3tQ8() : 0, (448 & 128) != 0 ? Integer.MAX_VALUE : 0, (448 & 256) != 0 ? 1 : 0, CollectionsKt.emptyList());
