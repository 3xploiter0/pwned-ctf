...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m2197constructorimpl(1);
    private static final int TwoLine = m2197constructorimpl(2);
    private static final int ThreeLine = m2197constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m2195boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2197constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2198equalsimpl(int i, Object obj) {
    ...
    public static String m2201toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m2198equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m2200hashCodeimpl(this.lines);
    }

    public String toString() {
        return m2201toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m2202compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m2196compareToyh95HIg(int arg0, int other) {
        return Intrinsics.compare(arg0, other);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m2202compareToyh95HIg(int other) {
        return m2196compareToyh95HIg(this.lines, other);
    }
