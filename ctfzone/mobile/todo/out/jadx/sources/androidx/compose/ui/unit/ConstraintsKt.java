...
public final class ConstraintsKt {
    ...
    public static final long createConstraints(int minWidth, int maxWidth, int minHeight, int maxHeight) {
        ...
        long value = (minWidth << 2) | focus | (maxWidthValue2 << 33) | (minHeight << minHeightOffset) | (maxHeightValue2 << maxHeightOffset);
        return Constraints.m6427constructorimpl(value);
    }
    ...
    public static final long m6453constrainN9IONVI(long $this$constrain_u2dN9IONVI, long otherConstraints) {
        return Constraints(RangesKt.coerceIn(Constraints.m6440getMinWidthimpl(otherConstraints), Constraints.m6440getMinWidthimpl($this$constrain_u2dN9IONVI), Constraints.m6438getMaxWidthimpl($this$constrain_u2dN9IONVI)), RangesKt.coerceIn(Constraints.m6438getMaxWidthimpl(otherConstraints), Constraints.m6440getMinWidthimpl($this$constrain_u2dN9IONVI), Constraints.m6438getMaxWidthimpl($this$constrain_u2dN9IONVI)), RangesKt.coerceIn(Constraints.m6439getMinHeightimpl(otherConstraints), Constraints.m6439getMinHeightimpl($this$constrain_u2dN9IONVI), Constraints.m6437getMaxHeightimpl($this$constrain_u2dN9IONVI)), RangesKt.coerceIn(Constraints.m6437getMaxHeightimpl(otherConstraints), Constraints.m6439getMinHeightimpl($this$constrain_u2dN9IONVI), Constraints.m6437getMaxHeightimpl($this$constrain_u2dN9IONVI)));
    }

    /* renamed from: constrain-4WqzIAM, reason: not valid java name */
    public static final long m6452constrain4WqzIAM(long $this$constrain_u2d4WqzIAM, long size) {
        return IntSizeKt.IntSize(RangesKt.coerceIn(IntSize.m6655getWidthimpl(size), Constraints.m6440getMinWidthimpl($this$constrain_u2d4WqzIAM), Constraints.m6438getMaxWidthimpl($this$constrain_u2d4WqzIAM)), RangesKt.coerceIn(IntSize.m6654getHeightimpl(size), Constraints.m6439getMinHeightimpl($this$constrain_u2d4WqzIAM), Constraints.m6437getMaxHeightimpl($this$constrain_u2d4WqzIAM)));
    }

    /* renamed from: constrainWidth-K40F9xA, reason: not valid java name */
    public static final int m6455constrainWidthK40F9xA(long $this$constrainWidth_u2dK40F9xA, int width) {
        return RangesKt.coerceIn(width, Constraints.m6440getMinWidthimpl($this$constrainWidth_u2dK40F9xA), Constraints.m6438getMaxWidthimpl($this$constrainWidth_u2dK40F9xA));
    }

    /* renamed from: constrainHeight-K40F9xA, reason: not valid java name */
    public static final int m6454constrainHeightK40F9xA(long $this$constrainHeight_u2dK40F9xA, int height) {
        return RangesKt.coerceIn(height, Constraints.m6439getMinHeightimpl($this$constrainHeight_u2dK40F9xA), Constraints.m6437getMaxHeightimpl($this$constrainHeight_u2dK40F9xA));
    }

    /* renamed from: isSatisfiedBy-4WqzIAM, reason: not valid java name */
    public static final boolean m6456isSatisfiedBy4WqzIAM(long $this$isSatisfiedBy_u2d4WqzIAM, long size) {
        int iM6440getMinWidthimpl = Constraints.m6440getMinWidthimpl($this$isSatisfiedBy_u2d4WqzIAM);
        int iM6438getMaxWidthimpl = Constraints.m6438getMaxWidthimpl($this$isSatisfiedBy_u2d4WqzIAM);
        int iM6655getWidthimpl = IntSize.m6655getWidthimpl(size);
        if (iM6440getMinWidthimpl <= iM6655getWidthimpl && iM6655getWidthimpl <= iM6438getMaxWidthimpl) {
            int iM6439getMinHeightimpl = Constraints.m6439getMinHeightimpl($this$isSatisfiedBy_u2d4WqzIAM);
            int iM6437getMaxHeightimpl = Constraints.m6437getMaxHeightimpl($this$isSatisfiedBy_u2d4WqzIAM);
            int iM6654getHeightimpl = IntSize.m6654getHeightimpl(size);
            if (iM6439getMinHeightimpl <= iM6654getHeightimpl && iM6654getHeightimpl <= iM6437getMaxHeightimpl) {
                return true;
            }
        }
        return false;
    ...
    public static /* synthetic */ long m6458offsetNN6EwU$default(long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        return m6457offsetNN6EwU(j, i, i2);
    }

    /* renamed from: offset-NN6Ew-U, reason: not valid java name */
    public static final long m6457offsetNN6EwU(long $this$offset_u2dNN6Ew_u2dU, int horizontal, int vertical) {
        return Constraints(RangesKt.coerceAtLeast(Constraints.m6440getMinWidthimpl($this$offset_u2dNN6Ew_u2dU) + horizontal, 0), addMaxWithMinimum(Constraints.m6438getMaxWidthimpl($this$offset_u2dNN6Ew_u2dU), horizontal), RangesKt.coerceAtLeast(Constraints.m6439getMinHeightimpl($this$offset_u2dNN6Ew_u2dU) + vertical, 0), addMaxWithMinimum(Constraints.m6437getMaxHeightimpl($this$offset_u2dNN6Ew_u2dU), vertical));
    }
