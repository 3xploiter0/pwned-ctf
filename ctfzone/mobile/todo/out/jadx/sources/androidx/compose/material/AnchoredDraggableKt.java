...
public final class AnchoredDraggableKt {
    ...
    static final class C03811<I> extends ContinuationImpl {
        int label;
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        static final class C00641 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00641(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C00641> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00641(this.$state, this.$velocity, continuation);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$draggable, null, null, new C00641(this.$state, velocity, null), 3, null);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
    ...
    static final class C03832<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        ...
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, T t, Continuation<? super Unit> continuation) {
            C03832 c03832 = new C03832(continuation);
            c03832.L$0 = anchoredDragScope;
            c03832.L$1 = draggableAnchors;
            c03832.L$2 = t;
            return c03832.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object snapTo(AnchoredDraggableState<T> anchoredDraggableState, T t, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C03832(null), continuation, 2, null);
    ...
    */
    public static final <I> java.lang.Object restartable(kotlin.jvm.functions.Function0<? extends I> r4, kotlin.jvm.functions.Function2<? super I, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            boolean r0 = r6 instanceof androidx.compose.material.AnchoredDraggableKt.C03811
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.material.AnchoredDraggableKt$restartable$1 r0 = (androidx.compose.material.AnchoredDraggableKt.C03811) r0
            int r1 = r0.label
        ...
        L25:
            ...
            throw r4
        L2d:
            kotlin.ResultKt.throwOnFailure(r0)     // Catch: androidx.compose.material.AnchoredDragFinishedSignal -> L31
            goto L49
        L31:
            r4 = move-exception
            goto L4a
        L33:
            ...
            r3 = 1
            r6.label = r3     // Catch: androidx.compose.material.AnchoredDragFinishedSignal -> L31
            java.lang.Object r2 = kotlinx.coroutines.CoroutineScopeKt.coroutineScope(r2, r6)     // Catch: androidx.compose.material.AnchoredDragFinishedSignal -> L31
            if (r2 != r1) goto L49
            return r1
        L49:
        L4a:
    ...
    static final class C03822 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03822(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C03822> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03822 c03822 = new C03822(this.$inputs, this.$block, continuation);
            c03822.L$0 = obj;
            return c03822;
        }
            ...
            */
            public final java.lang.Object emit(I r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
                ...
                L2d:
                    ...
                    androidx.compose.material.AnchoredDraggableKt$restartable$2$1 r2 = (androidx.compose.material.AnchoredDraggableKt.C03822.AnonymousClass1) r2
                    kotlin.ResultKt.throwOnFailure(r0)
                    goto L66
                L3c:
                    kotlin.ResultKt.throwOnFailure(r0)
                ...
                L68:
                    ...
                    return r1
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.AnchoredDraggableKt.C03822.AnonymousClass1.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
            ...
            static final class C00652 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00652(Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, I i, CoroutineScope coroutineScope, Continuation<? super C00652> continuation) {
                    super(2, continuation);
                    this.$block = function2;
                    this.$latestInputs = i;
                    this.$$this$coroutineScope = coroutineScope;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00652(this.$block, this.$latestInputs, this.$$this$coroutineScope, continuation);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    CoroutineScopeKt.cancel(c00652.$$this$coroutineScope, new AnchoredDragFinishedSignal());
                    return Unit.INSTANCE;
                }
            }
        }
