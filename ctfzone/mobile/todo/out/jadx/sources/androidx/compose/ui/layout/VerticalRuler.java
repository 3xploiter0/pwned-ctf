...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        long offset = OffsetKt.Offset(coordinate, IntSize.m6654getHeightimpl(sourceCoordinates.mo5347getSizeYbymL2g()) / 2.0f);
        return Offset.m3762getXimpl(targetCoordinates.mo5348localPositionOfR5De75A(sourceCoordinates, offset));
    }
}
