                ...
                if (!Dp.m6490equalsimpl0(this.$animatable.getTargetValue().m6499unboximpl(), this.$target)) {
                    if (!this.$enabled) {
                        ...
                        if (Dp.m6490equalsimpl0(fM6499unboximpl, this.this$0.pressedElevation)) {
                            start = new PressInteraction.Press(Offset.INSTANCE.m3778getZeroF1C5BW0(), null);
                        ...
                        } else if (Dp.m6490equalsimpl0(fM6499unboximpl, this.this$0.draggedElevation)) {
                            start = new DragInteraction.Start();
                        }
                        Interaction interaction = start;
                        this.label = 2;
                        if (ElevationKt.m2089animateElevationrAjV9yQ(this.$animatable, this.$target, interaction, this.$interaction, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
