...
public final class PathParserKt {
    ...
    public static final Path toPath(List<? extends PathNode> list, Path target) {
        ...
        Path path = target;
        int fillType2 = target.mo3894getFillTypeRgk1Os();
        target.rewind();
        path.mo3896setFillTypeoQ8Xj4U(fillType2);
        ...
        while (index$iv2 < size) {
            ...
            if (node2 instanceof PathNode.Close) {
                ...
                path.relativeQuadraticTo(((PathNode.RelativeQuadTo) node2).getDx1(), ((PathNode.RelativeQuadTo) node2).getDy1(), ((PathNode.RelativeQuadTo) node2).getDx2(), ((PathNode.RelativeQuadTo) node2).getDy2());
                ...
                path.quadraticTo(((PathNode.QuadTo) node2).getX1(), ((PathNode.QuadTo) node2).getY1(), ((PathNode.QuadTo) node2).getX2(), ((PathNode.QuadTo) node2).getY2());
                ...
                path.relativeQuadraticTo(reflectiveCtrlX2, reflectiveCtrlY2, ((PathNode.RelativeReflectiveQuadTo) node2).getDx(), ((PathNode.RelativeReflectiveQuadTo) node2).getDy());
                ...
                path.quadraticTo(reflectiveCtrlX, reflectiveCtrlY, ((PathNode.ReflectiveQuadTo) node2).getX(), ((PathNode.ReflectiveQuadTo) node2).getY());
                ...
                if (!(node2 instanceof PathNode.ArcTo)) {
                    ...
                    node = node2;
                    drawArc(target, currentX9, currentY4, ((PathNode.ArcTo) node2).getArcStartX(), ((PathNode.ArcTo) node2).getArcStartY(), ((PathNode.ArcTo) node2).getHorizontalEllipseRadius(), ((PathNode.ArcTo) node2).getVerticalEllipseRadius(), ((PathNode.ArcTo) node2).getTheta(), ((PathNode.ArcTo) node2).isMoreThanHalf(), ((PathNode.ArcTo) node2).isPositiveArc());
