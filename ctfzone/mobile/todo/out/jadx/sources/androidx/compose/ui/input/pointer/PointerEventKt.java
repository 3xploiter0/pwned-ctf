...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        return !Offset.m3759equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m3778getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        return true ^ Offset.m3759equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m3778getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        long offset = Offset.m3766minusMKHz9U(currentPosition, previousPosition);
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m3778getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        if (!Offset.m3759equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m3778getZeroF1C5BW0())) {
    ...
    public static final boolean m5154isOutOfBoundsO0kMr_c(PointerInputChange $this$isOutOfBounds_u2dO0kMr_c, long size) {
    ...
    public static final boolean m5155isOutOfBoundsjwHxaWs(PointerInputChange $this$isOutOfBounds_u2djwHxaWs, long size, long extendedTouchPadding) {
        if (!PointerType.m5282equalsimpl0($this$isOutOfBounds_u2djwHxaWs.getType(), PointerType.INSTANCE.m5289getTouchT8wyACA())) {
            return m5154isOutOfBoundsO0kMr_c($this$isOutOfBounds_u2djwHxaWs, size);
        }
        long position = $this$isOutOfBounds_u2djwHxaWs.getPosition();
        float x = Offset.m3762getXimpl(position);
        float y = Offset.m3763getYimpl(position);
        float minX = -Size.m3831getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m6655getWidthimpl(size) + Size.m3831getWidthimpl(extendedTouchPadding);
        float minY = -Size.m3828getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m6654getHeightimpl(size) + Size.m3828getHeightimpl(extendedTouchPadding);
