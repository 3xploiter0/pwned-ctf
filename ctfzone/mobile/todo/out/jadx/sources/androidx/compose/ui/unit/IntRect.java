...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m6631getSizeYbymL2g$annotations() {
    }
    ...
    public final long m6639getSizeYbymL2g() {
    ...
    public final IntRect m6643translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m6613getXimpl(offset), this.top + IntOffset.m6614getYimpl(offset), this.right + IntOffset.m6613getXimpl(offset), this.bottom + IntOffset.m6614getYimpl(offset));
    }
