...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) throws Throwable {
            ...
            long jMo5348localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5348localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m3778getZeroF1C5BW0());
            float x = Offset.m3762getXimpl(jMo5348localPositionOfR5De75A);
            float y = Offset.m3763getYimpl(jMo5348localPositionOfR5De75A);
            ...
            try {
                ...
                $this$clipPath_KD09W0M_u24lambda_u245$iv.mo4482clipPathmtrdDE(clipPath, clipOp$iv);
                drawScope.getDrawContext().getTransform().translate(x, y);
            } catch (Throwable th) {
                th = th;
            }
    ...
    public void draw(final ContentDrawScope $this$draw) {
        ...
        DrawScope.m4557recordJVtK1S4$default($this$draw, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
