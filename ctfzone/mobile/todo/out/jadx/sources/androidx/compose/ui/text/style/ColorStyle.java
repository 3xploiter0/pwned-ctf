...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m6251copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m6253copy8_81llA(j);
    }
    ...
    public final ColorStyle m6253copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m4004equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m4011toStringimpl(this.value)) + ')';
    }
    ...
    public final long m6254getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* renamed from: getColor-0d7_KjU */
    public long mo6250getColor0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m4005getAlphaimpl(mo6250getColor0d7_KjU());
    }
}
