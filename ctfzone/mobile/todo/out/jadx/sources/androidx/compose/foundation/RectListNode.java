...
public abstract class RectListNode extends Modifier.Node implements GlobalPositionAwareModifierNode {
    ...
    public void onGloballyPositioned(LayoutCoordinates coordinates) {
        ...
        if (getRect() == null) {
            ...
            rectCalcBounds = new Rect(MathKt.roundToInt(boundsInRoot.getLeft()), MathKt.roundToInt(boundsInRoot.getTop()), MathKt.roundToInt(boundsInRoot.getRight()), MathKt.roundToInt(boundsInRoot.getBottom()));
        } else {
    ...
    private final Rect calcBounds(LayoutCoordinates layoutCoordinates, androidx.compose.ui.geometry.Rect rect) {
        ...
        long topLeft = root.mo5348localPositionOfR5De75A(layoutCoordinates, rect.m3797getTopLeftF1C5BW0());
        long topRight = root.mo5348localPositionOfR5De75A(layoutCoordinates, rect.m3798getTopRightF1C5BW0());
        long bottomLeft = root.mo5348localPositionOfR5De75A(layoutCoordinates, rect.m3790getBottomLeftF1C5BW0());
        long bottomRight = root.mo5348localPositionOfR5De75A(layoutCoordinates, rect.m3791getBottomRightF1C5BW0());
        float left = ComparisonsKt.minOf(Offset.m3762getXimpl(topLeft), Offset.m3762getXimpl(topRight), Offset.m3762getXimpl(bottomLeft), Offset.m3762getXimpl(bottomRight));
        float top = ComparisonsKt.minOf(Offset.m3763getYimpl(topLeft), Offset.m3763getYimpl(topRight), Offset.m3763getYimpl(bottomLeft), Offset.m3763getYimpl(bottomRight));
        float right = ComparisonsKt.maxOf(Offset.m3762getXimpl(topLeft), Offset.m3762getXimpl(topRight), Offset.m3762getXimpl(bottomLeft), Offset.m3762getXimpl(bottomRight));
        float bottom = ComparisonsKt.maxOf(Offset.m3763getYimpl(topLeft), Offset.m3763getYimpl(topRight), Offset.m3763getYimpl(bottomLeft), Offset.m3763getYimpl(bottomRight));
