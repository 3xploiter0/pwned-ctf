...
public final /* data */ class RowMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        return RowColumnMeasurePolicyKt.measure$default(this, Constraints.m6440getMinWidthimpl(constraints), Constraints.m6439getMinHeightimpl(constraints), Constraints.m6438getMaxWidthimpl(constraints), Constraints.m6437getMaxHeightimpl(constraints), $this$measure_u2d3p2s80s.mo367roundToPx0680j_4(this.horizontalArrangement.getSpacing()), $this$measure_u2d3p2s80s, list, new Placeable[list.size()], 0, list.size(), null, 0, 3072, null);
    }
        ...
        return MeasureScope.layout$default(measureScope, mainAxisLayoutSize, crossAxisLayoutSize, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowMeasurePolicy$placeHelper$1$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                while (i3 < length) {
                    ...
                    int crossAxisPosition = rowMeasurePolicy.getCrossAxisPosition(placeable, RowColumnImplKt.getRowColumnParentData(placeable), i, i2);
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinWidth(list, height, $this$minIntrinsicWidth.mo367roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinHeight(list, width, $this$minIntrinsicHeight.mo367roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxWidth(list, height, $this$maxIntrinsicWidth.mo367roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxHeight(list, width, $this$maxIntrinsicHeight.mo367roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
}
