...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m3778getZeroF1C5BW0();
    ...
    public long mo345calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long $this$takeOrElse_u2d3MmeM6k$iv = this.positionProvider.mo971provideF1C5BW0();
        if (!OffsetKt.m3781isSpecifiedk4lQ0M($this$takeOrElse_u2d3MmeM6k$iv)) {
            $this$takeOrElse_u2d3MmeM6k$iv = this.prevPosition;
        }
        this.prevPosition = $this$takeOrElse_u2d3MmeM6k$iv;
        long adjustment = this.handleReferencePoint.mo3608alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m6660getZeroYbymL2g(), layoutDirection);
        return IntOffset.m6617plusqkQi6aY(IntOffset.m6617plusqkQi6aY(anchorBounds.m6641getTopLeftnOccac(), IntOffsetKt.m6629roundk4lQ0M($this$takeOrElse_u2d3MmeM6k$iv)), adjustment);
    }
}
