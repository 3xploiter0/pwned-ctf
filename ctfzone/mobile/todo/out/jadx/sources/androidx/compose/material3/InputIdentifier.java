...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m2162constructorimpl(0);
    private static final int StartDateInput = m2162constructorimpl(1);
    private static final int EndDateInput = m2162constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m2161boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2169getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m2170getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m2168getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2166toStringimpl(int arg0) {
        return m2164equalsimpl0(arg0, SingleDateInput) ? "SingleDateInput" : m2164equalsimpl0(arg0, StartDateInput) ? "StartDateInput" : m2164equalsimpl0(arg0, EndDateInput) ? "EndDateInput" : "Unknown";
    }
