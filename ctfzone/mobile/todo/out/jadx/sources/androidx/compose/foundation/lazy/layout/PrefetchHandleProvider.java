...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m866schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final PrefetchRequest m865createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    private final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope $this$execute) {
            ...
            if (!this.isUrgent) {
                if (!this.hasResolvedNestedPrefetches) {
                    if ($this$execute.availableTimeNanos() <= 0) {
                        return true;
                    }
            ...
            if (!hasMoreWork2 && !Constraints.m6442isZeroimpl(this.constraints)) {
                ...
                if (shouldExecute($this$execute, estimatedPremeasureTime)) {
                    ...
                    try {
                        m867performMeasureBRTryo0(this.constraints);
                        Unit unit3 = Unit.INSTANCE;
                        Trace.endSection();
                        long executionTime$iv2 = System.nanoTime() - start$iv$iv$iv2;
                        if (contentType2 != null) {
                            contentType = contentType2;
                            long currentAvgMeasureTimeNanos$iv = this_$iv2.getAverageMeasureTimeNanosByContentType().getOrDefault(contentType, 0L);
        ...
        private final void m867performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                ...
                handle.mo5365premeasure0kLqBqw(placeableIndex, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m6443toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
        ...
        private final class NestedPrefetchController {
            ...
            /* JADX WARN: Removed duplicated region for block: B:21:0x0063 A[Catch: all -> 0x008c, TryCatch #0 {all -> 0x008c, blocks: (B:8:0x001c, B:10:0x0026, B:12:0x002f, B:17:0x003e, B:18:0x0052, B:19:0x005b, B:21:0x0063, B:24:0x0075, B:25:0x007b, B:26:0x0083), top: B:34:0x001c }] */
            /*
            ...
            */
            public final boolean executeNestedPrefetches(androidx.compose.foundation.lazy.layout.PrefetchRequestScope r11) {
                ...
                Lc:
                    ...
                    r3 = 0
                L1c:
                    int r4 = r10.stateIndex     // Catch: java.lang.Throwable -> L8c
                    java.util.List<androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState> r5 = r10.states     // Catch: java.lang.Throwable -> L8c
                    int r5 = r5.size()     // Catch: java.lang.Throwable -> L8c
                    if (r4 >= r5) goto L83
                    java.util.List<androidx.compose.foundation.lazy.layout.PrefetchRequest>[] r4 = r10.requestsByState     // Catch: java.lang.Throwable -> L8c
                    int r5 = r10.stateIndex     // Catch: java.lang.Throwable -> L8c
                    r4 = r4[r5]     // Catch: java.lang.Throwable -> L8c
                    r5 = 1
                    if (r4 != 0) goto L52
                    long r6 = r11.availableTimeNanos()     // Catch: java.lang.Throwable -> L8c
                    r8 = 0
                ...
                L3e:
                    java.util.List<androidx.compose.foundation.lazy.layout.PrefetchRequest>[] r4 = r10.requestsByState     // Catch: java.lang.Throwable -> L8c
                    int r6 = r10.stateIndex     // Catch: java.lang.Throwable -> L8c
                    java.util.List<androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState> r7 = r10.states     // Catch: java.lang.Throwable -> L8c
                    int r8 = r10.stateIndex     // Catch: java.lang.Throwable -> L8c
                    java.lang.Object r7 = r7.get(r8)     // Catch: java.lang.Throwable -> L8c
                    androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState r7 = (androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState) r7     // Catch: java.lang.Throwable -> L8c
                    java.util.List r7 = r7.collectNestedPrefetchRequests$foundation_release()     // Catch: java.lang.Throwable -> L8c
                    r4[r6] = r7     // Catch: java.lang.Throwable -> L8c
                L52:
                    java.util.List<androidx.compose.foundation.lazy.layout.PrefetchRequest>[] r4 = r10.requestsByState     // Catch: java.lang.Throwable -> L8c
                    int r6 = r10.stateIndex     // Catch: java.lang.Throwable -> L8c
                ...
                L5b:
                    int r6 = r10.requestIndex     // Catch: java.lang.Throwable -> L8c
                    int r7 = r4.size()     // Catch: java.lang.Throwable -> L8c
                    if (r6 >= r7) goto L7b
                    int r6 = r10.requestIndex     // Catch: java.lang.Throwable -> L8c
                    java.lang.Object r6 = r4.get(r6)     // Catch: java.lang.Throwable -> L8c
                    androidx.compose.foundation.lazy.layout.PrefetchRequest r6 = (androidx.compose.foundation.lazy.layout.PrefetchRequest) r6     // Catch: java.lang.Throwable -> L8c
                    r7 = 0
                    boolean r8 = r6.execute(r11)     // Catch: java.lang.Throwable -> L8c
                    r6 = r8
                    if (r6 == 0) goto L75
                L74:
                    goto L3a
                L75:
                    int r7 = r10.requestIndex     // Catch: java.lang.Throwable -> L8c
                    int r7 = r7 + r5
                    r10.requestIndex = r7     // Catch: java.lang.Throwable -> L8c
                    goto L5b
                L7b:
                    r10.requestIndex = r2     // Catch: java.lang.Throwable -> L8c
                    int r6 = r10.stateIndex     // Catch: java.lang.Throwable -> L8c
                    int r6 = r6 + r5
                    r10.stateIndex = r6     // Catch: java.lang.Throwable -> L8c
                    goto L1c
                L83:
