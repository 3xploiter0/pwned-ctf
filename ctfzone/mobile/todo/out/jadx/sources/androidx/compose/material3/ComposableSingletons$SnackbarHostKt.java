...
public final class ComposableSingletons$SnackbarHostKt {
    ...
    public static Function3<SnackbarData, Composer, Integer, Unit> f53lambda1 = ComposableLambdaKt.composableLambdaInstance(818736383, false, new Function3<SnackbarData, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$SnackbarHostKt$lambda-1$1
        ...
        public final void invoke(SnackbarData it, Composer $composer, int $changed) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(818736383, $dirty, -1, "androidx.compose.material3.ComposableSingletons$SnackbarHostKt.lambda-1.<anonymous> (SnackbarHost.kt:223)");
            }
            SnackbarKt.m2442SnackbarsDKtq54(it, null, false, null, 0L, 0L, 0L, 0L, 0L, $composer, $dirty & 14, 510);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<SnackbarData, Composer, Integer, Unit> m1983getLambda1$material3_release() {
        return f53lambda1;
    }
}
