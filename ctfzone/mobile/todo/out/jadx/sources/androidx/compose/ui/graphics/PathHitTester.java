...
public final class PathHitTester {
    ...
    public final void updatePath(Path path, float tolerance) {
        ...
        while (iterator.hasNext()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[segment.getType().ordinal()]) {
                ...
                case 2:
                case 3:
                    long jComputeVerticalBounds$default = BezierKt.computeVerticalBounds$default(segment, this.curves, 0, 4, null);
                    int bits$iv$iv = (int) (jComputeVerticalBounds$default >> 32);
                    float min = Float.intBitsToFloat(bits$iv$iv);
                    int bits$iv$iv2 = (int) (jComputeVerticalBounds$default & 4294967295L);
    ...
    public final boolean m4287containsk4lQ0M(long position) {
        if (this.path.isEmpty() || !this.bounds.m3788containsk4lQ0M(position)) {
            return false;
        }
        ...
        boolean isEvenOdd = PathFillType.m4281equalsimpl0(this.path.mo3894getFillTypeRgk1Os(), PathFillType.INSTANCE.m4285getEvenOddRgk1Os());
        if (isEvenOdd) {
            winding &= 1;
        }
        if (winding != 0) {
