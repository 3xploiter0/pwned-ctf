...
public final class FontKt {
    ...
    public static /* synthetic */ Font m6039FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.INSTANCE.m6065getNormal_LCdwA();
        }
        return m6038FontRetOiIg(i, fontWeight, i2);
    }
    ...
    public static final /* synthetic */ Font m6038FontRetOiIg(int resId, FontWeight weight, int style) {
        return new ResourceFont(resId, weight, style, null, FontLoadingStrategy.INSTANCE.m6050getBlockingPKNRLFQ(), 8, null);
    }

    /* renamed from: Font-YpTlLL0$default, reason: not valid java name */
    public static /* synthetic */ Font m6041FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.INSTANCE.m6050getBlockingPKNRLFQ();
        }
        return m6040FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* renamed from: Font-YpTlLL0, reason: not valid java name */
    public static final Font m6040FontYpTlLL0(int resId, FontWeight weight, int style, int loadingStrategy) {
    ...
    public static /* synthetic */ Font m6037FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m6080Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m6036FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    /* renamed from: Font-F3nL8kk, reason: not valid java name */
    public static final Font m6036FontF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
