...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    public /* synthetic */ MagnifierNode(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m6592getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m6505getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m6505getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, (i & 512) != 0 ? PlatformMagnifierFactory.INSTANCE.getForCurrentPlatform() : platformMagnifierFactory, null);
    }
    ...
    public final void m299setSizeEaSLcWc(long j) {
        this.size = j;
    }
    ...
    public final void m297setCornerRadius0680j_4(float f) {
        this.cornerRadius = f;
    }
    ...
    public final void m298setElevation0680j_4(float f) {
        this.elevation = f;
    }
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
    }
    ...
    public final void m300update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        boolean previousClippingEnabled2 = (this.magnifier == null || ((Magnifier_androidKt.equalsIncludingNaN(zoom, previousZoom) || platformMagnifierFactory.getCanUpdateZoom()) && DpSize.m6580equalsimpl0(size, previousSize) && Dp.m6490equalsimpl0(cornerRadius, previousCornerRadius) && Dp.m6490equalsimpl0(elevation, previousElevation) && useTextDefault == previousUseTextDefault && clippingEnabled == previousClippingEnabled && Intrinsics.areEqual(platformMagnifierFactory, previousPlatformMagnifierFactory) && Intrinsics.areEqual(view, previousView) && Intrinsics.areEqual(density, previousDensity))) ? false : true;
    ...
    public void onAttach() {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C02221(null), 3, null);
    }
    ...
    static final class C02221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return MagnifierNode.this.new C02221(continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
                ...
                androidx.compose.foundation.MagnifierNode$onAttach$1$1 r2 = new kotlin.jvm.functions.Function1<java.lang.Long, kotlin.Unit>() { // from class: androidx.compose.foundation.MagnifierNode.onAttach.1.1
                    static {
                        /*
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C02221.C00101.<clinit>():void");
                    }

                    {
                        /*
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C02221.C00101.<init>():void");
                    }
                    ...
                    public /* bridge */ /* synthetic */ kotlin.Unit invoke(java.lang.Long r3) {
                        /*
                            ...
                            return r0
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C02221.C00101.invoke(java.lang.Object):java.lang.Object");
                    }
                    ...
                    public final void invoke(long r1) {
                        /*
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C02221.C00101.invoke(long):void");
                    }
                }
            ...
            L4f:
                ...
                goto L1f
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.MagnifierNode.C02221.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo327createnHHXs2Y(view, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density, this.zoom);
    ...
    */
    public final void updateMagnifier() {
        ...
        Lf:
            ...
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3781isSpecifiedk4lQ0M(r1)
            if (r3 == 0) goto L86
            long r3 = r11.m293getAnchorPositionInRootF1C5BW0()
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3781isSpecifiedk4lQ0M(r3)
            if (r3 == 0) goto L86
            long r3 = r11.m293getAnchorPositionInRootF1C5BW0()
            long r3 = androidx.compose.ui.geometry.Offset.m3767plusMKHz9U(r3, r1)
            ...
            r6 = 0
            boolean r4 = androidx.compose.ui.geometry.OffsetKt.m3781isSpecifiedk4lQ0M(r4)
            if (r4 == 0) goto L54
            goto L55
        L54:
            r3 = 0
        ...
        L58:
            long r3 = r3.getPackedValue()
            r5 = 0
            long r6 = r11.m293getAnchorPositionInRootF1C5BW0()
            long r3 = androidx.compose.ui.geometry.Offset.m3767plusMKHz9U(r6, r3)
            r8 = r3
            goto L6e
        L67:
            androidx.compose.ui.geometry.Offset$Companion r3 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r3 = r3.m3777getUnspecifiedF1C5BW0()
            r8 = r3
        L6e:
        ...
        L76:
            ...
            float r10 = r11.zoom
            r5.mo326updateWko1d7g(r6, r8, r10)
        L82:
    ...
    private final void updateSizeIfNecessary() {
        ...
        if (magnifier != null && (density = this.density) != null && !IntSize.m6652equalsimpl(magnifier.mo325getSizeYbymL2g(), this.previousSize)) {
            Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
            if (function1 != null) {
                function1.invoke(DpSize.m6571boximpl(density.mo371toDpSizekrfVVM(IntSizeKt.m6667toSizeozmzZPI(magnifier.mo325getSizeYbymL2g()))));
            }
            this.previousSize = IntSize.m6647boximpl(magnifier.mo325getSizeYbymL2g());
        }
    }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if (channel != null) {
            ChannelResult.m8469boximpl(channel.mo8459trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        $this$applySemantics.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode.applySemantics.1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m3751boximpl(m302invokeF1C5BW0());
            }
