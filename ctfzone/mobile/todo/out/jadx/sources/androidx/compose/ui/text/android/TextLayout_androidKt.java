...
public final class TextLayout_androidKt {
    ...
    public static final long VerticalPaddings(int topPadding, int bottomPadding) {
        return VerticalPaddings.m5997constructorimpl((topPadding << 32) | (bottomPadding & 4294967295L));
    }
    ...
    public static final long getVerticalPaddings(TextLayout $this$getVerticalPaddings) {
        ...
        if ($this$getVerticalPaddings.getLineCount() == 1) {
            ...
            charSequenceBounds = PaintExtensions_androidKt.getCharSequenceBounds(paint, text, $this$getVerticalPaddings.getLayout().getLineStart(line), $this$getVerticalPaddings.getLayout().getLineEnd(line));
        }
