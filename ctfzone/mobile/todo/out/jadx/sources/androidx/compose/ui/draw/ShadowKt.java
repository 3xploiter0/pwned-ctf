...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m3669shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        if ((i & 4) != 0) {
            int $this$dp$iv = Dp.m6484compareTo0680j_4(f, Dp.m6485constructorimpl(0));
            z = $this$dp$iv > 0;
        }
        return m3668shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m3668shadowziNgDLE(Modifier $this$shadow_u2dziNgDLE, float elevation, Shape shape, boolean clip) {
        return m3666shadows4CzXII($this$shadow_u2dziNgDLE, elevation, shape, clip, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m3666shadows4CzXII(Modifier $this$shadow_u2ds4CzXII, float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
        if (Dp.m6484compareTo0680j_4(elevation, Dp.m6485constructorimpl(0)) > 0 || clip) {
