...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View ownerView, long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m6660getZeroYbymL2g();
        ...
        this.renderNode.setClipToBounds(false);
        m4674applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4639getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m4639getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m3945getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3777getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m4029getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m4029getBlack0d7_KjU();
    ...
    public void mo4669setCompositingStrategyWpw9cng(int value) {
        this.compositingStrategy = value;
        updateLayerProperties();
    }

    /* renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m4674applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode $this$applyCompositingStrategy_Wpw9cng_u24lambda_u241 = this.renderNode;
        if (CompositingStrategy.m4635equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w())) {
        ...
        } else if (CompositingStrategy.m4635equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4640getModulateAlphake2Ky5w())) {
    ...
    public void mo4668setBlendModes9anfk8(int value) {
        if (!BlendMode.m3914equalsimpl0(this.blendMode, value)) {
            this.blendMode = value;
            Paint $this$setBlendMode_s9anfk8_u24lambda_u242 = obtainLayerPaint();
            $this$setBlendMode_s9anfk8_u24lambda_u242.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m3855toPorterDuffModes9anfk8(value)));
            updateLayerProperties();
        }
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m4635equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w()) && BlendMode.m3914equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m3945getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4674applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4641getOffscreenke2Ky5w());
        } else {
            m4674applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo4671setPivotOffsetk4lQ0M(long value) {
        this.pivotOffset = value;
        if (OffsetKt.m3783isUnspecifiedk4lQ0M(value)) {
            this.shouldManuallySetCenterPivot = true;
            this.renderNode.setPivotX(IntSize.m6655getWidthimpl(this.size) / 2.0f);
            this.renderNode.setPivotY(IntSize.m6654getHeightimpl(this.size) / 2.0f);
        } else {
            this.shouldManuallySetCenterPivot = false;
            this.renderNode.setPivotX(Offset.m3762getXimpl(value));
            this.renderNode.setPivotY(Offset.m3763getYimpl(value));
        }
    }
    ...
    public void mo4667setAmbientShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.ambientShadowColor = value;
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m4057toArgb8_81llA(value));
        }
    }
    ...
    public void mo4673setSpotShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.spotShadowColor = value;
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m4057toArgb8_81llA(value));
        }
    }
    ...
    public void mo4672setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setLeftTopRightBottom(x, y, IntSize.m6655getWidthimpl(size) + x, IntSize.m6654getHeightimpl(size) + y);
        if (!IntSize.m6653equalsimpl0(this.size, size)) {
            if (this.shouldManuallySetCenterPivot) {
                this.renderNode.setPivotX(IntSize.m6655getWidthimpl(size) / 2.0f);
                this.renderNode.setPivotY(IntSize.m6654getHeightimpl(size) / 2.0f);
            }
            this.size = size;
        }
    }
    ...
    public void mo4670setOutlineO0kMr_c(Outline outline, long outlineSize) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) throws Throwable {
        Canvas canvasStart = this.renderNode.start(Math.max(IntSize.m6655getWidthimpl(this.size), IntSize.m6655getWidthimpl(this.outlineSize)), Math.max(IntSize.m6654getHeightimpl(this.size), IntSize.m6654getHeightimpl(this.outlineSize)));
        try {
            CanvasHolder this_$iv = this.canvasHolder;
            Canvas previousCanvas$iv = this_$iv.getAndroidCanvas().getInternalCanvas();
            this_$iv.getAndroidCanvas().setInternalCanvas(canvasStart);
            ...
            long size$iv = IntSizeKt.m6667toSizeozmzZPI(this.size);
