    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object objM416awaitTouchSlopOrCancellationjO51t88 = DragGestureDetectorKt.m416awaitTouchSlopOrCancellationjO51t88($this$withTimeoutOrNull, j, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1$firstDragPastSlop$1
                    {
                        super(2);
                    }
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                        m1339invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
                    public final void m1339invokeUv8p0NA(PointerInputChange change, long slop) {
                        change.consume();
                        longRef.element = slop;
                    }
                }, selectionGesturesKt$touchSelectionSubsequentPress$downResolution$1);
                if (objM416awaitTouchSlopOrCancellationjO51t88 != coroutine_suspended) {
                    $result = objM416awaitTouchSlopOrCancellationjO51t88;
                    break;
                } else {
        ...
        if (firstDragPastSlop != null && OffsetKt.m3781isSpecifiedk4lQ0M(selectionGesturesKt$touchSelectionSubsequentPress$downResolution$1.$overSlop.element)) {
