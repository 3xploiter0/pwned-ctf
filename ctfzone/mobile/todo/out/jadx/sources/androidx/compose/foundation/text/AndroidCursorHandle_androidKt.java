...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m6485constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m6485constructorimpl(Dp.m6485constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m967CursorHandleUSBMPiE(final OffsetProvider offsetProvider, final Modifier modifier, long minTouchTargetSize, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) != 0 && !$composer2.getDefaultsInvalid()) {
                ...
                minTouchTargetSize2 = DpSize.INSTANCE.m6592getUnspecifiedMYxV2XQ();
                $dirty &= -897;
            }
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$finalModifier$1$1
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                        $this$semantics.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, offsetProvider.mo971provideF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
                    }
                };
            ...
            AndroidSelectionHandles_androidKt.HandlePopup(offsetProvider, Alignment.INSTANCE.getTopCenter(), ComposableLambdaKt.rememberComposableLambda(-1653527038, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if ($this$isSpecified$iv != InlineClassHelperKt.UnspecifiedPackedFloats) {
                        ...
                        Modifier modifier$iv = SizeKt.m722requiredSizeInqDBjuR0$default(finalModifier, DpSize.m6583getWidthD9Ej5fM(minTouchTargetSize2), DpSize.m6581getHeightD9Ej5fM(minTouchTargetSize2), 0.0f, 0.0f, 12, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            final long j = minTouchTargetSize3;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
                ...
                public final void invoke(Composer composer, int i3) {
                    AndroidCursorHandle_androidKt.m967CursorHandleUSBMPiE(offsetProvider, modifier, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 3) != 2 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m728sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.DefaultCursorHandle.1
                ...
                public final void invoke(Composer composer, int i3) {
                    AndroidCursorHandle_androidKt.DefaultCursorHandle(modifier, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final Modifier drawCursorHandle(Modifier $this$drawCursorHandle) {
        return ComposedModifierKt.composed$default($this$drawCursorHandle, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
                            final float radius = Size.m3831getWidthimpl($this$drawWithCache.m3652getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmap = AndroidSelectionHandles_androidKt.createHandleImage($this$drawWithCache, radius);
                            final ColorFilter colorFilter = ColorFilter.Companion.m4044tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope $this$onDrawWithContent) throws Throwable {
                                    ...
                                    try {
                                        ...
                                        $this$invoke_u24lambda_u240.mo4486rotateUv8p0NA(45.0f, Offset.INSTANCE.m3778getZeroF1C5BW0());
                                        try {
                                            DrawScope.m4543drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                            $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
                                            $this$withTransform_u24lambda_u246$iv.mo4481setSizeuvyYCjk(previousSize$iv2);
                                        } catch (Throwable th) {
                                            th = th;
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                Modifier modifierThen = $this$composed.then(DrawModifierKt.drawWithCache(companion, (Function1) value$iv));
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
