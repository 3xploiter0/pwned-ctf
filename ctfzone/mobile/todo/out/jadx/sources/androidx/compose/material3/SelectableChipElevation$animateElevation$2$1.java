            ...
            case 0:
                ...
                if (!Dp.m6490equalsimpl0(this.$animatable.getTargetValue().m6499unboximpl(), this.$target)) {
                    if (this.$enabled) {
                        ...
                        this.label = 2;
                        if (ElevationKt.m2089animateElevationrAjV9yQ(this.$animatable, this.$target, interactionAnimateElevation$lambda$2, this.$interaction, this) == coroutine_suspended) {
