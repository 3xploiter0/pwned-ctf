    ...
    public static final void populateViewStructure(AndroidAutofill $this$populateViewStructure, ViewStructure root) {
        ...
        while (it2.hasNext()) {
            ...
            if (child == null) {
                ...
                AutofillApi26Helper.INSTANCE.setAutofillType(child, ContentDataType.INSTANCE.m3631getTextA48pgw8());
                ...
                if (boundingBox == null) {
                    ...
                    int iRound = Math.round($this$fastRoundToInt$iv3);
                    float $this$fastRoundToInt$iv4 = boundingBox.getBottom();
                    int width = iRound - left;
                    int height = Math.round($this$fastRoundToInt$iv4) - top;
