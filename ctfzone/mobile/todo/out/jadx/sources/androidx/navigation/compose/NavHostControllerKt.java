...
public final class NavHostControllerKt {
    ...
    public static final NavHostController rememberNavController(Navigator<? extends NavDestination>[] navigatorArr, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new Function0<NavHostController>() { // from class: androidx.navigation.compose.NavHostControllerKt$rememberNavController$1$1
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        Object objM3589rememberSaveable = RememberSaveableKt.m3589rememberSaveable(objArrCopyOf, saverNavControllerSaver, (String) null, (Function0<? extends Object>) value$iv, $composer, 0, 4);
        NavHostController $this$rememberNavController_u24lambda_u241 = (NavHostController) objM3589rememberSaveable;
        for (Navigator<? extends NavDestination> navigator : navigatorArr) {
            $this$rememberNavController_u24lambda_u241.get_navigatorProvider().addNavigator(navigator);
        }
        NavHostController navHostController = (NavHostController) objM3589rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final NavHostController createNavController(Context context) {
        NavHostController $this$createNavController_u24lambda_u242 = new NavHostController(context);
        $this$createNavController_u24lambda_u242.get_navigatorProvider().addNavigator(new ComposeNavGraphNavigator($this$createNavController_u24lambda_u242.get_navigatorProvider()));
        $this$createNavController_u24lambda_u242.get_navigatorProvider().addNavigator(new ComposeNavigator());
        $this$createNavController_u24lambda_u242.get_navigatorProvider().addNavigator(new DialogNavigator());
        return $this$createNavController_u24lambda_u242;
    }
    ...
    private static final Saver<NavHostController, ?> NavControllerSaver(final Context context) {
        return SaverKt.Saver(new Function2<SaverScope, NavHostController, Bundle>() { // from class: androidx.navigation.compose.NavHostControllerKt.NavControllerSaver.1
            ...
            public final NavHostController invoke(Bundle it) {
                NavHostController $this$invoke_u24lambda_u240 = NavHostControllerKt.createNavController(context);
