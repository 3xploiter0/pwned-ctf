...
final class DialogHostKt$PopulateVisibleList$1$1$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope $this$DisposableEffect) {
        ...
        final LifecycleEventObserver observer = new LifecycleEventObserver() { // from class: androidx.navigation.compose.DialogHostKt$PopulateVisibleList$1$1$1$$ExternalSyntheticLambda0
        ...
        this.$entry.getLifecycleRegistry().addObserver(observer);
        ...
        return new DisposableEffectResult() { // from class: androidx.navigation.compose.DialogHostKt$PopulateVisibleList$1$1$1$invoke$$inlined$onDispose$1
            ...
            public void dispose() {
                navBackStackEntry2.getLifecycleRegistry().removeObserver(observer);
            }
        };
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invoke$lambda$0(boolean $isInspecting, List $this_PopulateVisibleList, NavBackStackEntry $entry, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
