...
public final class ComposableSingletons$ComposeNavigatorKt {
    ...
    public static Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> f78lambda1 = ComposableLambdaKt.composableLambdaInstance(127448943, false, new Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit>() { // from class: androidx.navigation.compose.ComposableSingletons$ComposeNavigatorKt$lambda-1$1
        ...
        public final void invoke(AnimatedContentScope $this$$receiver, NavBackStackEntry it, Composer $composer, int $changed) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(127448943, $changed, -1, "androidx.navigation.compose.ComposableSingletons$ComposeNavigatorKt.lambda-1.<anonymous> (ComposeNavigator.kt:59)");
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> m6798getLambda1$navigation_compose_release() {
        return f78lambda1;
    }
}
