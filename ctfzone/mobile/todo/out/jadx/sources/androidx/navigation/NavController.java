...
public class NavController {
    ...
    */
    ...
    public void navigate(NavDeepLinkRequest request, NavOptions navOptions, Navigator.Extras navigatorExtras) throws Resources.NotFoundException {
        ...
        if (deepLinkMatch != null) {
            ...
            Intent $this$navigate_u24lambda_u2438 = new Intent();
            ...
            args.putParcelable(KEY_DEEP_LINK_INTENT, $this$navigate_u24lambda_u2438);
    ...
    */
    ...
    public final <T> void navigate(T route, NavOptions navOptions, Navigator.Extras navigatorExtras) throws Resources.NotFoundException {
        ...
        String finalRoute = generateRouteFilled(route);
        NavDeepLinkRequest.Builder.Companion companion = NavDeepLinkRequest.Builder.INSTANCE;
        String $this$toUri$iv = NavDestination.INSTANCE.createRoute(finalRoute);
        Uri uri = Uri.parse($this$toUri$iv);
        Intrinsics.checkExpressionValueIsNotNull(uri, "Uri.parse(this)");
        navigate(companion.fromUri(uri).build(), navOptions, navigatorExtras);
    }
        ...
        if (backStackStateIds != null) {
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                if (backStackState == null) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(id, "id");
                    ArrayDeque $this$restoreState_u24lambda_u2459_u24lambda_u2458 = new ArrayDeque(backStackState.length);
                    Iterator it = ArrayIteratorKt.iterator(backStackState);
                    while (it.hasNext()) {
                        int[] backStackDestIds3 = backStackDestIds2;
                        Parcelable parcelable = (Parcelable) it.next();
                        Intrinsics.checkNotNull(parcelable, "null cannot be cast to non-null type androidx.navigation.NavBackStackEntryState");
                        $this$restoreState_u24lambda_u2459_u24lambda_u2458.add((NavBackStackEntryState) parcelable);
                        backStackIds2 = backStackIds2;
                        backStackDestIds2 = backStackDestIds3;
                    }
                    backStackDestIds = backStackDestIds2;
                    backStackIds = backStackIds2;
                    map.put(id, $this$restoreState_u24lambda_u2459_u24lambda_u2458);
                }
    ...
    public void setOnBackPressedDispatcher(OnBackPressedDispatcher dispatcher) {
        ...
        Lifecycle $this$setOnBackPressedDispatcher_u24lambda_u2461 = lifecycleOwner.getLifecycleRegistry();
        $this$setOnBackPressedDispatcher_u24lambda_u2461.removeObserver(this.lifecycleObserver);
        $this$setOnBackPressedDispatcher_u24lambda_u2461.addObserver(this.lifecycleObserver);
    }
