...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    private final void navigate(NavBackStackEntry entry, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (startRoute != null && !Intrinsics.areEqual(startRoute, startDestination.getRoute())) {
            NavDestination.DeepLinkMatch deepLinkMatchMatchDeepLink = startDestination.matchDeepLink(startRoute);
            Bundle matchingArgs = deepLinkMatchMatchDeepLink != null ? deepLinkMatchMatchDeepLink.getMatchingArgs() : null;
        ...
        NavBackStackEntry startDestinationEntry = getState().createBackStackEntry(startDestination, startDestination.addInDefaultArgs(arguments));
