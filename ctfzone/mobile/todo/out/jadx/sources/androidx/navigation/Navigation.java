...
public final class Navigation {
    ...
    public static final void createNavigateOnClickListener$lambda$0(int $resId, Bundle $args, View view) throws Resources.NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void createNavigateOnClickListener$lambda$1(NavDirections directions, View view) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter(directions, "$directions");
        Intrinsics.checkNotNullExpressionValue(view, "view");
