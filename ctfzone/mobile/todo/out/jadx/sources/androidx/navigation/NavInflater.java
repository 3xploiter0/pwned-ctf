            ...
            if (navTypeInferFromValue == NavType.ReferenceType) {
                ...
                switch (typedValue.type) {
                    case 3:
                        ...
                        break;
                    case 4:
                        navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeInferFromValue, NavType.FloatType, string, "float");
                        value = Float.valueOf(typedValue.getFloat());
                        break;
                    case 5:
                        navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeInferFromValue, NavType.IntType, string, "dimension");
                        value = Integer.valueOf((int) typedValue.getDimension(res.getDisplayMetrics()));
                        break;
                    case 18:
                        navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeInferFromValue, NavType.BoolType, string, "boolean");
                    ...
                    default:
                        if (typedValue.type >= 16 && typedValue.type <= 31) {
                            if (navTypeInferFromValue == NavType.FloatType) {
                                ...
                                navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navTypeInferFromValue, NavType.IntType, string, "integer");
