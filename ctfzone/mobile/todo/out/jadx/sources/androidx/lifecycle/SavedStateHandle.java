...
public final class SavedStateHandle {
    ...
    private final <T> MutableLiveData<T> getLiveDataInternal(String key, boolean hasInitialValue, T initialValue) {
        ...
        SavingStateLiveData<?> savingStateLiveData3 = $this$getOrPut$iv.get(key);
        if (savingStateLiveData3 == null) {
            if (this.impl.getRegular().containsKey(key)) {
                savingStateLiveData2 = new SavingStateLiveData(this, key, this.impl.getRegular().get(key));
    ...
    public static final class Companion {
        ...
        public final SavedStateHandle createHandle(Bundle restoredState, Bundle defaultState) {
            ...
            Bundle $this$createHandle_u24lambda_u240 = SavedStateReader.m6813constructorimpl($this$read$iv);
            return new SavedStateHandle(SavedStateReader.m6894toMapimpl($this$createHandle_u24lambda_u240));
        }
