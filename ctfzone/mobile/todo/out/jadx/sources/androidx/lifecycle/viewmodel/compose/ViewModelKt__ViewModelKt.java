...
final /* synthetic */ class ViewModelKt__ViewModelKt {
    ...
    /* JADX WARN: Type inference failed for: r15v14, types: [androidx.lifecycle.viewmodel.CreationExtras] */
    public static final /* synthetic */ <VM extends ViewModel> VM viewModel(ViewModelStoreOwner viewModelStoreOwner, String str, Function1<? super CreationExtras, ? extends VM> function1, Composer composer, int i, int i2) {
        ...
        VM vm = (VM) ViewModelKt.viewModel(orCreateKotlinClass, viewModelStoreOwner, str, factoryBuild, defaultViewModelCreationExtras, composer, ((i << 3) & 112) | ((i << 3) & 896), 0);
        ComposerKt.sourceInformationMarkerEnd(composer);
        return vm;
    }
