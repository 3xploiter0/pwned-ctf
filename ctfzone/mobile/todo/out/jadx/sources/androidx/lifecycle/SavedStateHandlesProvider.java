...
public final class SavedStateHandlesProvider implements SavedStateRegistry.SavedStateProvider {
    ...
    public Bundle saveState() {
        ...
        Bundle $this$saveState_u24lambda_u244 = SavedStateWriter.m6899constructorimpl($this$savedState_u24lambda_u241$iv);
        Bundle it = this.restoredState;
        if (it != null) {
            SavedStateWriter.m6903putAllimpl($this$saveState_u24lambda_u244, it);
        }
        ...
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            ...
            Bundle $this$saveState_u24lambda_u244_u24lambda_u243_u24lambda_u242 = SavedStateReader.m6813constructorimpl(savedState);
            if (!SavedStateReader.m6891isEmptyimpl($this$saveState_u24lambda_u244_u24lambda_u243_u24lambda_u242)) {
                SavedStateWriter.m6926putSavedStateimpl($this$saveState_u24lambda_u244, key, savedState);
            }
    ...
    public final void performRestore() {
        ...
        if (!this.restored) {
            ...
            Bundle $this$savedState_u24lambda_u241$iv = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairs$iv, pairs$iv.length));
            Bundle $this$performRestore_u24lambda_u247 = SavedStateWriter.m6899constructorimpl($this$savedState_u24lambda_u241$iv);
            Bundle it = this.restoredState;
            if (it != null) {
                SavedStateWriter.m6903putAllimpl($this$performRestore_u24lambda_u247, it);
            }
            if (newState != null) {
                SavedStateWriter.m6903putAllimpl($this$performRestore_u24lambda_u247, newState);
            }
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        Bundle $this$consumeRestoredStateForKey_u24lambda_u248 = SavedStateReader.m6813constructorimpl(state);
        if (!SavedStateReader.m6814containsimpl($this$consumeRestoredStateForKey_u24lambda_u248, key)) {
            return null;
        }
        Bundle $this$consumeRestoredStateForKey_u24lambda_u249 = SavedStateReader.m6813constructorimpl(state);
        Bundle bundleM6875getSavedStateOrNullimpl = SavedStateReader.m6875getSavedStateOrNullimpl($this$consumeRestoredStateForKey_u24lambda_u249, key);
        if (bundleM6875getSavedStateOrNullimpl == null) {
            Map initialState$iv = MapsKt.emptyMap();
            if (initialState$iv.isEmpty()) {
                pairArr = new Pair[0];
            } else {
            ...
            bundleM6875getSavedStateOrNullimpl = $this$savedState_u24lambda_u241$iv;
        }
        Bundle result = bundleM6875getSavedStateOrNullimpl;
        Bundle $this$consumeRestoredStateForKey_u24lambda_u2410 = SavedStateWriter.m6899constructorimpl(state);
        SavedStateWriter.m6935removeimpl($this$consumeRestoredStateForKey_u24lambda_u2410, key);
        Bundle $this$consumeRestoredStateForKey_u24lambda_u2411 = SavedStateReader.m6813constructorimpl(state);
        if (SavedStateReader.m6891isEmptyimpl($this$consumeRestoredStateForKey_u24lambda_u2411)) {
