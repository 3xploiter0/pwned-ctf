...
public final class MutableLongSet extends LongSet {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x00bd, code lost:
        ...
        if (((r23.metadata[r7 >> 3] >> ((r7 & 7) << 3)) & 255) != 254) goto L20;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00e9, code lost:
        ...
        if (((r23.metadata[r7 >> 3] >> ((r7 & 7) << 3)) & 255) != 128) goto L26;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00ed, code lost:
        ...
        r23.growthLimit = r8 - r19;
        r8 = r23.metadata;
        r11 = r23._capacity;
        r12 = r3;
        r16 = r7 >> 3;
        r17 = (r7 & 7) << 3;
        r8[r16] = (r8[r16] & (~(255 << r17))) | (r12 << r17);
        r9 = ((r7 - 7) & r11) + (r11 & 7);
        r8[r9 >> 3] = r8[r7 >> 3];
     */
            ...
            if (m == 128) {
                ...
                if (newProbeIndex != oldProbeIndex) {
                    if (((metadata[targetIndex >> 3] >> ((targetIndex & 7) << 3)) & 255) == 128) {
                        ...
                        long value$iv = elements[index];
                        elements[targetIndex] = value$iv;
                        elements[index] = 0;
                        swapIndex = index;
                    } else {
                        ...
                        metadata[i$iv3] = (metadata[i$iv3] & (~(255 << b$iv3))) | (value$iv2 << b$iv3);
                        if (swapIndex == -1) {
                    ...
                    int i$iv4 = index >> 3;
                    int b$iv4 = (index & 7) << 3;
                    metadata[i$iv4] = (metadata[i$iv4] & (~(255 << b$iv4))) | (m2 << b$iv4);
                    metadata[ArraysKt.getLastIndex(metadata)] = (metadata[0] & 72057594037927935L) | Long.MIN_VALUE;
                    index++;
                }
            }
