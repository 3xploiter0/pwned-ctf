...
public abstract class LongFloatMap {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (value$iv$iv < 128) {
                        ...
                        block.invoke(Long.valueOf(k[index$iv]), Float.valueOf(v[index$iv]));
                    }
                    slot$iv >>= 8;
                    j$iv++;
                    i = 8;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return longFloatMap.joinToString(charSequence, (i2 & 2) != 0 ? "" : charSequence2, (i2 & 4) != 0 ? "" : charSequence3, (i2 & 8) != 0 ? -1 : i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super Long, ? super Float, ? extends CharSequence> transform) {
        ...
        long[] k$iv = this_$iv.keys;
        float[] v$iv = this_$iv.values;
        LongFloatMap this_$iv$iv = this_$iv;
        int $i$f$forEachIndexed = 0;
        ...
        if (0 <= lastIndex$iv$iv) {
            loop0: while (true) {
                ...
                LongFloatMap this_$iv2 = this_$iv;
                LongFloatMap this_$iv$iv2 = this_$iv$iv;
                int $i$f$forEachIndexed2 = $i$f$forEachIndexed;
                long $this$maskEmptyOrDeleted$iv$iv$iv = ((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L);
                if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                    int i = 8;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if ($i$f$isFull == 0) {
                        ...
                        long key = k$iv[index$iv$iv];
                        float value = v$iv[index$iv$iv];
                        if (!(value == ((LongFloatMap) other).get(key))) {
                            return false;
                        }
                    }
                    i = 8;
