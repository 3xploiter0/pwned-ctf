...
public abstract class ObjectFloatMap<K> {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (value$iv$iv < 128) {
                        ...
                        block.invoke(k[index$iv], Float.valueOf(v[index$iv]));
                    }
                    slot$iv >>= 8;
                    j$iv++;
                    i = 8;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return objectFloatMap.joinToString(charSequence, (i2 & 2) != 0 ? "" : charSequence2, (i2 & 4) != 0 ? "" : charSequence3, (i2 & 8) != 0 ? -1 : i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv; j$iv$iv++) {
                    ...
                    if ($i$f$isFull != 0) {
                        ...
                        Object key = k$iv[index$iv$iv];
                        float value = v$iv[index$iv$iv];
                        if (!(value == objectFloatMap.get(key))) {
                            return false;
                        }
                    }
                    i = 8;
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        int index$iv = 0;
        ObjectFloatMap this_$iv$iv = this;
        int $i$f$forEach = 0;
