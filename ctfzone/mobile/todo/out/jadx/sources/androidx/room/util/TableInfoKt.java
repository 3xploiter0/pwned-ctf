...
public final class TableInfoKt {
    ...
    private static final Map<String, TableInfo.Column> readColumns(SupportSQLiteDatabase database, String tableName) throws IOException {
        Throwable th;
        String str = ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY;
        ...
        try {
            ...
            if (cursor2.getColumnCount() <= 0) {
                ...
                int typeIndex = cursor2.getColumnIndex(ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
    ...
    private static final Set<TableInfo.Index> readIndices(SupportSQLiteDatabase database, String tableName) throws IOException {
        ...
        try {
            Cursor cursor2 = cursor;
            int nameColumnIndex = cursor2.getColumnIndex(HintConstants.AUTOFILL_HINT_NAME);
