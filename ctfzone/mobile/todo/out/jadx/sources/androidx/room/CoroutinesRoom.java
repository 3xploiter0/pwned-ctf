...
public final class CoroutinesRoom {
    ...
    public static final class Companion {
        ...
        public final <R> Object execute(RoomDatabase db, boolean inTransaction, final CancellationSignal cancellationSignal, Callable<R> callable, Continuation<? super R> continuation) {
            ...
            final Job job = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, context, null, new CoroutinesRoom$Companion$execute$4$job$1(callable, continuation2, null), 2, null);
