...
public final class ActivityResultRegistryKt {
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> activityResultContract, Function1<? super O, Unit> function1, Composer $composer, int $changed) {
        ...
        String key = (String) RememberSaveableKt.m3589rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<String>() { // from class: androidx.activity.compose.ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1
        ...
        boolean invalid$iv = $composer.changedInstance(realLauncher) | $composer.changedInstance(activityResultRegistry) | $composer.changed(key) | $composer.changedInstance(activityResultContract) | $composer.changed(currentOnResult);
