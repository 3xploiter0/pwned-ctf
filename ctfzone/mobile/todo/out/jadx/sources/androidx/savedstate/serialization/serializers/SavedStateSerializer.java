...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public void serialize(Encoder encoder, Bundle value) {
        ...
        if (Intrinsics.areEqual($this$serialize_u24lambda_u243.getKey(), "")) {
            ...
            Bundle $this$serialize_u24lambda_u243_u24lambda_u241 = SavedStateWriter.m6899constructorimpl($this$write$iv);
            SavedStateWriter.m6903putAllimpl($this$serialize_u24lambda_u243_u24lambda_u241, value);
        } else {
            Bundle $this$write$iv2 = $this$serialize_u24lambda_u243.getSavedState();
            Bundle $this$serialize_u24lambda_u243_u24lambda_u242 = SavedStateWriter.m6899constructorimpl($this$write$iv2);
            SavedStateWriter.m6926putSavedStateimpl($this$serialize_u24lambda_u243_u24lambda_u242, $this$serialize_u24lambda_u243.getKey(), value);
        }
    }
    ...
    public Bundle deserialize(Decoder decoder) {
        ...
        Bundle $this$deserialize_u24lambda_u246_u24lambda_u245 = SavedStateReader.m6813constructorimpl($this$read$iv);
        return SavedStateReader.m6870getSavedStateimpl($this$deserialize_u24lambda_u246_u24lambda_u245, $this$deserialize_u24lambda_u246.getKey());
    }
}
