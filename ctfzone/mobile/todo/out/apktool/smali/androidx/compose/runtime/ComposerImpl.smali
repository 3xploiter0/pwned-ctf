...
.method private final insertMovableContentGuarded(Ljava/util/List;)V
    ...
    invoke-direct {v1, v0, v2, v7}, Landroidx/compose/runtime/internal/IntRef;-><init>(IILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-virtual {v1, v2, v4}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->determineMovableContentNodeIndex(Landroidx/compose/runtime/internal/IntRef;Landroidx/compose/runtime/Anchor;)V
    :try_end_1
    ...
    invoke-virtual {v1, v3}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->moveReaderToAbsolute(I)V
    ...
    .line 3354
    .local v1, "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    ...
    invoke-direct {v2, v9, v1, v0, v6}, Landroidx/compose/runtime/ComposerImpl$insertMovableContentGuarded$1$1$1$1;-><init>(Landroidx/compose/runtime/ComposerImpl;Landroidx/compose/runtime/changelist/ChangeList;Landroidx/compose/runtime/SlotReader;Landroidx/compose/runtime/MovableContentStateReference;)V
    ...
    .end local v1    # "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    .local v32, "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    move-object/from16 v1, p0
    ...
    .end local v32    # "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    ...
    .line 3395
    invoke-direct {v9, v0}, Landroidx/compose/runtime/ComposerImpl;->updatedNodeCount(I)I
    ...
    .line 3393
    invoke-direct {v9, v0, v7}, Landroidx/compose/runtime/ComposerImpl;->updateNodeCount(II)V
    :try_end_d
    ...
    .end local v34    # "anchor":Landroidx/compose/runtime/Anchor;
    .restart local v1    # "anchor":Landroidx/compose/runtime/Anchor;
    goto :goto_2
    ...
    .line 3403
    iget-object v7, v9, Landroidx/compose/runtime/ComposerImpl;->parentContext:Landroidx/compose/runtime/CompositionContext;
    :try_end_e
    ...
    .end local v29    # "to":Landroidx/compose/runtime/MovableContentStateReference;
    .local v11, "to":Landroidx/compose/runtime/MovableContentStateReference;
    .local v21, "newChangeList$iv":Landroidx/compose/runtime/changelist/ChangeList;
    :try_start_f
    invoke-virtual {v0, v5, v7, v6, v11}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->copySlotTableToAnchorLocation(Landroidx/compose/runtime/MovableContentState;Landroidx/compose/runtime/CompositionContext;Landroidx/compose/runtime/MovableContentStateReference;Landroidx/compose/runtime/MovableContentStateReference;)V
    ...
    .local v28, "reader":Landroidx/compose/runtime/SlotReader;
    const/16 v29, 0x0
    ...
    .local v30, "this_$iv":Landroidx/compose/runtime/ComposerImpl;
    const/16 v31, 0x0

    .line 4760
    .local v31, "$i$f$withReader":I
    :try_start_10
    invoke-virtual/range {v30 .. v30}, Landroidx/compose/runtime/ComposerImpl;->getReader$runtime_release()Landroidx/compose/runtime/SlotReader;
    ...
    invoke-static/range {v30 .. v30}, Landroidx/compose/runtime/ComposerImpl;->access$getNodeCountOverrides$p(Landroidx/compose/runtime/ComposerImpl;)[I
    ...
    invoke-static/range {v30 .. v30}, Landroidx/compose/runtime/ComposerImpl;->access$getProviderUpdates$p(Landroidx/compose/runtime/ComposerImpl;)Landroidx/compose/runtime/collection/IntMap;
    ...
    .end local v30    # "this_$iv":Landroidx/compose/runtime/ComposerImpl;
    .local v7, "this_$iv":Landroidx/compose/runtime/ComposerImpl;
    .local v35, "this_$iv":Landroidx/compose/runtime/SlotTable;
    :try_start_11
    invoke-static {v7, v0}, Landroidx/compose/runtime/ComposerImpl;->access$setNodeCountOverrides$p(Landroidx/compose/runtime/ComposerImpl;[I)V

    .line 4764
    invoke-static {v7, v0}, Landroidx/compose/runtime/ComposerImpl;->access$setProviderUpdates$p(Landroidx/compose/runtime/ComposerImpl;Landroidx/compose/runtime/collection/IntMap;)V
    :try_end_11
    ...
    .end local v28    # "reader":Landroidx/compose/runtime/SlotReader;
    .local v12, "reader":Landroidx/compose/runtime/SlotReader;
    .local v23, "$i$f$withChangeList":I
    :try_start_12
    invoke-virtual {v7, v12}, Landroidx/compose/runtime/ComposerImpl;->setReader$runtime_release(Landroidx/compose/runtime/SlotReader;)V

    .line 4767
    const/16 v28, 0x0

    .line 3410
    .local v28, "$i$a$-withReader-ComposerImpl$insertMovableContentGuarded$1$1$2$1":I
    ...
    .line 3411
    .local v30, "newLocation":I
    move/from16 v36, v14

    move/from16 v14, v30

    .end local v30    # "newLocation":I
    .local v14, "newLocation":I
    .local v36, "$i$a$-withChangeList-ComposerImpl$insertMovableContentGuarded$1":I
    :try_start_13
    ...
    invoke-virtual {v0, v14}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->moveReaderToAbsolute(I)V
    ...
    .line 3414
    .local v30, "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    iget-object v0, v9, Landroidx/compose/runtime/ComposerImpl;->changeListWriter:Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    ...
    .local v14, "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    ...
    :try_start_14
    invoke-virtual {v15, v14}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->setChangeList(Landroidx/compose/runtime/changelist/ChangeList;)V
    ...
    .local v44, "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    :try_start_15
    ...
    invoke-direct {v0, v9, v11}, Landroidx/compose/runtime/ComposerImpl$insertMovableContentGuarded$1$1$2$1$1$1$1;-><init>(Landroidx/compose/runtime/ComposerImpl;Landroidx/compose/runtime/MovableContentStateReference;)V
    ...
    .local v20, "fromAnchor":Landroidx/compose/runtime/Anchor;
    ...
    :try_start_17
    invoke-virtual {v10, v1}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->setImplicitRootStart(Z)V
    :try_end_17
    ...
    :try_start_18
    invoke-virtual {v15, v2}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->setChangeList(Landroidx/compose/runtime/changelist/ChangeList;)V
    ...
    .line 3431
    invoke-virtual {v0, v14, v8}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->includeOperationsIn(Landroidx/compose/runtime/changelist/ChangeList;Landroidx/compose/runtime/internal/IntRef;)V

    .line 3435
    nop

    .end local v14    # "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    .end local v28    # "$i$a$-withReader-ComposerImpl$insertMovableContentGuarded$1$1$2$1":I
    ...
    :try_start_19
    invoke-virtual {v7, v3}, Landroidx/compose/runtime/ComposerImpl;->setReader$runtime_release(Landroidx/compose/runtime/SlotReader;)V
    ...
    invoke-static {v7, v4}, Landroidx/compose/runtime/ComposerImpl;->access$setNodeCountOverrides$p(Landroidx/compose/runtime/ComposerImpl;[I)V
    ...
    invoke-static {v7, v5}, Landroidx/compose/runtime/ComposerImpl;->access$setProviderUpdates$p(Landroidx/compose/runtime/ComposerImpl;Landroidx/compose/runtime/collection/IntMap;)V
    ...
    .end local v7    # "this_$iv":Landroidx/compose/runtime/ComposerImpl;
    .end local v31    # "$i$f$withReader":I
    nop
    ...
    .line 3438
    .end local v20    # "fromAnchor":Landroidx/compose/runtime/Anchor;
    .end local v22    # "$i$f$read":I
    .end local v35    # "this_$iv":Landroidx/compose/runtime/SlotTable;
    ...
    .line 4747
    .end local v8    # "effectiveNodeIndex":Landroidx/compose/runtime/internal/IntRef;
    .end local v11    # "to":Landroidx/compose/runtime/MovableContentStateReference;
    .end local v18    # "$i$a$-fastForEach-ComposerImpl$insertMovableContentGuarded$1$1":I
    .end local v25    # "location":I
    ...
    .local v7, "this_$iv":Landroidx/compose/runtime/ComposerImpl;
    .restart local v8    # "effectiveNodeIndex":Landroidx/compose/runtime/internal/IntRef;
    .restart local v11    # "to":Landroidx/compose/runtime/MovableContentStateReference;
    .restart local v12    # "reader":Landroidx/compose/runtime/SlotReader;
    .restart local v17    # "item$iv":Ljava/lang/Object;
    .restart local v18    # "$i$a$-fastForEach-ComposerImpl$insertMovableContentGuarded$1$1":I
    .restart local v19    # "index$iv":I
    .restart local v20    # "fromAnchor":Landroidx/compose/runtime/Anchor;
    ...
    .restart local v31    # "$i$f$withReader":I
    ...
    .restart local v35    # "this_$iv":Landroidx/compose/runtime/SlotTable;
    ...
    .end local v4    # "savedCountOverrides$iv":[I
    .end local v5    # "savedProviderUpdates$iv":Landroidx/compose/runtime/collection/IntMap;
    .restart local v14    # "offsetChanges":Landroidx/compose/runtime/changelist/ChangeList;
    .restart local v15    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    .restart local v28    # "$i$a$-withReader-ComposerImpl$insertMovableContentGuarded$1$1$2$1":I
    .restart local v32    # "savedReader$iv":Landroidx/compose/runtime/SlotReader;
    .restart local v33    # "savedCountOverrides$iv":[I
    .restart local v34    # "savedProviderUpdates$iv":Landroidx/compose/runtime/collection/IntMap;
    ...
    .end local v19    # "index$iv":I
    .end local v20    # "fromAnchor":Landroidx/compose/runtime/Anchor;
    .end local v21    # "newChangeList$iv":Landroidx/compose/runtime/changelist/ChangeList;
    .end local v22    # "$i$f$read":I
    .end local v23    # "$i$f$withChangeList":I
    .end local v24    # "reader$iv":Landroidx/compose/runtime/SlotReader;
    .end local v25    # "location":I
    .end local v26    # "$i$a$-let-SlotTable$read$1$iv":I
    .end local v28    # "$i$a$-withReader-ComposerImpl$insertMovableContentGuarded$1$1$2$1":I
    ...
    .end local v31    # "$i$f$withReader":I
    .end local v35    # "this_$iv":Landroidx/compose/runtime/SlotTable;
    .end local v36    # "$i$a$-withChangeList-ComposerImpl$insertMovableContentGuarded$1":I
    .end local v38    # "$i$f$withChangeList":I
    .end local v40    # "newLocation":I
    .end local v41    # "fromTable":Landroidx/compose/runtime/SlotTable;
    .end local v44    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    .end local v45    # "resolvedState":Landroidx/compose/runtime/MovableContentState;
    .end local v46    # "from":Landroidx/compose/runtime/MovableContentStateReference;
    .end local v48    # "anchor":Landroidx/compose/runtime/Anchor;
    .end local v49    # "nodesToInsert":Ljava/util/List;
    ...
    .restart local v19    # "index$iv":I
    .restart local v20    # "fromAnchor":Landroidx/compose/runtime/Anchor;
    .restart local v21    # "newChangeList$iv":Landroidx/compose/runtime/changelist/ChangeList;
    .restart local v22    # "$i$f$read":I
    .restart local v23    # "$i$f$withChangeList":I
    .restart local v24    # "reader$iv":Landroidx/compose/runtime/SlotReader;
    .restart local v25    # "location":I
    .restart local v26    # "$i$a$-let-SlotTable$read$1$iv":I
    .restart local v28    # "$i$a$-withReader-ComposerImpl$insertMovableContentGuarded$1$1$2$1":I
    ...
    .restart local v31    # "$i$f$withReader":I
    .restart local v35    # "this_$iv":Landroidx/compose/runtime/SlotTable;
    .restart local v36    # "$i$a$-withChangeList-ComposerImpl$insertMovableContentGuarded$1":I
    .restart local v38    # "$i$f$withChangeList":I
    .restart local v40    # "newLocation":I
    .restart local v41    # "fromTable":Landroidx/compose/runtime/SlotTable;
    .restart local v44    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    .restart local v45    # "resolvedState":Landroidx/compose/runtime/MovableContentState;
    .restart local v46    # "from":Landroidx/compose/runtime/MovableContentStateReference;
    .restart local v48    # "anchor":Landroidx/compose/runtime/Anchor;
    .restart local v49    # "nodesToInsert":Ljava/util/List;
    ...
    .end local v44    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    .local v1, "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    invoke-virtual {v1, v13}, Landroidx/compose/runtime/changelist/ComposerChangeListWriter;->setChangeList(Landroidx/compose/runtime/changelist/ChangeList;)V
    ...
    .line 3443
    .end local v1    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    .end local v13    # "previousChangeList$iv":Landroidx/compose/runtime/changelist/ChangeList;
    .end local v21    # "newChangeList$iv":Landroidx/compose/runtime/changelist/ChangeList;
    .end local v23    # "$i$f$withChangeList":I
    return-void
    ...
    .end local v44    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    .restart local v1    # "this_$iv":Landroidx/compose/runtime/changelist/ComposerChangeListWriter;
    goto :goto_8
