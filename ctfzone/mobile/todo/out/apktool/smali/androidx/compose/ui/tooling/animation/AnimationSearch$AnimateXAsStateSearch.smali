...
.method private final findAnimatable(Landroidx/compose/ui/tooling/data/CallGroup;)Landroidx/compose/animation/core/Animatable;
    ...
    .line 573
    .local v2, "thisData$iv":Ljava/lang/Object;
    if-eqz v2, :cond_3
    ...
    .line 573
    .local v4, "$i$a$-let-AnimationSearch_androidKt$findRememberedData$2$iv":I
    invoke-static {v3}, Lkotlin/collections/CollectionsKt;->listOf(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v3

    .end local v3    # "it$iv":Ljava/lang/Object;
    .end local v4    # "$i$a$-let-AnimationSearch_androidKt$findRememberedData$2$iv":I
    if-nez v3, :cond_4
    ...
    .local v4, "$this$findRememberedData$iv$iv":Ljava/util/Collection;
    const/4 v5, 0x0

    .line 575
    .local v5, "$i$f$findRememberedData":I
    move-object v7, v4
    ...
    .line 584
    .local v6, "$i$a$-let-CollectionsKt___CollectionsKt$mapNotNullTo$1$1$iv$iv$iv$iv":I
    invoke-interface {v9, v0}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 585
    .end local v0    # "it$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v6    # "$i$a$-let-CollectionsKt___CollectionsKt$mapNotNullTo$1$1$iv$iv$iv$iv":I
    ...
    .local v17, "$i$f$findRememberedData":I
    move-object v1, v15

    check-cast v1, Landroidx/compose/ui/tooling/data/Group;

    .local v1, "it$iv$iv":Landroidx/compose/ui/tooling/data/Group;
    const/16 v18, 0x0
    ...
    .end local v2    # "thisData$iv":Ljava/lang/Object;
    .local v21, "thisData$iv":Ljava/lang/Object;
    move-object/from16 v2, v19

    check-cast v2, Lkotlin/jvm/functions/Function1;

    invoke-static {v1, v2}, Landroidx/compose/ui/tooling/PreviewUtils_androidKt;->firstOrNull(Landroidx/compose/ui/tooling/data/Group;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/tooling/data/Group;

    move-result-object v1

    .line 599
    .end local v1    # "it$iv$iv":Landroidx/compose/ui/tooling/data/Group;
    .end local v18    # "$i$a$-mapNotNull-AnimationSearch_androidKt$findRememberedData$rememberCalls$1$iv$iv":I
    if-eqz v1, :cond_a

    .line 574
    .local v1, "it$iv$iv$iv$iv":Ljava/lang/Object;
    const/4 v2, 0x0

    .line 599
    .local v2, "$i$a$-let-CollectionsKt___CollectionsKt$mapNotNullTo$1$1$iv$iv$iv$iv":I
    invoke-interface {v8, v1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 600
    .end local v1    # "it$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v2    # "$i$a$-let-CollectionsKt___CollectionsKt$mapNotNullTo$1$1$iv$iv$iv$iv":I
    ...
    .line 601
    .end local v17    # "$i$f$findRememberedData":I
    .end local v21    # "thisData$iv":Ljava/lang/Object;
    .local v1, "$i$f$findRememberedData":I
    .local v2, "thisData$iv":Ljava/lang/Object;
    :cond_b
    move/from16 v17, v1
    ...
    .restart local v17    # "$i$f$findRememberedData":I
    .restart local v21    # "thisData$iv":Ljava/lang/Object;
    nop
    ...
    .line 603
    .local v1, "rememberCalls$iv$iv":Ljava/util/List;
    move-object v2, v0
    ...
    .local v28, "selfData$iv$iv":Ljava/util/List;
    ...
    .end local v28    # "selfData$iv$iv":Ljava/util/List;
    .local v0, "selfData$iv$iv":Ljava/util/List;
    :cond_d
    move-object/from16 v28, v0

    .end local v0    # "selfData$iv$iv":Ljava/util/List;
    .restart local v28    # "selfData$iv$iv":Ljava/util/List;
    const/4 v0, 0x0
    ...
    .end local v1    # "rememberCalls$iv$iv":Ljava/util/List;
    .local v22, "rememberCalls$iv$iv":Ljava/util/List;
    ...
    .line 616
    .end local v22    # "rememberCalls$iv$iv":Ljava/util/List;
    .end local v28    # "selfData$iv$iv":Ljava/util/List;
    .local v0, "selfData$iv$iv":Ljava/util/List;
    .local v1, "rememberCalls$iv$iv":Ljava/util/List;
    :cond_10
    ...
    .end local v1    # "rememberCalls$iv$iv":Ljava/util/List;
    .end local v4    # "$this$findRememberedData$iv$iv":Ljava/util/Collection;
    .end local v5    # "$i$f$findRememberedData":I
    .end local v28    # "selfData$iv$iv":Ljava/util/List;
    check-cast v0, Ljava/lang/Iterable;
